define(['jquery', 'core/ajax', 'core/notification','core/modal_save_cancel','core/str','core/modal_events', 'mod_wordcards/a4e'],
    function($, Ajax, Notification,ModalSaveCancel, str, ModalEvents, a4e) {
  "use strict"; // jshint ;_;
