...
$string['reviewwords'] = 'Words to review';
$string['addwordsintro'] = 'Add new words to the WordCards activity.';
$string['wordslist'] = 'Words list';
$string['wordslist_help'] = 'Enter the words you want to add to the WordCards activity. Each word should be on a new line. You can add up to 1000 words at once.';
$string['editword'] = 'Edit word';
$string['editdefinition'] = 'Edit definition';
$string['deleteword'] = 'Delete word';
$string['deletewordconfirm'] = 'Are you sure you want to delete this word?';
$string['savechanges'] = 'Save changes';
$string['cancel'] = 'Cancel';
$string['addnewword'] = 'Add new word';
$string['addnewwordsuccess'] = 'New word added successfully!';
$string['editwordsuccess'] = 'Word edited successfully!';
$string['deletewordsuccess'] = 'Word deleted successfully!';
$string['erroraddword'] = 'Error while adding the word. Please try again.';
$string['erroreditword'] = 'Error while editing the word. Please try again.';
$string['errordeleteword'] = 'Error while deleting the word. Please try again.';
$string['emptywordlist'] = 'The words list is empty. Please add at least one word to continue.';
$string['wordnotfound'] = 'Word not found.';
$string['wordalreadyexists'] = 'This word already exists in your list.';
$string['totalwords'] = 'Total number of words: {$a}';
$string['learnedwords'] = 'Learned words: {$a}';
$string['unlearnedwords'] = 'Unlearned words: {$a}';
$string['progress'] = 'Progress';
$string['progressdescription'] = 'Your progress in learning words.';
$string['progressreport'] = 'Progress report';
$string['practiceagain'] = 'Practice again';
$string['viewprogress'] = 'View progress';
$string['resetprogress'] = 'Reset progress';
$string['resetprogressconfirm'] = 'Are you sure you want to reset your progress? This action is irreversible.';
$string['progressreset'] = 'Progress successfully reset!';
$string['errorresetprogress'] = 'Error while resetting progress. Please try again.';
$string['exitactivity'] = 'Exit activity';
$string['exitactivityconfirm'] = 'Are you sure you want to exit the activity? Your progress might not be saved.';
$string['activitycompleted'] = 'Activity completed!';
$string['congratulations'] = 'Congratulations!';
$string['youcompletedactivity'] = 'You have successfully completed this activity.';
