...
$string['recentlylearned'] = 'Recently Learned';
$string['recentlypracticed'] = 'Recently Practiced';
$string['langchooser'] = 'My Native Language';
$string['nextactivity'] = 'Next Activity';
$string['imageonfront'] = 'Image location (learn mode)';
$string['imageonfront_details'] = 'If an image is specified for a wordcard, should it be shown on the front or back of the card in learn mode?';
$string['imageonfront_help'] = 'If an image is specified for a wordcard, should it be shown on the front or back of the card in learn mode?';
$string['cardfront'] = 'Card front';
$string['cardback'] = 'Card back';