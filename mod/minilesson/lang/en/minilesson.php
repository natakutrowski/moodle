...
$string['fluencyresponses'] = 'Enter a list of phrases/sentences in the text area below. Each item should be a on a new line. Optionally add a translation or hint to be shown to student for each sentence, using the format: sentence | <i>hint</i> <br>e.g Hello|<i>Hola</i>';
...
$string['aigentemplate_itemtypes'] = 'Item types';
...
$string['hint'] = 'Hint';
$string['hints'] = 'Hints';
$string['hintrtl'] = 'Hint RTL';
$string['hintrtl_desc'] = 'If checked, the hint will be displayed in right-to-left format.';
$string['scatterdefrtl'] = 'Definition RTL';
$string['scatterdefrtl_desc'] = 'If checked, the definition will be displayed in right-to-left format.';
...
$string['aigenpage_explanation'] = 'Select a lesson template and then set the template options. The AI will use the current activity settings and the information you provide to generate the lesson items. The lesson items will be added to the current activity. In most cases the target language of the current MiniLesson will be used as the language for the generated items.';
$string['aigenpage_notemplates'] = 'There are no AI Generate templates for your selected items (yet).';
...
$string['col:timemodified'] = 'Updated at';
...
$string['sametemplatefound'] = "Template key used in template with name '{\$a->templatename}'";
$string['uploadtemplate'] = 'Upload template';
$string['error:atleast2jsonfiles'] = 'At least two json files needed';
$string['error:templatefilenotuploaded'] = "Template file with name name '*_template.json' not uploaded";
$string['error:templatefilejsonparsingfailed'] = "Template file with name '{\$a}' can not be readed";
$string['error:configfilenotuploaded'] = "Config file with name name '*_template.json' not uploaded";
$string['error:configfilejsonparsingfailed'] = "Config file with name '{\$a}' can not be readed";
$string['error:configfile:uniqueidmissing'] = 'Template uniqueid not defined in config file';
$string['error:configfile:lessontitlemissing'] = 'Template name not defined config file';
$string['error:configfile:lessondescriptionmissing'] = 'Template description not defined in config file';
...
$string['aigentemplatename:choose_best_reply'] = 'Choose the correct reply.';
...
$string['aigentemplatedescription:keywordstogapfillsfluency'] = 'Enter a list of words (maximum 30) and Poodll will make a short activity for students to practice those words';
...
$string['aigentemplatedescription:youtubefinale_freespeak'] = 'This is a lesson based on a YouTube video story. A related but simplified story is prepared and comprehension, and a speaking activity are built on the story.';
...
$string['aigentemplatedescription:spacegame'] = 'Enter 4 - 10 keywords/phrases. The keywords/phrases will be used to generate a space game activity with definitons in the user\'s native language.';
...
$string['aigentemplatedescription:speakinggapfill_generate'] = 'Creates a Speaking GapFill activity from a list of keywords (maximum 30).';
$string['aigentemplatename:typinggapfill_generate'] = 'Typing GapFill (generate sentences)';
$string['aigentemplatedescription:typinggapfill_generate'] = 'Creates a Typing GapFill activity from a list of keywords (maximum 30).';
$string['aigentemplatename:gapfill_set'] = 'GapFill Set';
$string['aigentemplatedescription:gapfill_set'] = 'Creates a full set of Listening, Speaking and Typing GapFills from a list of words (maximum 30).';
$string['aigentemplatename:audiostory_generate'] = 'Audio Story (generate story)';
$string['aigentemplatedescription:audiostory_generate'] = 'Enter a topic, the learners language level and a type of story. AI will prepare a story and images which is like a short narrated slide show using text to speech to narrate the story.';
$string['aigentemplatename:shadow'] = 'Shadow';
$string['aigentemplatedescription:shadow'] = 'Enter a YouTube URL or ID and it will be turned into an interactive shadowing exercise.';
$string['aigentemplatename:listenandspeak_generate'] = 'Listen and Speak (generate sentences)';
$string['aigentemplatedescription:listenandspeak_generate'] = 'Enter a topic and language level. A Listen and Speak item with  5 sentences will be created.';
$string['aigentemplatename:dictation_generate'] = 'Dictation (generate sentences)';
$string['aigentemplatedescription:dictation_generate'] = 'Enter a topic and language level. A Dictation item with 5 sentences will be created.';
$string['aigentemplatename:dictationchat_generate'] = 'Dictation Chat (generate sentences)';
$string['aigentemplatedescription:dictationchat_generate'] = 'Enter a topic and language level. A Dictation Chat item with 5 sentences will be created.';
$string['aigentemplatename:shortanswer'] = 'Short Answer';
$string['aigentemplatedescription:shortanswer'] = 'Enter a topic and language level. A short answer question will be created';
$string['aigentemplatename:passagegapfill_upload'] = 'Passage Gapfill (upload passage)';
$string['aigentemplatedescription:passagegapfill_upload'] = 'Enter a text passage, AI will create add number of "gaps" in the passage for students to complete.';
$string['aigentemplatename:passagegapfill_upload_keywords'] = 'Passage Gapfill (upload passage and keywords)';
$string['aigentemplatedescription:passagegapfill_upload_keywords'] = 'Enter a text passage, and a list of keywords,  AI will create add number of "gaps" in the passage for students to complete.';
$string['aigentemplatename:passagereading_upload'] = 'Passage Reading (upload passage)';
$string['aigentemplatedescription:passagereading_upload'] = 'Upload a passage of text, AI will prepare a passage reading activity from it.';
$string['aigentemplatename:wordshuffle_upload'] = 'Word Shuffle (upload sentences)';
$string['aigentemplatedescription:wordshuffle_upload'] = 'Create a Word Shuffle activity by supplying  4 - 10 sentences. A picture will be generated to go with each sentence in the shuffle activity.';
$string['aigentemplatename:listenandspeak_upload'] = 'Listen and Speak (upload sentences)';
$string['aigentemplatedescription:listenandspeak_upload'] = 'Create a Listen and Speak activity by supplying  up to 5 sentences. A picture will be generated to go with each sentence in the activity.';
$string['aigentemplatename:dictation_upload'] = 'Dictation (upload sentences)';
$string['aigentemplatedescription:dictation_upload'] = 'Create a Dictation item by supplying  up to 5 sentences.';
$string['aigentemplatename:dictationchat_upload'] = 'Dictation Chat (upload sentences)';
$string['aigentemplatedescription:dictationchat_upload'] = 'Create a Dictation Chat item by supplying  up to 5 sentences. A picture will be generated to go with each sentence in the item.';
...
$string['aigentemplatedescription:speakinggapfill_upload'] = 'Creates a Speaking GapFill  by supplying up to 30 sentences. A picture will be generated to go with each sentence in the item.';
$string['aigentemplatename:listeninggapfill_upload'] = 'Listening GapFill (upload sentences)';
$string['aigentemplatedescription:listeninggapfill_upload'] = 'Creates a Listening GapFill  by supplying up to 30 sentences. A picture will be generated to go with each sentence in the item.';
$string['aigentemplatename:reading_speaking_upload'] = 'Reading and Speaking (upload story and keywords)';
...
$string['col:progress'] = 'Progress';
$string['col:timecreated'] = 'Scheduled On';
$string['col:usageid'] = '#';
...
$string['wordshuffle_shuffleorder'] = 'Shuffle sentence order';
$string['wordshuffle_shuffleorder_desc'] = 'If checked, the order in which the sentence sets are presented to the student is randomized. Each sentence keeps its matching image and audio.';
...
$string['cantchat'] = 'Chat is NOT available. To use this item type you must have a valid {$a} key set in the MiniLesson activity admin settings.';

$string['confirm_desc'] = 'You have not finished this step. Are you sure want to go to the next step?';
...
$string['level'] = 'Level';
$string['items'] = 'Items';
$string['lessonitemcreate'] = 'Lesson Item Created Successfully';
$string['error:functionnotfound'] = 'Function not found';
$string['lessonbank:desc'] = 'You can import ready made items from the lesson bank into your MiniLesson activity. Search using the form below and use the "import" button in the search item result to import the lesson items.';
$string['enablelessonbank'] = 'Enable Lesson Bank';
$string['enablelessonbank_details'] = 'Enable Lesson Bank';
...
$string['slides:fontsmallest'] = 'Smallest  ';
