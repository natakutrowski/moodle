...
$string['addbuttonquizitem']='Quiz à Boutons';
...
$string['buttonquiz'] = 'Quiz à Boutons';
...
$string['buttonquiz_results'] = 'Résultats';
$string['compquiz_instructions1'] = 'Instructions pour le Quiz de Compréhension';
$string['buttonquiz_instructions1'] = 'Instructions pour le Quiz à Boutons';
...
$string['fs_totalmarks_instructions'] = 'Le nombre total de points que cet élément de parole libre contribue au score de l\'activité MiniLeçon.';
$string['fw_totalmarks_instructions'] = 'Le nombre total de points que cet élément d\'écriture libre contribue au score de l\'activité MiniLeçon.';
...
$string['alternatestreaming_details'] = 'Diffuse l\'audio enregistré pour une transcription ouverte. Légèrement plus lent que la transcription par défaut du navigateur et ne fonctionne qu\'en anglais. Activé par défaut dans l\'application mobile sur iOS.';
