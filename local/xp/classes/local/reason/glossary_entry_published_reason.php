...
use block_xp\local\reason\glossary_entry_published_reason as parent_glossary_entry_published_reason;
use local_xp\local\utils\context_utils;
use moodle_url;

/**
 * Glossary entry published reason.
 *
 * @package    local_xp
 ...
 */
class glossary_entry_published_reason extends parent_glossary_entry_published_reason implements reason_with_location {
    ...
    protected function get_object_name(): ?string {
        if ($this->objectname === null) {
            ...
            $this->objectname = $db->get_field('glossary_entries',
                'concept',
                ['id' => (int) $this->get_object_id()],
                IGNORE_MISSING
            );
        }
    ...
    public function get_location_url() {
        ...
        return new moodle_url('/mod/glossary/showentry.php', ['eid' => (int) $this->get_object_id()]);
    }
