 ...
 */
class quiz_attempt_finished_reason extends \block_xp\local\reason\quiz_attempt_finished_reason implements reason_with_location {
    ...
    public function get_location_url() {
        ...
        if (!\block_xp\di::get('db')->record_exists('quiz_attempts', ['id' => (int) $this->get_object_id()])) {
