 ...
 */
class chapter_read_reason extends \block_xp\local\reason\chapter_read_reason implements reason_with_location {
    ...
    protected function get_object_name(): ?string {
        if ($this->objectname === null) {
            ...
            $this->objectname = $db->get_field('book_chapters', 'title', ['id' => (int) $this->get_object_id()], IGNORE_MISSING);
        }
    ...
    public function get_location_url() {
        ...
        return new moodle_url('/mod/book/view.php', [
            ...
            'chapterid' => (int) $this->get_object_id(),
        ]);
    }
}
