...
$string['commerce_identity_merge_preferred_identity_safety'] = 'Меняются местами только username и email. Сохранённый аккаунт сохраняет Moodle ID, учебную историю, имя и данные Commerce. Поглощённый аккаунт блокируется и получает прежние данные входа сохранённого аккаунта. Изменение полностью записывается в аудит объединения.';
