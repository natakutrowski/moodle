...
$string['availability_mode'] = 'Доступность страниц Commerce';
$string['availability_mode_desc'] = 'Управляет доступом к публичным страницам Commerce. Режим «Только администраторы» временно закрывает Commerce для клиентов, сохраняя доступ администраторам.';
...
$string['commerce_translations'] = 'Переводы';
$string['commerce_components'] = 'Компоненты';
...
$string['commerce_storefront_edit_language'] = 'Языковая версия';
$string['commerce_storefront_edit_language_help'] = 'Вы редактируете выбранную языковую версию страницы магазина. Блоки, тексты и медиа могут отличаться в разных языках.';
...
$string['commerce_promotion_productskus'] = 'Подходящие продукты';
...
$string['commerce_personal_offer_mail_queue_single'] = 'Поставить письмо в очередь';
...
$string['commerce_identity_merge_m756_scope_detail'] = 'Предпросмотр обнаружил {$a->learning} учебных, {$a->commerce} коммерческих и {$a->gamification} элементов Level Up XP/Quest в объединяемых аккаунтах. Они будут объединены до отключения старых аккаунтов.';
...
$string['commerce_guest_crm_class_provider_paid_pending'] = 'Оплачено у провайдера, продажа всё ещё ожидает';
...
$string['commerce_guest_crm_check_provider'] = 'Проверить у провайдера';
...
$string['commerce_identity_merge_gamification_summary'] = 'Level Up: {$a->xp} XP · завершено квестов: {$a->quests}';
$string['commerce_identity_merge_advanced_mode'] = 'Расширенный режим — собрать итоговый аккаунт по полям';
$string['commerce_identity_merge_advanced_mode_help'] = 'Включите этот режим, чтобы вручную выбрать сохраняемое значение для каждого конфликтующего поля профиля. Email/логин и пароль выбираются отдельно выше. Учебные данные, Commerce, Level Up XP и Quest объединяются без потери истории.';
$string['commerce_identity_merge_advanced_no_profile_conflicts'] = 'Других различающихся данных профиля между этими аккаунтами не обнаружено.';
$string['commerce_identity_merge_advanced_field'] = 'Данные';
$string['commerce_identity_merge_advanced_account_column'] = 'Аккаунт {$a->letter} · #{$a->userid}';
$string['commerce_identity_merge_advanced_identity_note'] = 'Выбор выше относится к профилю Moodle. Идентификаторы входа (email + логин) и пароль имеют отдельные селекторы для соблюдения требований уникальности и безопасности.';
$string['commerce_identity_merge_m16_gamification_title'] = 'Прогресс Level Up восстановлен';
$string['commerce_identity_merge_gamification_incomplete'] = 'Объединение Level Up XP/Quest не завершено: часть данных всё ещё привязана к исходному аккаунту. Транзакция отменена.';
$string['commerce_customer_email_change_action'] = 'Изменить e-mail';
$string['commerce_customer_email_change_title'] = 'Изменить e-mail клиента';
$string['commerce_customer_email_change_description'] = 'Изменяет текущий e-mail в Moodle и Commerce, не переписывая историю покупок.';
$string['commerce_customer_email_change_current'] = 'Текущий адрес: {$a->email}';
$string['commerce_customer_email_change_scope_title'] = 'Что будет изменено';
$string['commerce_customer_email_change_scope_current'] = 'Новый адрес будет записан в профиль Moodle и в текущие права/доступы Commerce, связанные с этим аккаунтом.';
$string['commerce_customer_email_change_scope_history'] = 'Старые заказы, платежи, счета и исторические данные Legacy сохранят e-mail, который использовался в момент покупки.';
$string['commerce_customer_email_change_confirm'] = 'Я подтверждаю, что новый адрес должен стать текущим e-mail этого клиента.';
$string['commerce_customer_email_change_preview'] = 'Предпросмотр';
$string['commerce_customer_email_change_execute'] = 'Применить изменение';
$string['commerce_customer_email_change_preview_title'] = 'Предпросмотр';
$string['commerce_customer_email_change_preview_current'] = '{$a->count} текущих записей идентификации/доступа будут обновлены новым адресом.';
$string['commerce_customer_email_change_preview_history'] = '{$a->count} исторических коммерческих записей останутся без изменений.';
$string['commerce_customer_email_change_success'] = 'Текущий e-mail клиента обновлён.';
$string['commerce_customer_email_change_duplicate'] = 'Этот e-mail уже используется другим активным аккаунтом Moodle.';
$string['commerce_customer_email_change_confirmation_required'] = 'Необходимо явно подтвердить изменение e-mail.';

$string['commerce_customer_email_change_newemail'] = 'Новый адрес электронной почты';
$string['commerce_customer_email_change_newlang'] = 'Новый язык аккаунта';
$string['commerce_customer_email_change_preview_email'] = 'Email';
$string['commerce_customer_email_change_preview_language'] = 'Язык аккаунта';
$string['commerce_customer_email_change_preview_impacted_title'] = 'Что именно будет обновлено';
$string['commerce_customer_email_change_preview_preserved_title'] = 'Что останется без изменений';
$string['commerce_customer_email_change_impact_moodle_user'] = 'Профиль Moodle: изменение email {$a->email}; изменение языка {$a->lang}.';
$string['commerce_customer_email_change_impact_grants'] = '{$a} прав Commerce будут привязаны к новому email.';
$string['commerce_customer_email_change_impact_digital'] = '{$a} записей цифрового доступа будут привязаны к новому email.';
$string['commerce_customer_email_change_impact_offers'] = '{$a} персональных предложений будут привязаны к новому email.';
$string['commerce_customer_email_change_impact_offer_campaigns'] = '{$a} записей участников кампаний персональных предложений будут привязаны к новому email.';
$string['commerce_customer_email_change_impact_grant_campaigns'] = '{$a} записей участников кампаний прав доступа будут привязаны к новому email.';
$string['commerce_customer_email_change_impact_guests'] = '{$a} активных гостевых/сессионных записей идентичности будут привязаны к новому email.';
$string['commerce_customer_email_change_history_purchases'] = '{$a} исторических покупок Commerce сохранят email, указанный при покупке.';
$string['commerce_customer_email_change_history_payments'] = '{$a} исторических запросов на оплату сохранят исходный email.';
$string['commerce_customer_email_change_history_digital_payments'] = '{$a} исторических запросов на цифровую оплату сохранят исходный email.';
$string['commerce_customer_email_change_history_none'] = 'Исторические коммерческие записи не затрагиваются.';

$string['commerce_customer_email_change_impact_moodle_email'] = 'Email в профиле Moodle будет заменён на новый адрес.';
$string['commerce_customer_email_change_impact_moodle_language'] = 'Язык аккаунта Moodle будет заменён на выбранный язык.';

// 7.95N CRM UX and navigation.
$string['crm_nav_showrooms'] = 'Витрины';
$string['crm_nav_dashboard'] = 'CRM Dashboard';
$string['crm_nav_users'] = 'Пользователи';
$string['crm_nav_commerce'] = 'Commerce';
$string['crm_nav_inbox'] = 'Входящие';
$string['crm_nav_work'] = 'Задачи';
$string['crm_nav_assistant'] = 'Ассистент';
$string['crm_nav_tools'] = 'Инструменты';
$string['crm_nav_help'] = 'Помощь';
$string['crm_nav_users_overview'] = 'Все пользователи';
$string['crm_nav_inbox_overview'] = 'Входящие';
$string['crm_nav_diagnostics'] = 'Диагностика';
$string['crm_nav_work_items'] = 'Задачи';
$string['crm_nav_work_teams'] = 'Команды';
$string['crm_nav_tools_overview'] = 'Все инструменты';
$string['crm_nav_tools_history'] = 'История инструментов';
$string['crm_nav_help_overview'] = 'Центр помощи';
$string['crm_nav_open_menu'] = 'Открыть меню «{$a}»';

// Commerce 7.95N2 — дашборд Commerce.
$string['crm_breadcrumb_root'] = 'CRM';
$string['commerce_dashboard_revenue_30d'] = 'Продажи (последние 30 дней)';
$string['commerce_dashboard_orders_30d'] = 'Заказы';
$string['commerce_dashboard_mails_30d'] = 'Отправленные письма';
$string['commerce_dashboard_unfinished_checkouts'] = 'Незавершённые оплаты';
$string['commerce_dashboard_active_offers'] = 'Активные предложения';
$string['commerce_dashboard_customers_30d'] = 'Новые клиенты';
$string['commerce_dashboard_new_today'] = '{$a} новых сегодня';
$string['commerce_dashboard_expiring_7d'] = '{$a} истекают в течение 7 дней';
$string['commerce_dashboard_vs_previous'] = 'к предыдущему периоду';
$string['commerce_dashboard_no_comparison'] = 'Нет данных для сравнения';
$string['commerce_dashboard_sales_30d'] = 'Продажи за последние 30 дней';
$string['commerce_dashboard_sales_chart'] = 'Динамика продаж за последние 30 дней';
$string['commerce_dashboard_latest_sales'] = 'Последние продажи';
$string['commerce_dashboard_view_all_sales'] = 'Все продажи';
$string['commerce_dashboard_no_sales_data'] = 'За этот период пока нет данных.';
$string['commerce_dashboard_quick_actions'] = 'Быстрые действия';
$string['commerce_dashboard_action_create_product'] = 'Создать продукт';
$string['commerce_dashboard_action_create_offer'] = 'Создать персональное предложение';
$string['commerce_dashboard_action_mail'] = 'Управление письмами';
$string['commerce_dashboard_action_import'] = 'Импортировать подписки';
$string['commerce_dashboard_action_unfinished'] = 'Незавершённые оплаты';
$string['commerce_dashboard_action_statistics'] = 'Статистика продаж';
$string['commerce_dashboard_alerts'] = 'Предупреждения';
$string['commerce_dashboard_alert_checkouts'] = '{$a} незавершённых оплат';
$string['commerce_dashboard_alert_offers'] = '{$a} предложений скоро истекают';
$string['commerce_dashboard_alert_mail'] = '{$a} писем с ошибкой';
$string['commerce_dashboard_no_alerts'] = 'Сейчас нет предупреждений Commerce.';
$string['commerce_dashboard_top_products'] = 'Лидеры продаж (30 дней)';
$string['commerce_dashboard_view_statistics'] = 'Посмотреть статистику';
$string['commerce_dashboard_product_summary'] = 'Продукты';
$string['commerce_dashboard_products_total'] = 'Продукты';
$string['commerce_dashboard_products_bundles'] = 'Комплекты';
$string['commerce_dashboard_products_courses'] = 'Курсы';
$string['commerce_dashboard_products_digital'] = 'Цифровые продукты';
$string['commerce_dashboard_active'] = 'Активны';
$string['commerce_dashboard_manage_catalog'] = 'Управление каталогом';
$string['commerce_dashboard_minutes_ago'] = '{$a} мин назад';
$string['commerce_dashboard_hours_ago'] = '{$a} ч назад';

// Commerce 7.95N2.3 dashboard UX.
$string['crm_commerce_nav_showrooms'] = 'Витрины';
$string['crm_commerce_nav_offers_access'] = 'Предложения и доступы';
$string['commerce_dashboard_period_label'] = 'Период';
$string['commerce_dashboard_period_days'] = 'Последние {$a} дней';
$string['commerce_dashboard_revenue'] = 'Оплаченные продажи';
$string['commerce_dashboard_orders_paid'] = 'Оплаченные заказы';
$string['commerce_dashboard_orders_status_foot'] = '{$a->total} начато · {$a->pending} ожидают · {$a->failed} ошибка/отмена';
$string['commerce_dashboard_mails_sent'] = 'Отправленные письма';
$string['commerce_dashboard_new_customers'] = 'Новые клиенты';
$string['commerce_dashboard_conversion_rate'] = 'Конверсия оплаты';
$string['commerce_dashboard_sales_period'] = 'Продажи за выбранный период';
$string['commerce_dashboard_period_today'] = 'Сегодня';
$string['commerce_dashboard_period_7'] = '7 дней';
$string['commerce_dashboard_period_30'] = '30 дней';
$string['commerce_dashboard_period_90'] = '90 дней';
$string['commerce_dashboard_period_365'] = '1 год';
$string['commerce_dashboard_period_apply'] = 'Применить';
$string['commerce_dashboard_alert_pending_orders'] = 'Заказов в ожидании: {$a}';
$string['commerce_dashboard_alert_failed_orders'] = 'Отменённых/ошибочных заказов: {$a}';
$string['commerce_dashboard_alert_grants'] = 'Проблем с выдачей доступа: {$a}';
$string['commerce_dashboard_alert_mail_pending'] = 'Писем в ожидании: {$a}';
$string['commerce_dashboard_top_products_period'] = 'Лучшие продажи';

$string['commerce_dashboard_sales_short'] = 'Продажи';

$string['commerce_dashboard_period_summary'] = 'Итоги за период: {$a->start} — {$a->end}';

$string['commerce_dashboard_action_merge_accounts'] = 'Объединить аккаунты';

$string['commerce_dashboard_product_showroom_summary'] = 'Сводка по продуктам и витринам';
$string['commerce_dashboard_products_section'] = 'Продукты';
$string['commerce_dashboard_showrooms_section'] = 'Витрины';
$string['commerce_dashboard_showrooms_total'] = 'Витрины';
$string['commerce_dashboard_showrooms_published'] = 'Опубликовано';
$string['commerce_dashboard_showrooms_workinprogress'] = 'В работе';
$string['commerce_dashboard_manage_showrooms'] = 'Управлять витринами';

$string['commerce_sales_filters_title'] = 'Фильтры';
$string['commerce_sales_search_placeholder'] = 'Поиск по номеру, клиенту, e-mail или продукту…';
$string['commerce_sales_period'] = 'Период';
$string['commerce_sales_period_today'] = 'Сегодня';
$string['commerce_sales_period_7'] = 'Последние 7 дней';
$string['commerce_sales_period_30'] = 'Последние 30 дней';
$string['commerce_sales_period_90'] = 'Последние 90 дней';
$string['commerce_sales_period_365'] = '1 год';
$string['commerce_sales_period_all'] = 'За всё время';
$string['commerce_sales_period_custom'] = 'Произвольный';
$string['commerce_sales_more_filters'] = 'Дополнительные фильтры';
$string['commerce_sales_date_from'] = 'С';
$string['commerce_sales_date_to'] = 'По';
$string['commerce_sales_currency'] = 'Валюта';
$string['commerce_sales_kpi_matches'] = 'Найденные продажи';
$string['commerce_sales_kpi_revenue'] = 'Полученная выручка';
$string['commerce_sales_kpi_delivered'] = 'Выданные продажи';
$string['commerce_sales_kpi_pending'] = 'В ожидании';
$string['commerce_sales_kpi_failed'] = 'Ошибки / отмены';
$string['commerce_sales_kpi_invalid_checkouts'] = 'Проблемные checkout';
$string['commerce_sales_kpi_invalid_current'] = 'Текущее состояние';
$string['commerce_sales_found'] = 'Найдено продаж: {$a}';
$string['commerce_sales_per_page'] = 'На странице';

$string['commerce_sales_product_type'] = 'Тип продукта';
$string['commerce_sales_columns'] = 'Столбцы';
$string['commerce_sales_export'] = 'Экспорт';
$string['commerce_sales_apply_columns'] = 'Применить';
$string['commerce_sales_more_actions'] = 'Другие действия';
$string['commerce_sales_sort_by'] = 'Сортировать по «{$a->column}» ({$a->direction})';
$string['commerce_sales_sort_ascending'] = 'по возрастанию';
$string['commerce_sales_sort_descending'] = 'по убыванию';
$string['commerce_purchase_payment_status_redirected'] = 'Переход к оплате';
$string['commerce_purchase_payment_status_unknown'] = 'Неизвестно';
$string['commerce_purchase_fulfillment_status_planned'] = 'Запланировано';
$string['commerce_purchase_fulfillment_status_skipped'] = 'Пропущено';

$string['commerce_purchase_payment_status_requires_action'] = 'Требуется действие';
$string['commerce_purchase_payment_status_open'] = 'Открыт';
$string['commerce_purchase_payment_status_complete'] = 'Завершён';
$string['commerce_purchase_payment_status_captured'] = 'Оплата получена';
$string['commerce_purchase_payment_status_authorized'] = 'Авторизован';
$string['commerce_purchase_payment_status_payment_pending'] = 'Ожидает оплаты';
$string['commerce_purchase_fulfillment_status_success'] = 'Успешно';
$string['commerce_purchase_fulfillment_status_succeeded'] = 'Успешно';
$string['commerce_purchase_fulfillment_status_cancelled'] = 'Отменено';
$string['commerce_purchase_fulfillment_status_canceled'] = 'Отменено';

$string['commerce_sales_origin'] = 'Источник';
$string['commerce_sales_origin_personal_offer'] = 'Персональное предложение';
$string['commerce_sales_origin_standard'] = 'Обычная продажа';
$string['commerce_sales_personal_offer_badge'] = 'Персональное предложение';
$string['commerce_sales_kpi_personal_offers'] = 'Персональные предложения';

$string['commerce_sales_filters_toggle'] = 'Поиск и фильтры';
$string['commerce_sales_filters_active'] = 'Фильтры активны';
$string['commerce_sales_filters_collapsed_hint'] = 'Нажмите, чтобы открыть';

$string['commerce_mail_admin_description_n41'] = 'Контроль e-mail коммуникаций Commerce, журнал отправок и состояние почтового движка.';
$string['commerce_mail_nav_label'] = 'Навигация по e-mail Commerce';
$string['commerce_mail_nav_journal'] = 'Журнал писем';
$string['commerce_mail_nav_templates'] = 'Шаблоны писем';
$string['commerce_mail_nav_campaigns'] = 'Кампании';
$string['commerce_mail_health_operational'] = 'Mail Engine работает';
$string['commerce_mail_health_operational_subtitle'] = 'Транзакционный почтовый движок работает и контролируется.';
$string['commerce_mail_health_diagnostic'] = 'Посмотреть диагностику';
$string['commerce_mail_period'] = 'Период';
$string['commerce_mail_period_today'] = 'Сегодня';
$string['commerce_mail_period_7'] = 'Последние 7 дней';
$string['commerce_mail_period_30'] = 'Последние 30 дней';
$string['commerce_mail_period_90'] = 'Последние 90 дней';
$string['commerce_mail_period_365'] = '1 год';
$string['commerce_mail_period_all'] = 'За всё время';
$string['commerce_mail_period_custom'] = 'Свой период';
$string['commerce_mail_search_placeholder_n41'] = 'Получатель, e-mail, ID заказа, ключ идемпотентности…';
$string['commerce_mail_attempts_min'] = 'Минимум попыток';
$string['commerce_mail_date_from'] = 'С';
$string['commerce_mail_date_to'] = 'По';
$string['commerce_mail_more_filters'] = 'Больше фильтров';
$string['commerce_mail_columns'] = 'Столбцы';
$string['commerce_mail_columns_apply'] = 'Применить';
$string['commerce_mail_export'] = 'Экспорт';
$string['commerce_mail_filters_title'] = 'Поиск и фильтры';
$string['commerce_mail_filters_active'] = 'Фильтры активны';
$string['commerce_mail_kpi_total'] = 'Письма';
$string['commerce_mail_kpi_period'] = 'За выбранный период';
$string['commerce_mail_kpi_sent'] = 'Отправлено';
$string['commerce_mail_kpi_pending'] = 'В ожидании';
$string['commerce_mail_kpi_failed'] = 'Ошибки';
$string['commerce_mail_kpi_campaigns'] = 'Активные кампании';
$string['commerce_mail_kpi_campaigns_help'] = 'Черновики / в работе';
$string['commerce_mail_kpi_templates_review'] = 'Шаблоны к проверке';
$string['commerce_mail_kpi_templates_review_help'] = 'Отключённые шаблоны';
$string['commerce_mail_recipient_column'] = 'Получатель';
$string['commerce_mail_context_column'] = 'Контекст';
$string['commerce_mail_last_error'] = 'Последняя ошибка';
$string['commerce_mail_context_personal_offer'] = 'Персональное предложение';
$string['commerce_mail_context_order'] = 'Заказ #{$a}';
$string['commerce_mail_action_preview'] = 'Предпросмотр';
$string['commerce_mail_action_open_order'] = 'Открыть заказ';
$string['commerce_mail_action_open_context'] = 'Открыть предложение / кампанию';
$string['commerce_mail_more_actions'] = 'Другие действия';
$string['commerce_mail_found'] = 'Найдено писем: {$a}';
$string['commerce_mail_per_page'] = 'На странице';

// Commerce 7.95N4.2 — mail journal operational polish.
$string['commerce_mail_search_placeholder_n42'] = 'Получатель, e-mail, заказ, продукт, кампания…';
$string['commerce_mail_send_now'] = 'Отправить сейчас';
$string['commerce_mail_send_now_success'] = 'Письмо отправлено немедленно.';
$string['commerce_mail_send_now_failed'] = 'Не удалось выполнить немедленную отправку. Проверьте статус письма и сведения об ошибке.';
$string['commerce_mail_send_now_not_allowed'] = 'Немедленно отправить можно только письмо, которое сейчас находится в очереди.';
$string['commerce_mail_health_compact_ok'] = 'Движок OK';
$string['commerce_mail_health_compact_issues'] = 'Предупреждения: {$a->warnings} · ошибки: {$a->errors}';
$string['commerce_mail_technical_details'] = 'Технические данные';
$string['commerce_mail_internal_id'] = 'ID письма';
$string['commerce_mail_idempotency_key'] = 'Ключ идемпотентности';

$string['commerce_mail_include_audit'] = 'Показывать AUDIT-письма';
$string['commerce_mail_kpi_offers_sent'] = 'Предложения отправлены';
$string['commerce_mail_kpi_offers_pending'] = 'Предложения в ожидании';
$string['commerce_mail_kpi_sent_last_hour'] = 'Отправлено за последний час';
$string['commerce_mail_kpi_last_check'] = 'Последняя проверка: {$a}';
$string['commerce_mail_kpi_last_check_never'] = 'Последняя проверка: никогда';
$string['commerce_mail_kpi_smtp_load_help'] = 'SMTP-нагрузка без audit-писем';

$string['commerce_mail_nav_configuration'] = 'Настройки';
$string['commerce_mail_configuration_title'] = 'Настройки e-mail';
$string['commerce_mail_configuration_description'] = 'Управляйте обработчиками писем, SMTP-нагрузкой и лимитами Mail Engine.';
$string['commerce_mail_configuration_saved'] = 'Настройки Mail Engine сохранены.';
$string['commerce_mail_configuration_smtp_title'] = 'Ограничение SMTP-нагрузки';
$string['commerce_mail_configuration_smtp_help'] = 'Общий защитный лимит для всех Commerce-писем: транзакционных, персональных предложений и audit-копий.';
$string['commerce_mail_configuration_sent_last_hour'] = 'писем отправлено за последний час';
$string['commerce_mail_configuration_global_hourly'] = 'Общий SMTP-лимит / час';
$string['commerce_mail_configuration_global_hourly_help'] = '0 = без ограничений. Если лимит задан, суммарная отправка всех Commerce-worker’ов не может превысить его за скользящий час.';
$string['commerce_mail_configuration_workers_title'] = 'Обработчики отправки';
$string['commerce_mail_configuration_workers_help'] = 'Переключатели включают или приостанавливают обработку. Плановые задачи Moodle остаются в расписании, поэтому отправку можно возобновить сразу.';
$string['commerce_mail_configuration_transactional_title'] = 'Транзакционные письма';
$string['commerce_mail_configuration_transactional_description'] = 'Подтверждения, доступы, платежные сообщения и другие приоритетные письма клиентам.';
$string['commerce_mail_configuration_personal_title'] = 'Персональные предложения';
$string['commerce_mail_configuration_personal_description'] = 'Отдельный worker кампаний персональных предложений со своим ограничением скорости.';
$string['commerce_mail_configuration_audit_title'] = 'Audit-копии';
$string['commerce_mail_configuration_audit_description'] = 'Технические письма низкого приоритета, отправляемые только когда нет ожидающих клиентских писем.';
$string['commerce_mail_configuration_processing_enabled'] = 'Обработка включена';
$string['commerce_mail_configuration_processing_enabled_help'] = 'Отключение приостанавливает worker, не меняя расписание задачи Moodle.';
$string['commerce_mail_configuration_batch_size'] = 'Писем за batch';
$string['commerce_mail_configuration_hourly_limit'] = 'Лимит в час';
$string['commerce_mail_configuration_hourly_zero_help'] = '0 = без отдельного почасового лимита. Общий SMTP-лимит всё равно действует, если он задан.';
$string['commerce_mail_configuration_transactional_batch_help'] = 'Максимум транзакционных писем за один запуск worker’а.';
$string['commerce_mail_configuration_personal_batch_help'] = 'Максимум писем персональных предложений за один запуск.';
$string['commerce_mail_configuration_personal_hourly_help'] = 'Отдельный лимит персональных предложений за скользящий час.';
$string['commerce_mail_configuration_audit_batch_help'] = 'Максимум audit-копий за один запуск.';
$string['commerce_mail_configuration_audit_hourly_help'] = 'Отдельный лимит audit-копий за скользящий час.';
$string['commerce_mail_configuration_task_active'] = 'Задача Moodle активна';
$string['commerce_mail_configuration_task_disabled'] = 'Задача Moodle отключена';
$string['commerce_mail_configuration_task_missing'] = 'Задача Moodle не найдена';
$string['commerce_mail_configuration_last_run'] = 'Последний запуск: {$a}';
$string['commerce_mail_configuration_next_run'] = 'Следующий запуск: {$a}';
$string['commerce_mail_configuration_cron_note'] = 'Переключатели Commerce не меняют cron-выражения Moodle. Системное расписание настраивается в плановых задачах Moodle.';
$string['commerce_mail_configuration_open_scheduled_tasks'] = 'Открыть плановые задачи';

$string['commerce_mail_library_description'] = 'Единая библиотека шаблонов CampusFR для маркетинговых, транзакционных, персональных, коммерческих и системных писем.';
$string['commerce_mail_library_heading'] = 'Mail Studio · Библиотека шаблонов';
$string['commerce_mail_library_help'] = 'Создавайте, группируйте, дублируйте, экспортируйте и импортируйте шаблоны для будущих кампаний и транзакционных писем.';
$string['commerce_mail_library_new'] = 'Новый шаблон';
$string['commerce_mail_library_import'] = 'Импорт';
$string['commerce_mail_library_export'] = 'Экспорт';
$string['commerce_mail_library_category'] = 'Категория';
$string['commerce_mail_library_category_marketing'] = 'Маркетинг';
$string['commerce_mail_library_category_transactional'] = 'Транзакционный';
$string['commerce_mail_library_category_personal_offer'] = 'Персональное предложение';
$string['commerce_mail_library_category_system'] = 'Системный';
$string['commerce_mail_library_status_draft'] = 'Черновик';
$string['commerce_mail_library_status_active'] = 'Активный';
$string['commerce_mail_library_status_archived'] = 'В архиве';
$string['commerce_mail_library_runtime_live'] = 'Используется в production';
$string['commerce_mail_library_modified'] = 'Изменён {$a}';
$string['commerce_mail_library_native_title'] = 'Шаблоны Mail Studio';
$string['commerce_mail_library_runtime_title'] = 'Текущие транзакционные шаблоны';
$string['commerce_mail_library_runtime_help'] = 'Эти шаблоны пока напрямую используются текущим транзакционным движком. Библиотека показывает их через адаптер и уже позволяет экспортировать в формате Mail Studio.';
$string['commerce_mail_library_transactional_bridge_help'] = 'Текущий транзакционный шаблон · настроено языков: {$a}; для остальных используется встроенный текст.';
$string['commerce_mail_library_edit_transactional'] = 'Редактировать языки';
$string['commerce_mail_library_empty'] = 'Нет шаблонов, соответствующих фильтрам.';
$string['commerce_mail_library_archive'] = 'В архив';
$string['commerce_mail_library_archive_confirm'] = 'Переместить шаблон в архив? Он останется в библиотеке, но больше не будет считаться активным.';
$string['commerce_mail_library_duplicated'] = 'Шаблон продублирован как черновик.';
$string['commerce_mail_library_archived'] = 'Шаблон перемещён в архив.';
$string['commerce_mail_library_copy_suffix'] = 'Копия';
$string['commerce_mail_library_create_title'] = 'Создать шаблон';
$string['commerce_mail_library_edit_title'] = 'Редактировать «{$a}»';
$string['commerce_mail_library_edit_description'] = 'Редактируйте шаблон в Mail Studio и сохраняйте переиспользуемую, переводимую и переносимую структуру.';
$string['commerce_mail_library_name'] = 'Внутреннее название шаблона';
$string['commerce_mail_library_body'] = 'HTML-текст';
$string['commerce_mail_library_language_optional'] = 'Язык необязателен';
$string['commerce_mail_library_foundation_note'] = 'Шаблон хранится в библиотеке Mail Studio. Его использование зависит от категории и связанного контекста отправки.';
$string['commerce_mail_library_import_title'] = 'Импорт шаблона';
$string['commerce_mail_library_import_description'] = 'Импортируйте шаблон CampusFR Mail Studio, экспортированный из этой или другой установки.';
$string['commerce_mail_library_import_drop_title'] = 'Импорт файла Mail Studio';
$string['commerce_mail_library_import_help'] = 'JSON-файл CampusFR Mail Studio (schema campusfr-mail-template v1), максимум 2 МБ. Импорт всегда создаёт новый черновик, чтобы исключить случайную перезапись.';
$string['commerce_mail_library_import_missing'] = 'Выберите JSON-файл для импорта.';
$string['commerce_mail_library_import_too_large'] = 'Размер файла не должен превышать 2 МБ.';
$string['commerce_mail_library_import_success'] = 'Шаблон импортирован как черновик. Теперь его можно проверить и отредактировать.';

$string['commerce_mail_library_builder_note'] = 'Mail Studio теперь использует общий CampusFR Mail Builder. Форматированный текст редактируется в TinyMCE, а переменные и структурные теги совместимы с кампаниями персональных предложений.';
$string['commerce_mail_builder_variables'] = 'Переменные';
$string['commerce_mail_builder_blocks'] = 'Блоки Mail Builder';
$string['commerce_mail_builder_no_variables'] = 'Для этого контекста нет доступных переменных.';
$string['commerce_mail_builder_tag_help'] = 'Нажмите на тег, чтобы скопировать его, затем вставьте в нужное место в TinyMCE.';

$string['commerce_mail_library_builder_badge'] = 'Builder v{$a}';

$string['commerce_personal_offer_mailstudio_title'] = 'Mail Studio';
$string['commerce_personal_offer_mailstudio_help'] = 'Используйте готовый шаблон Mail Studio или сохраните письмо этой кампании как шаблон. При загрузке создаётся независимая копия: дальнейшие изменения шаблона не изменят уже подготовленную кампанию.';
$string['commerce_personal_offer_mailstudio_library'] = 'Библиотека шаблонов';
$string['commerce_personal_offer_mailstudio_snapshot_source'] = 'Контент создан из «{$a}» — независимая копия';
$string['commerce_personal_offer_mailstudio_apply'] = 'Загрузить шаблон';
$string['commerce_personal_offer_mailstudio_apply_help'] = 'Контент FR/EN/RU из шаблона заменит текущий текст кампании. Назначение CTA и showroom останутся без изменений.';
$string['commerce_personal_offer_mailstudio_apply_button'] = 'Загрузить в кампанию';
$string['commerce_personal_offer_mailstudio_empty'] = 'В Mail Studio пока нет шаблонов категории «Персональное предложение».';
$string['commerce_personal_offer_mailstudio_save_as'] = 'Сохранить кампанию как шаблон';
$string['commerce_personal_offer_mailstudio_save_help'] = 'Создаёт новый многоразовый черновик Mail Studio из текущего контента кампании.';
$string['commerce_personal_offer_mailstudio_save_button'] = 'Создать шаблон';
$string['commerce_personal_offer_mailstudio_applied'] = 'Шаблон Mail Studio загружен в кампанию.';
$string['commerce_personal_offer_mailstudio_saved'] = 'Контент кампании сохранён как новый шаблон Mail Studio.';

$string['commerce_mail_type_marketing_campaign'] = 'Маркетинговая кампания';
$string['commerce_mail_context_marketing_campaign'] = 'Маркетинговая кампания';
$string['task_process_marketing_mail_campaigns'] = 'Подготовка запланированных маркетинговых кампаний';
$string['task_process_marketing_mail_queue'] = 'Отправка очереди маркетинговых кампаний';
$string['commerce_marketing_campaigns_title'] = 'Кампании';
$string['commerce_marketing_campaigns_description'] = 'Создавайте и планируйте маркетинговые кампании независимо от персональных предложений, используя шаблоны Mail Studio.';
$string['commerce_marketing_campaign_new'] = 'Новая кампания';
$string['commerce_marketing_campaign_empty'] = 'Маркетинговых кампаний пока нет.';
$string['commerce_marketing_campaign_status_draft'] = 'Черновик';
$string['commerce_marketing_campaign_status_scheduled'] = 'Запланирована';
$string['commerce_marketing_campaign_status_queued'] = 'В процессе';
$string['commerce_marketing_campaign_status_completed'] = 'Завершена';
$string['commerce_marketing_campaign_status_cancelled'] = 'Отменена';
$string['commerce_marketing_campaign_schedule_summary'] = 'Отправка: {$a}';
$string['commerce_marketing_campaign_recipient_count'] = '{$a} получателей';
$string['commerce_marketing_campaign_sent_count'] = '{$a} отправлено';
$string['commerce_marketing_campaign_failed_count'] = '{$a} ошибок';
$string['commerce_marketing_campaign_edit_description'] = 'Выберите маркетинговый шаблон, зафиксируйте аудиторию и запланируйте отправку. Контент шаблона копируется в кампанию при сохранении.';
$string['commerce_marketing_campaign_name'] = 'Название кампании';
$string['commerce_marketing_campaign_template'] = 'Шаблон Mail Studio';
$string['commerce_marketing_campaign_cta_url'] = 'Ссылка CTA';
$string['commerce_marketing_campaign_cta_help'] = 'Блоки {{cta|…}} из шаблона будут использовать эту ссылку. Оставьте пустым, чтобы убрать CTA при рендеринге.';
$string['commerce_marketing_campaign_schedule'] = 'Дата и время отправки';
$string['commerce_marketing_campaign_audience'] = 'Аудитория';
$string['commerce_marketing_campaign_audience_help'] = 'Один получатель на строку: email;имя;фамилия;язык. Имя, фамилию и язык можно не указывать, если найден аккаунт Moodle.';
$string['commerce_marketing_campaign_schedule_button'] = 'Запланировать кампанию';
$string['commerce_marketing_campaign_saved'] = 'Маркетинговая кампания сохранена как черновик.';
$string['commerce_marketing_campaign_scheduled'] = 'Маркетинговая кампания запланирована.';
$string['commerce_marketing_campaign_locked'] = 'Кампания зафиксирована: {$a->total} получателей · {$a->sent} отправлено · {$a->failed} ошибок.';
$string['commerce_mail_configuration_marketing_title'] = 'Маркетинговые кампании';
$string['commerce_mail_configuration_marketing_description'] = 'Универсальные маркетинговые рассылки Mail Studio, не связанные с персональными предложениями.';
$string['commerce_mail_configuration_marketing_batch_help'] = 'Максимальное число маркетинговых писем за один запуск worker’а.';
$string['commerce_mail_configuration_marketing_hourly_help'] = 'Отдельный лимит маркетинговых писем за скользящий час. 0 = без ограничений.';

$string['commerce_mail_transactional_runtime_mailstudio'] = 'Mail Studio активно';
$string['commerce_mail_transactional_runtime_legacy'] = 'Legacy runtime';
$string['commerce_mail_transactional_migrate'] = 'Перенести в Mail Studio';
$string['commerce_mail_transactional_edit_mailstudio'] = 'Редактировать в Mail Studio';
$string['commerce_mail_transactional_edit_legacy'] = 'Legacy-редактор';
$string['commerce_mail_transactional_migrated'] = 'Транзакционный шаблон теперь управляется через Mail Studio.';
$string['commerce_mail_transactional_builder_note'] = 'Динамическая структура транзакционного письма (заказ, доступы, служебные кнопки) сохраняется. Mail Studio управляет редакционной оболочкой: темой, preheader, заголовком, вступлением, завершением и подписью.';
$string['commerce_mail_transactional_headerimage_compatibility'] = 'Изображения заголовка перенесённых транзакционных шаблонов хранятся в Mail Studio. Старый редактор остаётся только как точка совместимости для ещё не перенесённых шаблонов.';

$string['commerce_mail_transactional_migrate_all'] = 'Перенести все транзакционные шаблоны в Mail Studio';
$string['commerce_mail_transactional_migrate_all_confirm'] = 'Перенести все оставшиеся Legacy-транзакционные шаблоны в Mail Studio? Уже перенесённые шаблоны не будут изменены.';
$string['commerce_mail_transactional_migrate_all_done'] = 'Миграция завершена: перенесено {$a->migrated}, уже были в Mail Studio — {$a->already}.';

$string['commerce_mail_configuration_legacy_title'] = 'Исторические автоматические письма';
$string['commerce_mail_configuration_legacy_help'] = 'Эти письма относятся к старому почтовому механизму и не входят в современный Mail Engine. По умолчанию они отключены, чтобы исключить нежелательные старые рассылки.';
$string['commerce_mail_configuration_legacy_warning_title'] = 'Legacy-зона — осторожно';
$string['commerce_mail_configuration_legacy_warning'] = 'Рекомендуется оставить этот раздел отключённым. Cron-задачи продолжат техническую работу (истечение платежа, активация или завершение доступа), но старые письма отправляться не будут.';
$string['commerce_mail_configuration_legacy_master'] = 'Разрешить автоматические Legacy-письма';
$string['commerce_mail_configuration_legacy_master_help'] = 'Главный выключатель. Пока он отключён, ни один из трёх каналов ниже не сможет отправлять письма.';
$string['commerce_mail_configuration_legacy_payment_reminders'] = 'Исторические напоминания об оплате';
$string['commerce_mail_configuration_legacy_payment_reminders_help'] = 'Разрешает T_REMINDER_FIRST и T_REMINDER_SECOND из followup_task. Техническое истечение платёжных запросов продолжает работать.';
$string['commerce_mail_configuration_legacy_expiry_reminders'] = 'Напоминания об окончании подписки';
$string['commerce_mail_configuration_legacy_expiry_reminders_help'] = 'Разрешает T_SUBSCRIPTION_EXPIRY_REM из send_expiry_reminders_task.';
$string['commerce_mail_configuration_legacy_lifecycle'] = 'Исторические уведомления об активации / окончании';
$string['commerce_mail_configuration_legacy_lifecycle_help'] = 'Разрешает T_SUBSCRIPTION_ACTIVATED и T_SUBSCRIPTION_EXPIRED из cron жизненного цикла. Изменения доступа продолжают работать без этих писем.';
$string['commerce_mail_configuration_legacy_task_followup'] = 'Cron контроля платежей';
$string['commerce_mail_configuration_legacy_task_expiry'] = 'Cron напоминаний об окончании';
$string['commerce_mail_configuration_legacy_task_lifecycle'] = 'Cron жизненного цикла подписок';

$string['commerce_mail_library_delete'] = 'Удалить';
$string['commerce_mail_library_delete_confirm'] = 'Навсегда удалить этот архивный шаблон Mail Studio? Это действие нельзя отменить.';
$string['commerce_mail_library_deleted'] = 'Шаблон Mail Studio удалён навсегда.';
$string['commerce_mail_library_delete_in_use'] = 'Шаблон нельзя удалить: на него всё ещё ссылаются маркетинговые кампании ({$a}). Историю кампаний необходимо сохранить.';

$string['commerce_mail_library_category_sales_followup'] = 'Коммерческие напоминания';
$string['commerce_mail_type_sales_followup'] = 'Коммерческое напоминание';
$string['commerce_sales_followup_action'] = 'Написать клиенту';
$string['commerce_sales_followup_title'] = 'Коммерческое напоминание';
$string['commerce_sales_followup_description'] = 'Подготовьте письмо из Mail Studio, адаптируйте его под контекст продажи, проверьте предпросмотр и явно подтвердите отправку.';
$string['commerce_sales_followup_not_eligible'] = 'Эта продажа больше не подходит для коммерческого напоминания. Возможно, оплата уже завершена или нет подходящего e-mail клиента.';
$string['commerce_sales_followup_invalid_template'] = 'Выбранный шаблон напоминания недоступен.';
$string['commerce_sales_followup_no_templates'] = 'В Mail Studio нет шаблонов коммерческого напоминания.';
$string['commerce_sales_followup_context_title'] = 'Контекст продажи';
$string['commerce_sales_followup_customer'] = 'Клиент';
$string['commerce_sales_followup_order'] = 'Заказ';
$string['commerce_sales_followup_product'] = 'Продукт';
$string['commerce_sales_followup_amount'] = 'Сумма';
$string['commerce_sales_followup_payment_status'] = 'Оплата';
$string['commerce_sales_followup_language'] = 'Язык';
$string['commerce_sales_followup_template'] = 'Шаблон Mail Studio';
$string['commerce_sales_followup_load_template'] = 'Загрузить шаблон';
$string['commerce_sales_followup_preview'] = 'Предпросмотр';
$string['commerce_sales_followup_preview_title'] = 'Предпросмотр письма';
$string['commerce_sales_followup_send_now'] = 'Отправить сейчас';
$string['commerce_sales_followup_send_confirm'] = 'Отправить это коммерческое напоминание клиенту сейчас? Письмо будет записано в Mail Engine и связано с продажей.';
$string['commerce_sales_followup_sent'] = 'Коммерческое напоминание отправлено и записано в журнал.';
$string['commerce_sales_followup_send_failed'] = 'Письмо добавлено в Mail Engine, но немедленная отправка не завершилась. Проверьте детали письма.';
$string['commerce_sales_followup_resume_payment'] = 'Завершить покупку';
$string['commerce_sales_followup_no_resume_url'] = 'Для этой продажи нет надёжной ссылки для продолжения оплаты. Блок {{resume_payment}} будет просто удалён из письма.';
$string['commerce_sales_followup_previous'] = 'Для этой продажи уже создано напоминаний: {$a->count}. Последнее: {$a->date}.';

$string['commerce_sales_followup_open_library'] = 'Открыть шаблоны напоминаний в Mail Studio';

$string['commerce_sales_actions_customer'] = 'Клиент';
$string['commerce_sales_actions_communication'] = 'Коммуникация';
$string['commerce_sales_actions_commercial'] = 'Коммерческие действия';
$string['commerce_sales_actions_order'] = 'Заказ';
$string['commerce_sales_action_open_user360'] = 'Открыть User360';
$string['commerce_sales_action_resend_invoice'] = 'Отправить счёт повторно';
$string['commerce_sales_action_resend_invoice_help'] = 'Повторно отправляет письмо с чеком и PDF-счётом во вложении.';
$string['commerce_sales_action_resend_invoice_confirm'] = 'Повторно отправить клиенту письмо с чеком и PDF-счётом во вложении?';
$string['commerce_sales_action_resend_access'] = 'Отправить доступы повторно';
$string['commerce_sales_action_create_offer'] = 'Создать персональное предложение';

$string['commerce_sales_subnav_label'] = 'Навигация по продажам';
$string['commerce_sales_subnav_sales'] = 'Продажи';
$string['commerce_sales_subnav_unfinished'] = 'Незавершённые оплаты';
$string['commerce_sales_adminstate'] = 'Административный статус';
$string['commerce_sales_adminstate_open'] = 'Активные продажи';
$string['commerce_sales_adminstate_closed'] = 'Закрытые продажи';
$string['commerce_sales_adminstate_all'] = 'Все продажи';
$string['commerce_sales_admin_closed_badge'] = 'Закрыта';
$string['commerce_sales_actions_administration'] = 'Администрирование';
$string['commerce_sales_action_view_details'] = 'Открыть детали';
$string['commerce_sales_action_close'] = 'Закрыть продажу';
$string['commerce_sales_action_close_confirm'] = 'Закрыть продажу административно? Она останется в истории, но по умолчанию будет скрыта из списка.';
$string['commerce_sales_action_reopen'] = 'Открыть продажу снова';
$string['commerce_sales_close_not_allowed'] = 'Эту продажу нельзя закрыть вручную. Доступно для неудачных/отменённых продаж или ожидающих оплату не менее 24 часов.';
$string['commerce_sales_close_default_reason'] = 'Ручное закрытие из CRM';
$string['commerce_sales_closed_success'] = 'Продажа административно закрыта.';
$string['commerce_sales_reopened_success'] = 'Продажа снова открыта и отображается среди активных.';
$string['commerce_guest_crm_search_placeholder'] = 'E-mail, клиент, номер заказа или продукт…';
$string['commerce_guest_crm_filter_status'] = 'Ситуация';
$string['commerce_guest_crm_kpi_total'] = 'Требуют внимания';
$string['commerce_guest_crm_kpi_pending'] = 'Ожидает оплаты';
$string['commerce_guest_crm_kpi_multiple'] = 'Несколько покупок';
$string['commerce_guest_crm_kpi_provider_paid'] = 'Оплачено у провайдера';
$string['commerce_guest_crm_kpi_provisional'] = 'Без покупки';
$string['commerce_guest_crm_column_client'] = 'Клиент';
$string['commerce_guest_crm_column_checkout'] = 'Checkout';
$string['commerce_guest_crm_column_purchase'] = 'Покупка / продукт';
$string['commerce_guest_crm_column_payment'] = 'Оплата';
$string['commerce_guest_crm_column_status'] = 'Ситуация';
$string['commerce_guest_crm_column_age'] = 'Возраст';
$string['commerce_guest_crm_age_minutes'] = '{$a} мин';
$string['commerce_guest_crm_age_hours'] = '{$a} ч';
$string['commerce_guest_crm_age_days'] = '{$a} дн';

$string['commerce_sales_closed_banner'] = 'Эта продажа была административно закрыта {$a}. Она остаётся доступной в истории.';

$string['commerce_mail_library_subject'] = 'Тема';

$string['commerce_sales_action_view_customer_order'] = 'Открыть страницу клиента';
$string['commerce_order_details_back_to_sales'] = 'Вернуться к продажам';
$string['commerce_mail_actions_message'] = 'Письмо';
$string['commerce_mail_actions_delivery'] = 'Отправка';
$string['commerce_mail_actions_context'] = 'Контекст';

$string['commerce_mail_filters_collapsed_hint'] = 'Нажмите, чтобы открыть';

$string['commerce_guest_crm_search_filters_title'] = 'Поиск и фильтры';
$string['commerce_guest_crm_account_id'] = 'Аккаунт #{$a}';
$string['commerce_guest_crm_checkout_id'] = 'Платёжная сессия #{$a}';
$string['commerce_guest_crm_unknown_product'] = 'Продукт не определён';
$string['commerce_guest_crm_resume_active'] = 'Возобновление оплаты активно';
$string['commerce_guest_crm_provider_state'] = 'Статус провайдера: {$a}';
$string['commerce_guest_crm_provider_status_open'] = 'Открыт';
$string['commerce_guest_crm_provider_status_unpaid'] = 'Не оплачено';
$string['commerce_guest_crm_provider_status_open_unpaid'] = 'Открыт · не оплачено';
$string['commerce_guest_crm_provider_status_paid'] = 'Оплачено';
$string['commerce_guest_crm_provider_status_succeeded'] = 'Оплачено';
$string['commerce_guest_crm_provider_status_pending'] = 'Ожидает';
$string['commerce_guest_crm_provider_status_authorized'] = 'Авторизовано';
$string['commerce_guest_crm_provider_status_declined'] = 'Отклонено';
$string['commerce_guest_crm_provider_status_cancelled'] = 'Отменено';
$string['commerce_guest_crm_provider_status_canceled'] = 'Отменено';
$string['commerce_guest_crm_provider_status_failed'] = 'Ошибка оплаты';
$string['commerce_guest_crm_provider_status_error'] = 'Ошибка';
$string['commerce_guest_crm_provider_status_expired'] = 'Истёк';
$string['commerce_guest_crm_help_legend_title'] = 'Как читать незавершённые оплаты';
$string['commerce_guest_crm_help_legend_hint'] = 'Нажмите, чтобы открыть пояснения';
$string['commerce_guest_crm_help_checkout_title'] = 'Незавершённый checkout';
$string['commerce_guest_crm_help_checkout_text'] = 'Клиент начал оплату, но процесс ещё не завершился полноценной продажей. Это не обязательно означает ошибку платежа.';
$string['commerce_guest_crm_help_resume_title'] = 'Возобновление оплаты активно';
$string['commerce_guest_crm_help_resume_text'] = 'Этот значок показывает покупку, которая сейчас связана с сессией возобновления оплаты. Именно её клиент увидит, если продолжит checkout.';
$string['commerce_guest_crm_help_provider_title'] = 'Платёжный провайдер';
$string['commerce_guest_crm_help_provider_text'] = 'Логотип показывает использованного платёжного провайдера. Рядом указан статус в Commerce; если выполнялась проверка у провайдера, её результат показан ниже.';
$string['commerce_guest_crm_help_situations_title'] = 'Ситуация';
$string['commerce_guest_crm_help_situations_text'] = 'Ситуация кратко описывает основную проблему: платёж ожидает, несколько конкурирующих покупок, платёж подтверждён провайдером, но ещё ожидает в CampusFR, заблокированная идентификация или checkout без покупки.';

$string['commerce_result_scope_label'] = 'Выборка';
$string['commerce_result_scope_period_all'] = 'Период: все даты';
$string['commerce_result_scope_period_range'] = 'Период: {$a->from} → {$a->to}';
$string['commerce_result_scope_period_named'] = 'Период: {$a}';
$string['commerce_result_scope_search'] = 'Поиск: {$a}';
$string['commerce_result_scope_product_type'] = 'Тип: {$a}';
$string['commerce_result_scope_commercial_status'] = 'Статус: {$a}';
$string['commerce_result_scope_provider'] = 'Провайдер: {$a}';
$string['commerce_result_scope_currency'] = 'Валюта: {$a}';
$string['commerce_result_scope_origin'] = 'Источник: {$a}';
$string['commerce_result_scope_payment'] = 'Оплата: {$a}';
$string['commerce_result_scope_fulfillment'] = 'Выдача доступа: {$a}';
$string['commerce_result_scope_admin_state'] = 'Состояние: {$a}';
$string['commerce_result_scope_mail_type'] = 'Тип: {$a}';
$string['commerce_result_scope_mail_status'] = 'Статус: {$a}';
$string['commerce_result_scope_language'] = 'Язык: {$a}';
$string['commerce_result_scope_purchase'] = 'Заказ #{$a}';
$string['commerce_result_scope_attempts'] = 'Попыток ≥ {$a}';
$string['commerce_result_scope_audit_excluded'] = 'AUDIT исключены';
$string['commerce_result_scope_audit_included'] = 'AUDIT включены';
$string['commerce_result_scope_remove_filter'] = 'Убрать этот фильтр';
$string['commerce_result_scope_remove_filter_named'] = 'Убрать фильтр «{$a}»';

$string['commerce_filters_apply'] = 'Применить';

// Commerce N7.1 — единый раздел предложений и доступов.
$string['crm_commerce_nav_offers_access'] = 'Предложения и доступы';
$string['commerce_offers_access_title'] = 'Предложения и доступы';
$string['commerce_offers_access_description'] = 'Управляйте персональными предложениями и доступами, выданными клиентам напрямую.';
$string['commerce_offers_access_tab_overview'] = 'Обзор';
$string['commerce_offers_access_tab_offers'] = 'Персональные предложения';
$string['commerce_offers_access_tab_grants'] = 'Выдача доступов';
$string['commerce_offers_access_tab_campaigns'] = 'Кампании';
$string['commerce_offers_access_question'] = 'Что вы хотите сделать?';
$string['commerce_offers_access_offer_title'] = 'Предложить особую цену';
$string['commerce_offers_access_offer_description'] = 'Предложить специальную цену одному или нескольким клиентам.';
$string['commerce_offers_access_offer_action'] = 'Создать предложение';
$string['commerce_offers_access_grant_title'] = 'Выдать доступ';
$string['commerce_offers_access_grant_description'] = 'Предоставить прямой доступ к продукту или курсу.';
$string['commerce_offers_access_grant_action'] = 'Выдать доступ';
$string['commerce_offers_access_beneficiary_hint'] = 'Получателей — одного клиента или нескольких — можно будет выбрать на следующем шаге.';
$string['commerce_offers_access_kpi_active_offers'] = 'Активные предложения';
$string['commerce_offers_access_kpi_used_offers'] = 'Использованные предложения';
$string['commerce_offers_access_kpi_grants'] = 'Выданные доступы';
$string['commerce_offers_access_kpi_campaigns'] = 'Активные кампании';
$string['commerce_offers_access_kpi_pending'] = 'В ожидании';
$string['commerce_offers_access_kpi_attention'] = 'Требуют проверки';
$string['commerce_offers_access_kpi_now'] = 'сейчас';
$string['commerce_offers_access_kpi_total'] = 'всего';
$string['commerce_offers_access_kpi_active'] = 'в работе';
$string['commerce_offers_access_kpi_to_process'] = 'к обработке';
$string['commerce_offers_access_kpi_to_check'] = 'нужно действие';
$string['commerce_offers_access_recent_title'] = 'Последняя активность';
$string['commerce_offers_access_recent_hint'] = 'Последние предложения и выдачи доступов появятся здесь на следующем этапе.';
$string['commerce_offers_access_view_all'] = 'Все кампании';
$string['commerce_offers_access_campaigns_title'] = 'Кампании';
$string['commerce_offers_access_campaigns_description'] = 'Подготавливайте и отслеживайте операции для нескольких клиентов.';
$string['commerce_offers_access_new_offer_campaign'] = 'Новая кампания предложений';
$string['commerce_offers_access_new_grant_campaign'] = 'Новая кампания доступов';
$string['commerce_offers_access_campaign_action'] = 'Действие';
$string['commerce_offers_access_campaign_audience'] = 'Аудитория';
$string['commerce_offers_access_campaign_progress'] = 'Прогресс';
$string['commerce_offers_access_kind_offer'] = 'Персональное предложение';
$string['commerce_offers_access_kind_grant'] = 'Выдача доступа';
$string['commerce_offers_access_campaigns_empty'] = 'Кампаний пока нет.';

$string['commerce_offers_access_create_title'] = 'Новое действие';
$string['commerce_offers_access_create_description'] = 'Сначала выберите, что вы хотите предоставить. Получатели будут выбраны на следующем шаге.';
$string['commerce_offers_access_create_audience_title'] = 'Выбрать получателей';
$string['commerce_offers_access_create_audience_description'] = 'Укажите, относится ли действие к одному клиенту или к группе клиентов.';
$string['commerce_offers_access_create_question'] = 'Что вы хотите сделать?';
$string['commerce_offers_access_create_offer'] = 'Создать предложение';
$string['commerce_offers_access_create_offer_help'] = 'Предложить специальную цену или условия, не выдавая доступ сразу.';
$string['commerce_offers_access_create_grant'] = 'Выдать доступ';
$string['commerce_offers_access_create_grant_help'] = 'Сразу предоставить продукт или курс независимо от продажи.';
$string['commerce_offers_access_create_continue'] = 'Продолжить';
$string['commerce_offers_access_create_selected_action'] = 'Выбранное действие';
$string['commerce_offers_access_create_who'] = 'Кому это предоставить?';
$string['commerce_offers_access_create_one'] = 'Одному клиенту';
$string['commerce_offers_access_create_one_help'] = 'Найдите или выберите одного клиента, затем настройте предложение или доступ.';
$string['commerce_offers_access_create_many'] = 'Нескольким клиентам';
$string['commerce_offers_access_create_many_help'] = 'Определите аудиторию, выполните симуляцию и зафиксируйте получателей перед запуском.';
$string['commerce_offers_access_workflow_beneficiaries'] = 'Получатели';
$string['commerce_offers_access_workflow_offer'] = 'Предложение';
$string['commerce_offers_access_workflow_access'] = 'Доступ';
$string['commerce_offers_access_workflow_verification'] = 'Проверка';
$string['commerce_offers_access_workflow_execution'] = 'Запуск';
$string['commerce_offers_access_workflow_one'] = '1 клиент';
$string['commerce_offers_access_workflow_many'] = 'Несколько клиентов';
$string['commerce_offers_access_new_campaign'] = 'Новая кампания';

$string['commerce_offers_access_config_identity_help'] = 'Дайте операции понятное название. Технические идентификаторы остаются в дополнительных настройках.';
$string['commerce_offers_access_config_technical'] = 'Техническая информация';
$string['commerce_offers_access_config_optional'] = 'Необязательно · будет создано автоматически, если поле пустое';
$string['commerce_offers_access_config_audience_help'] = 'Определите нужную аудиторию. Сложные правила доступны в дополнительных настройках.';
$string['commerce_offers_access_config_advanced_audience'] = 'Расширенные настройки аудитории';
$string['commerce_offers_access_config_advanced_audience_hint'] = 'Дополнительные источники, даты, исключения и сложные правила';
$string['commerce_offers_access_config_offer_help'] = 'Выберите продукт, коммерческие условия и срок действия.';
$string['commerce_offers_access_config_summary_offer_campaign'] = 'Сводка кампании предложений';
$string['commerce_offers_access_config_summary_offer'] = 'Сводка предложения';
$string['commerce_offers_access_config_summary_grant_campaign'] = 'Сводка выдачи доступа';
$string['commerce_offers_access_config_not_set'] = 'Нужно указать';
$string['commerce_offers_access_config_audience'] = 'Получатели';
$string['commerce_offers_access_config_product'] = 'Продукт';
$string['commerce_offers_access_config_conditions'] = 'Условия';
$string['commerce_offers_access_config_validity'] = 'Срок действия';
$string['commerce_offers_access_config_mailstudio_title'] = 'Коммуникация';
$string['commerce_offers_access_config_mailstudio_help'] = 'Создание писем остаётся централизованным в Mail Studio. Mail Engine отвечает за отправку и журналирование.';
$string['commerce_offers_access_config_open_mailstudio'] = 'Открыть Mail Studio';
$string['commerce_offers_access_config_bulk_audience_title'] = 'Определить получателей и доступ';
$string['commerce_offers_access_config_bulk_audience_help'] = 'Выберите исходную аудиторию и целевой продукт, затем запустите симуляцию до любых изменений.';
$string['commerce_offers_access_config_source'] = 'Исходная аудитория';
$string['commerce_offers_access_config_mode'] = 'Режим';
$string['commerce_offers_access_config_simulation_required'] = 'Нужно запустить симуляцию';
$string['commerce_offers_access_config_open_user360'] = 'Открыть User360';
$string['commerce_offers_access_config_technical_evidence'] = 'Показать технические детали';
$string['commerce_offers_access_config_communication'] = 'Коммуникация с получателями';
$string['commerce_offers_access_config_beneficiary_title'] = 'Получатель';
$string['commerce_offers_access_config_beneficiary_help'] = 'Выберите клиента. Информация о связях и источнике находится в дополнительных настройках.';
$string['commerce_offers_access_config_context_title'] = 'Контекст и привязка';
$string['commerce_offers_access_config_context_hint'] = 'Кампания, покупка или исходный продукт · необязательно';
$string['commerce_offers_access_config_communication_hint'] = 'Изображение и шаблон письма';
$string['commerce_offers_access_config_beneficiary'] = 'Клиент';
$string['commerce_offers_access_config_no_limit'] = 'Срок не задан';

$string['commerce_offers_access_config_manual_access_title'] = 'Настроить доступ';
$string['commerce_offers_access_config_manual_access_help'] = 'Выберите клиента, продукт и параметры доступа. Существующие механизмы выдачи доступа не меняются.';
$string['commerce_offers_access_config_summary_grant'] = 'Сводка доступа';
$string['commerce_offers_access_config_choose_in_form'] = 'Выберите в форме';

$string['commerce_offers_access_campaign_step_configuration'] = 'Настройка';
$string['commerce_offers_access_campaign_step_configuration_done'] = 'Настройка готова';
$string['commerce_offers_access_campaign_step_audience'] = 'Аудитория';
$string['commerce_offers_access_campaign_step_audience_count'] = 'Получателей: {$a}';
$string['commerce_offers_access_campaign_step_audience_waiting'] = 'Нужно рассчитать аудиторию';
$string['commerce_offers_access_campaign_step_snapshot'] = 'Зафиксированная аудитория';
$string['commerce_offers_access_campaign_step_snapshot_done'] = 'Зафиксировано получателей: {$a}';
$string['commerce_offers_access_campaign_step_snapshot_waiting'] = 'Нужно зафиксировать аудиторию';
$string['commerce_offers_access_campaign_step_execution'] = 'Запуск';
$string['commerce_offers_access_campaign_step_execution_waiting'] = 'Готово к запуску';
$string['commerce_offers_access_campaign_step_execution_running'] = 'Обработано получателей: {$a}';
$string['commerce_offers_access_campaign_step_execution_done'] = 'Обработано получателей: {$a}';
$string['commerce_offers_access_campaign_step_complete'] = 'Завершение';
$string['commerce_offers_access_campaign_step_complete_waiting'] = 'Ожидание завершения';
$string['commerce_offers_access_campaign_step_complete_done'] = 'Кампания завершена';
$string['commerce_offers_access_campaign_step_complete_errors'] = 'Завершено с ошибками: {$a}';
$string['commerce_offers_access_campaign_summary_title'] = 'Сводка кампании';
$string['commerce_offers_access_campaign_selected'] = 'Выбрано получателей';
$string['commerce_offers_access_campaign_status'] = 'Статус';
$string['commerce_offers_access_campaign_communication_title'] = 'Коммуникация';
$string['commerce_offers_access_campaign_mail_queued'] = 'В ожидании';
$string['commerce_offers_access_campaign_mail_sent'] = 'Отправлено';
$string['commerce_offers_access_campaign_mail_failed'] = 'Ошибки';
$string['commerce_offers_access_campaign_open_mail_journal'] = 'Открыть журнал писем';
$string['commerce_offers_access_campaign_member_details'] = 'Детали';

$string['commerce_offers_access_search_filters'] = 'Поиск и фильтры';
$string['commerce_offers_access_period'] = 'Период';
$string['commerce_offers_access_period_7'] = 'Последние 7 дней';
$string['commerce_offers_access_period_30'] = 'Последние 30 дней';
$string['commerce_offers_access_period_90'] = 'Последние 90 дней';
$string['commerce_offers_access_period_365'] = '1 год';
$string['commerce_offers_access_period_all'] = 'Все даты';
$string['commerce_offers_access_offers_found'] = 'Найдено предложений: {$a}';
$string['commerce_offers_access_created'] = 'Создано';
$string['commerce_offers_access_grants_workspace_description'] = 'Просматривайте фактически выданные клиентам доступы и их состояние без лишних технических идентификаторов.';
$string['commerce_offers_access_grants_kpi_total'] = 'Выдачи доступа';
$string['commerce_offers_access_grants_kpi_active'] = 'Активные доступы';
$string['commerce_offers_access_grants_kpi_pending'] = 'В ожидании';
$string['commerce_offers_access_grants_kpi_failed'] = 'Требуют проверки';
$string['commerce_offers_access_grants_search_placeholder'] = 'Клиент, email или продукт…';
$string['commerce_offers_access_grants_found'] = 'Найдено выдач: {$a}';
$string['commerce_offers_access_grants_empty'] = 'Нет выдач доступа по выбранным критериям.';
$string['commerce_offers_access_grant_status_planned'] = 'В ожидании';
$string['commerce_offers_access_grant_status_active'] = 'Доступ выдан';
$string['commerce_offers_access_grant_status_failed'] = 'Ошибка';
$string['commerce_offers_access_validity'] = 'Срок действия';
$string['commerce_offers_access_recent_grant_campaigns'] = 'Недавние кампании выдачи доступа';
$string['commerce_offers_access_campaign_state_active'] = 'В процессе';
$string['commerce_offers_access_campaign_state_completed'] = 'Завершённые';
$string['commerce_offers_access_campaign_state_error'] = 'С ошибками';
$string['commerce_offers_access_campaign_kpi_total'] = 'Кампании';
$string['commerce_offers_access_campaign_kpi_active'] = 'В процессе';
$string['commerce_offers_access_campaign_kpi_completed'] = 'Завершено';
$string['commerce_offers_access_campaign_kpi_error'] = 'Требуют проверки';
$string['commerce_offers_access_campaign_search_placeholder'] = 'Название кампании…';
$string['commerce_offers_access_campaigns_found'] = 'Найдено кампаний: {$a}';

$string['commerce_personal_offer_eligibility_detail'] = 'Подробности';
$string['commerce_offers_access_offer_detail_help'] = 'Просматривайте предложение, получателя, условия, коммуникацию и жизненный цикл на одном экране.';
$string['commerce_offers_access_now'] = 'Сейчас';
$string['commerce_offers_access_no_expiry'] = 'Без срока действия';
$string['commerce_offers_access_offer_mail_journal'] = 'Открыть письма';
$string['commerce_offers_access_open_source_sale'] = 'Открыть исходную продажу';
$string['commerce_offers_access_open_redeemed_sale'] = 'Открыть использованную продажу';
$string['commerce_offers_access_open_campaign'] = 'Открыть кампанию';
$string['commerce_offers_access_offer_context'] = 'Источник и условия';
$string['commerce_offers_access_last_mail_sent'] = 'Последнее отправленное письмо';
$string['commerce_offers_access_management'] = 'Управление';
$string['commerce_offers_access_grant_detail_title'] = 'Детали доступа';
$string['commerce_offers_access_grant_detail_help'] = 'Просматривайте фактически выданный доступ, его источник, срок действия и связанную коммуникацию.';
$string['commerce_offers_access_grant_status_completed'] = 'Завершено';
$string['commerce_offers_access_grant_quantity'] = 'Количество';
$string['commerce_offers_access_grant_access_title'] = 'Выданный доступ';
$string['commerce_offers_access_grant_type'] = 'Тип доступа';
$string['commerce_offers_access_grant_no_sale'] = 'Выдача вне продажи';
$string['commerce_offers_access_grant_origin_title'] = 'Источник';
$string['commerce_offers_access_grant_lifecycle_title'] = 'Жизненный цикл';
$string['commerce_offers_access_grant_mail_journal'] = 'Журнал писем';
$string['commerce_offers_access_grant_reference'] = 'Ссылка доступа';
$string['commerce_offers_access_grant_resource'] = 'Ресурс';
$string['commerce_offers_access_grant_idempotency'] = 'Ключ идемпотентности';
$string['commerce_offers_access_grant_item_reference'] = 'Ссылка элемента';
$string['commerce_offers_access_grant_configuration'] = 'Конфигурация';
$string['commerce_offers_access_grant_metadata'] = 'Метаданные';
$string['commerce_offers_access_source_sale'] = 'Исходная продажа';

$string['commerce_offers_access_remove_filter'] = 'Убрать этот фильтр';
$string['commerce_offers_access_offers_empty_title'] = 'Нет предложений для отображения';
$string['commerce_offers_access_offers_empty_help'] = 'По выбранным условиям предложений нет. Измените фильтры или создайте новое предложение.';
$string['commerce_offers_access_grants_empty_title'] = 'Нет доступов для отображения';
$string['commerce_offers_access_campaigns_empty_title'] = 'Нет кампаний для отображения';
$string['commerce_offers_access_change'] = 'Изменить';

$string['commerce_offers_access_product_legacy'] = 'Legacy';
$string['commerce_personal_offer_mail_template'] = 'Шаблон письма';
$string['commerce_personal_offer_mail_template_default'] = 'Стандартный транзакционный шаблон';
$string['commerce_personal_offer_mail_template_help'] = 'Выбранный шаблон фиксируется вместе с предложением. Последующие изменения в Mail Studio не изменят это письмо.';
$string['commerce_personal_offer_no_expiration'] = 'Предложение не имеет срока действия';
$string['commerce_personal_offer_no_expiration_help'] = 'Отметьте этот пункт только если предложение действительно должно оставаться бессрочным.';
$string['commerce_personal_offer_expiration_required'] = 'Укажите дату и время окончания или отметьте «Предложение не имеет срока действия».';
$string['commerce_personal_offer_expiration_after_start'] = 'Дата окончания должна быть позже начала действия.';

$string['commerce_personal_offer_mail_refresh_status'] = 'Обновить статус';
$string['commerce_personal_offer_mail_preview'] = 'Предпросмотр письма';
$string['commerce_personal_offer_mail_preview_unavailable'] = 'Предпросмотр письма сейчас недоступен.';
$string['commerce_personal_offer_secure_link_copy'] = 'Скопировать ссылку';
$string['commerce_personal_offer_secure_link_copied'] = 'Скопировано';

$string['commerce_personal_offer_validity_mode_help'] = 'Выберите точный период по датам или длительность, которая рассчитывается с момента создания предложения.';
$string['commerce_offers_access_create_offer_action'] = 'Создать предложение';
$string['commerce_offers_access_menu_offer'] = 'Предложение';
$string['commerce_offers_access_menu_communication'] = 'Коммуникация';
$string['commerce_offers_access_recent_offer'] = 'Предложение создано для {$a->email} · {$a->product}';
$string['commerce_offers_access_recent_grant'] = 'Доступ выдан {$a->email} · {$a->product}';
$string['commerce_offers_access_recent_campaign'] = 'Кампания «{$a}»';
$string['commerce_personal_offer_conditions_required_help'] = 'Задайте цену и срок действия предложения. Эти условия обязательны.';
$string['commerce_manual_grant_page_title'] = 'Выдать доступ';
$string['commerce_manual_grant_page_description'] = 'Вручную выдайте клиенту Legacy- или Commerce-доступ без создания продажи.';
$string['commerce_manual_grant_beneficiary_section'] = 'Получатель';
$string['commerce_manual_grant_mode_legacy_access'] = 'Legacy-доступ';
$string['commerce_manual_grant_mode_commerce_product'] = 'Продукт Commerce';
$string['commerce_manual_grant_legacy_section'] = 'Legacy-доступ';
$string['commerce_manual_grant_legacy_plan'] = 'Legacy-план';
$string['commerce_manual_grant_commerce_section'] = 'Commerce-доступ';
$string['commerce_manual_grant_silent_help'] = 'Если снять флажок, доступ будет выдан без письма клиенту. Это удобно для исправления доступа без лишнего уведомления.';
$string['commerce_manual_grant_mail_template'] = 'Шаблон письма';
$string['commerce_manual_grant_mail_template_default'] = 'Стандартный шаблон «Доступы доступны»';
$string['commerce_manual_grant_mail_template_help'] = 'Выберите активный шаблон Mail Studio. Выдача доступа не зависит от содержания письма.';
$string['commerce_bulk_grant_silent_help'] = 'Если снять флажок, доступы будут выданы без отправки писем получателям.';
$string['commerce_bulk_grant_mail_template'] = 'Шаблон письма';
$string['commerce_bulk_grant_mail_template_default'] = 'Стандартный шаблон «Доступы доступны»';
$string['commerce_bulk_grant_mail_template_help'] = 'Выбранный шаблон фиксируется вместе с кампанией, поэтому последующие изменения в Mail Studio не изменят отправку.';
$string['commerce_bulk_grant_schedule_enable'] = 'Запланировать выполнение кампании';
$string['commerce_bulk_grant_schedule_at'] = 'Дата и время запуска';
$string['commerce_bulk_grant_schedule_timezone'] = 'Часовой пояс: {$a}';
$string['commerce_bulk_grant_schedule_action'] = 'Запланировать';
$string['commerce_bulk_grant_schedule_future_required'] = 'Дата запуска должна быть в будущем.';
$string['commerce_bulk_grant_campaign_scheduled'] = 'Кампания выдачи доступа запланирована.';
$string['commerce_bulk_grant_campaign_run_now'] = 'Выполнить сейчас';
$string['commerce_bulk_grant_campaign_run_now_done'] = 'Кампания выполнена сразу: обработано получателей — {$a}.';
$string['commerce_offers_access_last_update'] = 'Последнее обновление';
$string['commerce_manual_grant_user_language'] = 'Язык нового пользователя';
$string['commerce_manual_grant_user_language_help'] = 'Этот язык будет сохранён в аккаунте и использован, в частности, для письма о доступе. По умолчанию выбран русский.';
$string['commerce_language_ru'] = 'Русский';
$string['commerce_language_fr'] = 'Французский';
$string['commerce_language_en'] = 'Английский';
$string['commerce_grant_menu_grant'] = 'Выдача доступа';
$string['commerce_grant_menu_details'] = 'Открыть детали доступа';
$string['commerce_grant_menu_client'] = 'Клиент';
$string['commerce_grant_menu_communication'] = 'Коммуникация';
$string['commerce_grant_menu_mail_journal'] = 'Открыть журнал писем';
$string['commerce_bulk_grant_campaign_process_all_now'] = 'Обработать всех получателей сейчас';
$string['commerce_grant_preview_email'] = 'Предпросмотр письма';
$string['commerce_grant_preview_email_help'] = 'Предпросмотр использует выбранные сейчас продукт, шаблон и язык.';
$string['commerce_grant_mail_preview_title'] = 'Предпросмотр письма о доступе';
$string['commerce_grant_mail_preview_description'] = 'Проверьте письмо, которое будет отправлено при выдаче доступа. Можно менять язык и режим просмотра.';
$string['commerce_grant_preview_example_product'] = 'Выданный продукт CampusFR';
$string['commerce_grant_campaign_email_preview'] = 'Предпросмотр письма кампании';

$string['commerce_offers_access_campaign_type'] = 'Тип';
$string['commerce_offers_access_campaign_processing'] = 'Обработка получателей';
$string['commerce_offers_access_campaign_menu_campaign'] = 'КАМПАНИЯ';
$string['commerce_campaign_scope_type'] = 'Тип: {$a}';
$string['commerce_campaign_menu_edit'] = 'Изменить кампанию';
$string['commerce_campaign_menu_email'] = 'Настроить письмо';
$string['commerce_campaign_menu_preview_email'] = 'Предпросмотр письма';
$string['commerce_campaign_menu_mail_journal'] = 'Открыть журнал писем';
$string['commerce_campaign_beneficiaries_processed'] = 'Обработано получателей: {$a->processed} / {$a->total}';
$string['commerce_offer_campaign_secondary_counts'] = 'Уже имеют доступ: {$a->covered} · Проверить личность: {$a->identity}';
$string['commerce_offer_campaign_details'] = 'Детали';
$string['commerce_offer_campaign_view_details'] = 'Показать детали';
$string['commerce_campaign_member_search_placeholder'] = 'Имя, e-mail или ID Moodle';
$string['commerce_mail_context_grant_campaign'] = 'Кампания выдачи доступа';
$string['commerce_mail_action_open_grant_campaign'] = 'Открыть кампанию выдачи доступа';
$string['commerce_campaign_mail_not_applicable'] = 'Не применяется';
$string['commerce_campaign_member_results'] = 'Показано {$a->visible} из {$a->total}';
$string['commerce_campaign_member_per_page'] = 'На странице';

$string['commerce_manual_grant_activation_mail_title'] = 'Завершите настройку доступа к CampusFR';

$string['commerce_manual_grant_activation_mail_help'] = 'Ваш аккаунт только что создан. Задайте пароль, чтобы войти в CampusFR. Эта ссылка персональная и действует ограниченное время.';

$string['commerce_manual_grant_activation_mail_button'] = 'Задать пароль';

$string['commerce_manual_grant_new_user_silent_warning'] = 'Для нового пользователя отключение письма также создаёт аккаунт без уведомления: ссылка для задания пароля отправлена не будет.';
$string['commerce_product_search_placeholder'] = 'Название, тип или техническая ссылка';
$string['commerce_product_validation_filter'] = 'Проверка';
$string['commerce_product_filter_status_active'] = 'Активный';
$string['commerce_product_filter_status_inactive'] = 'Неактивный';
$string['commerce_product_filter_status_archived'] = 'Архив';
$string['commerce_product_filter_validation_valid'] = 'Корректный';
$string['commerce_product_filter_validation_incomplete'] = 'Требует проверки';
$string['commerce_product_kpi_total'] = 'Продукты';
$string['commerce_product_kpi_active'] = 'Активные';
$string['commerce_product_kpi_inactive'] = 'Неактивные';
$string['commerce_product_kpi_archived'] = 'В архиве';
$string['commerce_product_kpi_incomplete'] = 'Требуют проверки';
$string['commerce_products_found'] = 'Найдено продуктов: {$a}';
$string['commerce_product_scope_type'] = 'Тип: {$a}';
$string['commerce_product_scope_validation'] = 'Проверка: {$a}';
$string['commerce_product_scope_origin'] = 'Источник: {$a}';
$string['commerce_product_scope_currency'] = 'Валюта: {$a}';
$string['commerce_product_menu_product'] = 'Продукт';
$string['commerce_product_menu_commerce'] = 'Commerce';
$string['commerce_product_menu_sales'] = 'Открыть продажи этого продукта';
$string['commerce_product_pagination_count'] = 'Показано {$a->visible} из {$a->total}';
$string['commerce_product_technical_information'] = 'Техническая информация';
$string['commerce_product_technical_sku'] = 'Техническая ссылка';
$string['commerce_product_status_publication'] = 'Публикация';
$string['commerce_product_status_publication_help'] = 'Редакционный статус продукта.';
$string['commerce_product_status_visibility'] = 'Видимость';
$string['commerce_product_status_visibility_help'] = 'Отображение продукта в разделах и сценариях Commerce.';
$string['commerce_product_status_sale'] = 'Продажа';
$string['commerce_product_status_sale_help'] = 'Текущая доступность продукта для покупки.';
$string['commerce_product_status_validation'] = 'Проверка';
$string['commerce_product_status_validation_help'] = 'Техническая корректность конфигурации.';
$string['commerce_product_downloads_total'] = 'скачиваний';
$string['commerce_result_scope_status'] = 'Статус: {$a}';
$string['commerce_product_edit_general_title'] = 'Основная информация';
$string['commerce_product_fallback_name'] = 'Резервное название продукта';
$string['commerce_product_fallback_name_help'] = 'Используется только если нет подходящего перевода на текущем языке, языке Campus по умолчанию, RU, FR или EN.';
$string['commerce_product_identity_title'] = 'Идентификаторы продукта';
$string['commerce_product_identity_editable_help'] = 'SKU и тип продукта можно менять, пока продукт не был куплен или выдан ни одному клиенту.';
$string['commerce_product_identity_locked_help'] = 'SKU и тип продукта заблокированы, потому что продукт уже был выдан или куплен клиентом.';
$string['commerce_product_identity_locked'] = 'SKU или тип продукта больше нельзя изменить: продукт уже был использован клиентом.';
$string['commerce_product_sku_duplicate'] = 'Этот SKU уже используется другим продуктом.';
$string['commerce_product_sku_auto_placeholder'] = 'Будет создан автоматически, если оставить пустым';
$string['commerce_product_digital_file_ready'] = 'Файл готов к выдаче';
$string['commerce_product_digital_file_missing'] = 'Native-файл не загружен';
$string['commerce_product_digital_file_upload_prompt'] = 'Добавьте PDF-файл для этой версии.';
$string['commerce_product_digital_file_replace_or_add'] = 'Добавить или заменить файл';
$string['commerce_product_pricing_business_intro'] = 'Укажите обычную цену для каждой валюты и при необходимости временную акцию. Во время акции клиент платит акционную цену и видит перечёркнутую обычную цену. После окончания акции обычная цена восстанавливается автоматически.';
$string['commerce_product_pricing_regular_price'] = 'Обычная цена';
$string['commerce_product_pricing_regular_price_help'] = 'Реальная базовая цена, которая списывается вне акции.';
$string['commerce_product_pricing_available_for_sale'] = 'Доступно для продажи';
$string['commerce_product_pricing_enabled'] = 'Активно';
$string['commerce_product_pricing_disabled'] = 'Неактивно';
$string['commerce_product_pricing_new_currency'] = 'Новая валюта';
$string['commerce_product_pricing_add_currency'] = 'Добавить валюту';
$string['commerce_product_pricing_add_currency_help'] = 'Добавьте обычную цену. Акцию можно включить сразу.';
$string['commerce_product_promotion_enable'] = 'Включить временную акцию';
$string['commerce_product_promotion_auto_restore'] = 'После окончания акции обычная цена восстановится автоматически.';
$string['commerce_product_promotion_price'] = 'Акционная цена';
$string['commerce_product_promotion_start'] = 'Начало';
$string['commerce_product_promotion_end'] = 'Окончание';
$string['commerce_product_promotion_timezone'] = 'Часовой пояс: {$a}';
$string['commerce_product_promotion_none'] = 'Без акции';
$string['commerce_product_promotion_active'] = 'Акция активна';
$string['commerce_product_promotion_scheduled'] = 'Запланирована';
$string['commerce_product_promotion_expired'] = 'Завершена';
$string['commerce_product_promotion_invalid'] = 'Проверить';
$string['commerce_product_promotion_invalid_price'] = 'Укажите корректную акционную цену.';
$string['commerce_product_promotion_must_be_lower'] = 'Акционная цена должна быть больше нуля и строго ниже обычной цены.';
$string['commerce_product_promotion_invalid_period'] = 'Дата окончания акции должна быть позже даты начала.';
$string['commerce_product_promotion_invalid_datetime'] = 'Некорректная дата или время акции.';
$string['commerce_storefront_promotions_moved'] = 'Акции теперь настраиваются в разделе «Тарификация».';
$string['commerce_access_scope_business_title'] = 'Периметр доступа';
$string['commerce_access_scope_business_intro'] = 'Укажите, какой доступ клиент реально получает с этим продуктом. Совместимость со старым каталогом Legacy вынесена отдельно и используется только для миграции.';
$string['commerce_access_scope_metric_source'] = 'Источник доступа';
$string['commerce_access_scope_metric_scope'] = 'Применённый периметр';
$string['commerce_access_scope_metric_courses'] = 'Выдаваемые курсы';
$string['commerce_access_scope_customer_access_title'] = 'Доступ, выдаваемый клиенту';
$string['commerce_access_scope_customer_access_help'] = 'Выберите исторический план, чей периметр доступа должен использовать этот Commerce-продукт. Несколько Native-продуктов могут использовать один и тот же периметр.';
$string['commerce_access_scope_source_plan_business'] = 'Источник периметра';
$string['commerce_access_scope_source_plan_business_help'] = 'Этот выбор определяет курсы, которые реально выдаются после покупки или административной выдачи.';
$string['commerce_access_scope_effective_scope'] = 'Сейчас применяется периметр: {$a}';
$string['commerce_access_scope_courses_business_title'] = 'Выдаваемое содержимое';
$string['commerce_access_scope_courses_count'] = 'Курсов: {$a}';
$string['commerce_access_scope_courses_empty'] = 'С этим периметром пока не связан ни один курс.';
$string['commerce_access_scope_legacy_compatibility_title'] = 'Совместимость с каталогом Legacy';
$string['commerce_access_scope_legacy_compatibility_badge'] = 'Только миграция';
$string['commerce_access_scope_legacy_compatibility_help'] = 'Этот параметр не меняет доступ клиента. Он лишь указывает, какой старый Legacy-план канонически соответствует этому Native-продукту для миграций, исправлений и backfill.';
$string['commerce_access_scope_legacy_plan_business'] = 'Соответствующий Legacy-план';
$string['commerce_access_scope_legacy_plan_help'] = 'Один Legacy-план может быть канонически связан только с одним Native-продуктом.';
$string['commerce_access_scope_legacy_current_mapping'] = 'Текущее соответствие Legacy: {$a}';
$string['commerce_access_scope_admin_shortcuts'] = 'Расширенное администрирование';
$string['commerce_access_scope_unknown_product'] = 'неизвестный Native-продукт';
$string['commerce_bundle_components_help_n89'] = 'Соберите bundle из нужных продуктов. Меняйте порядок перетаскиванием или стрелками; этот порядок будет использоваться везде, где показывается состав.';
$string['commerce_bundle_reorder_help'] = 'Перетаскивайте компоненты для изменения порядка или используйте стрелки вверх/вниз.';
$string['commerce_bundle_move_up'] = 'Переместить компонент выше';
$string['commerce_bundle_move_down'] = 'Переместить компонент ниже';
$string['commerce_bundle_drag_handle'] = 'Перетащить для изменения порядка';
$string['commerce_bundle_component_row_help'] = 'Продукт, входящий в bundle';
$string['commerce_bundle_add_component'] = 'Добавить компонент';
$string['commerce_bundle_preview_help_n89'] = 'Предпросмотр фактического состава после раскрытия вложенных bundles.';
$string['commerce_bundle_pricing_intro_n810'] = 'Выберите способ расчёта обычной цены bundle, затем настраивайте временные акции так же, как для других продуктов. Акция реально меняет оплачиваемую цену, а после её окончания обычная цена восстанавливается автоматически.';
$string['commerce_bundle_pricing_method_help_n810'] = 'Фиксированная цена задаётся вручную. Сумма компонентов использует цены включённых продуктов. Скидка рассчитывает обычную цену bundle как сумму компонентов минус указанный процент.';
$string['commerce_bundle_pricing_strategy_fixed_help_n810'] = 'Вы задаёте обычную цену bundle для каждой валюты.';
$string['commerce_bundle_pricing_strategy_sum_help_n810'] = 'Обычная цена автоматически пересчитывается из цен компонентов.';
$string['commerce_bundle_pricing_strategy_discount_help_n810'] = 'Обычная цена равна сумме компонентов за вычетом указанной скидки.';
$string['commerce_bundle_discount_percent_help_n810'] = 'Используется только для стратегии скидки на компоненты.';
$string['commerce_bundle_pricing_currency_section'] = 'Цены и акции по валютам';
$string['commerce_bundle_pricing_currency_section_help'] = 'Для каждой валюты есть обычная цена. Затем можно включить отдельную временную акцию.';
$string['commerce_bundle_pricing_calculated_price'] = 'Рассчитанная обычная цена';
$string['commerce_bundle_add_currency_help_n810'] = 'Добавьте новую валюту bundle. Для расчётных стратегий эта валюта должна быть доступна у всех компонентов.';
$string['commerce_bundle_preview_intro_n811'] = 'Проверьте, что именно получит клиент: входящие продукты, количество, выдаваемые доступы и итоговую цену bundle.';
$string['commerce_bundle_preview_unavailable_help_n811'] = 'Предпросмотр нельзя рассчитать с текущим составом. Проверьте компоненты bundle.';
$string['commerce_bundle_preview_contents_title_n811'] = 'Состав bundle';
$string['commerce_bundle_preview_contents_help_n811'] = 'Каждая карточка показывает продукт, который реально будет выдан клиенту после раскрытия вложенных bundles.';
$string['commerce_bundle_preview_technical_details_n811'] = 'Техническая информация';
$string['commerce_bundle_preview_pricing_help_n811'] = 'Цена, которая реально показывается клиенту сейчас, включая активные акции.';
$string['commerce_bundle_preview_pricing_note_title_n811'] = 'Важно';
$string['commerce_bundle_preview_pricing_note_n811'] = 'Цены рассчитываются по стратегии из раздела «Тарификация». Временные акции применяются автоматически в период их действия.';
$string['commerce_storefront_n812_title'] = 'Страница магазина — {$a}';
$string['commerce_storefront_n812_intro'] = 'Создавайте клиентскую страницу, не смешивая контент, внешний вид, коммерческое продвижение и технические инструменты.';
$string['commerce_storefront_n812_eyebrow'] = 'Страница магазина';
$string['commerce_storefront_n812_tab_content'] = 'Контент';
$string['commerce_storefront_n812_tab_presentation'] = 'Оформление';
$string['commerce_storefront_n812_tab_distribution'] = 'Продвижение';
$string['commerce_storefront_n812_tab_tools'] = 'Инструменты';
$string['commerce_storefront_n812_sections_short'] = 'блоков';
$string['commerce_storefront_n812_ready_short'] = 'готово';
$string['commerce_storefront_n812_attention_short'] = 'проверить';
$string['commerce_storefront_n812_content_title'] = 'Контент страницы';
$string['commerce_storefront_n812_content_help'] = 'Здесь показаны блоки выбранной языковой версии. Откройте Builder, чтобы изменить их содержимое, порядок и оформление.';
$string['commerce_storefront_n812_open_builder'] = 'Открыть Builder';
$string['commerce_storefront_n812_empty_title'] = 'Нет редакционных блоков';
$string['commerce_storefront_n812_empty_help'] = 'Добавьте первый блок, чтобы начать собирать эту языковую версию страницы.';
$string['commerce_storefront_n812_status_ready'] = 'Готово';
$string['commerce_storefront_n812_status_attention'] = 'Проверить';
$string['commerce_storefront_n812_status_draft'] = 'Черновик';
$string['commerce_storefront_n812_builder_next_title'] = 'Визуальный Builder';
$string['commerce_storefront_n812_builder_next_help'] = 'Builder сосредоточен на блоках: понятные описания, визуальный выбор компоновки и предпросмотр каждого блока до публикации.';
$string['commerce_storefront_n812_metric_layout'] = 'Шаблон страницы';
$string['commerce_storefront_n812_metric_commerce'] = 'Блок Commerce';
$string['commerce_storefront_n812_metric_header'] = 'Шапка продукта';
$string['commerce_storefront_n812_presentation_title'] = 'Общее оформление';
$string['commerce_storefront_n812_presentation_help'] = 'Настройки общей структуры страницы без изменения редакционного контента.';
$string['commerce_storefront_n812_modify_presentation'] = 'Изменить оформление';
$string['commerce_storefront_n812_card_layout_title'] = 'Макет страницы';
$string['commerce_storefront_n812_card_layout_help'] = 'Общая организация зон и ширина страницы.';
$string['commerce_storefront_n812_card_commerce_title'] = 'Положение блока Commerce';
$string['commerce_storefront_n812_card_commerce_help'] = 'Определяет место цены, покупки и коммерческой информации.';
$string['commerce_storefront_n812_card_shell_title'] = 'Оболочка Moodle';
$string['commerce_storefront_n812_card_shell_help'] = 'Шапка продукта, header/footer Edly и общий режим отображения.';
$string['commerce_storefront_n812_advanced_title'] = 'Расширенные настройки';
$string['commerce_storefront_n812_advanced_presentation_help'] = 'Ключи темы, глобальные зоны и технические параметры shell остаются доступны для совместимости, но больше не являются частью основного сценария.';
$string['commerce_storefront_n812_metric_featured'] = 'В приоритете';
$string['commerce_storefront_n812_metric_showroom'] = 'Showroom';
$string['commerce_storefront_n812_metric_languages'] = 'Языки';
$string['commerce_storefront_n812_showroom_configured'] = 'Привязан';
$string['commerce_storefront_n812_showroom_custom'] = 'Особая привязка';
$string['commerce_storefront_n812_distribution_title'] = 'Продвижение и переходы';
$string['commerce_storefront_n812_distribution_help'] = 'Всё, что определяет отображение продукта в магазине, Showroom, поиске и рекомендациях.';
$string['commerce_storefront_n812_modify_distribution'] = 'Изменить продвижение';
$string['commerce_storefront_n812_merch_title'] = 'Коммерческое продвижение';
$string['commerce_storefront_n812_merch_help'] = 'Приоритет продукта, порядок отображения и маркетинговые бейджи.';
$string['commerce_storefront_n812_experience_title'] = 'Клиентский опыт';
$string['commerce_storefront_n812_experience_help'] = 'Категория каталога, элементы доверия и ключевая информация.';
$string['commerce_storefront_n812_seo_title'] = 'SEO и публикация';
$string['commerce_storefront_n812_seo_help'] = 'Публичный заголовок, описание и URL. Автоматические значения остаются основными, пока не нужна ручная настройка.';
$string['commerce_storefront_n812_discovery_title'] = 'Куда ведёт «Подробнее»';
$string['commerce_storefront_n812_discovery_help'] = 'Определяет, открывается ли сразу эта страница продукта или связанный Showroom.';
$string['commerce_storefront_n812_badges_short'] = 'бейджей';
$string['commerce_storefront_n812_items_short'] = 'элементов';
$string['commerce_storefront_n812_customised'] = 'Настроено';
$string['commerce_storefront_n812_automatic'] = 'Автоматически';
$string['commerce_storefront_n812_defaults_title'] = 'Больше автоматических настроек';
$string['commerce_storefront_n812_defaults_help'] = 'Автоматические настройки уменьшают лишнюю конфигурацию: SEO, элементы доверия и переход в Showroom можно менять только при необходимости.';
$string['commerce_storefront_n812_tools_title'] = 'Служебные инструменты';
$string['commerce_storefront_n812_tools_help'] = 'Редкие операции: перевод, перенос конфигурации и сброс.';
$string['commerce_storefront_n812_open_tools'] = 'Открыть инструменты';
$string['commerce_storefront_n812_tool_translation_title'] = 'Языки и перевод';
$string['commerce_storefront_n812_tool_translation_help'] = 'Скопировать существующую локаль или подготовить перевод через OpenAI.';
$string['commerce_storefront_n812_tool_transfer_title'] = 'Импорт / экспорт';
$string['commerce_storefront_n812_tool_transfer_help'] = 'Перенести всю конфигурацию страницы в файле .cfrproduct.';
$string['commerce_storefront_n812_tool_reset_title'] = 'Сброс';
$string['commerce_storefront_n812_tool_reset_help'] = 'Удалить конфигурацию Storefront, не меняя продукт, цены и права доступа.';
$string['commerce_storefront_n812_tools_safety_help'] = 'Эти операции отделены от Builder, чтобы редакционная работа не смешивалась с техническим обслуживанием.';
$string['commerce_storefront_n812_back_to_hub'] = 'Назад к странице магазина';
$string['commerce_storefront_n812_builder_transition_help'] = 'Расширенный редактор страницы магазина.';
$string['commerce_storefront_n813_builder_focus_help'] = 'Builder контента — в центре внимания редакционные блоки. Оформление, продвижение и служебные настройки находятся в отдельных разделах.';
$string['commerce_storefront_n813_content_builder_title'] = 'Собрать контент';
$string['commerce_storefront_n813_content_builder_help'] = 'Добавляйте блоки, визуально выбирайте их компоновку и сразу проверяйте результат. Технические параметры остаются доступными, но больше не перегружают сценарий.';
$string['commerce_storefront_n813_add_block_title'] = 'Добавить блок';
$string['commerce_storefront_n813_add_block_help'] = 'Сначала выберите, что вы хотите рассказать. У каждого типа блока есть понятная редакционная задача.';
$string['commerce_storefront_n813_type_hero_help'] = 'Крупное начало страницы: заголовок, обещание, визуал и при необходимости кнопка действия.';
$string['commerce_storefront_n813_type_rich_text_help'] = 'Свободный редакционный текст для объяснения, подробностей или дополнительного доверия.';
$string['commerce_storefront_n813_type_image_text_help'] = 'Визуал и текст рядом — удобно для объяснения преимущества или функции.';
$string['commerce_storefront_n813_type_video_help'] = 'Видео для демонстрации, отзыва или объяснения.';
$string['commerce_storefront_n813_type_features_help'] = 'Несколько преимуществ или характеристик в виде легко читаемых карточек.';
$string['commerce_storefront_n813_type_cta_help'] = 'Завершает или продолжает сценарий понятным действием для посетителя.';
$string['commerce_storefront_n813_more_blocks'] = 'Другие типы блоков';
$string['commerce_storefront_n813_more_blocks_help'] = 'FAQ, отзывы, программа, галерея, H5P и другие компоненты остаются доступны в подробном списке ниже.';
$string['commerce_storefront_n813_layout_choice_title'] = 'Визуальная компоновка';
$string['commerce_storefront_n813_layout_choice_help'] = 'Нажмите на схему, которая ближе всего к желаемому результату. Соответствующие технические поля синхронизируются автоматически.';
$string['commerce_storefront_n813_layout_automatic_help'] = 'Для этого типа блока стандартная компоновка обычно оптимальна. Ниже при необходимости можно уточнить ширину, интервалы и выравнивание.';
$string['commerce_storefront_n813_advanced_layout_title'] = 'Точная настройка макета';
$string['commerce_storefront_n813_advanced_layout_help'] = 'Эти параметры нужны для точной подстройки. В большинстве случаев достаточно визуального выбора выше.';
$string['commerce_storefront_n814_title'] = 'Продвижение — {$a}';
$string['commerce_storefront_n814_intro'] = 'Настройте, как продукт обнаруживается и показывается клиенту. Автоматические значения используются по умолчанию, чтобы не усложнять конфигурацию.';
$string['commerce_storefront_n814_defaults_hint'] = 'Автоматические значения учитывают тип продукта и уже доступный контент.';
$string['commerce_storefront_n814_discovery_title'] = 'Куда попадает клиент после «Подробнее»';
$string['commerce_storefront_n814_discovery_help'] = 'Выберите основное направление. Страница продукта в магазине в любом случае остаётся доступной напрямую.';
$string['commerce_storefront_n814_destination_storefront'] = 'Открывать страницу продукта';
$string['commerce_storefront_n814_destination_storefront_help'] = 'Клиент сразу видит полную презентацию этого продукта.';
$string['commerce_storefront_n814_destination_showroom'] = 'Открывать связанный Showroom';
$string['commerce_storefront_n814_destination_showroom_help'] = 'Клиент видит продукт внутри коммерческой страницы с несколькими предложениями.';
$string['commerce_storefront_n814_showroom_label'] = 'Связанный Showroom';
$string['commerce_storefront_n814_no_showroom'] = 'Без Showroom';
$string['commerce_storefront_n814_show_storefront_cta'] = 'В Showroom разрешить открыть полную страницу продукта';
$string['commerce_storefront_n814_show_storefront_cta_help'] = 'Добавляет ссылку на эту страницу продукта, не меняя основное направление кнопки «Подробнее».';
$string['commerce_storefront_n814_merch_title'] = 'Продвижение в магазине';
$string['commerce_storefront_n814_merch_help'] = 'Здесь остаются только параметры, влияющие на порядок и маркетинговые бейджи в каталоге.';
$string['commerce_storefront_n814_display_order'] = 'Приоритет показа';
$string['commerce_storefront_n814_display_order_help'] = 'Сначала показываются выделенные продукты; при одинаковом приоритете меньшая цифра идёт раньше.';
$string['commerce_storefront_n814_experience_title'] = 'Клиентский опыт';
$string['commerce_storefront_n814_experience_help'] = 'Позвольте CampusFR автоматически выбрать элементы для этого типа продукта и меняйте их только при необходимости.';
$string['commerce_storefront_n814_catalog_group'] = 'Категория каталога';
$string['commerce_storefront_n814_catalog_group_help'] = 'Автоматический режим определяет категорию по типу продукта.';
$string['commerce_storefront_n814_reassurance_title'] = 'Элементы доверия';
$string['commerce_storefront_n814_reassurance_help'] = 'В автоматическом режиме CampusFR показывает подходящие гарантии для данного типа продукта.';
$string['commerce_storefront_n814_reassurance_auto'] = 'Автоматически — рекомендуется';
$string['commerce_storefront_n814_reassurance_custom'] = 'Настроить';
$string['commerce_storefront_n814_automatic'] = 'Автоматически';
$string['commerce_storefront_n814_custom'] = 'Настроено';
$string['commerce_storefront_n814_recommendations_title'] = 'Продолжить маршрут';
$string['commerce_storefront_n814_recommendations_help'] = 'Выберите до четырёх дополнительных продуктов. Названия берутся через Product Name Resolver — технические ключи не нужны.';
$string['commerce_storefront_n814_recommendations_limit'] = 'Максимум 4 продукта. Текущий продукт исключён из списка.';
$string['commerce_storefront_n814_seo_title'] = 'SEO и публикация';
$string['commerce_storefront_n814_seo_help'] = 'Автоматический режим использует название, описание и лучший доступный визуал продукта. Ручная настройка нужна только для особых маркетинговых случаев.';
$string['commerce_storefront_n814_auto_title_label'] = 'Название';
$string['commerce_storefront_n814_auto_description_label'] = 'Описание по умолчанию';
$string['commerce_storefront_n814_seo_auto'] = 'Автоматический SEO — рекомендуется';
$string['commerce_storefront_n814_seo_custom'] = 'Настроить SEO';
$string['commerce_storefront_n814_public_urls'] = 'Настроить публичные URL';
$string['commerce_storefront_n814_seo_no_description'] = 'Описание продукта пока не заполнено.';
$string['commerce_storefront_n815_presentation_title'] = 'Оформление — {$a}';
$string['commerce_storefront_n815_presentation_intro'] = 'Настройте общую структуру страницы продукта. Основные варианты представлены визуально, а технические параметры скрыты по умолчанию.';
$string['commerce_storefront_n815_layout_title'] = 'Общий стиль страницы';
$string['commerce_storefront_n815_layout_help'] = 'Выберите структуру, которая лучше всего подходит для подачи продукта.';
$string['commerce_storefront_n815_template_default_help'] = 'Сбалансированный универсальный вариант для большинства продуктов.';
$string['commerce_storefront_n815_template_editorial_help'] = 'Более редакционная подача для страниц с большим количеством объяснений.';
$string['commerce_storefront_n815_template_immersive_help'] = 'Максимально визуальная подача для кампаний и крупных запусков.';
$string['commerce_storefront_n815_commerce_title'] = 'Где показывать покупку?';
$string['commerce_storefront_n815_commerce_help'] = 'Блок Commerce содержит цену и действие покупки. Выберите его место без технических терминов структуры страницы.';
$string['commerce_storefront_n815_position_hero_help'] = 'Цена и покупка встроены в верхнюю часть страницы.';
$string['commerce_storefront_n815_position_sidebar_help'] = 'Блок покупки остаётся видимым справа на больших экранах.';
$string['commerce_storefront_n815_position_none_help'] = 'Автоматический блок Commerce не показывается. Используйте только если покупка организована иначе.';
$string['commerce_storefront_n815_shell_title'] = 'Оболочка страницы';
$string['commerce_storefront_n815_shell_help'] = 'Настройте элементы Moodle вокруг контента, не меняя редакционные блоки.';
$string['commerce_storefront_n815_advanced_title'] = 'Расширенные технические настройки';
$string['commerce_storefront_n815_advanced_help'] = 'Параметры совместимости со старыми страницами. Меняйте их только когда действительно нужен специальный theme или zone.';
$string['commerce_storefront_n815_tools_title'] = 'Инструменты — {$a}';
$string['commerce_storefront_n815_tools_intro'] = 'Редкие и технические операции вынесены из Builder, чтобы снизить риск при обычном редактировании.';
$string['commerce_storefront_n815_tools_scope_help'] = 'Эти инструменты могут копировать, переводить, импортировать или удалять всю конфигурацию страницы. Они не меняют цены и права доступа продукта, если это явно не указано.';

$string['commerce_storefront_n816_advanced_options'] = 'Расширенные настройки макета';

$string['commerce_storefront_n816_seo_language'] = 'Язык SEO';

$string['commerce_storefront_n816_seo_language_help'] = 'SEO-заголовок и описание относятся к выбранному языку. Остальные настройки продвижения являются общими для продукта.';

$string['commerce_storefront_n816_tools_target_language'] = 'Целевая языковая версия для языковых инструментов';
$string['commerce_storefront_n817_block_preview'] = 'Предпросмотр блока';
$string['commerce_storefront_n818_missing_items'] = 'Добавьте хотя бы одну карточку или вопрос.';
$string['commerce_storefront_n818_missing_image'] = 'Добавьте изображение.';
$string['commerce_storefront_n818_missing_text'] = 'Добавьте заголовок или текст.';
$string['commerce_storefront_n818_missing_video'] = 'Добавьте или выберите видео.';
$string['commerce_storefront_n818_missing_h5p'] = 'Добавьте или выберите H5P-контент.';
$string['commerce_storefront_n818_missing_content'] = 'Добавьте основной контент блока.';
$string['commerce_storefront_n818_feature_items'] = 'Карточки преимуществ';
$string['commerce_storefront_n818_feature_items_help'] = 'Одна карточка на строку: заголовок ||| текст. Отдельное поле основного контента для этого блока не требуется.';
$string['commerce_storefront_n818_faq_items'] = 'Вопросы и ответы';
$string['commerce_storefront_n818_faq_items_help'] = 'Один вопрос на строку: вопрос ||| ответ. Отдельное поле основного контента для этого блока не требуется.';
$string['commerce_storefront_n819_tab_builder'] = 'Builder';
$string['commerce_storefront_n819_preview_device'] = 'Адаптивный предпросмотр';
$string['commerce_showroom_n9_description'] = 'Создавайте, публикуйте и управляйте страницами Showroom для презентации коммерческих предложений.';
$string['commerce_showroom_n9_kpi_total'] = 'Showroom';
$string['commerce_showroom_n9_search_placeholder'] = 'Название или публичный URL';
$string['commerce_showroom_n9_public_language'] = 'Язык страницы';
$string['commerce_showroom_n9_public_pages'] = 'Публичные страницы';
$string['commerce_showroom_n9_updated'] = 'Последнее изменение';
$string['commerce_showroom_n9_found'] = 'Найдено Showroom: {$a}';
$string['commerce_showroom_n9_empty_title'] = 'Нет Showroom для отображения';
$string['commerce_showroom_n9_empty'] = 'Ни один Showroom не соответствует выбранным фильтрам.';
$string['commerce_showroom_n9_no_public_page'] = 'Нет публичной страницы';
$string['commerce_showroom_n9_scope_status'] = 'Статус: {$a}';
$string['commerce_showroom_n9_scope_language'] = 'Язык: {$a}';
$string['commerce_showroom_n9_menu_public'] = 'Публичные страницы';
$string['commerce_showroom_n9_menu_admin'] = 'Администрирование';
$string['commerce_showroom_n9_menu_danger'] = 'Опасные действия';
$string['commerce_showroom_n9_open_public'] = 'Открыть версию {$a}';
$string['commerce_showroom_n9_export_json'] = 'Экспорт JSON';
$string['commerce_showroom_n9_export_portable'] = 'Экспорт переносимого пакета';
$string['commerce_showroom_n9_delete_confirm'] = 'Удалить этот Showroom без возможности восстановления?';
$string['commerce_showroom_n91_import_intro'] = 'Импортируйте Showroom целиком или восстановите только его конфигурацию. Для переноса между средами рекомендуется переносимый пакет.';
$string['commerce_showroom_n91_import_package_title'] = 'Импорт Showroom';
$string['commerce_showroom_n91_import_package_help'] = 'Предпочтительно использовать пакет .showroom.zip: он содержит конфигурацию, блоки и медиа. JSON остаётся доступен для импорта только конфигурации.';
$string['commerce_showroom_n91_import_formats'] = 'Поддерживаемые форматы: рекомендуемый .showroom.zip или .json без медиа.';
$string['commerce_showroom_n91_import_json_advanced'] = 'Расширенный импорт JSON';
$string['commerce_showroom_n91_import_action'] = 'Импортировать Showroom';
$string['commerce_showroom_n92_history_title'] = 'История — {$a}';
$string['commerce_showroom_n92_history_description'] = 'Просматривайте сохранённые версии и изменения публикации и при необходимости восстанавливайте предыдущую версию.';
$string['commerce_showroom_n92_back_showroom'] = 'Вернуться к Showroom';
$string['commerce_showroom_n92_current_status'] = 'Текущий статус';
$string['commerce_showroom_n92_revision_count'] = 'Версии';
$string['commerce_showroom_n92_latest_revision'] = 'Последняя версия';
$string['commerce_showroom_n92_latest_badge'] = 'Последняя';
$string['commerce_showroom_n92_restore_help'] = 'При восстановлении выбранная версия создаётся как черновик и не заменяет незаметно текущую опубликованную версию.';
$string['commerce_showroom_n92_restore_confirm'] = 'Восстановить версию {$a} как черновик?';
$string['commerce_showroom_n931_menu_transfer'] = 'Перенос и резервная копия';
$string['commerce_showroom_n931_general_title'] = 'Основная информация';
$string['commerce_showroom_n931_general_help'] = 'Укажите название Showroom и выберите оформление публичной страницы.';
$string['commerce_showroom_n931_public_layout'] = 'Оформление публичной страницы';
$string['commerce_showroom_n931_public_layout_help'] = 'Выберите представление, которое увидят посетители Showroom.';
$string['commerce_showroom_n931_products_help'] = 'Свяжите продукты, предлагаемые в этом Showroom. Технические идентификаторы скрыты в обычном режиме работы.';
$string['commerce_showroom_n931_change_product'] = 'Изменить';
$string['commerce_showroom_n931_publication_title'] = 'Публикация';
$string['commerce_showroom_n931_publication_help'] = 'Управляйте публикацией Showroom отдельно от его конфигурации.';
$string['commerce_showroom_n931_publication_status'] = 'Статус';
$string['commerce_showroom_n931_publication_status_draft'] = 'Showroom находится в черновике и ещё не опубликован.';
$string['commerce_showroom_n931_publication_status_review'] = 'Showroom ожидает проверки перед публикацией.';
$string['commerce_showroom_n931_publication_status_published'] = 'Showroom опубликован и доступен по своим публичным URL.';
$string['commerce_showroom_n931_publication_status_archived'] = 'Showroom находится в архиве.';
$string['commerce_showroom_n931_publication_note_placeholder'] = 'Необязательная заметка для истории публикаций';
$string['commerce_showroom_n932_seo_title'] = 'SEO и публикация ссылок';
$string['commerce_showroom_n932_seo_help'] = 'Настройте публичный URL и метаданные для поисковых систем и социальных сетей отдельно для каждого языка.';
$string['commerce_showroom_n932_social_image_help'] = 'Это изображение общее для всех языков и используется при публикации ссылки в социальных сетях.';
$string['commerce_showroom_n932_no_social_image'] = 'Пользовательское изображение для публикаций не задано';
$string['commerce_showroom_n932_locale_help'] = 'Поля этой языковой версии не зависят от других языков.';
$string['commerce_showroom_n932_public_url'] = 'Публичный URL';
$string['commerce_showroom_n932_public_url_help'] = 'Используйте короткий, понятный и стабильный идентификатор без доменного имени.';
$string['commerce_showroom_n932_open_public_page'] = 'Открыть публичную страницу';
$string['commerce_showroom_n932_social_overrides'] = 'Публикация в социальных сетях';
$string['commerce_showroom_n932_social_overrides_help'] = 'Необязательно. Если поля пусты, автоматически используются SEO-заголовок и описание.';
$string['commerce_showroom_n932_technical'] = 'Совместимость со старым SEO';
$string['commerce_showroom_n932_technical_help'] = 'Эти ключи используются только как fallback для старого Moodle-контента. Текущие SEO-настройки задаются полями выше; внутренний JSON больше не показывается.';
$string['commerce_showroom_n94_builder_title'] = 'Конструктор Showroom';
$string['commerce_showroom_n94_builder_help'] = 'Меняйте порядок блоков перетаскиванием, добавляйте блоки или применяйте готовый шаблон прямо на этой странице.';
$string['commerce_showroom_n94_block_count'] = 'Блоков: {$a}';
$string['commerce_showroom_n94_add_block_title'] = 'Добавить блок';
$string['commerce_showroom_n94_template_title'] = 'Использовать шаблон';
$string['commerce_showroom_n94_more_actions'] = 'Параметры';
$string['commerce_showroom_n94_collapse_all'] = 'Свернуть все';
$string['commerce_showroom_n94_expand_all'] = 'Развернуть все';
$string['commerce_showroom_n94_visible'] = 'Видим';
$string['commerce_showroom_n94_hidden'] = 'Скрыт';
$string['commerce_showroom_n94_collapse_block'] = 'Свернуть или развернуть блок';
$string['commerce_showroom_n94_hide_block'] = 'Скрыть блок';
$string['commerce_showroom_n94_show_block'] = 'Показать блок';
$string['commerce_showroom_n94_technical_info'] = 'Техническая информация';
$string['commerce_showroom_n94_block_key'] = 'Ключ блока';
$string['commerce_showroom_n941_information_page_title'] = 'Информация — {$a}';
$string['commerce_showroom_n941_information_page_subtitle'] = 'Настройте данные Showroom, связанные продукты и процесс публикации.';
$string['commerce_showroom_n941_seo_page_title'] = 'SEO — {$a}';
$string['commerce_showroom_n941_seo_page_subtitle'] = 'Настройте публичные URL, поисковые метаданные и публикацию в соцсетях для каждого языка.';
$string['commerce_showroom_n941_builder_page_title'] = 'Builder — {$a}';
$string['commerce_showroom_n941_builder_page_subtitle'] = 'Создавайте страницу Showroom, добавляя, упорядочивая и настраивая её блоки.';
$string['commerce_showroom_n95_common_presentation'] = 'Оформление блока';
$string['commerce_showroom_n95_common_presentation_help'] = 'Эти настройки общие для всех блоков и используются как базовое оформление и fallback, если у блока нет собственного фона.';
$string['commerce_showroom_n95_common_background'] = 'Фон блока';
$string['commerce_showroom_n95_width'] = 'Ширина';
$string['commerce_showroom_n95_width_contained'] = 'По центру';
$string['commerce_showroom_n95_width_wide'] = 'Широкая';
$string['commerce_showroom_n95_width_full'] = 'На всю ширину';
$string['commerce_showroom_n95_background'] = 'Фон';
$string['commerce_showroom_n95_background_default'] = 'По умолчанию';
$string['commerce_showroom_n95_background_white'] = 'Белый';
$string['commerce_showroom_n95_background_light'] = 'Светлый';
$string['commerce_showroom_n95_background_soft'] = 'Мягкий';
$string['commerce_showroom_n95_background_pink'] = 'Розовый CampusFR';
$string['commerce_showroom_n95_background_dark'] = 'Тёмный';
$string['commerce_showroom_n95_background_gradient'] = 'Градиент';
$string['commerce_showroom_n95_background_custom'] = 'Свой';
$string['commerce_showroom_n95_background_image'] = 'Изображение';
$string['commerce_showroom_n95_spacing'] = 'Отступ';
$string['commerce_showroom_n95_spacing_compact'] = 'Компактный';
$string['commerce_showroom_n95_spacing_normal'] = 'Обычный';
$string['commerce_showroom_n95_spacing_large'] = 'Большой';

// N10.1 — Центр настроек Commerce.
$string['commerce_configuration_description_n101'] = 'Просматривайте состояние настроек Commerce и переходите к системным параметрам из единого центра.';
$string['commerce_configuration_status_enabled'] = 'Включено';
$string['commerce_configuration_status_disabled'] = 'Выключено';
$string['commerce_configuration_catalogue_title'] = 'Каталог, доступ и запись на курсы';
$string['commerce_configuration_catalogue_description'] = 'Области доступа и планы — бизнес-объекты каталога: они связывают курсы Moodle с продуктами Commerce, записью на курсы и стратегиями апгрейда. Они отделены от системных настроек.';
$string['commerce_configuration_catalogue_step_course'] = 'Курс Moodle';
$string['commerce_configuration_catalogue_step_scope'] = 'Область доступа';
$string['commerce_configuration_catalogue_step_plan'] = 'Коммерческий план';
$string['commerce_configuration_catalogue_step_product'] = 'Продукт Commerce';
$string['commerce_configuration_open_products'] = 'Открыть продукты';
$string['commerce_configuration_open_scopes'] = 'Управлять областями доступа';
$string['commerce_configuration_open_plans'] = 'Управлять планами';
$string['commerce_configuration_system_title'] = 'Системная конфигурация';
$string['commerce_configuration_system_description'] = 'Краткий обзор настроек движка Commerce. Секреты и чувствительные параметры остаются в администрировании Moodle.';
$string['commerce_configuration_advanced_settings'] = 'Расширенные настройки Moodle';
$string['commerce_configuration_configure'] = 'Настроить';
$string['commerce_configuration_technical_badge'] = 'Техническое';
$string['commerce_configuration_payments_title'] = 'Платежи';
$string['commerce_configuration_payments_description'] = 'Провайдеры, среды Stripe и Alfa и сверка платежей.';
$string['commerce_configuration_localisation_title'] = 'Commerce и языки';
$string['commerce_configuration_localisation_description'] = 'Доступность Commerce, языки по умолчанию и отображение валют.';
$string['commerce_configuration_checkout_title'] = 'Checkout и напоминания';
$string['commerce_configuration_checkout_description'] = 'Жизненный цикл ожидающих платежей, срок действия и автоматические напоминания.';
$string['commerce_configuration_communications_title'] = 'Коммуникации';
$string['commerce_configuration_communications_description'] = 'Письма Commerce, поддержка, кампании персональных предложений и лимиты отправки.';
$string['commerce_configuration_legal_title'] = 'Счета и юридические данные';
$string['commerce_configuration_legal_description'] = 'Реквизиты для счетов, политики, условия и юридическая информация.';
$string['commerce_configuration_storefront_title'] = 'Магазин и Storefront';
$string['commerce_configuration_storefront_description'] = 'Глобальные редакционные сервисы Boutique и параметры совместимости, которые ещё использует старый каталог.';
$string['commerce_configuration_engine_title'] = 'Движок Commerce';
$string['commerce_configuration_engine_description'] = 'Runtime Native/Legacy, fallback, shadow и инструменты миграции или восстановления.';
$string['commerce_configuration_fact_provider'] = 'Провайдер по умолчанию';
$string['commerce_configuration_fact_availability'] = 'Доступность';
$string['commerce_configuration_fact_user_language'] = 'Язык аккаунта';
$string['commerce_configuration_fact_email_language'] = 'Язык писем';
$string['commerce_configuration_site_default'] = 'По умолчанию сайта';
$string['commerce_configuration_fact_pending_expiry'] = 'Срок платежа';
$string['commerce_configuration_fact_reminder1'] = '1-е напоминание';
$string['commerce_configuration_fact_reminder2'] = '2-е напоминание';
$string['commerce_configuration_fact_support_email'] = 'Email поддержки';
$string['commerce_configuration_fact_offer_batch'] = 'Пакет кампании';
$string['commerce_configuration_fact_hourly_limit'] = 'Лимит в час';
$string['commerce_configuration_fact_ru_policy'] = 'Политика RU';
$string['commerce_configuration_fact_row_policy'] = 'Политика ROW';
$string['commerce_configuration_fact_copy_to'] = 'Копия письма';
$string['commerce_configuration_fact_ai_translation'] = 'ИИ-перевод';
$string['commerce_configuration_fact_currency_symbols'] = 'Символы валют';
$string['commerce_configuration_fact_runtime'] = 'Runtime';
$string['commerce_configuration_fact_read_mode'] = 'Режим чтения';
$string['commerce_configuration_fact_repair'] = 'Восстановление Native';

// Commerce configuration N10.2.
$string['commerce_configuration_open_section'] = 'Посмотреть настройки';
$string['commerce_configuration_back_overview'] = 'Обзор';
$string['commerce_configuration_section_notice'] = 'На этой странице показаны фактически используемые настройки Commerce. Изменения и секретные параметры остаются в расширенных настройках Moodle.';
$string['commerce_configuration_group_general'] = 'Общие настройки';
$string['commerce_configuration_group_payment_routing'] = 'Маршрутизация платежей';
$string['commerce_configuration_group_reconciliation'] = 'Автоматическая сверка';
$string['commerce_configuration_group_followup'] = 'Срок действия и напоминания';
$string['commerce_configuration_group_checkout_safety'] = 'Безопасность и очистка checkout';
$string['commerce_configuration_group_mail_audit'] = 'Копии и аудит писем';
$string['commerce_configuration_group_legal_links'] = 'Юридические документы и ссылки';
$string['commerce_configuration_group_runtime'] = 'Runtime Commerce';
$string['commerce_configuration_group_native_tools'] = 'Native-контроль и миграция';

// Commerce configuration editor (N10.3).
$string['commerce_configuration_saved'] = 'Настройки сохранены.';
$string['commerce_configuration_edit_notice'] = 'Эти параметры сохраняются непосредственно в конфигурации Commerce. Под каждым полем указан технический ключ, используемый get_config().';
$string['commerce_configuration_url_setting_desc'] = 'URL, используемый Commerce для этой юридической страницы.';
$string['commerce_configuration_stripe_environment'] = 'Среда Stripe';
$string['commerce_configuration_alfa_environment'] = 'Среда Alfa';
$string['commerce_configuration_stripe_reconciliation_batch_size_desc'] = 'Ограничивает число ожидающих платежей Stripe, проверяемых за один запуск плановой задачи. Рекомендуемое значение: 20.';
$string['commerce_configuration_stripe_reconciliation_min_age_desc'] = 'Минимальная задержка после создания платежа Stripe до автоматической проверки. Рекомендуемое значение: 300 секунд.';
$string['commerce_configuration_stripe_reconciliation_max_age_desc'] = 'Платежи Stripe старше этого периода больше не проверяются автоматически. Рекомендуемое значение: 172800 секунд (48 часов).';
$string['commerce_configuration_group_payment_integrity'] = 'Целостность платежей';
$string['commerce_configuration_group_payment_integrity_desc'] = 'Проверки сумм и валют, возвращённых платёжными провайдерами, перед окончательным подтверждением платежа.';
$string['commerce_configuration_group_commerce_availability'] = 'Доступность Commerce';
$string['commerce_configuration_group_languages'] = 'Языки';
$string['commerce_configuration_group_currencies'] = 'Валюты и отображение цен';
$string['commerce_configuration_availability_label'] = 'Доступность страниц Commerce';
$string['commerce_configuration_availability_desc'] = 'Управляет доступом к публичным страницам Commerce. Параметр реально используется защитой доступа плагина: публично, только для администраторов или отключено.';
$string['commerce_configuration_default_user_language_label'] = 'Язык по умолчанию для новых аккаунтов';
$string['commerce_configuration_default_user_language_desc'] = 'Используется при автоматическом создании новых аккаунтов, если более точный язык пользователя неизвестен. Язык существующих пользователей не изменяется.';
$string['commerce_configuration_default_email_language_label'] = 'Принудительный язык писем Commerce';
$string['commerce_configuration_default_email_language_desc'] = 'Если выбран язык, mailer Commerce использует его для соответствующих писем. Оставьте язык сайта, чтобы сохранить обычную логику языка получателя и fallback.';
$string['commerce_configuration_enabled_currencies_label'] = 'Активные валюты';
$string['commerce_configuration_enabled_currencies_desc'] = 'Определяет валюты, доступные и принимаемые каталогом Native Commerce. Должна оставаться активной хотя бы одна валюта.';
$string['commerce_configuration_currency_symbols_label'] = 'Показывать символы валют';
$string['commerce_configuration_currency_symbols_desc'] = 'Используется на checkout и страницах результата оплаты, например для отображения 49 € вместо 49 EUR. Это глобальная настройка Commerce.';
$string['commerce_configuration_currency_eur'] = 'Евро';
$string['commerce_configuration_currency_rub'] = 'Российский рубль';
$string['commerce_configuration_currency_usd'] = 'Доллар США';
$string['commerce_configuration_currency_gbp'] = 'Фунт стерлингов';
$string['commerce_configuration_currency_chf'] = 'Швейцарский франк';
$string['commerce_configuration_currency_cad'] = 'Канадский доллар';
$string['commerce_configuration_currency_jpy'] = 'Японская иена';
$string['commerce_configuration_currency_required'] = 'Активируйте хотя бы одну валюту Commerce.';
$string['commerce_configuration_group_payment_lifecycle'] = 'Истечение запросов на оплату';
$string['commerce_configuration_group_payment_reminders'] = 'Напоминания об оплате';
$string['commerce_configuration_group_guest_cleanup'] = 'Очистка гостевых checkout-аккаунтов';
$string['commerce_configuration_expire_pending_after_minutes_desc'] = 'Запрос на оплату в статусе ожидания помечается истёкшим после этого срока. Смена статуса выполняется независимо от отправки писем-напоминаний.';
$string['commerce_configuration_reminder1_after_minutes_desc'] = 'Первый порог напоминания от момента создания запроса на оплату. Фактическая отправка письма также зависит от политики Legacy-автописем.';
$string['commerce_configuration_reminder2_after_minutes_desc'] = 'Второй порог напоминания от момента создания. Он не может быть раньше первого; job также соблюдает минимальный интервал между письмами.';
$string['commerce_configuration_checkout_mail_policy_note'] = 'Задержки ниже управляют job отслеживания платежей. Сами по себе они не включают старые автоматические письма: разрешение на их отправку настраивается в Communications / Mail Studio.';
$string['commerce_configuration_duration_minutes'] = '{$a} мин';
$string['commerce_configuration_duration_hours'] = '{$a} ч';
$string['commerce_configuration_duration_days'] = '{$a} д';
$string['commerce_configuration_group_mail_identity'] = 'Адреса и идентификация отправителя';
$string['commerce_configuration_group_mail_global_throttle'] = 'Ограничение нагрузки SMTP';
$string['commerce_configuration_group_mail_workers'] = 'Воркеры Mail Engine';
$string['commerce_configuration_group_legacy_mail'] = 'Исторические автоматические отправки';
$string['commerce_configuration_support_email_desc'] = 'Адрес поддержки, используемый в письмах, на страницах оплаты, в Showroom и запросах в поддержку.';
$string['commerce_configuration_admin_copy_desc'] = 'Историческая административная копия, добавляемая общим mailer. Несколько адресов можно указать через запятую.';
$string['commerce_configuration_transactional_enabled_desc'] = 'Включает или приостанавливает воркер транзакционных писем (заказы, доступы, платежи и приоритетные сообщения). Задача Moodle остаётся запланированной.';
$string['commerce_configuration_transactional_batch_label'] = 'Транзакционные — писем за пакет';
$string['commerce_configuration_transactional_hourly_label'] = 'Транзакционные — лимит в час';
$string['commerce_configuration_personal_offer_enabled_desc'] = 'Включает или приостанавливает воркер писем персональных предложений. Задача Moodle остаётся запланированной.';
$string['commerce_configuration_personal_offer_batch_label'] = 'Персональные предложения — писем за пакет';
$string['commerce_configuration_personal_offer_hourly_label'] = 'Персональные предложения — лимит в час';
$string['commerce_configuration_marketing_enabled_desc'] = 'Включает или приостанавливает воркер маркетинговых кампаний, созданных в Mail Studio.';
$string['commerce_configuration_marketing_batch_label'] = 'Маркетинговые кампании — писем за пакет';
$string['commerce_configuration_marketing_hourly_label'] = 'Маркетинговые кампании — лимит в час';
$string['commerce_configuration_audit_copy_generation_label'] = 'Создавать аудит-копии';
$string['commerce_configuration_audit_copy_generation_desc'] = 'Определяет, создаётся ли для подходящих клиентских писем отдельная запись аудит-копии. Этот параметр создаёт копии, но не обрабатывает очередь.';
$string['commerce_configuration_audit_copy_address_desc'] = 'Технический адрес для созданных аудит-копий, например log@campusfr.fr.';
$string['commerce_configuration_audit_worker_label'] = 'Обрабатывать очередь аудит-копий';
$string['commerce_configuration_audit_worker_desc'] = 'Включает или приостанавливает воркер, отправляющий уже созданные аудит-копии. Это отдельный параметр от «Создавать аудит-копии».';
$string['commerce_configuration_audit_batch_label'] = 'Аудит-копии — писем за пакет';
$string['commerce_configuration_audit_hourly_label'] = 'Аудит-копии — лимит в час';
$string['commerce_configuration_communications_mail_engine_note'] = 'Эта страница и E-mails > Configuration управляют одними и теми же ключами Mail Engine, поэтому значения синхронизированы. Экран E-mails остаётся полезным для состояния воркеров, задач Moodle и времени последнего запуска.';
$string['commerce_configuration_open_mail_engine'] = 'Состояние воркеров';
$string['commerce_configuration_copy_destination_label'] = 'Адрес копий / аудита';
$string['commerce_configuration_copy_destination_desc'] = 'Общий адрес для административных копий Legacy-mailer и аудит-копий Native Mail Engine. При сохранении значение синхронизируется для обоих механизмов.';
$string['commerce_configuration_group_invoice_eur'] = 'Счета EUR — Stripe';
$string['commerce_configuration_group_invoice_rub'] = 'Счета RUB — Alfa';
$string['commerce_configuration_invoice_name_desc'] = 'Название или юридическое лицо, указанное как эмитент счёта.';
$string['commerce_configuration_invoice_address_desc'] = 'Полный почтовый адрес юридического лица.';
$string['commerce_configuration_invoice_legal_desc'] = 'Регистрационные номера, организационно-правовая форма и другие юридические сведения.';
$string['commerce_configuration_invoice_email_desc'] = 'Контактный e-mail на счёте.';
$string['commerce_configuration_invoice_phone_desc'] = 'Телефон, отображаемый на счёте.';
$string['commerce_configuration_invoice_website_desc'] = 'Сайт юридического лица.';
$string['commerce_configuration_invoice_tax_notice_desc'] = 'Налоговая или НДС-формулировка для этого юридического лица.';
$string['commerce_configuration_invoice_footer_desc'] = 'Свободный текст в нижней части PDF-счёта.';
$string['commerce_configuration_policy_url_ru_by_label'] = 'Политика конфиденциальности — Россия / Беларусь';
$string['commerce_configuration_policy_url_ru_by_desc'] = 'Документ для посетителей, которых Commerce определяет как находящихся в России или Беларуси.';
$string['commerce_configuration_policy_url_row_label'] = 'Политика конфиденциальности — остальные страны';
$string['commerce_configuration_policy_url_row_desc'] = 'Документ для всех остальных стран.';
$string['commerce_configuration_terms_url_ru_by_label'] = 'Условия использования — Россия / Беларусь';
$string['commerce_configuration_terms_url_ru_by_desc'] = 'Условия для посетителей из России или Беларуси.';
$string['commerce_configuration_terms_url_row_label'] = 'Условия использования — остальные страны';
$string['commerce_configuration_terms_url_row_desc'] = 'Условия для всех остальных стран.';
$string['commerce_configuration_offer_url_ru_by_label'] = 'Условия продажи — Россия / Беларусь';
$string['commerce_configuration_offer_url_ru_by_desc'] = 'Условия продажи для посетителей из России или Беларуси.';
$string['commerce_configuration_offer_url_row_label'] = 'Условия продажи — остальные страны';
$string['commerce_configuration_offer_url_row_desc'] = 'Условия продажи для всех остальных стран.';
$string['commerce_configuration_legal_resolution_note'] = 'Профиль счёта выбирается по валюте: EUR использует профиль Stripe, RUB — профиль Alfa. Юридические ссылки выбираются отдельно по определённому региону (Россия/Беларусь или остальные страны).';
$string['commerce_configuration_fact_invoice_eur'] = 'Эмитент EUR';
$string['commerce_configuration_fact_invoice_rub'] = 'Эмитент RUB';
$string['commerce_configuration_fact_legal_regions'] = 'Юридические регионы';
$string['commerce_configuration_legal_regions_value'] = 'RU/BY + остальные страны';
$string['commerce_configuration_group_legal_ru_by'] = 'Юридические документы — Россия / Беларусь';
$string['commerce_configuration_group_legal_row'] = 'Юридические документы — Остальной мир';
$string['commerce_configuration_policy_document_label'] = 'Политика конфиденциальности';
$string['commerce_configuration_terms_document_label'] = 'Условия использования';
$string['commerce_configuration_offer_document_label'] = 'Условия продажи';
$string['commerce_configuration_brand_logo_email_label'] = 'Логотип в e-mail';
$string['commerce_configuration_brand_logo_email_desc'] = 'Логотип, используемый почтовым движком Commerce. Этот параметр не управляет изображениями Boutique или Showroom.';
$string['commerce_configuration_group_storefront_editorial'] = 'Редакционные сервисы Storefront';
$string['commerce_configuration_group_storefront_legacy'] = 'Совместимость со старой страницей предложений';
$string['commerce_configuration_storefront_ai_translation_desc'] = 'Разрешает Builder страницы продукта подготавливать переводы через настроенный аккаунт OpenAI. Перед сохранением перевод всё равно нужно просмотреть и подтвердить.';
$string['commerce_configuration_featured_plan_legacy_label'] = 'Выделенный план — старый fallback';
$string['commerce_configuration_featured_plan_legacy_desc'] = 'Используется только старой страницей предложений, если у плана не задан собственный тип выделения. Native Page Boutique от этого параметра не зависит.';
$string['commerce_configuration_no_featured_plan'] = 'Не задавать план принудительно';
$string['commerce_configuration_plan_inactive'] = 'Неактивен';
$string['commerce_configuration_storefront_scope_title'] = 'Где настраивается Boutique?';
$string['commerce_configuration_storefront_scope_desc'] = 'Редакционные и коммерческие настройки теперь задаются в каждом Продукте (Page Boutique) и Showroom. Здесь остаются только глобальные системные параметры.';
$string['commerce_configuration_storefront_open_products'] = 'Открыть Продукты';
$string['commerce_configuration_storefront_open_showrooms'] = 'Открыть Showrooms';
$string['commerce_configuration_nav_overview'] = 'Обзор';
$string['commerce_configuration_internal_navigation'] = 'Навигация по настройкам Commerce';
$string['commerce_configuration_fact_currencies'] = 'Валюты';
$string['commerce_configuration_fact_guest_cleanup'] = 'Очистка гостевых аккаунтов';
$string['commerce_configuration_fact_transactional_worker'] = 'Транзакционные письма';
$string['commerce_configuration_fact_marketing_worker'] = 'Маркетинговые кампании';
$string['commerce_configuration_fact_legacy_featured_plan'] = 'Выделенный Legacy-план';
$string['commerce_configuration_fact_engine_switches'] = 'Checkout / fulfillment';

$string['commerce_configuration_group_engine_availability'] = 'Доступность движка';
$string['commerce_configuration_checkout_engine_enabled_desc'] = 'Глобальный переключатель Commerce checkout. Отключение блокирует новые Native checkout-процессы и должно использоваться только как контролируемая оперативная остановка.';
$string['commerce_configuration_fulfillment_engine_enabled_desc'] = 'Глобальный переключатель Commerce fulfillment. Отключение приостанавливает выдачу прав после оплаты и служит механизмом оперативного отката.';
$string['commerce_configuration_runtime_mode_label'] = 'Основной движок fulfillment';
$string['commerce_configuration_runtime_mode_desc'] = 'Legacy использует исторический путь fulfillment. Shadow оставляет Legacy основным и параллельно проверяет Native. Native делает Native fulfillment основным.';
$string['commerce_configuration_runtime_fallback_desc'] = 'В режиме Native при исключении Native fulfillment Commerce немедленно пробует путь Legacy. Этот защитный механизм полезен во время перехода и стабилизации.';
$string['commerce_configuration_group_runtime_reads'] = 'Чтение данных Commerce';
$string['commerce_configuration_runtime_read_mode_label'] = 'Источник чтения Commerce';
$string['commerce_configuration_runtime_read_mode_desc'] = 'Определяет источник данных для читателей Commerce, которые ещё поддерживают Legacy/Native. Native читает Native-хранилище; Auto предпочитает Native с fallback на Legacy; Shadow сравнивает, не делая Native основным.';
$string['commerce_configuration_runtime_read_strict_label'] = 'Строгое Native-чтение';
$string['commerce_configuration_runtime_read_strict_desc'] = 'В режиме Native запрещает скрытый fallback, если ожидаемые Native-данные отсутствуют. Включайте только после сертификации полного Native-покрытия.';
$string['commerce_configuration_native_reconciliation_label'] = 'Разрешить сверку Legacy → Native';
$string['commerce_configuration_native_reconciliation_desc'] = 'Разрешает явные инструменты сравнения и синхронизации покупок Legacy в Native. Сам по себе этот параметр не включает cron-задачу сверки.';
$string['commerce_configuration_native_repair_label'] = 'Разрешить исправления при сверке';
$string['commerce_configuration_native_repair_desc'] = 'Разрешает явные операции исправления во время сверки. Требует включённой Native-сверки.';
$string['commerce_configuration_repair_requires_reconciliation'] = 'Native-исправление нельзя включить, если Native-сверка отключена.';
$string['commerce_configuration_engine_shadow_status_title'] = 'Shadow Native fulfillment';
$string['commerce_configuration_engine_shadow_status_desc'] = 'Этот технический флаг теперь автоматически синхронизируется с режимом fulfillment: он активен только при выбранном режиме Shadow и больше не редактируется отдельно в этом интерфейсе.';
$string['commerce_product_course_journey_title'] = 'Добавить курс Moodle в Commerce';
$string['commerce_product_course_journey_description'] = 'Чтобы продавать новый курс, сначала привяжите его к периметру доступа, затем создайте или используйте существующий коммерческий план и после этого создайте продукт Commerce. Так сохраняется согласованность зачислений и стратегии upgrade.';

// N10.6A — Access scopes UX.
$string['commerce_scopes_description_n106'] = 'Периметры доступа объединяют курсы, которые выдаются вместе по коммерческому плану. Они связывают курсы Moodle с планами, а затем с продуктами Commerce.';
$string['commerce_scope_add_description_n106'] = 'Создайте периметр, объединив курсы, доступ к которым должен выдаваться вместе при покупке коммерческого плана.';
$string['commerce_scope_edit_description_n106'] = 'Определите курсы, доступ к которым предоставляет этот периметр и связанные с ним коммерческие планы.';
$string['commerce_scope_course_search'] = 'Найти и выбрать курсы…';
$string['commerce_scope_courses_help'] = 'Найдите курс по названию и выберите один или несколько курсов. Выбранные курсы останутся видимыми в поле.';
$string['commerce_scope_courses_help_help'] = 'Найдите курс по названию и выберите один или несколько курсов. Выбранные курсы останутся видимыми в поле.';
$string['commerce_scope_courses_badge'] = '{$a} курсов';
$string['commerce_scope_plans_badge'] = '{$a} планов';
$string['commerce_scope_dependency_title'] = 'Используется в коммерческих планах: {$a}';
$string['commerce_scope_dependency_help'] = 'Изменение курсов в этом периметре изменит доступ, предоставляемый продуктами, использующими эти планы.';
$string['commerce_scope_general_title'] = 'Основная информация';
$string['commerce_scope_general_description'] = 'Укажите название периметра и курсы Moodle, которые он объединяет.';

$string['commerce_scope_view_description_n106'] = 'Просмотрите включённые курсы, коммерческие планы, использующие эту область доступа, и техническую информацию.';
$string['commerce_scope_view_courses_description'] = 'Курсы Moodle, доступ к которым выдаётся при предоставлении плана с этой областью доступа.';
$string['commerce_scope_view_plans_description'] = 'Коммерческие планы, которые сейчас связаны с этой областью доступа.';
$string['commerce_scope_view_no_plans'] = 'Сейчас эту область доступа не использует ни один коммерческий план.';

// N10.6B — Тарифы, права доступа и апгрейды.
$string['commerce_plans_description_n106'] = 'Тарифы превращают периметр доступа в коммерческое предложение: срок, продление, правила выдачи доступа и апгрейды. Затем тариф можно связать с Native-продуктом Commerce.';
$string['commerce_plans_list_title'] = 'Коммерческие тарифы';
$string['commerce_plans_list_description'] = 'Обзор тарифов, их периметров доступа, активности и возможной связи с Native-продуктом.';
$string['commerce_plans_empty'] = 'Коммерческие тарифы пока не настроены.';
$string['commerce_plan_native_product'] = 'Native-продукт Commerce';
$string['commerce_plan_native_product_desc'] = 'Native-продукт, связанный с этим тарифом через слой совместимости Commerce.';
$string['commerce_plan_no_native_product'] = 'Native-продукт не связан';
$string['commerce_plan_no_native_product_desc'] = 'Этот тариф пока существует без связи с Native-продуктом Commerce.';
$string['commerce_plan_open_native_product'] = 'Открыть Native-продукт';
$string['commerce_plan_add_description_n106'] = 'Создайте коммерческий тариф на основе периметра доступа и задайте его срок и коммерческое поведение.';
$string['commerce_plan_edit_description_n106'] = 'Изменяйте параметры тарифа, одновременно контролируя права доступа, апгрейды и связанный Native-продукт.';
$string['commerce_plan_general_title'] = 'Основная информация';
$string['commerce_plan_general_description'] = 'Задайте название, периметр доступа, срок, автопродление и выделение тарифа.';
$string['commerce_plan_view_description_n106'] = 'Просматривайте структуру тарифа, права доступа, правила апгрейда и связь с Native-продуктом Commerce.';
$string['commerce_plan_business_information_desc_n106'] = 'Бизнес-параметры, определяющие доступ и срок действия этого тарифа.';
$string['commerce_plan_entitlements_rules_title'] = 'Настроенные права доступа';
$string['commerce_plan_entitlements_rules_desc'] = 'Исторические правила исполнения, дополняющие периметр доступа тарифа.';
$string['commerce_plan_upgrade_rules_title'] = 'Настроенные правила апгрейда';
$string['commerce_plan_upgrade_rules_desc'] = 'Разрешённые переходы между этим и другими тарифами с методом расчёта цены.';

// N10.6C — Legacy-цены и переводы тарифов.
$string['commerce_plan_legacy_compatibility_title'] = 'Совместимость Legacy';
$string['commerce_plan_legacy_mapped_readonly_desc'] = 'Этот тариф связан с Native-продуктом Commerce. Старые цены и переводы сохраняются для совместимости и аудита, но больше не редактируются здесь. Официальным источником коммерческих данных теперь является Native-продукт.';
$string['commerce_plan_legacy_unmapped_desc'] = 'Этот исторический экран доступен только для Legacy-тарифов, которые ещё не связаны с Native-продуктом Commerce.';
$string['commerce_plan_legacy_readonly_notice'] = 'Этот тариф связан с Native-продуктом Commerce: Legacy-данные доступны только для чтения. Изменяйте Native-продукт.';
$string['commerce_plan_legacy_readonly_badge'] = 'Только чтение';
$string['commerce_plan_open_native_prices'] = 'Управлять Native-ценами';
$string['commerce_plan_open_native_translations'] = 'Управлять Native-переводами';

// Commerce 7.95N10.7 — Акции и промокоды в «Предложения и доступ».
$string['commerce_offers_access_tab_promotions'] = 'Акции и промокоды';
$string['commerce_offers_access_promotion_title'] = 'Акция или промокод';
$string['commerce_offers_access_promotion_description'] = 'Создайте автоматическую скидку или промокод, который можно применить при оплате Commerce.';
$string['commerce_offers_access_promotion_action'] = 'Создать акцию';
$string['commerce_promotions_coupon_hint'] = 'Автоматическая акция применяется без кода. Ручная акция с кодом — это промокод, который вводится при оплате.';
$string['commerce_promotion_coupon_badge'] = 'ПРОМОКОД';
$string['commerce_promotion_automatic_badge'] = 'АВТО';

// N10.7.1 — Promotions UX.
$string['commerce_promotions_metric_total'] = 'Промоакции';
$string['commerce_promotions_metric_active'] = 'Активные';
$string['commerce_promotions_metric_coupons'] = 'Купоны';
$string['commerce_promotions_metric_automatic'] = 'Автоматические';
$string['commerce_promotions_mode_title'] = 'Два режима применения';
$string['commerce_promotions_list_title'] = 'Промоакции и купоны';
$string['commerce_promotions_list_description'] = 'Обзор скидок, способов их применения и использования.';
$string['commerce_promotion_section_identity'] = 'Название и способ применения';
$string['commerce_promotion_section_identity_desc'] = 'Укажите внутреннее название, код при необходимости и способ применения скидки.';
$string['commerce_promotion_section_discount'] = 'Скидка и ограничения';
$string['commerce_promotion_section_discount_desc'] = 'Настройте размер скидки, валюту, минимальную сумму корзины и лимиты использования.';
$string['commerce_promotion_section_products'] = 'Подходящие товары';
$string['commerce_promotion_section_products_desc'] = 'Ограничьте промоакцию отдельными товарами или типами товаров. Без ограничений она применяется ко всему каталогу.';

// N10.7.2 — UX акций и промокодов, детали и срок действия.
$string['commerce_promotion_section_validity'] = 'Период действия';
$string['commerce_promotion_section_validity_desc'] = 'Укажите, когда акция может применяться. Оставьте дату пустой, если с этой стороны ограничение не нужно.';
$string['commerce_promotion_starts_at'] = 'Начало действия';
$string['commerce_promotion_starts_at_help'] = 'Дата и время, начиная с которых акция применяется. Оставьте пустым, чтобы акция действовала сразу.';
$string['commerce_promotion_ends_at'] = 'Окончание действия';
$string['commerce_promotion_ends_at_help'] = 'Дата и время, после которых акция больше не применяется. Оставьте пустым, если даты окончания нет.';
$string['commerce_promotion_validity'] = 'Срок действия';
$string['commerce_promotion_validity_upcoming'] = 'Запланировано';
$string['commerce_promotion_validity_expired'] = 'Истекло';
$string['commerce_promotion_validity_unlimited'] = 'Без ограничения по времени';
$string['commerce_promotion_validity_current'] = 'Действует';
$string['commerce_promotion_validity_immediate'] = 'сразу';
$string['commerce_promotion_validity_no_end'] = 'без даты окончания';
$string['commerce_promotion_validity_range'] = '{$a->from} → {$a->to}';
$string['commerce_promotion_view_description'] = 'Просмотрите скидку, срок действия, ограничения по продуктам и условия для клиента.';
$string['commerce_promotion_view_summary'] = 'Краткая информация';
$string['commerce_promotion_view_limits'] = 'Лимиты и использование';
$string['commerce_promotion_mode'] = 'Способ применения';
$string['commerce_promotion_no_restriction'] = 'Без ограничений';
$string['commerce_promotion_unlimited'] = 'Без ограничений';

$string['commerce_promotions_found'] = 'Найдено промоакций: {$a}';
$string['commerce_promotions_no_results'] = 'По текущим фильтрам промоакции не найдены.';
$string['commerce_promotions_search_placeholder'] = 'Поиск по названию или коду…';
$string['commerce_promotions_menu_manage'] = 'Управление';
$string['commerce_promotions_menu_danger'] = 'Опасные действия';
$string['commerce_promotion_delete_confirm'] = 'Удалить эту промоакцию? Это действие нельзя отменить.';

/* Commerce 7.95N11.2.1 — User Explorer UX. */
$string['crm_user_sort_score_asc'] = 'Самый низкий CRM-балл';
$string['crm_user_sort_risk_asc'] = 'Самый низкий риск';
$string['crm_user_sort_subscriptions_asc'] = 'Меньше всего подписок';
$string['crm_user_sort_subscriptions_desc'] = 'Больше всего подписок';
$string['crm_user_sort_purchases_asc'] = 'Меньше всего цифровых покупок';
$string['crm_user_sort_purchases_desc'] = 'Больше всего цифровых покупок';
$string['crm_user_sort_last_access_asc'] = 'Самая давняя активность';
$string['crm_user_sort_created_asc'] = 'Самая ранняя регистрация';
$string['crm_user_actions'] = 'Действия';
$string['crm_user_more_actions'] = 'Другие действия';
$string['crm_user_open_moodle_profile'] = 'Открыть профиль Moodle';
$string['crm_user_open_inbox'] = 'Открыть входящие';

/* Commerce 7.95N11.2.2 — User Explorer Sales-style UX. */
$string['crm_user_kpi_suspended'] = 'Приостановленные Moodle-аккаунты';
$string['crm_user_kpi_no_moodle'] = 'Без аккаунта Moodle';
$string['crm_user_search_filters_title'] = 'Поиск и фильтры';
$string['crm_user_filter_panel_hint'] = 'Нажмите, чтобы открыть';
$string['crm_user_filter_panel_active'] = 'Активных фильтров: {$a}';
$string['crm_user_save_view_help'] = 'Сохраняет текущие фильтры, поиск и сортировку под выбранным именем для быстрого повторного использования. Это не снимок списка пользователей.';
$string['crm_user_menu_client'] = 'Клиент';
$string['crm_user_menu_communication'] = 'Коммуникация';
$string['crm_user_open_user360'] = 'Открыть User360';

/* Commerce 7.95N11.2.6 — User Explorer Sales table. */
$string['crm_user_explorer_found'] = 'Найдено пользователей: {$a}';
$string['crm_user_explorer_active_filters_short'] = 'Фильтры';
$string['crm_user_filter_type_label'] = 'Тип пользователя';

$string['crm_user_account_status_no_moodle'] = 'Без аккаунта Moodle';

/* Commerce 7.95N11.3A — User360 overview. */
$string['crm_user360_n113_moodle_account'] = 'Аккаунт Moodle';
$string['crm_user360_n113_created'] = 'Создан';
$string['crm_user360_n113_active_subscriptions'] = 'Активные подписки';
$string['crm_user360_n113_score'] = 'CRM-балл';
$string['crm_user360_n113_risk'] = 'Риск';
$string['crm_user360_n113_nav_label'] = 'Навигация User360';
$string['crm_user360_n113_tab_overview'] = 'Обзор';
$string['crm_user360_n113_tab_commerce'] = 'Покупки и доступ';
$string['crm_user360_n113_tab_relation'] = 'CRM-отношения';
$string['crm_user360_n113_tab_identities'] = 'Идентичности';
$string['crm_user360_n113_tab_timeline'] = 'CRM Timeline';
$string['crm_user360_n113_current_situation'] = 'Текущая ситуация';
$string['crm_user360_n113_identity'] = 'Идентичность';
$string['crm_user360_n113_no_intelligence'] = 'Для этого пользователя пока нет анализа CRM Intelligence.';
$string['crm_user360_n113_guest_identity_help'] = 'Эта Commerce-идентичность пока не связана с аккаунтом Moodle.';
$string['crm_user360_n113_recent_activity'] = 'Последняя активность';
$string['crm_user360_n113_priority_actions'] = 'Приоритетные действия';
$string['crm_user360_n113_priority_normal'] = 'Проверить';
$string['crm_user360_n113_no_priority_action'] = 'Сейчас приоритетных действий нет.';
$string['crm_user360_n113_work_items_hint'] = 'Подробные Work Items остаются доступны в CRM-разделах ниже.';
$string['crm_user360_n113_send_email'] = 'Отправить письмо';
$string['crm_user360_n113_create_offer'] = 'Создать предложение';
$string['crm_user360_n113_detailed_sections'] = 'Подробные разделы — переход N11.3';

// Commerce 7.95 N11.3B — User360 Commerce & access.
$string['crm_user360_n113b_title'] = 'Покупки и доступ';
$string['crm_user360_n113b_intro'] = 'Заказы, подписки, цифровые покупки и учебные доступы собраны в одном месте.';
$string['crm_user360_n113b_orders'] = 'Заказы';
$string['crm_user360_n113b_orders_help'] = 'Заказы Commerce Native, связанные с этим клиентом.';
$string['crm_user360_n113b_subscriptions'] = 'Подписки';
$string['crm_user360_n113b_subscriptions_help'] = 'Активные и исторические тарифы, связанные с этим клиентом.';
$string['crm_user360_n113b_digital'] = 'Цифровые покупки';
$string['crm_user360_n113b_digital_help'] = 'Цифровые покупки, включая Legacy-данные, которые ещё используются CRM.';
$string['crm_user360_n113b_access'] = 'Текущие доступы';
$string['crm_user360_n113b_access_help'] = 'Курсы, к которым аккаунт Moodle имеет доступ в данный момент.';
$string['crm_user360_n113b_guest_access_title'] = 'Нет Moodle-доступов для отображения';
$string['crm_user360_n113b_guest_access_help'] = 'Эта Commerce / Legacy-идентичность пока не связана с аккаунтом Moodle. Покупки остаются видимыми выше.';
$string['crm_user360_n113b_empty'] = 'Для этого клиента не найдено коммерческой активности.';

// Commerce 7.95 N11.3C — User360 Relation CRM.
$string['crm_user360_n113c_title'] = 'CRM-отношения';
$string['crm_user360_n113c_intro'] = 'Intelligence, действия, заметки, Inbox, Customer Success и Work Items собраны в одном месте.';
$string['crm_user360_n113c_score'] = 'Коммерческий балл';
$string['crm_user360_n113c_engagement'] = 'Вовлечённость';
$string['crm_user360_n113c_risk'] = 'Риск';
$string['crm_user360_n113c_unread'] = 'Непрочитанные письма';
$string['crm_user360_n113c_intelligence'] = 'CRM Intelligence';
$string['crm_user360_n113c_intelligence_help'] = 'Баллы, сегменты, возможности и рекомендации, рассчитанные для клиента.';
$string['crm_user360_n113c_actions'] = 'CRM-действия';
$string['crm_user360_n113c_actions_help'] = 'Операционные действия и быстрое добавление внутренней заметки.';
$string['crm_user360_n113c_notes'] = 'Внутренние заметки';
$string['crm_user360_n113c_notes_help'] = 'История заметок CRM-команды.';
$string['crm_user360_n113c_customer_success'] = 'Customer Success';
$string['crm_user360_n113c_customer_success_help'] = 'Планы сопровождения и этапы Customer Success клиента.';
$string['crm_user360_n113c_inbox'] = 'CRM Inbox';
$string['crm_user360_n113c_inbox_help'] = 'Диалоги и сообщения, связанные с клиентом.';
$string['crm_user360_n113c_assistant'] = 'CRM Assistant';
$string['crm_user360_n113c_assistant_help'] = 'Рекомендации и действия на основе CRM-сигналов.';
$string['crm_user360_n113c_work_items'] = 'Work Items';
$string['crm_user360_n113c_work_items_help'] = 'Открытые, срочные или просроченные CRM-задачи клиента.';

// Commerce 7.95 N11.3D — User360 Identities + Timeline.
$string['crm_user360_n113d_identities_title'] = 'Идентичности';
$string['crm_user360_n113d_identities_intro'] = 'Известные e-mail, аккаунт Moodle, Commerce-идентичности и возможные совпадения собраны в одном месте.';
$string['crm_user360_n113d_commerce_identity'] = 'Commerce / Legacy-идентичность';
$string['crm_user360_n113d_moodle_identity'] = 'Аккаунт Moodle';
$string['crm_user360_n113d_known_identities'] = 'E-mail и идентичности';
$string['crm_user360_n113d_known_identities_help'] = 'История известных адресов и потенциально связанных аккаунтов.';
$string['crm_user360_n113d_account_linking'] = 'Привязка Moodle';
$string['crm_user360_n113d_account_linking_help'] = 'Создать или привязать аккаунт Moodle к этой Commerce-идентичности.';
$string['crm_user360_n113d_merge_history'] = 'История объединений';
$string['crm_user360_n113d_merge_history_help'] = 'Операции объединения идентичностей, уже выполненные для аккаунта.';
$string['crm_user360_n113d_identity_safety'] = 'Проверка идентичности';
$string['crm_user360_n113d_identity_safety_help'] = 'Возможные совпадения — только сигналы. Всегда проверяйте человека перед объединением или привязкой.';
$string['crm_user360_n113d_no_identity_data'] = 'Дополнительных данных об идентичности нет.';
$string['crm_user360_n113d_timeline_title'] = 'CRM Timeline';
$string['crm_user360_n113d_timeline_intro'] = 'Полная фильтруемая история Commerce, учебных и CRM-событий.';
$string['crm_user360_n113d_timeline_events'] = 'События';
$string['crm_user360_n113d_timeline_important'] = 'Важные';

// Commerce 7.95 N11.3E — User360 final polish.
$string['crm_user360_n113e_match_high'] = 'Высокое совпадение';
$string['crm_user360_n113e_match_medium'] = 'Возможное совпадение';
$string['crm_user360_n113e_match_low'] = 'Проверить';

// Commerce 7.95 N11.3F — User360 workspace consolidation.
$string['crm_user360_n113f_assistant_open'] = 'Открыть CRM-ассистента';

// Commerce 7.95 N11.4A — Support-first User360.
$string['crm_user360_n114_orders'] = 'Заказы';
$string['crm_user360_n114_spent'] = 'Потрачено';
$string['crm_user360_n114_courses'] = 'Доступные курсы';
$string['crm_user360_n114_started'] = 'Начатые курсы';
$string['crm_user360_n114_completed'] = 'Завершённые курсы';
$string['crm_user360_n114_last_activity'] = 'Последняя активность';
$string['crm_user360_n114_purchases_title'] = 'Последние покупки';
$string['crm_user360_n114_purchases_help'] = 'Что клиент купил на сайте.';
$string['crm_user360_n114_no_purchases'] = 'Покупок у этого клиента не найдено.';
$string['crm_user360_n114_learning_title'] = 'Курсы и прогресс';
$string['crm_user360_n114_learning_help'] = 'Текущие доступы, прогресс Moodle и область Level Up XP.';
$string['crm_user360_n114_no_moodle_learning'] = 'Эта Commerce-идентичность пока не связана с аккаунтом Moodle.';
$string['crm_user360_n114_no_courses'] = 'Сейчас нет доступных курсов.';
$string['crm_user360_n114_progress_unavailable'] = 'Не отслеживается';
$string['crm_user360_n114_activity_progress'] = 'Завершено {$a->completed} из {$a->tracked} активностей';
$string['crm_user360_n114_no_tracking'] = 'Прогресс Moodle не отслеживается';
$string['crm_user360_n114_communication_title'] = 'Общение с клиентом';
$string['crm_user360_n114_communication_help'] = 'Диалоги, сообщения и заметки, полезные службе поддержки.';
$string['crm_user360_n114_conversations'] = 'Диалоги';
$string['crm_user360_n114_unread'] = 'Непрочитанные';
$string['crm_user360_n114_last_exchange'] = 'Последний обмен';
$string['crm_user360_n114_internal_notes'] = 'Внутренние заметки';
$string['crm_user360_n114_recent_title'] = 'Последняя активность';
$string['crm_user360_n114_recent_help'] = 'Последние события, помогающие понять ситуацию клиента.';
$string['crm_user360_n114_no_activity'] = 'Недавней активности нет.';
$string['crm_user360_n114_actions_title'] = 'Быстрые действия';
$string['crm_user360_n114_send_email'] = 'Отправить письмо';
$string['crm_user360_n114_create_offer'] = 'Создать предложение';
$string['crm_user360_n114_xp_disabled'] = 'XP выключен';
$string['crm_user360_n114_xp_site_scope'] = 'XP · Глобально';
$string['crm_user360_n114_xp_course_scope'] = 'XP · Курс';
$string['crm_user360_n114_xp_level'] = 'Уровень {$a}';
$string['crm_user360_n114_status_paid'] = 'Оплачено';
$string['crm_user360_n114_status_failed'] = 'Ошибка';
$string['crm_user360_n114_status_pending'] = 'Ожидает';
$string['crm_user360_n114_advanced_open'] = 'Открыть расширенное CRM-досье';

// Commerce 7.95 N11.4B — Support-first dashboard design.
$string['crm_user360_n114b_started_sub'] = 'Начато курсов: {$a}';
$string['crm_user360_n114b_xp_total'] = 'Level Up XP';
$string['crm_user360_n114b_xp_courses_sub'] = 'XP на курсах: {$a}';
$string['crm_user360_n114b_recent_purchases'] = 'Последние заказы';
$string['crm_user360_n114b_view_all_purchases'] = 'Все заказы';
$string['crm_user360_n114b_view_all_courses'] = 'Все курсы';
$string['crm_user360_n114b_recent_conversations'] = 'Последние диалоги';
$string['crm_user360_n114b_unread_badge'] = 'Непрочитано: {$a}';
$string['crm_user360_n114b_no_conversations'] = 'Нет недавних диалогов.';
$string['crm_user360_n114b_last_note'] = 'Последняя заметка';
$string['crm_user360_n114b_internal_note'] = 'Внутренняя заметка';
$string['crm_user360_n114b_no_notes'] = 'Нет внутренних заметок.';
$string['crm_user360_n114b_open_exchanges'] = 'Открыть переписку';
$string['crm_user360_n114b_recent_notes'] = 'Последние внутренние заметки';
$string['crm_user360_n114b_recent_notes_help'] = 'Заметки и напоминания для команды поддержки.';
$string['crm_user360_n114b_view_all_notes'] = 'Все заметки';
$string['crm_user360_n114b_view_all_activity'] = 'Вся активность';
$string['crm_user360_n114b_actions_help'] = 'Частые действия для работы с клиентом.';
$string['crm_user360_n114b_open_inbox'] = 'Открыть переписку';
$string['crm_user360_n114b_all_actions'] = 'Все действия';
$string['crm_user360_n114b_total_activities'] = 'Всего заданий';
$string['crm_user360_n114b_average_progress'] = 'Средний прогресс';
$string['crm_user360_n114b_access_active'] = 'Активен';

// Commerce 7.95 N11.4C — Support dashboard refinements.
$string['crm_user360_n114c_no_course_activity'] = 'Нет завершённых заданий';

// Commerce 7.95 N11.5A — User360 Advanced CRM architecture.
$string['crm_user360_n115a_eyebrow'] = 'Экспертное досье';
$string['crm_user360_n115a_title'] = 'Расширенный CRM';
$string['crm_user360_n115a_intro'] = 'Аналитика, полная история и экспертные инструменты. Они дополняют карточку клиента, не перегружая ежедневную работу поддержки.';
$string['crm_user360_n115a_navigation'] = 'Навигация расширенного CRM-досье';
$string['crm_user360_n115a_relation'] = 'CRM-отношения';
$string['crm_user360_n115a_relation_short'] = 'Аналитика и сопровождение';
$string['crm_user360_n115a_relation_help'] = 'CRM Intelligence, действия, переписка, заметки и Customer Success.';
$string['crm_user360_n115a_commerce'] = 'Расширенный Commerce';
$string['crm_user360_n115a_commerce_short'] = 'История и доступы';
$string['crm_user360_n115a_commerce_help'] = 'Native-заказы, подписки, Legacy-покупки и подробные права доступа.';
$string['crm_user360_n115a_identities'] = 'Идентичности';
$string['crm_user360_n115a_identities_short'] = 'Аккаунты и совпадения';
$string['crm_user360_n115a_identities_help'] = 'Известные e-mail, потенциально связанные аккаунты, привязки и история объединений.';
$string['crm_user360_n115a_timeline'] = 'Полная Timeline';
$string['crm_user360_n115a_timeline_short'] = 'Фильтруемая история';
$string['crm_user360_n115a_timeline_help'] = 'Полная история Commerce, обучения, Inbox, CRM и административных событий.';
$string['crm_user360_n115a_intelligence_title'] = 'Подробная CRM Intelligence';
$string['crm_user360_n115a_intelligence_help'] = 'Баллы, тенденция, сегменты, возможности и объяснение рассчитанных сигналов клиента.';
$string['crm_user360_n115a_expert_followup'] = 'Экспертное сопровождение';
$string['crm_user360_n115a_expert_followup_help'] = 'Редко используемые экспертные инструменты скрыты по умолчанию для компактности экрана.';
$string['crm_user360_n115a_assistant_help'] = 'Рекомендации и запросы к CRM Assistant.';
$string['crm_user360_n115a_workitems_help'] = 'Открытые, срочные и просроченные CRM-задачи.';
$string['crm_user360_n115a_customer_success_help'] = 'Планы и этапы сопровождения Customer Success.';

// Commerce 7.95 N11.5B — Advanced Relation CRM dashboard.
$string['crm_user360_n115b_no_intelligence'] = 'Подробная CRM-аналитика для этого клиента пока недоступна.';
$string['crm_user360_n115b_intelligence_dashboard_help'] = 'Сводка оценок и сигналов, помогающих понять текущую ситуацию клиента.';
$string['crm_user360_n115b_why_score'] = 'Почему такой балл?';
$string['crm_user360_n115b_why_score_help'] = 'Основные факторы, влияющие на итоговую оценку.';
$string['crm_user360_n115b_segments_title'] = 'Сегменты и приоритеты';
$string['crm_user360_n115b_segments_help'] = 'Текущие сегменты и обнаруженные рекомендации.';
$string['crm_user360_n115b_recommendations_priority'] = 'Приоритетные рекомендации';
$string['crm_user360_n115b_actions_help'] = 'Быстрые действия для работы с клиентом.';
$string['crm_user360_n115b_inbox_help'] = 'Последние диалоги и сообщения клиента.';
$string['crm_user360_n115b_inbox_unavailable'] = 'CRM Inbox недоступен для этого пользователя.';
$string['crm_user360_n115b_notes_recent'] = 'Последние внутренние заметки';
$string['crm_user360_n115b_notes_help'] = 'Последние заметки и напоминания команды CRM.';
$string['crm_user360_n115b_assistant_help'] = 'Две приоритетные рекомендации ИИ и доступ к CRM Assistant.';
$string['crm_user360_n115b_workitems_help'] = 'Открытые, срочные и просроченные CRM-задачи клиента.';
$string['crm_user360_n115b_customer_success_help'] = 'Текущие планы и этапы сопровождения Customer Success.';
$string['crm_user360_n115b_no_customer_success'] = 'Нет открытого плана Customer Success.';
$string['crm_user360_n115b_no_score_factors'] = 'Подробные факторы оценки недоступны.';
$string['crm_user360_n115b_no_segments'] = 'CRM-сегменты не обнаружены.';
$string['crm_user360_n115c_digital_products'] = 'Цифровые продукты';
$string['crm_user360_n115c_digital_products_help'] = 'Приобретённые цифровые материалы, доступные загрузки и история загрузок, если она отслеживается.';
$string['crm_user360_n115c_no_digital_products'] = 'Нет доступных цифровых продуктов.';
$string['crm_user360_n115c_owned_since'] = 'В собственности с {$a}';
$string['crm_user360_n115c_download_count'] = 'Загрузок: {$a}';
$string['crm_user360_n115c_last_download'] = 'Последняя загрузка: {$a}';
$string['crm_user360_n115c_download_history_unavailable'] = 'История загрузок недоступна';
$string['crm_user360_n115c_digital_resource'] = 'Цифровой продукт';
$string['crm_user360_n115c_action_change_email_help'] = 'Изменить e-mail для входа в аккаунт.';
$string['crm_user360_n115c_action_reset_password_help'] = 'Чувствительное действие: сбросить пароль.';
$string['crm_user360_n115c_action_resend_delivery_help'] = 'Повторно отправить письмо с доступом к цифровой покупке.';
$string['crm_user360_n115c_action_expert_help'] = 'Расширенное CRM-действие для клиента.';
$string['crm_user360_n115c_no_expert_actions'] = 'Нет доступных расширенных CRM-действий.';
$string['crm_intelligence_recommendation_review_customer_success_risk'] = 'Проверить риск Customer Success';
$string['crm_intelligence_recommendation_intervene_disengagement_spiral'] = 'Отреагировать на снижение вовлечённости';
$string['crm_intelligence_recommendation_review_learning_difficulty'] = 'Проверить учебную трудность';

// Commerce 7.95 N11.5D — Relation CRM fixes.
$string['crm_user360_n115d_assistant_recommendations'] = 'Приоритетные рекомендации';
$string['crm_user360_n115d_assistant_question'] = 'Спросить Ассистента';
$string['crm_user360_n115d_no_assistant_recommendations'] = 'Сейчас нет приоритетных рекомендаций.';
$string['crm_user360_n115d_assistant_unavailable'] = 'Диалоговый Ассистент недоступен в этой сессии.';

// Commerce 7.95 N11.6A — Advanced Commerce.
$string['crm_user360_n116a_orders_title'] = 'Подробные заказы';
$string['crm_user360_n116a_orders_help'] = 'История Native и объединённого Commerce с прямыми переходами к заказам и продуктам.';
$string['crm_user360_n116a_legacy_subscriptions_title'] = 'Legacy-подписки';
$string['crm_user360_n116a_legacy_subscriptions_help'] = 'Старые подписки, сохранённые для истории и операций поддержки.';
$string['crm_user360_n116a_open_course'] = 'Открыть курс';
$string['crm_user360_n116a_open_product'] = 'Открыть продукт';
$string['crm_user360_n116a_communication'] = 'Коммуникация';
$string['crm_user360_n116a_management'] = 'Управление';
$string['crm_user360_n116a_extend_30_days'] = 'Продлить на 30 дней';
$string['crm_user360_n116a_access_period'] = 'С {$a->start} по {$a->end}';
$string['crm_user360_n116a_access_until'] = 'До {$a}';
$string['crm_user360_n116a_access_unlimited'] = 'Бессрочный доступ';

// Commerce 7.95 N11.6B — User360 Commerce actions/readability.
$string['crm_user360_n116b_open_sales'] = 'Открыть в CRM Продажи';

// Commerce 7.95 N11.6C — User360 / Commerce polish.
$string['crm_user360_n116c_access_lifetime'] = 'Бессрочный доступ';
$string['crm_user360_n116c_access_until'] = 'Доступ до {$a}';
$string['crm_user360_n116c_access_expired'] = 'Доступ истёк';

// Commerce 7.95 N11.7A — User360 Identity panel.
$string['crm_user360_n117a_commerce_orders'] = '{$a} заказ(ов) Commerce';
$string['crm_user360_n117a_legacy_purchases'] = '{$a} Legacy-покупок';
$string['crm_user360_n117a_personal_offers'] = '{$a} персональных предложений';
$string['crm_user360_n117a_merge_sources'] = '{$a} элементов объединения';
$string['crm_user360_n117a_identity_source_details'] = 'Показать технические детали';

// Commerce 7.95 N11.7B — Identity 2-column layout.
$string['crm_user360_n117b_merge'] = 'Объединить';
$string['crm_user360_n117b_potential_column_title'] = 'Возможно связанные аккаунты';

// Commerce 7.95 N11.8A — Legacy subscription editor polish.
$string['crm_subscription_edit_legacy_badge'] = 'Legacy-подписка';
$string['crm_subscription_edit_current_period'] = 'Текущий период';
$string['crm_subscription_edit_access_title'] = 'Параметры доступа';
$string['crm_subscription_edit_access_help'] = 'Изменяйте только период доступа или административный статус этой Legacy-подписки.';
$string['crm_subscription_edit_start_date'] = 'Дата начала';
$string['crm_subscription_edit_start_date_help'] = 'Дата, с которой подписка предоставляет доступ к связанным ресурсам.';
$string['crm_subscription_edit_no_end_date'] = 'Без даты окончания';
$string['crm_subscription_edit_no_end_date_help'] = 'Включите эту опцию для бессрочного доступа.';
$string['crm_subscription_edit_end_date'] = 'Дата окончания';
$string['crm_subscription_edit_end_date_help'] = 'Последний день действия подписки при ограниченном сроке доступа.';
$string['crm_subscription_edit_status'] = 'Статус';
$string['crm_subscription_edit_status_help'] = 'Административный Legacy-статус подписки. Изменяйте только при необходимости ручной корректировки.';

// Commerce 7.95 N11.8B — Legacy CSV import polish.
$string['crm_legacy_import_upload_title'] = 'Импорт Legacy-доступов';
$string['crm_legacy_import_upload_help'] = 'Выберите CSV-файл с Legacy-подписками. Перед созданием доступов можно проверить все строки.';
$string['crm_legacy_import_preview_title'] = 'Проверка импорта';
$string['crm_legacy_import_preview_help'] = 'Проверьте пользователей, планы и суммы. Обнаруженные дубликаты автоматически исключаются.';
$string['crm_legacy_import_result_summary_title'] = 'Импорт завершён';
$string['crm_legacy_import_result_summary_help'] = 'Результат создания Legacy-доступов из CSV-файла.';
$string['crm_legacy_import_no_file'] = 'Файл не выбран';
$string['crm_legacy_import_entry_title'] = 'Legacy CSV-импорт';
$string['crm_legacy_import_entry_help'] = 'Создать несколько исторических Legacy-доступов из CSV-файла.';
$string['crm_legacy_import_entry_action'] = 'Импортировать доступы';

// Commerce 7.95 N11.9B — Identity reconciliation UX.
$string['crm_identity_reconciliation_search_placeholder'] = 'E-mail, клиент, ссылка CFR…';
$string['crm_identity_reconciliation_more_filters'] = 'Дополнительные фильтры';
$string['crm_identity_reconciliation_results_title'] = '{$a} продаж(и) для сверки';
$string['crm_identity_reconciliation_results_help'] = 'Для каждой строки предлагается наиболее вероятный аккаунт Moodle. Данные не изменяются до явного подтверждения.';
$string['crm_identity_reconciliation_sale'] = 'Продажа';
$string['crm_identity_reconciliation_proposed_account'] = 'Предлагаемый аккаунт';
$string['crm_identity_reconciliation_expected_effect'] = 'Ожидаемый результат';
$string['crm_identity_reconciliation_moodle_account'] = 'Аккаунт Moodle';
$string['crm_identity_reconciliation_effect_total'] = '{$a} планируемых изменений';
$string['crm_identity_reconciliation_effect_course_access'] = '{$a} доступов к курсам';
$string['crm_identity_reconciliation_effect_digital'] = '{$a} цифровых доступов';
$string['crm_identity_reconciliation_effect_guest'] = '{$a} гостевых сессий';
$string['crm_identity_reconciliation_effect_legacy'] = '{$a} Legacy-записей';
$string['crm_identity_reconciliation_effect_link_only'] = 'Связать клиента с продажей';

// Commerce 7.95 N11.9B.1 — Reconciliation impact details.
$string['crm_identity_reconciliation_effect_heading'] = 'Что будет изменено';
$string['crm_identity_reconciliation_effect_purchase_link'] = 'Привязать продажу к аккаунту Moodle #{$a->userid}';
$string['crm_identity_reconciliation_effect_course_access_detail'] = 'Назначить {$a->count} доступ(ов) к курсам аккаунту Moodle #{$a->userid}';
$string['crm_identity_reconciliation_effect_digital_detail'] = 'Назначить {$a->count} цифровых доступов аккаунту Moodle #{$a->userid}';
$string['crm_identity_reconciliation_effect_guest_detail'] = 'Привязать {$a->count} гостевых сессий к аккаунту Moodle #{$a->userid}';
$string['crm_identity_reconciliation_effect_legacy_detail'] = 'Привязать Legacy-покупку #{$a->legacyid} к аккаунту Moodle #{$a->userid}';
$string['crm_identity_reconciliation_effect_none'] = 'Дополнительные связанные данные обновлять не требуется';

// Commerce 7.95 N11.9C — Similarity UX and scoring.
$string['crm_identity_similarity_results_title'] = '{$a} предложенных совпадений';
$string['crm_identity_similarity_scan_detail'] = '{$a} аккаунтов проанализировано';
$string['crm_identity_similarity_score_help'] = 'Индекс показывает силу общих сигналов, а не гарантирует, что аккаунты принадлежат одному человеку. Два разных аккаунта никогда не получают 100 %, а объединение всегда выполняется вручную.';

// Commerce 7.95 N11.9D — Weighted similarity and identity links UX.
$string['crm_identity_similarity_check_email'] = 'E-mail';
$string['crm_identity_similarity_check_name'] = 'Имя и фамилия';
$string['crm_identity_similarity_check_phone'] = 'Телефон';
$string['crm_identity_similarity_check_weight'] = 'вес {$a} %';
$string['crm_identity_relationships_inspector_title'] = 'Проверить идентичность';
$string['crm_identity_relationships_inspector_help'] = 'Найдите аккаунт Moodle или Commerce / Legacy-идентичность. Затем экран объединит известные e-mail и связи идентичностей.';
$string['crm_identity_relationships_moodle_account'] = 'Аккаунт Moodle';
$string['crm_identity_relationships_moodle_account_help'] = 'Используйте Moodle ID, если аккаунт уже существует.';
$string['crm_identity_relationships_userid_placeholder'] = 'Напр. 163';
$string['crm_identity_relationships_or'] = 'или';
$string['crm_identity_relationships_external_identity'] = 'Commerce / Legacy-идентичность';
$string['crm_identity_relationships_external_identity_help'] = 'Используйте e-mail, если аккаунт Moodle пока неизвестен.';
$string['crm_identity_relationships_email_placeholder'] = 'client@example.com';
$string['crm_identity_relationships_empty_help'] = 'Идентичность не выбрана. Введите Moodle ID или e-mail, чтобы открыть историю и связанные записи.';

// Commerce 7.95 N11.9E — Provisioning and Legacy quality polish.
$string['crm_identity_provisioning_diagnostic'] = 'Диагностика';
$string['crm_identity_provisioning_recommendation'] = 'Рекомендуемое действие';
$string['crm_identity_provisioning_ready_help'] = 'Подходящий аккаунт Moodle не найден: создание нового аккаунта можно предварительно проверить.';
$string['crm_identity_provisioning_open_existing'] = 'Открыть аккаунт Moodle #{$a}';
$string['crm_identity_provisioning_ambiguous_help'] = 'Несколько аккаунтов используют этот e-mail. Сначала проверьте личность.';
$string['crm_identity_provisioning_similar_help'] = 'Обнаружено потенциально похожих аккаунтов: {$a}. Проверьте их перед созданием нового аккаунта.';
$string['crm_identity_provisioning_more_candidates'] = '+ ещё {$a} кандидат(ов)';
$string['crm_identity_legacy_quality_results_title'] = '{$a} Legacy-идентичностей';
$string['crm_identity_legacy_quality_results_help'] = 'Подозрительные и некорректные адреса приоритетны; корректные можно показать фильтром.';
$string['crm_identity_legacy_quality_history'] = 'История Legacy';
$string['crm_identity_legacy_quality_correct'] = 'Исправить';

// Commerce 7.95 N12.1 — CRM Inbox UX and manual refresh.
$string['crm_inbox_refresh'] = 'Обновить почту';
$string['crm_inbox_refresh_success'] = 'Почта обновлена: получено {$a->fetched}, новых {$a->created}, обновлено {$a->updated}, ошибок {$a->errors}.';
$string['crm_inbox_refresh_has_more'] = 'Доступны дополнительные сообщения; при необходимости обновите почту ещё раз.';
$string['crm_inbox_refresh_no_accounts'] = 'Нет активной настроенной CRM-почты.';
$string['crm_inbox_refresh_failed'] = 'Не удалось обновить CRM-почту. Проверьте диагностику Inbox.';

// Commerce 7.95 N12.2 — Inbox card badges and remote-image preview polish.
$string['crm_inbox_unread_count_compact'] = 'Непрочитано: {$a}';
$string['crm_inbox_remote_images_blocked_summary'] = 'Скрыто внешних изображений: {$a}. Их загрузка может сообщить отправителю, что письмо было открыто.';


$string['crm_inbox_load_remote_images'] = 'Показать изображения';

// Commerce 7.95 N12.4A — Inbox AI translation and analysis workspace.
$string['crm_inbox_ai_panel_description_n124'] = 'Переведите последнее сообщение клиента, проанализируйте запрос или подготовьте ответ с помощью ИИ.';
$string['crm_inbox_ai_translate_title'] = 'Перевести сообщение';
$string['crm_inbox_ai_translate_help'] = 'Перевод последнего сообщения клиента на выбранный администратором язык.';
$string['crm_inbox_ai_translate_action'] = 'Перевести';
$string['crm_inbox_ai_analysis_title_n124'] = 'Проанализировать запрос';
$string['crm_inbox_ai_analysis_help_n124'] = 'Определяет язык, срочность, категорию, запросы клиента и важные пункты.';
$string['crm_inbox_ai_reply_title_n124'] = 'Подготовить ответ';
$string['crm_inbox_ai_reply_help_n124'] = 'Создаёт черновик ответа, который нужно проверить перед отправкой.';
$string['crm_inbox_ai_processing_n124'] = 'ИИ обрабатывает запрос…';
$string['crm_inbox_ai_processing_short_n124'] = 'Обработка…';
$string['crm_inbox_ai_empty_title_n124'] = 'Выберите инструмент';
$string['crm_inbox_ai_empty_help_n124'] = 'Перевод и анализ появятся здесь в достаточно большом блоке для удобной проверки.';
$string['crm_inbox_ai_translation_result_title'] = 'Перевод последнего сообщения';
$string['crm_inbox_ai_analysis_result_title_n124'] = 'Анализ запроса клиента';
$string['crm_inbox_ai_analysis_no_summary_n124'] = 'Не удалось получить полезное резюме.';
$string['crm_inbox_ai_analysis_no_details_n124'] = 'Дополнительные пункты не обнаружены.';
$string['crm_inbox_ai_fallback_notice_n124'] = 'Для части или всего результата использован локальный резервный анализ. Расширенные функции работают лучше при доступном внешнем ИИ-провайдере.';

// Commerce 7.95 N12.4B — AI layout and result hierarchy fix.
$string['crm_inbox_ai_translation_provider_missing_n124b'] = 'Для перевода требуется ИИ-провайдер OpenAI, но он недоступен в текущей конфигурации. Проверьте активацию провайдера, модель и API-ключ.';

// Commerce 7.95 N12.7A — Work Management workspace polish.
$string['crm_work_section_navigation_n127a'] = 'Навигация Work Management';
$string['crm_work_open_n127a'] = 'Открыть';
$string['crm_work_no_due_n127a'] = 'Без срока';
$string['crm_work_unassigned_n127a'] = 'Не назначено';
$string['crm_work_assignment_n127a'] = 'Назначение';
$string['crm_work_assignee_n127a'] = 'Ответственный';
$string['crm_work_management_n127a'] = 'Управление';
$string['crm_work_description_n127a'] = 'Описание';
$string['crm_work_create_content_n127a'] = 'Содержание Work Item';
$string['crm_work_create_settings_n127a'] = 'Организация и приоритет';
$string['crm_work_team_description_n127a'] = 'Описание';
$string['crm_work_team_empty_n127a'] = 'Команды пока не созданы.';
$string['crm_work_team_members_n127a'] = 'Участники';
$string['crm_work_team_no_members_n127a'] = 'В этой команде пока нет участников.';

// Commerce 7.95 N12.7A.1 — Work runtime/history polish.
$string['crm_work_team_enabled_n127a1'] = 'Активна';
$string['crm_work_team_disabled_n127a1'] = 'Неактивна';
$string['crm_work_history_created_n127a1'] = 'Work Item создан';
$string['crm_work_history_status_changed_n127a1'] = 'Статус изменён';
$string['crm_work_history_priority_changed_n127a1'] = 'Приоритет изменён';
$string['crm_work_history_assignment_changed_n127a1'] = 'Назначение изменено';
$string['crm_work_history_comment_added_n127a1'] = 'Комментарий добавлен';
$string['crm_work_history_link_added_n127a1'] = 'Ссылка добавлена';

// Commerce 7.95 N12.8A — Administrator Tools workspace polish.
$string['crm_admin_tools_navigation_n128a'] = 'Навигация административных инструментов';
$string['crm_admin_tools_group_messaging_n128a'] = 'CRM-почта';
$string['crm_admin_tools_group_messaging_help_n128a'] = 'Синхронизация, подключение и диагностика входящей почты.';
$string['crm_admin_tools_group_automation_n128a'] = 'Интеллект и автоматизации';
$string['crm_admin_tools_group_automation_help_n128a'] = 'Запуск CRM-механизмов, пересчётов и рекомендаций.';
$string['crm_admin_tools_group_operations_n128a'] = 'Commerce и обслуживание';
$string['crm_admin_tools_group_operations_help_n128a'] = 'Технические операции с цифровыми платежами и качеством Help Center.';
$string['crm_admin_tool_execution_context_n128a'] = 'На этой странице выполняется контролируемая административная операция. Уровень риска показывает возможное влияние на данные и процессы CRM.';
$string['crm_admin_tool_execution_settings_n128a'] = 'Параметры запуска';

// Commerce 7.95 N12.9A — CRM Assistant workspace polish.
$string['crm_assistant_results_count_n129a'] = 'Рекомендаций по фильтрам: {$a}';
$string['crm_assistant_per_page_n129a'] = 'На странице';
$string['crm_assistant_overview_title_n129a'] = 'Состояние CRM Assistant';

// Commerce 7.95 N12.9B — Assistant Customer Success subpages polish.
$string['csplanoverviewlabel_n129b'] = 'План Customer Success';
$string['csplanconfirmhelp_n129b'] = 'Проверьте действие перед изменением плана Customer Success.';
$string['csplanconfirmwarning_n129b'] = 'Это действие изменит сопровождение клиента. Можно вернуться к плану, не применяя изменение.';

// Commerce 7.95 N12.9C — User360 Customer Success plan creation.
$string['csplancreate_button_n129c'] = 'Создать план';
$string['csplancreate_title_n129c'] = 'Создать план Customer Success';
$string['csplancreate_help_n129c'] = 'Подготовьте план сопровождения для {$a}. Перед активацией план будет создан как черновик.';
$string['csplancreate_success_n129c'] = 'План Customer Success создан.';
$string['csplancreate_plan_section_n129c'] = 'Цель сопровождения';
$string['csplancreate_title_field_n129c'] = 'Название плана';
$string['csplancreate_description_field_n129c'] = 'Описание';
$string['csplancreate_settings_section_n129c'] = 'Приоритет и срок';
$string['csplancreate_priority_field_n129c'] = 'Приоритет';
$string['csplancreate_targetdate_field_n129c'] = 'Общий срок';
$string['csplancreate_first_step_section_n129c'] = 'Первый этап';
$string['csplancreate_first_step_help_n129c'] = 'Необязательно: сразу добавьте первое действие.';
$string['csplancreate_first_step_title_n129c'] = 'Действие';
$string['csplancreate_first_step_description_n129c'] = 'Описание действия';
$string['csplancreate_first_step_due_n129c'] = 'Срок этапа';
$string['csplancreate_submit_n129c'] = 'Создать план';

// Commerce 7.95 N12.9D — AI diagnostics and Customer Success polish.
$string['csplancreate_new_after_cancel_n129d'] = 'Создать новый план';
$string['crm_inbox_ai_diag_health_title_n129d'] = 'ИИ-помощник работает';
$string['crm_inbox_ai_diag_health_detail_n129d'] = 'Пройдено проверок: {$a->ok} из {$a->total}.';
$string['crm_inbox_ai_usage_global_label_n129d'] = 'Общий лимит сегодня';
$string['crm_inbox_ai_usage_user_label_n129d'] = 'Ваш лимит сегодня';
$string['crm_inbox_ai_failures_label_n129d'] = 'Ошибки сегодня';
$string['crm_inbox_ai_diag_checks_title_n129d'] = 'Состояние конфигурации';
$string['crm_inbox_ai_diag_checks_help_n129d'] = 'Технические проверки хранилища, ИИ-провайдера и оркестратора.';
$string['crm_inbox_ai_diag_usage_help_n129d'] = 'Использование лимитов ИИ за текущий день.';

// Commerce 7.95 N12.10A — Help diagnostics and Inbox AI navigation polish.
$string['crm_nav_inbox_ai_diagnostics_n1210a'] = 'Диагностика ИИ';
$string['crm_help_diagnostics_health_ok_n1210a'] = 'Центр помощи согласован';
$string['crm_help_diagnostics_health_attention_n1210a'] = 'Требуются исправления';
$string['crm_help_diagnostics_health_detail_n1210a'] = 'Проверок: {$a->total} · ошибок: {$a->errors} · предупреждений: {$a->warnings}';
$string['crm_help_diagnostics_errors_help_n1210a'] = 'Критические проблемы или отсутствующие материалы, которые нужно исправить.';
$string['crm_help_diagnostics_warnings_help_n1210a'] = 'Несоответствия или проблемы перевода, которые стоит проверить.';
$string['crm_help_diagnostics_successes_help_n1210a'] = 'Успешно пройденные проверки. Раздел по умолчанию свернут.';

// Commerce 7.95 N12.10B — Help Center homepage polish.
$string['crm_help_quick_navigation_n1210b'] = 'Быстрые ссылки Центра помощи';

// Commerce 7.95 N12.10C — missing Commerce configuration labels.
$string['commerce_configuration_setting_alfa_env'] = 'Среда Alfa';
$string['commerce_configuration_setting_alfa_reconciliation_batch_size'] = 'Размер пакета Alfa';
$string['commerce_configuration_setting_alfa_reconciliation_cron_enabled'] = 'Сверка Alfa';
$string['commerce_configuration_setting_availability_mode'] = 'Доступность Commerce';
$string['commerce_configuration_setting_brand_logo_url'] = 'Логотип бренда';
$string['commerce_configuration_setting_commerce_enabled_currencies'] = 'Активные валюты';
$string['commerce_configuration_setting_commerce_fulfillment_shadow_enabled'] = 'Теневой fulfillment';
$string['commerce_configuration_setting_commerce_mail_audit_batch_size'] = 'Размер пакета аудита писем';
$string['commerce_configuration_setting_commerce_mail_audit_copy_address'] = 'Адрес копии аудита писем';
$string['commerce_configuration_setting_commerce_mail_audit_copy_enabled'] = 'Копия аудита писем';
$string['commerce_configuration_setting_commerce_mail_audit_hourly_limit'] = 'Лимит аудита писем в час';
$string['commerce_configuration_setting_commerce_native_reconciliation_enabled'] = 'Нативная сверка';
$string['commerce_configuration_setting_commerce_native_repair_enabled'] = 'Нативное исправление';
$string['commerce_configuration_setting_commerce_runtime_mode'] = 'Основной runtime';
$string['commerce_configuration_setting_commerce_runtime_native_fallback_enabled'] = 'Нативный fallback';
$string['commerce_configuration_setting_commerce_runtime_read_mode'] = 'Режим чтения';
$string['commerce_configuration_setting_commerce_runtime_read_strict'] = 'Строгое чтение';
$string['commerce_configuration_setting_defaultemaillang'] = 'Язык писем по умолчанию';
$string['commerce_configuration_setting_defaultuserlang'] = 'Язык аккаунтов по умолчанию';
$string['commerce_configuration_setting_display_currency_symbols'] = 'Символы валют';
$string['commerce_configuration_setting_email_copy_to'] = 'Копия писем';
$string['commerce_configuration_setting_expire_pending_after_minutes'] = 'Срок ожидания платежа';
$string['commerce_configuration_setting_featured_planid'] = 'Рекомендуемый план';
$string['commerce_configuration_setting_guest_checkout_cleanup_age_days'] = 'Возраст перед очисткой (дни)';
$string['commerce_configuration_setting_guest_checkout_cleanup_enabled'] = 'Очистка гостевых checkout';
$string['commerce_configuration_setting_offer_url_row'] = 'Публичное предложение — другие регионы';
$string['commerce_configuration_setting_offer_url_ru'] = 'Публичное предложение — Россия';
$string['commerce_configuration_setting_payments_lock_strict'] = 'Строгая блокировка платежей';
$string['commerce_configuration_setting_payments_mismatch_tolerance_cents'] = 'Допуск расхождения платежа (центы)';
$string['commerce_configuration_setting_personal_offer_mail_batch_size'] = 'Размер пакета кампаний';
$string['commerce_configuration_setting_personal_offer_mail_hourly_limit'] = 'Лимит кампаний в час';
$string['commerce_configuration_setting_policy_url_row'] = 'Политика конфиденциальности — другие регионы';
$string['commerce_configuration_setting_policy_url_ru'] = 'Политика конфиденциальности — Россия';
$string['commerce_configuration_setting_provider_default'] = 'Провайдер по умолчанию';
$string['commerce_configuration_setting_reminder1_after_minutes'] = 'Первое напоминание';
$string['commerce_configuration_setting_reminder2_after_minutes'] = 'Второе напоминание';
$string['commerce_configuration_setting_storefront_ai_translation_enabled'] = 'ИИ-перевод Storefront';
$string['commerce_configuration_setting_stripe_env'] = 'Среда Stripe';
$string['commerce_configuration_setting_stripe_reconciliation_batch_size'] = 'Размер пакета Stripe';
$string['commerce_configuration_setting_stripe_reconciliation_cron_enabled'] = 'Сверка Stripe';
$string['commerce_configuration_setting_support_email'] = 'E-mail поддержки';
$string['commerce_configuration_setting_terms_url_row'] = 'Условия — другие регионы';
$string['commerce_configuration_setting_terms_url_ru'] = 'Условия — Россия';

// Commerce 7.95 N12.10C — localized Help Center diagnostic messages.
$string['crm_help_diag_msg_content_dir_missing_n1210c'] = 'Каталог материалов Центра помощи не существует: {$a}';
$string['crm_help_diag_msg_content_dir_unreadable_n1210c'] = 'Каталог материалов Центра помощи недоступен для чтения: {$a}';
$string['crm_help_diag_msg_content_dir_ok_n1210c'] = 'Каталог материалов Центра помощи доступен.';
$string['crm_help_diag_msg_language_dir_missing_n1210c'] = 'Отсутствует языковой каталог Центра помощи: {$a}';
$string['crm_help_diag_msg_language_dir_unreadable_n1210c'] = 'Языковой каталог Центра помощи недоступен для чтения: {$a}';
$string['crm_help_diag_msg_language_dir_ok_n1210c'] = 'Языковой каталог Центра помощи доступен: {$a}';
$string['crm_help_diag_msg_language_file_unloadable_n1210c'] = 'Не удалось загрузить языковой файл: {$a}';
$string['crm_help_diag_msg_language_strings_loaded_n1210c'] = 'Загружено строк: {$a->count}, язык: {$a->language}.';
$string['crm_help_diag_msg_language_key_missing_n1210c'] = 'Отсутствует строка на языке {$a->language}: {$a->key}';
$string['crm_help_diag_msg_language_key_extra_n1210c'] = 'Строка существует на языке {$a->language}, но отсутствует в английском: {$a->key}';
$string['crm_help_diag_msg_language_keys_match_n1210c'] = 'Языковой файл {$a} соответствует набору английских ключей.';
$string['crm_help_diag_msg_no_category_n1210c'] = 'В реестре Центра помощи нет категорий.';
$string['crm_help_diag_msg_category_empty_id_n1210c'] = 'У категории Центра помощи пустой идентификатор.';
$string['crm_help_diag_msg_category_duplicate_id_n1210c'] = 'Дублирующийся идентификатор категории: {$a}';
$string['crm_help_diag_msg_category_empty_title_n1210c'] = 'У категории пустой заголовок: {$a}';
$string['crm_help_diag_msg_category_no_description_n1210c'] = 'У категории нет описания: {$a}';
$string['crm_help_diag_msg_categories_validated_n1210c'] = 'Проверено категорий Центра помощи: {$a}.';
$string['crm_help_diag_msg_no_article_n1210c'] = 'В реестре Центра помощи нет статей.';
$string['crm_help_diag_msg_articles_validated_n1210c'] = 'Проверено статей Центра помощи: {$a}.';
$string['crm_help_diag_msg_article_empty_id_n1210c'] = 'У статьи Центра помощи пустой идентификатор.';
$string['crm_help_diag_msg_article_duplicate_id_n1210c'] = 'Дублирующийся идентификатор статьи: {$a}';
$string['crm_help_diag_msg_article_unknown_category_n1210c'] = 'Статья «{$a->article}» ссылается на неизвестную категорию «{$a->category}».';
$string['crm_help_diag_msg_article_empty_title_n1210c'] = 'У статьи пустой заголовок: {$a}';
$string['crm_help_diag_msg_article_no_summary_n1210c'] = 'У статьи нет краткого описания: {$a}';
$string['crm_help_diag_msg_article_invalid_filename_n1210c'] = 'Статья «{$a->article}» использует недопустимое имя файла: {$a->file}';
$string['crm_help_diag_msg_article_invalid_context_n1210c'] = 'Статья «{$a->article}» ссылается на недопустимый контекст «{$a->context}».';
$string['crm_help_diag_msg_article_no_context_n1210c'] = 'Для статьи не назначен контекст: {$a}';
$string['crm_help_diag_msg_article_no_keyword_n1210c'] = 'У статьи нет поисковых ключевых слов: {$a}';
$string['crm_help_diag_msg_markdown_missing_n1210c'] = 'Отсутствует Markdown-файл статьи «{$a->article}» для языка «{$a->language}»: {$a->file}';
$string['crm_help_diag_msg_markdown_unreadable_n1210c'] = 'Markdown-файл недоступен для чтения: {$a}';
$string['crm_help_diag_msg_markdown_read_failed_n1210c'] = 'Не удалось прочитать Markdown-файл: {$a}';
$string['crm_help_diag_msg_markdown_empty_n1210c'] = 'Пустой Markdown-файл: {$a}';
$string['crm_help_diag_msg_markdown_no_h1_n1210c'] = 'В Markdown-файле нет заголовка первого уровня: {$a}';
$string['crm_help_diag_msg_markdown_link_missing_n1210c'] = 'Статья «{$a->article}» ({$a->language}) ссылается на отсутствующий Markdown-файл «{$a->target}».';
$string['crm_help_diag_source_article_n1210c'] = 'Статья {$a->article} ({$a->language})';
$string['crm_help_diag_msg_markdown_unregistered_n1210c'] = 'Незарегистрированный Markdown-файл: {$a}';
$string['crm_help_diag_msg_no_guide_n1210c'] = 'В Центре помощи нет практических руководств.';
$string['crm_help_diag_msg_guides_validated_n1210c'] = 'Проверено практических руководств: {$a}.';
$string['crm_help_diag_msg_guide_empty_id_n1210c'] = 'У практического руководства пустой идентификатор.';
$string['crm_help_diag_msg_guide_duplicate_id_n1210c'] = 'Дублирующийся идентификатор руководства: {$a}';
$string['crm_help_diag_msg_guide_empty_title_n1210c'] = 'У руководства пустой заголовок: {$a}';
$string['crm_help_diag_msg_guide_no_description_n1210c'] = 'У руководства нет описания: {$a}';
$string['crm_help_diag_msg_guide_no_step_n1210c'] = 'В руководстве нет этапов: {$a}';
$string['crm_help_diag_msg_guide_invalid_context_n1210c'] = 'Руководство «{$a->guide}» ссылается на недопустимый контекст «{$a->context}».';
$string['crm_help_diag_msg_guide_step_empty_id_n1210c'] = 'Руководство «{$a}» содержит этап без идентификатора.';
$string['crm_help_diag_msg_guide_step_duplicate_n1210c'] = 'Руководство «{$a->guide}» содержит дублирующийся этап «{$a->step}».';
$string['crm_help_diag_msg_guide_step_empty_title_n1210c'] = 'У этапа руководства пустой заголовок: {$a->guide}/{$a->step}';
$string['crm_help_diag_msg_guide_step_incomplete_action_n1210c'] = 'У этапа руководства неполное действие: {$a->guide}/{$a->step}';
$string['crm_help_diag_source_guide_step_n1210c'] = 'Этап руководства {$a->guide}/{$a->step}';
$string['crm_help_diag_msg_no_onboarding_n1210c'] = 'В Центре помощи нет этапов знакомства с CRM.';
$string['crm_help_diag_msg_onboarding_invalid_object_n1210c'] = 'Некорректный объект этапа знакомства с CRM.';
$string['crm_help_diag_msg_onboarding_empty_id_n1210c'] = 'У этапа знакомства с CRM пустой идентификатор.';
$string['crm_help_diag_msg_onboarding_duplicate_id_n1210c'] = 'Дублирующийся идентификатор этапа знакомства: {$a}';
$string['crm_help_diag_msg_onboarding_empty_title_n1210c'] = 'У этапа знакомства пустой заголовок: {$a}';
$string['crm_help_diag_msg_onboarding_no_description_n1210c'] = 'У этапа знакомства нет описания: {$a}';
$string['crm_help_diag_source_onboarding_step_n1210c'] = 'Этап знакомства {$a}';
$string['crm_help_diag_msg_onboarding_validated_n1210c'] = 'Проверено этапов знакомства: {$a}.';
$string['crm_help_diag_msg_missing_page_n1210c'] = '{$a->source} ссылается на отсутствующую страницу: {$a->path}';
$string['crm_help_diag_msg_unknown_help_article_n1210c'] = '{$a->source} ссылается на неизвестную статью Центра помощи: {$a->article}';
$string['crm_help_diag_empty_value_n1210c'] = '[пусто]';

// Commerce 7.95 N12.10D — Help Center page UX harmonisation.
$string['crm_help_internal_navigation_n1210d'] = 'Навигация Центра помощи';
$string['crm_help_nav_home_n1210d'] = 'Главная';
$string['crm_help_nav_guides_n1210d'] = 'Практические руководства';
$string['crm_help_nav_articles_n1210d'] = 'Документация';
$string['crm_help_nav_diagnostics_n1210d'] = 'Диагностика';
$string['crm_help_documentation_title_n1210d'] = 'Документация CRM';
$string['crm_help_documentation_description_n1210d'] = 'Просматривайте статьи по темам, чтобы быстро понять работу экрана, инструмента или процесса.';

// Commerce 7.95 N12.11A — Dashboard information architecture.
$string['dashboard_n1211_focus_title'] = 'Требует внимания';
$string['dashboard_n1211_focus_description'] = 'Сигналы и приоритеты, по которым нужно быстро принять решение или выполнить действие.';
$string['dashboard_n1211_operations_title'] = 'Операционная работа';
$string['dashboard_n1211_operations_description'] = 'Inbox, задачи и Customer Success в одной рабочей зоне.';
$string['dashboard_n1211_insights_title'] = 'Аналитика и тенденции';
$string['dashboard_n1211_insights_description'] = 'CRM Intelligence, воронка, тенденции и предупреждения для понимания изменений.';
$string['dashboard_n1211_secondary_title'] = 'История и контекст';
$string['dashboard_n1211_secondary_description'] = 'Недавняя активность и дополнительный контекст без перегрузки основной панели.';

// Commerce 7.95 N12.11B — Dashboard grid and density polish.
$string['dashboard_onboarding_open_full_n1211b'] = 'Открыть весь маршрут знакомства с CRM →';
$string['dashboard_team_permissions_count_n1211b'] = 'Активных прав CRM: {$a}';
$string['dashboard_team_last_access_n1211b'] = 'Последний вход: {$a}';

// Commerce 7.95 final certification — Legacy Access Scope compatibility.
$string['commerce_scope_legacy_compatibility_title'] = 'Совместимость Legacy';
$string['commerce_scope_legacy_mapped_readonly_desc'] = 'Этот Legacy-периметр связан с одним или несколькими Native-продуктами Commerce. Старые переводы сохраняются для совместимости и аудита, но больше не являются официальным источником данных.';
$string['commerce_scope_legacy_unmapped_desc'] = 'Этот периметр всё ещё относится к модели Legacy. Его переводы остаются доступными, пока его не заменит Native-продукт Commerce.';
$string['commerce_scope_legacy_readonly_notice'] = 'Этот периметр управляется Native Commerce и больше не редактируется через Legacy-редактор.';
