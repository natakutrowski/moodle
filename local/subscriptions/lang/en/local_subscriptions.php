...
$string['commerce_identity_merge_preferred_identity_safety'] = 'Only username and email are swapped. The retained account keeps its Moodle ID, learning history, name and Commerce ownership. The absorbed account is suspended and receives the retained account’s previous login identity. The full change is written to the merge audit.';
