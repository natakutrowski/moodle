...
$string['availability_mode'] = 'Commerce page availability';
$string['availability_mode_desc'] = 'Controls access to public Commerce pages. “Admins only” temporarily closes Commerce to customers while keeping it available to administrators.';
...
$string['commerce_storefront_edit_language'] = 'Language version';
$string['commerce_storefront_edit_language_help'] = 'You are editing the selected language version of the Store Page. Editorial blocks, text and media can differ between languages.';
...
$string['commerce_promotion_productskus'] = 'Eligible products';
...
$string['commerce_personal_offer_mail_queue_single'] = 'Queue email';
...
$string['commerce_identity_merge_m756_scope_detail'] = 'The preview found {$a->learning} learning item(s), {$a->commerce} commercial item(s), and {$a->gamification} Level Up XP/Quest item(s) on the accounts being merged. They will be consolidated before the old accounts are disabled.';
...
$string['commerce_personal_offer_m11_collision_title'] = 'Existing active offer for the same product';
$string['commerce_personal_offer_m11_collision_help'] = 'Choose what to do when a campaign recipient already has an active Personal Offer for the target product.';
$string['commerce_personal_offer_m11_collision_skip'] = 'Exclude the recipient (current behaviour)';
$string['commerce_personal_offer_m11_collision_replace'] = 'Replace the active offer with this campaign’s new offer';
$string['commerce_personal_offer_m11_collision_resend'] = 'Keep the active offer and send the new campaign email';
$string['commerce_personal_offer_m11_collision_warning'] = 'An offer attached to an in-progress payment is never replaced. In replace mode, the old link is revoked while the audit history is preserved.';
$string['commerce_personal_offer_reason_m11_will_replace'] = 'Eligible: the existing active offer will be replaced by this campaign’s offer.';
$string['commerce_personal_offer_reason_m11_will_resend'] = 'Eligible: the existing active offer will be kept and reused for the new email.';
$string['commerce_personal_offer_reason_m11_reused'] = 'Existing active offer reused for the follow-up campaign.';
$string['commerce_personal_offer_reason_m11_payment_in_progress'] = 'Offer not replaced: a payment is currently in progress for this offer.';
$string['crm_commerce_nav_unfinished_checkouts'] = 'Unfinished checkouts';

// M9.3 / M9.4 — Guest checkout recovery CRM and safe cleanup.
$string['commerce_guest_crm_title'] = 'Unfinished guest checkouts';
$string['commerce_guest_crm_help'] = 'Diagnose and recover provisional accounts whose purchase flow was never completed.';
$string['commerce_guest_crm_empty'] = 'No unfinished guest checkout needs attention.';
$string['commerce_guest_crm_filter_all'] = 'All';
$string['commerce_guest_crm_class_pending_purchase'] = 'Payment pending';
$string['commerce_guest_crm_class_multiple_pending'] = 'Multiple pending purchases';
$string['commerce_guest_crm_class_stuck_identity'] = 'Identity blocked';
$string['commerce_guest_crm_class_provisional_no_purchase'] = 'Provisional without purchase';
$string['commerce_guest_crm_class_provider_paid_pending'] = 'Paid at provider, sale still pending';
$string['commerce_guest_crm_source_summary'] = 'Source session #{$a->session} ({$a->status}) · resume {$a->purchase} · blocked sessions {$a->stuck}';
$string['commerce_guest_crm_user360'] = 'Open User360';
$string['commerce_guest_crm_repair'] = 'Repair sessions';
$string['commerce_guest_crm_pending_purchases'] = 'Pending purchases';
$string['commerce_guest_crm_open_purchase'] = 'Open purchase';
$string['commerce_guest_crm_use_for_resume'] = 'Use for resume';
$string['commerce_guest_crm_current_resume'] = 'Current resume';
$string['commerce_guest_crm_check_provider'] = 'Check with provider';
$string['commerce_guest_crm_no_purchase_help'] = 'This provisional account created no purchase. No payment should be invented; it can only be kept or cleaned after the configured delay.';
$string['commerce_guest_crm_action_repaired'] = 'Blocked sessions were repaired.';
$string['commerce_guest_crm_action_resume_selected'] = 'This purchase is now the checkout resume reference.';
$string['commerce_guest_crm_action_reconciled'] = 'The payment was checked and reconciled.';
$string['commerce_guest_crm_candidate_not_found'] = 'This account is no longer an unfinished guest checkout.';
$string['commerce_guest_crm_source_not_found'] = 'No source guest session was found.';
$string['commerce_guest_crm_provider_not_supported'] = 'This provider does not support automatic CRM reconciliation.';
$string['commerce_guest_crm_source_session'] = 'Source session';
$string['commerce_guest_crm_resume_purchase'] = 'Resume purchase';
$string['commerce_guest_crm_stuck_sessions'] = 'Blocked sessions';
$string['commerce_guest_crm_open_case'] = 'Handle unfinished checkout';
$string['user360_guest_checkout_recovery_title'] = 'Unfinished guest checkout';
$string['user360_guest_checkout_recovery_description'] = 'Diagnosis and recovery actions for the provisional account.';
$string['task_cleanup_abandoned_guest_checkouts'] = 'Clean abandoned guest checkouts';
$string['settings:guest_checkout_cleanup_header'] = 'Abandoned Guest Checkout cleanup';
$string['settings:guest_checkout_cleanup_header_desc'] = 'Only removes old provisional accounts with no purchase or business activity. Disabled by default.';
$string['settings:guest_checkout_cleanup_enabled'] = 'Enable automatic cleanup';
$string['settings:guest_checkout_cleanup_enabled_desc'] = 'Disabled by default. When enabled, cron only handles checkout_* accounts that are unconfirmed, technically suspended and have no purchase, access, grant, enrolment or offer.';
$string['settings:guest_checkout_cleanup_age_days'] = 'Minimum age before cleanup (days)';
$string['settings:guest_checkout_cleanup_age_days_desc'] = 'A newer provisional account is never removed.';
$string['settings:guest_checkout_cleanup_batch_size'] = 'Maximum cleanup batch size';
$string['settings:guest_checkout_cleanup_batch_size_desc'] = 'Maximum accounts examined per run.';

$string['admin_event_user_legacy_digital_linked'] = 'Legacy Digital purchase linked to Moodle account';
$string['admin_event_commerce_personal_offer_beneficiary_corrected'] = 'Personal offer beneficiary corrected';

// M9.3a — live provider status in unfinished checkout CRM.
$string['commerce_guest_crm_provider_live_status'] = 'Provider: {$a->status}';
$string['commerce_guest_crm_provider_paid_pending'] = 'Paid at provider — reconcile';
$string['commerce_guest_crm_provider_probe_unavailable'] = 'Provider status unavailable';

// M11.1 — optional secondary campaign CTA.
$string['commerce_personal_offer_campaign_email_secondary_cta_label'] = 'Secondary CTA label';
$string['commerce_personal_offer_campaign_email_secondary_cta_url'] = 'Secondary CTA URL';
...
$string['commerce_personal_offer_identity_conflict_title'] = 'This offer belongs to another account';
$string['commerce_personal_offer_identity_conflict_message'] = 'This Personal Offer was sent to {$a->offeremail}, but you are currently signed in as {$a->currentemail}. For security, the offer cannot be used by the current account.';
$string['commerce_personal_offer_identity_conflict_continue'] = 'Sign out and continue with this offer';
$string['commerce_personal_offer_identity_conflict_cancel'] = 'Keep my current account';
$string['commerce_identity_nav_relationships'] = 'Identity links';
$string['commerce_identity_relationships_title'] = 'Identity links and email history';
$string['commerce_identity_relationships_description'] = 'Inspect known historical emails and review-only potential account relationships. No account is linked or merged automatically.';
$string['commerce_identity_relationships_userid'] = 'Moodle user ID';
$string['commerce_identity_relationships_inspect'] = 'Inspect identity';
$string['user360_identity_graph_title'] = 'Emails & identities';
$string['user360_identity_graph_help'] = 'Known email history and potential related accounts. Potential matches are signals for manual review only.';
$string['user360_identity_current'] = 'Current';
$string['user360_identity_historical'] = 'Historical';
$string['user360_identity_potential_title'] = 'Potentially related accounts';
$string['user360_identity_potential_help'] = 'These accounts are not linked. Similarity can be coincidental; verify the person manually before any action.';
$string['user360_identity_source_moodle_current'] = 'Current Moodle account';
$string['user360_identity_source_commerce_purchase'] = 'Commerce purchase';
$string['user360_identity_source_legacy_digital'] = 'Legacy digital purchase';
$string['user360_identity_source_personal_offer'] = 'Personal Offer';
$string['user360_identity_source_merged_account'] = 'Merged account';
$string['user360_identity_source_merge_identity_history'] = 'Merge identity history';
$string['commerce_identity_merge_preferred_identity_title'] = 'Login identity after merge';
$string['commerce_identity_merge_preferred_identity_help'] = 'Keep the pedagogically recommended account while optionally adopting the email and username of another compared account.';
$string['commerce_identity_merge_preferred_identity_choice'] = '#{$a->userid} — {$a->email} · login {$a->username}';
$string['commerce_identity_merge_preferred_identity_safety'] = 'Email and username are swapped independently from the password choice below. The retained account keeps its Moodle ID, learning history, name and Commerce ownership. The absorbed account is suspended and receives the retained account’s previous login identity.';
$string['commerce_identity_merge_preferred_identity_invalid'] = 'The requested login identity cannot be transferred safely.';
$string['commerce_identity_merge_preferred_password_title'] = 'Password after merge';
$string['commerce_identity_merge_preferred_password_help'] = 'Choose explicitly which account’s current password the retained Moodle account will keep. By default, the retained account keeps its own password.';
$string['commerce_identity_merge_preferred_password_choice'] = 'Keep the password of account #{$a->userid} — {$a->email}';
$string['commerce_identity_merge_preferred_password_unavailable'] = 'unavailable for external authentication';
$string['commerce_identity_merge_preferred_password_safety'] = 'A password can be transferred only between two Moodle manual-auth accounts. Password hashes are never displayed and are never written to the merge audit.';
$string['commerce_identity_merge_preferred_password_invalid'] = 'The requested password owner is not valid for this merge.';
$string['commerce_identity_merge_preferred_password_manual_only'] = 'A password can only be transferred between two Moodle manual-auth accounts.';
$string['user360_merge_identity_transfer'] = 'Login identity changed during merge: {$a->oldemail} → {$a->newemail} (identity taken from account #{$a->sourceuserid}).';
$string['commerce_identity_relationships_email'] = 'Email (for Legacy/Commerce-only identities)';
$string['user360_identity_source_external_current'] = 'External/Commerce-only identity';


// Identity merge final-state preview.
$string['commerce_identity_merge_final_state_title'] = 'Final state after merge';
$string['commerce_identity_merge_final_state_help'] = 'Review the account that will remain usable, its final sign-in identity, and the data that will be preserved or consolidated.';
$string['commerce_identity_merge_final_retained_title'] = 'Account that will remain active';
$string['commerce_identity_merge_final_retained_help'] = 'This is the account the customer will use after the merge.';
$string['commerce_identity_merge_final_absorbed_title'] = 'Absorbed and suspended account(s)';
$string['commerce_identity_merge_final_absorbed_help'] = 'These accounts will no longer be usable by the customer after the merge.';
$string['commerce_identity_merge_final_active_badge'] = 'ACTIVE';
$string['commerce_identity_merge_final_suspended_badge'] = 'SUSPENDED';
$string['commerce_identity_merge_final_identity_title'] = 'Final identity';
$string['commerce_identity_merge_final_moodle_id'] = 'Moodle ID';
$string['commerce_identity_merge_final_name'] = 'Account name';
$string['commerce_identity_merge_final_email'] = 'Sign-in email';
$string['commerce_identity_merge_final_username'] = 'Login (username)';
$string['commerce_identity_merge_final_status'] = 'Status';
$string['commerce_identity_merge_final_status_value'] = 'Active · retained account';
$string['commerce_identity_merge_final_learning_title'] = 'Learning data';
$string['commerce_identity_merge_final_courses'] = 'courses currently enrolled';
$string['commerce_identity_merge_final_completed_courses'] = 'courses currently completed';
$string['commerce_identity_merge_final_activities'] = 'activities currently completed';
$string['commerce_identity_merge_final_grades'] = 'grades currently stored';
$string['commerce_identity_merge_final_grades_value'] = '{$a->count} · average {$a->average}%';
$string['commerce_identity_merge_final_learning_consolidation'] = '{$a} additional learning record(s) from absorbed accounts will be consolidated. Duplicates and conflicts follow the choices shown below, so final counters may change.';
$string['commerce_identity_merge_final_learning_unchanged'] = 'No additional learning data was detected on absorbed accounts: these counters will remain unchanged.';
$string['commerce_identity_merge_final_commerce_title'] = 'Final Commerce data';
$string['commerce_identity_merge_final_purchases'] = 'purchases';
$string['commerce_identity_merge_final_grants'] = 'entitlements';
$string['commerce_identity_merge_final_digital'] = 'digital accesses';
$string['commerce_identity_merge_final_guests'] = 'guest sessions';
$string['commerce_identity_merge_final_commerce_consolidated'] = 'All supported Commerce data will be attached to the retained account.';
$string['commerce_identity_merge_final_after_merge'] = 'Status after merge';
$string['commerce_identity_merge_final_absorbed_status'] = 'Suspended · unusable';
$string['commerce_identity_merge_final_absorbed_identity_swap_note'] = 'This account’s sign-in identity is transferred to the retained account. It receives the retained account’s former identifiers to free the selected email and login.';
$string['commerce_identity_merge_final_absorbed_regular_note'] = 'This account will be suspended after its supported data has been consolidated.';
$string['commerce_identity_merge_final_transferred_from'] = 'transferred from #{$a}';
$string['commerce_identity_merge_final_replaced_by_target'] = 'former identifiers of #{$a}';
$string['commerce_identity_merge_final_sentence'] = 'Result: the customer will sign in with {$a->email} to Moodle account #{$a->userid}. That account will keep its current learning history ({$a->courses} courses, {$a->activities} completed activities, {$a->grades} grades) and will hold {$a->purchases} Commerce purchase(s). {$a->sources} source account(s) will be suspended.';
$string['commerce_identity_merge_technical_title'] = 'Full technical detail';
$string['commerce_identity_merge_technical_badge'] = 'Hidden by default';
$string['commerce_identity_merge_technical_help'] = 'Shows before/after identifiers, detected raw volumes, and consolidation parameters for control or audit.';
$string['commerce_identity_merge_warning_different_emails_transfer'] = 'The accounts use different email addresses. The selected sign-in identity will be transferred to the primary account, so its current address will no longer remain its sign-in email.';
$string['commerce_identity_merge_final_confirmation'] = 'You are about to retain Moodle account #{$a->userid}, use {$a->email} as its final sign-in email, and suspend {$a->sources} source account(s). Review the final state above one last time before confirming.';

// Detailed irreversible merge preview.
$string['commerce_identity_merge_technical_help_detailed'] = 'Inspect the exact courses, purchases, Legacy records, rights and identity changes that will be consolidated. These details are read-only and reflect the records currently found before confirmation.';
$string['commerce_identity_merge_technical_courses'] = 'Courses and learning history';
$string['commerce_identity_merge_technical_purchases'] = 'Commerce purchase history';
$string['commerce_identity_merge_technical_legacy'] = 'Legacy subscriptions and digital purchases';
$string['commerce_identity_merge_technical_rights'] = 'Rights and digital accesses';
$string['commerce_identity_merge_technical_identity_audit'] = 'Identity and merge audit';
$string['commerce_identity_merge_detail_origin'] = 'Origin account';
$string['commerce_identity_merge_detail_course'] = 'Course';
$string['commerce_identity_merge_detail_enrolment'] = 'Enrolment';
$string['commerce_identity_merge_detail_completion'] = 'Completion';
$string['commerce_identity_merge_detail_activity_grade'] = 'Activities / grades';
$string['commerce_identity_merge_detail_decision'] = 'Merge result';
$string['commerce_identity_merge_detail_purchase'] = 'Purchase';
$string['commerce_identity_merge_detail_product'] = 'Product / identity';
$string['commerce_identity_merge_detail_status_amount'] = 'Status / amount';
$string['commerce_identity_merge_detail_legacy_link'] = 'Legacy link';
$string['commerce_identity_merge_detail_record'] = 'Record';
$string['commerce_identity_merge_detail_period_access'] = 'Period / access';
$string['commerce_identity_merge_detail_status'] = 'Status';
$string['commerce_identity_merge_detail_none'] = 'No matching records found.';
$string['commerce_identity_merge_detail_already_target'] = 'Already belongs to the retained account; preserved as-is.';
$string['commerce_identity_merge_detail_course_consolidate'] = 'Also present on the retained account; learning records will be consolidated using the existing conflict rules.';
$string['commerce_identity_merge_detail_course_transfer'] = 'Transferred to the retained account.';
$string['commerce_identity_merge_detail_purchase_transfer'] = 'Purchase userid will be reassigned to retained account #{$a}.';
$string['commerce_identity_merge_detail_legacy_transfer'] = 'Legacy record will be reassigned to retained account #{$a}.';
$string['commerce_identity_merge_detail_right_transfer'] = 'Right/access beneficiary will be reassigned to retained account #{$a}.';
$string['commerce_identity_merge_detail_enrolment_value'] = '{$a->status} · since {$a->date}';
$string['commerce_identity_merge_detail_completed_on'] = 'Completed: {$a}';
$string['commerce_identity_merge_detail_not_completed'] = 'Not completed';
$string['commerce_identity_merge_detail_activity_grade_value'] = '{$a->activities} completed activities · {$a->grades} grades · average {$a->average} · last access {$a->lastaccess}';
...
$string['commerce_showroom_config_social_image'] = 'Sharing image';
$string['commerce_showroom_config_social_image_help'] = 'Image used for Telegram, WhatsApp, Facebook and other social previews. When empty, the showroom keeps using an offer image automatically.';
...
$string['commerce_identity_merge_gamification_summary'] = 'Level Up: {$a->xp} XP · {$a->quests} completed quest(s)';
$string['commerce_identity_merge_advanced_mode'] = 'Advanced mode — build the final account field by field';
$string['commerce_identity_merge_advanced_mode_help'] = 'Enable this mode to manually select which value is retained for each conflicting profile field. Email/login and password remain independently selectable above. Learning, Commerce, Level Up XP and Quest data are consolidated without discarding history.';
$string['commerce_identity_merge_advanced_no_profile_conflicts'] = 'No other differing profile information was detected between these accounts.';
$string['commerce_identity_merge_advanced_field'] = 'Field';
$string['commerce_identity_merge_advanced_account_column'] = 'Account {$a->letter} · #{$a->userid}';
$string['commerce_identity_merge_advanced_identity_note'] = 'The choices above apply to the Moodle profile. Login identity (email + username) and password use their dedicated selectors to preserve uniqueness and security constraints.';
$string['commerce_identity_merge_m16_gamification_title'] = 'Level Up progress recovered';
$string['commerce_identity_merge_gamification_incomplete'] = 'The Level Up XP/Quest merge is incomplete: some data remains attached to a source account. The transaction was rolled back.';
$string['commerce_customer_email_change_action'] = 'Change email address';
$string['commerce_customer_email_change_title'] = 'Change customer email address';
$string['commerce_customer_email_change_description'] = 'Changes the current email identity in Moodle and Commerce without rewriting commercial history.';
$string['commerce_customer_email_change_current'] = 'Current address: {$a->email}';
$string['commerce_customer_email_change_scope_title'] = 'Change scope';
$string['commerce_customer_email_change_scope_current'] = 'The current address will be updated in the Moodle profile and Commerce entitlements/access records linked to this account.';
$string['commerce_customer_email_change_scope_history'] = 'Past orders, payments, invoices and Legacy snapshots keep the address used when the purchase was made.';
$string['commerce_customer_email_change_confirm'] = 'I confirm that this new address must become this customer’s current email identity.';
$string['commerce_customer_email_change_preview'] = 'Preview';
$string['commerce_customer_email_change_execute'] = 'Apply change';
$string['commerce_customer_email_change_preview_title'] = 'Preview';
$string['commerce_customer_email_change_preview_current'] = '{$a->count} current identity/access reference(s) will be aligned to the new address.';
$string['commerce_customer_email_change_preview_history'] = '{$a->count} historical commercial record(s) will remain unchanged.';
$string['commerce_customer_email_change_success'] = 'The customer’s current email address has been updated.';
$string['commerce_customer_email_change_duplicate'] = 'This email address is already used by another active Moodle account.';
$string['commerce_customer_email_change_confirmation_required'] = 'You must explicitly confirm the email address change.';

$string['commerce_customer_email_change_newemail'] = 'New email address';
$string['commerce_customer_email_change_newlang'] = 'New account language';
$string['commerce_customer_email_change_preview_email'] = 'Email';
$string['commerce_customer_email_change_preview_language'] = 'Account language';
$string['commerce_customer_email_change_preview_impacted_title'] = 'What will be updated';
$string['commerce_customer_email_change_preview_preserved_title'] = 'What will remain unchanged';
$string['commerce_customer_email_change_impact_moodle_user'] = 'Moodle profile: email change {$a->email}; language change {$a->lang}.';
$string['commerce_customer_email_change_impact_grants'] = '{$a} Commerce grant(s) will be aligned with the new email.';
$string['commerce_customer_email_change_impact_digital'] = '{$a} digital access record(s) will be aligned with the new email.';
$string['commerce_customer_email_change_impact_offers'] = '{$a} personal offer(s) will be aligned with the new email.';
$string['commerce_customer_email_change_impact_offer_campaigns'] = '{$a} personal-offer campaign member record(s) will be aligned with the new email.';
$string['commerce_customer_email_change_impact_grant_campaigns'] = '{$a} grant-campaign member record(s) will be aligned with the new email.';
$string['commerce_customer_email_change_impact_guests'] = '{$a} active guest/session identity record(s) will be aligned with the new email.';
$string['commerce_customer_email_change_history_purchases'] = '{$a} historical Commerce purchase(s) keep the email recorded at purchase time.';
$string['commerce_customer_email_change_history_payments'] = '{$a} historical payment request(s) keep their original email.';
$string['commerce_customer_email_change_history_digital_payments'] = '{$a} historical digital payment request(s) keep their original email.';
$string['commerce_customer_email_change_history_none'] = 'No historical commercial record is affected.';

$string['commerce_customer_email_change_impact_moodle_email'] = 'The Moodle profile email will become the new address.';
$string['commerce_customer_email_change_impact_moodle_language'] = 'The Moodle account language will be changed to the selected language.';

// 7.95N CRM UX and navigation.
$string['crm_nav_showrooms'] = 'Showrooms';
$string['crm_nav_dashboard'] = 'CRM Dashboard';
$string['crm_nav_users'] = 'Users';
$string['crm_nav_commerce'] = 'Commerce';
$string['crm_nav_inbox'] = 'Inbox';
$string['crm_nav_work'] = 'Work Items';
$string['crm_nav_assistant'] = 'Assistant';
$string['crm_nav_tools'] = 'Tools';
$string['crm_nav_help'] = 'Help';
$string['crm_nav_users_overview'] = 'All users';
$string['crm_nav_inbox_overview'] = 'Inbox';
$string['crm_nav_diagnostics'] = 'Diagnostics';
$string['crm_nav_work_items'] = 'Work Items';
$string['crm_nav_work_teams'] = 'Teams';
$string['crm_nav_tools_overview'] = 'All tools';
$string['crm_nav_tools_history'] = 'Tool history';
$string['crm_nav_help_overview'] = 'Help centre';
$string['crm_nav_open_menu'] = 'Open {$a} menu';

// Commerce 7.95N2 — Commerce dashboard.
$string['crm_breadcrumb_root'] = 'CRM';
$string['commerce_dashboard_revenue_30d'] = 'Sales (last 30 days)';
$string['commerce_dashboard_orders_30d'] = 'Orders';
$string['commerce_dashboard_mails_30d'] = 'Emails sent';
$string['commerce_dashboard_unfinished_checkouts'] = 'Unfinished checkouts';
$string['commerce_dashboard_active_offers'] = 'Active offers';
$string['commerce_dashboard_customers_30d'] = 'New customers';
$string['commerce_dashboard_new_today'] = '{$a} new today';
$string['commerce_dashboard_expiring_7d'] = '{$a} expire within 7 days';
$string['commerce_dashboard_vs_previous'] = 'vs previous period';
$string['commerce_dashboard_no_comparison'] = 'No comparison available';
$string['commerce_dashboard_sales_30d'] = 'Sales over the last 30 days';
$string['commerce_dashboard_sales_chart'] = 'Sales trend over the last 30 days';
$string['commerce_dashboard_latest_sales'] = 'Latest sales';
$string['commerce_dashboard_view_all_sales'] = 'View all sales';
$string['commerce_dashboard_no_sales_data'] = 'No data yet for this period.';
$string['commerce_dashboard_quick_actions'] = 'Quick actions';
$string['commerce_dashboard_action_create_product'] = 'Create a product';
$string['commerce_dashboard_action_create_offer'] = 'Create a personal offer';
$string['commerce_dashboard_action_mail'] = 'Manage emails';
$string['commerce_dashboard_action_import'] = 'Import subscriptions';
$string['commerce_dashboard_action_unfinished'] = 'View unfinished checkouts';
$string['commerce_dashboard_action_statistics'] = 'Commerce statistics';
$string['commerce_dashboard_alerts'] = 'Alerts';
$string['commerce_dashboard_alert_checkouts'] = '{$a} unfinished checkouts';
$string['commerce_dashboard_alert_offers'] = '{$a} offers expire soon';
$string['commerce_dashboard_alert_mail'] = '{$a} failed emails';
$string['commerce_dashboard_no_alerts'] = 'No Commerce alerts at the moment.';
$string['commerce_dashboard_top_products'] = 'Best sellers (30 days)';
$string['commerce_dashboard_view_statistics'] = 'View statistics';
$string['commerce_dashboard_product_summary'] = 'Product summary';
$string['commerce_dashboard_products_total'] = 'Products';
$string['commerce_dashboard_products_bundles'] = 'Bundles';
$string['commerce_dashboard_products_courses'] = 'Courses';
$string['commerce_dashboard_products_digital'] = 'Digital products';
$string['commerce_dashboard_active'] = 'Active';
$string['commerce_dashboard_manage_catalog'] = 'Manage catalogue';
$string['commerce_dashboard_minutes_ago'] = '{$a} min ago';
$string['commerce_dashboard_hours_ago'] = '{$a} h ago';

// Commerce 7.95N2.3 dashboard UX.
$string['crm_commerce_nav_showrooms'] = 'Showrooms';
$string['crm_commerce_nav_offers_access'] = 'Offers & access';
$string['commerce_dashboard_period_label'] = 'Period';
$string['commerce_dashboard_period_days'] = 'Last {$a} days';
$string['commerce_dashboard_revenue'] = 'Sales revenue';
$string['commerce_dashboard_orders_paid'] = 'Paid orders';
$string['commerce_dashboard_orders_status_foot'] = '{$a->total} initiated · {$a->pending} pending · {$a->failed} failed/cancelled';
$string['commerce_dashboard_mails_sent'] = 'Emails sent';
$string['commerce_dashboard_new_customers'] = 'New customers';
$string['commerce_dashboard_conversion_rate'] = 'Payment conversion';
$string['commerce_dashboard_sales_period'] = 'Sales over the selected period';
$string['commerce_dashboard_period_today'] = 'Today';
$string['commerce_dashboard_period_7'] = '7 days';
$string['commerce_dashboard_period_30'] = '30 days';
$string['commerce_dashboard_period_90'] = '90 days';
$string['commerce_dashboard_period_365'] = '1 year';
$string['commerce_dashboard_period_apply'] = 'Apply';
$string['commerce_dashboard_alert_pending_orders'] = '{$a} pending orders';
$string['commerce_dashboard_alert_failed_orders'] = '{$a} cancelled/failed orders';
$string['commerce_dashboard_alert_grants'] = '{$a} entitlement delivery issues';
$string['commerce_dashboard_alert_mail_pending'] = '{$a} pending e-mails';
$string['commerce_dashboard_top_products_period'] = 'Top sales';

$string['commerce_dashboard_sales_short'] = 'Sales';

$string['commerce_dashboard_period_summary'] = 'Summary from {$a->start} to {$a->end}';

$string['commerce_dashboard_action_merge_accounts'] = 'Merge accounts';

$string['commerce_dashboard_product_showroom_summary'] = 'Products & showrooms summary';
$string['commerce_dashboard_products_section'] = 'Products';
$string['commerce_dashboard_showrooms_section'] = 'Showrooms';
$string['commerce_dashboard_showrooms_total'] = 'Showrooms';
$string['commerce_dashboard_showrooms_published'] = 'Published';
$string['commerce_dashboard_showrooms_workinprogress'] = 'In progress';
$string['commerce_dashboard_manage_showrooms'] = 'Manage showrooms';

$string['commerce_sales_filters_title'] = 'Filters';
$string['commerce_sales_search_placeholder'] = 'Search by reference, customer, email or product…';
$string['commerce_sales_period'] = 'Period';
$string['commerce_sales_period_today'] = 'Today';
$string['commerce_sales_period_7'] = 'Last 7 days';
$string['commerce_sales_period_30'] = 'Last 30 days';
$string['commerce_sales_period_90'] = 'Last 90 days';
$string['commerce_sales_period_365'] = '1 year';
$string['commerce_sales_period_all'] = 'All time';
$string['commerce_sales_period_custom'] = 'Custom';
$string['commerce_sales_more_filters'] = 'More filters';
$string['commerce_sales_date_from'] = 'From';
$string['commerce_sales_date_to'] = 'To';
$string['commerce_sales_currency'] = 'Currency';
$string['commerce_sales_kpi_matches'] = 'Matching sales';
$string['commerce_sales_kpi_revenue'] = 'Collected revenue';
$string['commerce_sales_kpi_delivered'] = 'Delivered sales';
$string['commerce_sales_kpi_pending'] = 'Pending';
$string['commerce_sales_kpi_failed'] = 'Failed / cancelled';
$string['commerce_sales_kpi_invalid_checkouts'] = 'Invalid checkouts';
$string['commerce_sales_kpi_invalid_current'] = 'Current situation';
$string['commerce_sales_found'] = '{$a} sales found';
$string['commerce_sales_per_page'] = 'Per page';

$string['commerce_sales_product_type'] = 'Product type';
$string['commerce_sales_columns'] = 'Columns';
$string['commerce_sales_export'] = 'Export';
$string['commerce_sales_apply_columns'] = 'Apply';
$string['commerce_sales_more_actions'] = 'More actions';
$string['commerce_sales_sort_by'] = 'Sort by {$a->column} ({$a->direction})';
$string['commerce_sales_sort_ascending'] = 'ascending';
$string['commerce_sales_sort_descending'] = 'descending';
$string['commerce_purchase_payment_status_redirected'] = 'Redirected to payment';
$string['commerce_purchase_payment_status_unknown'] = 'Unknown';
$string['commerce_purchase_fulfillment_status_planned'] = 'Planned';
$string['commerce_purchase_fulfillment_status_skipped'] = 'Skipped';

$string['commerce_purchase_payment_status_requires_action'] = 'Action required';
$string['commerce_purchase_payment_status_open'] = 'Open';
$string['commerce_purchase_payment_status_complete'] = 'Complete';
$string['commerce_purchase_payment_status_captured'] = 'Captured';
$string['commerce_purchase_payment_status_authorized'] = 'Authorized';
$string['commerce_purchase_payment_status_payment_pending'] = 'Payment pending';
$string['commerce_purchase_fulfillment_status_success'] = 'Successful';
$string['commerce_purchase_fulfillment_status_succeeded'] = 'Successful';
$string['commerce_purchase_fulfillment_status_cancelled'] = 'Cancelled';
$string['commerce_purchase_fulfillment_status_canceled'] = 'Canceled';

$string['commerce_sales_origin'] = 'Origin';
$string['commerce_sales_origin_personal_offer'] = 'Personal offer';
$string['commerce_sales_origin_standard'] = 'Standard sale';
$string['commerce_sales_personal_offer_badge'] = 'Personal offer';
$string['commerce_sales_kpi_personal_offers'] = 'Personal offers';

$string['commerce_sales_filters_toggle'] = 'Search and filters';
$string['commerce_sales_filters_active'] = 'Active filters';
$string['commerce_sales_filters_collapsed_hint'] = 'Click to open';

$string['commerce_mail_admin_description_n41'] = 'Monitor Commerce e-mail communications, delivery journal and mail-engine health.';
$string['commerce_mail_nav_label'] = 'Commerce e-mail navigation';
$string['commerce_mail_nav_journal'] = 'E-mail journal';
$string['commerce_mail_nav_templates'] = 'E-mail templates';
$string['commerce_mail_nav_campaigns'] = 'Campaigns';
$string['commerce_mail_health_operational'] = 'Mail Engine operational';
$string['commerce_mail_health_operational_subtitle'] = 'Transactional mail engine is operational and monitored.';
$string['commerce_mail_health_diagnostic'] = 'View diagnostics';
$string['commerce_mail_period'] = 'Period';
$string['commerce_mail_period_today'] = 'Today';
$string['commerce_mail_period_7'] = 'Last 7 days';
$string['commerce_mail_period_30'] = 'Last 30 days';
$string['commerce_mail_period_90'] = 'Last 90 days';
$string['commerce_mail_period_365'] = '1 year';
$string['commerce_mail_period_all'] = 'All time';
$string['commerce_mail_period_custom'] = 'Custom';
$string['commerce_mail_search_placeholder_n41'] = 'Recipient, e-mail, order ID, idempotency key…';
$string['commerce_mail_attempts_min'] = 'Minimum attempts';
$string['commerce_mail_date_from'] = 'From';
$string['commerce_mail_date_to'] = 'To';
$string['commerce_mail_more_filters'] = 'More filters';
$string['commerce_mail_columns'] = 'Columns';
$string['commerce_mail_columns_apply'] = 'Apply';
$string['commerce_mail_export'] = 'Export';
$string['commerce_mail_filters_title'] = 'Search and filters';
$string['commerce_mail_filters_active'] = 'Active filters';
$string['commerce_mail_kpi_total'] = 'E-mails';
$string['commerce_mail_kpi_period'] = 'For selected period';
$string['commerce_mail_kpi_sent'] = 'Sent';
$string['commerce_mail_kpi_pending'] = 'Pending';
$string['commerce_mail_kpi_failed'] = 'Failures';
$string['commerce_mail_kpi_campaigns'] = 'Active campaigns';
$string['commerce_mail_kpi_campaigns_help'] = 'Draft / in progress';
$string['commerce_mail_kpi_templates_review'] = 'Templates to review';
$string['commerce_mail_kpi_templates_review_help'] = 'Disabled templates';
$string['commerce_mail_recipient_column'] = 'Recipient';
$string['commerce_mail_context_column'] = 'Context';
$string['commerce_mail_last_error'] = 'Last error';
$string['commerce_mail_context_personal_offer'] = 'Personal offer';
$string['commerce_mail_context_order'] = 'Order #{$a}';
$string['commerce_mail_action_preview'] = 'Preview';
$string['commerce_mail_action_open_order'] = 'Open order';
$string['commerce_mail_action_open_context'] = 'Open offer / campaign';
$string['commerce_mail_more_actions'] = 'More actions';
$string['commerce_mail_found'] = '{$a} e-mails found';
$string['commerce_mail_per_page'] = 'Per page';

// Commerce 7.95N4.2 — mail journal operational polish.
$string['commerce_mail_search_placeholder_n42'] = 'Recipient, e-mail, order, product, campaign…';
$string['commerce_mail_send_now'] = 'Send now';
$string['commerce_mail_send_now_success'] = 'The e-mail was sent immediately.';
$string['commerce_mail_send_now_failed'] = 'Immediate delivery could not be completed. Check the e-mail status and error details.';
$string['commerce_mail_send_now_not_allowed'] = 'Only an e-mail currently waiting in the queue can be sent immediately.';
$string['commerce_mail_health_compact_ok'] = 'Engine OK';
$string['commerce_mail_health_compact_issues'] = '{$a->warnings} warnings · {$a->errors} errors';
$string['commerce_mail_technical_details'] = 'Technical details';
$string['commerce_mail_internal_id'] = 'E-mail ID';
$string['commerce_mail_idempotency_key'] = 'Idempotency key';

$string['commerce_mail_include_audit'] = 'Show AUDIT emails';
$string['commerce_mail_kpi_offers_sent'] = 'Offers sent';
$string['commerce_mail_kpi_offers_pending'] = 'Offers pending';
$string['commerce_mail_kpi_sent_last_hour'] = 'Sent last hour';
$string['commerce_mail_kpi_last_check'] = 'Last check: {$a}';
$string['commerce_mail_kpi_last_check_never'] = 'Last check: never';
$string['commerce_mail_kpi_smtp_load_help'] = 'SMTP load excluding audit';

$string['commerce_mail_nav_configuration'] = 'Configuration';
$string['commerce_mail_configuration_title'] = 'Email configuration';
$string['commerce_mail_configuration_description'] = 'Control mail workers, SMTP throughput and Mail Engine processing limits.';
$string['commerce_mail_configuration_saved'] = 'Mail Engine configuration saved.';
$string['commerce_mail_configuration_smtp_title'] = 'SMTP throughput protection';
$string['commerce_mail_configuration_smtp_help'] = 'Define a common safeguard for all Commerce emails. The global cap applies to transactional emails, personal offers and audit copies.';
$string['commerce_mail_configuration_sent_last_hour'] = 'emails sent in the last hour';
$string['commerce_mail_configuration_global_hourly'] = 'Global SMTP cap / hour';
$string['commerce_mail_configuration_global_hourly_help'] = '0 = unlimited. When defined, no Commerce worker can exceed this combined rolling one-hour cap.';
$string['commerce_mail_configuration_workers_title'] = 'Mail workers';
$string['commerce_mail_configuration_workers_help'] = 'These switches functionally enable or pause processing. Moodle scheduled tasks remain scheduled so processing can be resumed immediately.';
$string['commerce_mail_configuration_transactional_title'] = 'Transactional emails';
$string['commerce_mail_configuration_transactional_description'] = 'Receipts, access delivery, payment messages and other priority customer communications.';
$string['commerce_mail_configuration_personal_title'] = 'Personal offers';
$string['commerce_mail_configuration_personal_description'] = 'Dedicated Personal Offer campaign worker with its own throughput limit.';
$string['commerce_mail_configuration_audit_title'] = 'Audit copies';
$string['commerce_mail_configuration_audit_description'] = 'Low-priority technical copies processed only when no higher-priority customer mail is waiting.';
$string['commerce_mail_configuration_processing_enabled'] = 'Processing enabled';
$string['commerce_mail_configuration_processing_enabled_help'] = 'Disabling pauses this worker without changing the Moodle task schedule.';
$string['commerce_mail_configuration_batch_size'] = 'Emails per batch';
$string['commerce_mail_configuration_hourly_limit'] = 'Hourly cap';
$string['commerce_mail_configuration_hourly_zero_help'] = '0 = no worker-specific hourly limit. The global SMTP cap still applies when configured.';
$string['commerce_mail_configuration_transactional_batch_help'] = 'Maximum transactional emails processed on each worker run.';
$string['commerce_mail_configuration_personal_batch_help'] = 'Maximum Personal Offer emails processed on each worker run.';
$string['commerce_mail_configuration_personal_hourly_help'] = 'Personal Offer-specific rolling one-hour cap.';
$string['commerce_mail_configuration_audit_batch_help'] = 'Maximum audit copies processed on each worker run.';
$string['commerce_mail_configuration_audit_hourly_help'] = 'Audit-specific rolling one-hour cap.';
$string['commerce_mail_configuration_task_active'] = 'Moodle task active';
$string['commerce_mail_configuration_task_disabled'] = 'Moodle task disabled';
$string['commerce_mail_configuration_task_missing'] = 'Moodle task not found';
$string['commerce_mail_configuration_last_run'] = 'Last run: {$a}';
$string['commerce_mail_configuration_next_run'] = 'Next run: {$a}';
$string['commerce_mail_configuration_cron_note'] = 'Commerce switches do not change Moodle cron expressions. System scheduling remains managed from Moodle scheduled tasks.';
$string['commerce_mail_configuration_open_scheduled_tasks'] = 'Open scheduled tasks';

$string['commerce_mail_library_description'] = 'Unified CampusFR template library for marketing, transactional, Personal Offer, sales follow-up and system emails.';
$string['commerce_mail_library_heading'] = 'Mail Studio · Template library';
$string['commerce_mail_library_help'] = 'Create, organise, duplicate, export and import templates that will progressively power campaigns and transactional emails.';
$string['commerce_mail_library_new'] = 'New template';
$string['commerce_mail_library_import'] = 'Import';
$string['commerce_mail_library_export'] = 'Export';
$string['commerce_mail_library_category'] = 'Category';
$string['commerce_mail_library_category_marketing'] = 'Marketing';
$string['commerce_mail_library_category_transactional'] = 'Transactional';
$string['commerce_mail_library_category_personal_offer'] = 'Personal offer';
$string['commerce_mail_library_category_system'] = 'System';
$string['commerce_mail_library_status_draft'] = 'Draft';
$string['commerce_mail_library_status_active'] = 'Active';
$string['commerce_mail_library_status_archived'] = 'Archived';
$string['commerce_mail_library_runtime_live'] = 'Used in production';
$string['commerce_mail_library_modified'] = 'Modified {$a}';
$string['commerce_mail_library_native_title'] = 'Mail Studio templates';
$string['commerce_mail_library_runtime_title'] = 'Current transactional templates';
$string['commerce_mail_library_runtime_help'] = 'These templates still directly power the current transactional engine. They are exposed through the library adapter and can already be exported in Mail Studio format.';
$string['commerce_mail_library_transactional_bridge_help'] = 'Current transactional template · {$a} customised language(s), remaining languages use built-in defaults.';
$string['commerce_mail_library_edit_transactional'] = 'Edit languages';
$string['commerce_mail_library_empty'] = 'No templates match these filters.';
$string['commerce_mail_library_archive'] = 'Archive';
$string['commerce_mail_library_archive_confirm'] = 'Archive this template? It will remain available in the library but will no longer be considered active.';
$string['commerce_mail_library_duplicated'] = 'Template duplicated as a draft.';
$string['commerce_mail_library_archived'] = 'Template archived.';
$string['commerce_mail_library_copy_suffix'] = 'Copy';
$string['commerce_mail_library_create_title'] = 'Create template';
$string['commerce_mail_library_edit_title'] = 'Edit “{$a}”';
$string['commerce_mail_library_edit_description'] = 'Edit the template in Mail Studio and keep a reusable, translatable and portable structure.';
$string['commerce_mail_library_name'] = 'Internal template name';
$string['commerce_mail_library_body'] = 'HTML body';
$string['commerce_mail_library_language_optional'] = 'Optional language';
$string['commerce_mail_library_foundation_note'] = 'This template is stored in the Mail Studio library. Its use depends on its category and associated sending context.';
$string['commerce_mail_library_import_title'] = 'Import template';
$string['commerce_mail_library_import_description'] = 'Import a CampusFR Mail Studio template exported from this or another instance.';
$string['commerce_mail_library_import_drop_title'] = 'Import a Mail Studio file';
$string['commerce_mail_library_import_help'] = 'CampusFR Mail Studio JSON file (campusfr-mail-template schema v1), maximum 2 MB. Import always creates a new draft to prevent accidental replacement.';
$string['commerce_mail_library_import_missing'] = 'Choose a JSON file to import.';
$string['commerce_mail_library_import_too_large'] = 'The file must not exceed 2 MB.';
$string['commerce_mail_library_import_success'] = 'Template imported as a draft. You can now review and adapt it.';

$string['commerce_mail_library_builder_note'] = 'Mail Studio now uses the shared CampusFR builder. Rich content is edited with TinyMCE and variable/layout tags stay compatible with Personal Offer campaigns.';
$string['commerce_mail_builder_variables'] = 'Variables';
$string['commerce_mail_builder_blocks'] = 'Mail Builder blocks';
$string['commerce_mail_builder_no_variables'] = 'No variables are available in this context.';
$string['commerce_mail_builder_tag_help'] = 'Click a tag to copy it, then paste it where you want inside the TinyMCE content.';

$string['commerce_mail_library_builder_badge'] = 'Builder v{$a}';

$string['commerce_personal_offer_mailstudio_title'] = 'Mail Studio';
$string['commerce_personal_offer_mailstudio_help'] = 'Reuse a Mail Studio template or turn this campaign content into a template. Loading a template creates a campaign snapshot, so later template edits never alter a prepared campaign.';
$string['commerce_personal_offer_mailstudio_library'] = 'Template library';
$string['commerce_personal_offer_mailstudio_snapshot_source'] = 'Content initialized from “{$a}” — independent snapshot';
$string['commerce_personal_offer_mailstudio_apply'] = 'Load a template';
$string['commerce_personal_offer_mailstudio_apply_help'] = 'The template FR/EN/RU content replaces the current campaign editorial content. CTA destination and showroom remain unchanged.';
$string['commerce_personal_offer_mailstudio_apply_button'] = 'Load into campaign';
$string['commerce_personal_offer_mailstudio_empty'] = 'No Personal Offer template is available in Mail Studio yet.';
$string['commerce_personal_offer_mailstudio_save_as'] = 'Save this campaign as a template';
$string['commerce_personal_offer_mailstudio_save_help'] = 'Creates a new reusable draft Mail Studio template from the current campaign content.';
$string['commerce_personal_offer_mailstudio_save_button'] = 'Create template';
$string['commerce_personal_offer_mailstudio_applied'] = 'The Mail Studio template was loaded into the campaign.';
$string['commerce_personal_offer_mailstudio_saved'] = 'The campaign content was saved as a new Mail Studio template.';

$string['commerce_mail_type_marketing_campaign'] = 'Marketing campaign';
$string['commerce_mail_context_marketing_campaign'] = 'Marketing campaign';
$string['task_process_marketing_mail_campaigns'] = 'Prepare scheduled marketing campaigns';
$string['task_process_marketing_mail_queue'] = 'Send marketing campaign queue';
$string['commerce_marketing_campaigns_title'] = 'Campaigns';
$string['commerce_marketing_campaigns_description'] = 'Prepare and schedule marketing campaigns independently from Personal Offers, using Mail Studio templates.';
$string['commerce_marketing_campaign_new'] = 'New campaign';
$string['commerce_marketing_campaign_empty'] = 'No marketing campaign yet.';
$string['commerce_marketing_campaign_status_draft'] = 'Draft';
$string['commerce_marketing_campaign_status_scheduled'] = 'Scheduled';
$string['commerce_marketing_campaign_status_queued'] = 'In progress';
$string['commerce_marketing_campaign_status_completed'] = 'Completed';
$string['commerce_marketing_campaign_status_cancelled'] = 'Cancelled';
$string['commerce_marketing_campaign_schedule_summary'] = 'Schedule: {$a}';
$string['commerce_marketing_campaign_recipient_count'] = '{$a} recipients';
$string['commerce_marketing_campaign_sent_count'] = '{$a} sent';
$string['commerce_marketing_campaign_failed_count'] = '{$a} failed';
$string['commerce_marketing_campaign_edit_description'] = 'Choose a Marketing template, freeze the audience and schedule delivery. Template content is copied into the campaign when it is saved.';
$string['commerce_marketing_campaign_name'] = 'Campaign name';
$string['commerce_marketing_campaign_template'] = 'Mail Studio template';
$string['commerce_marketing_campaign_cta_url'] = 'CTA destination';
$string['commerce_marketing_campaign_cta_help'] = 'The template {{cta|…}} blocks will use this URL. Leave empty to remove CTAs during rendering.';
$string['commerce_marketing_campaign_schedule'] = 'Send date and time';
$string['commerce_marketing_campaign_audience'] = 'Audience';
$string['commerce_marketing_campaign_audience_help'] = 'One recipient per line: email;firstname;lastname;language. First name, last name and language may be omitted when a matching Moodle account exists.';
$string['commerce_marketing_campaign_schedule_button'] = 'Schedule campaign';
$string['commerce_marketing_campaign_saved'] = 'Marketing campaign saved as draft.';
$string['commerce_marketing_campaign_scheduled'] = 'Marketing campaign scheduled.';
$string['commerce_marketing_campaign_locked'] = 'Frozen campaign: {$a->total} recipients · {$a->sent} sent · {$a->failed} failed.';
$string['commerce_mail_configuration_marketing_title'] = 'Marketing campaigns';
$string['commerce_mail_configuration_marketing_description'] = 'Generic Mail Studio marketing sends, independent from Personal Offers.';
$string['commerce_mail_configuration_marketing_batch_help'] = 'Maximum marketing emails processed on each worker run.';
$string['commerce_mail_configuration_marketing_hourly_help'] = 'Marketing-specific rolling one-hour cap. 0 = unlimited.';

$string['commerce_mail_transactional_runtime_mailstudio'] = 'Mail Studio active';
$string['commerce_mail_transactional_runtime_legacy'] = 'Legacy runtime';
$string['commerce_mail_transactional_migrate'] = 'Migrate to Mail Studio';
$string['commerce_mail_transactional_edit_mailstudio'] = 'Edit in Mail Studio';
$string['commerce_mail_transactional_edit_legacy'] = 'Legacy editor';
$string['commerce_mail_transactional_migrated'] = 'The transactional template is now driven by Mail Studio.';
$string['commerce_mail_transactional_builder_note'] = 'This transactional template keeps its dynamic mail structure (order, access, business buttons). Mail Studio controls only the editorial envelope: subject, preheader, heading, introduction, closing and signature.';
$string['commerce_mail_transactional_headerimage_compatibility'] = 'Header images for migrated transactional templates are stored in Mail Studio. The old editor remains only as a compatibility entry point for templates not yet migrated.';

$string['commerce_mail_transactional_migrate_all'] = 'Migrate all transactionals to Mail Studio';
$string['commerce_mail_transactional_migrate_all_confirm'] = 'Migrate every remaining Legacy transactional template to Mail Studio? Templates already migrated will not be changed.';
$string['commerce_mail_transactional_migrate_all_done'] = 'Migration complete: {$a->migrated} template(s) migrated, {$a->already} already in Mail Studio.';

$string['commerce_mail_configuration_legacy_title'] = 'Historical automatic emails';
$string['commerce_mail_configuration_legacy_help'] = 'These emails belong to the old mailer and are separate from the modern Mail Engine. They are disabled by default to prevent unwanted historical follow-ups.';
$string['commerce_mail_configuration_legacy_warning_title'] = 'Legacy area — use with care';
$string['commerce_mail_configuration_legacy_warning'] = 'Keeping this area disabled is recommended. Crons still perform their operational work (payment expiry, access activation or expiry) without sending the old emails.';
$string['commerce_mail_configuration_legacy_master'] = 'Allow Legacy automatic emails';
$string['commerce_mail_configuration_legacy_master_help'] = 'Master switch. While disabled, none of the three channels below can send mail, even if an individual switch is enabled.';
$string['commerce_mail_configuration_legacy_payment_reminders'] = 'Historical payment reminders';
$string['commerce_mail_configuration_legacy_payment_reminders_help'] = 'Allows T_REMINDER_FIRST and T_REMINDER_SECOND from followup_task. Technical payment-request expiry continues while reminders are disabled.';
$string['commerce_mail_configuration_legacy_expiry_reminders'] = 'Subscription expiry reminders';
$string['commerce_mail_configuration_legacy_expiry_reminders_help'] = 'Allows T_SUBSCRIPTION_EXPIRY_REM from send_expiry_reminders_task.';
$string['commerce_mail_configuration_legacy_lifecycle'] = 'Historical activation / expiry notifications';
$string['commerce_mail_configuration_legacy_lifecycle_help'] = 'Allows T_SUBSCRIPTION_ACTIVATED and T_SUBSCRIPTION_EXPIRED from the lifecycle cron. Access transitions continue without those emails.';
$string['commerce_mail_configuration_legacy_task_followup'] = 'Payment follow-up cron';
$string['commerce_mail_configuration_legacy_task_expiry'] = 'Expiry reminder cron';
$string['commerce_mail_configuration_legacy_task_lifecycle'] = 'Subscription lifecycle cron';

$string['commerce_mail_library_delete'] = 'Delete';
$string['commerce_mail_library_delete_confirm'] = 'Permanently delete this archived Mail Studio template? This action cannot be undone.';
$string['commerce_mail_library_deleted'] = 'The Mail Studio template was permanently deleted.';
$string['commerce_mail_library_delete_in_use'] = 'This template cannot be deleted because it is still referenced by {$a} marketing campaign(s). Campaign history must remain intact.';

$string['commerce_mail_library_category_sales_followup'] = 'Sales follow-ups';
$string['commerce_mail_type_sales_followup'] = 'Sales follow-up';
$string['commerce_sales_followup_action'] = 'Follow up by email';
$string['commerce_sales_followup_title'] = 'Sales follow-up';
$string['commerce_sales_followup_description'] = 'Prepare an email from Mail Studio, adapt it to the sale context, preview it and explicitly decide whether to send it.';
$string['commerce_sales_followup_not_eligible'] = 'This sale is no longer eligible for a sales follow-up. Payment may have completed or no usable customer email is available.';
$string['commerce_sales_followup_invalid_template'] = 'The selected follow-up template is not available.';
$string['commerce_sales_followup_no_templates'] = 'No Sales follow-up template is available in Mail Studio.';
$string['commerce_sales_followup_context_title'] = 'Sale context';
$string['commerce_sales_followup_customer'] = 'Customer';
$string['commerce_sales_followup_order'] = 'Order';
$string['commerce_sales_followup_product'] = 'Product';
$string['commerce_sales_followup_amount'] = 'Amount';
$string['commerce_sales_followup_payment_status'] = 'Payment';
$string['commerce_sales_followup_language'] = 'Language';
$string['commerce_sales_followup_template'] = 'Mail Studio template';
$string['commerce_sales_followup_load_template'] = 'Load template';
$string['commerce_sales_followup_preview'] = 'Preview';
$string['commerce_sales_followup_preview_title'] = 'Message preview';
$string['commerce_sales_followup_send_now'] = 'Send now';
$string['commerce_sales_followup_send_confirm'] = 'Send this sales follow-up to the customer now? The message will be logged in the Mail Engine and linked to this sale.';
$string['commerce_sales_followup_sent'] = 'The sales follow-up was sent and logged.';
$string['commerce_sales_followup_send_failed'] = 'The follow-up was queued in the Mail Engine but immediate delivery did not complete. Check the mail details.';
$string['commerce_sales_followup_resume_payment'] = 'Complete my purchase';
$string['commerce_sales_followup_no_resume_url'] = 'No reliable payment-resume URL is available for this sale. The {{resume_payment}} block will simply be removed from the message.';
$string['commerce_sales_followup_previous'] = '{$a->count} follow-up(s) already created for this sale. Latest: {$a->date}.';

$string['commerce_sales_followup_open_library'] = 'Open follow-up templates in Mail Studio';

$string['commerce_sales_actions_customer'] = 'Customer';
$string['commerce_sales_actions_communication'] = 'Communication';
$string['commerce_sales_actions_commercial'] = 'Sales actions';
$string['commerce_sales_actions_order'] = 'Order';
$string['commerce_sales_action_open_user360'] = 'Open User360';
$string['commerce_sales_action_resend_invoice'] = 'Resend invoice';
$string['commerce_sales_action_resend_invoice_help'] = 'Resends the receipt email with the PDF invoice attached.';
$string['commerce_sales_action_resend_invoice_confirm'] = 'Resend the receipt email with the PDF invoice attached now?';
$string['commerce_sales_action_resend_access'] = 'Resend access';
$string['commerce_sales_action_create_offer'] = 'Create Personal Offer';

$string['commerce_sales_subnav_label'] = 'Sales navigation';
$string['commerce_sales_subnav_sales'] = 'Sales';
$string['commerce_sales_subnav_unfinished'] = 'Unfinished checkouts';
$string['commerce_sales_adminstate'] = 'Administrative state';
$string['commerce_sales_adminstate_open'] = 'Active sales';
$string['commerce_sales_adminstate_closed'] = 'Closed sales';
$string['commerce_sales_adminstate_all'] = 'All sales';
$string['commerce_sales_admin_closed_badge'] = 'Closed';
$string['commerce_sales_actions_administration'] = 'Administration';
$string['commerce_sales_action_view_details'] = 'View details';
$string['commerce_sales_action_close'] = 'Close sale';
$string['commerce_sales_action_close_confirm'] = 'Administratively close this sale? It will remain in history but be hidden from the default list.';
$string['commerce_sales_action_reopen'] = 'Reopen sale';
$string['commerce_sales_close_not_allowed'] = 'This sale cannot be manually closed. Only failed/cancelled sales or sales pending for at least 24 hours are eligible.';
$string['commerce_sales_close_default_reason'] = 'Manual closure from CRM';
$string['commerce_sales_closed_success'] = 'The sale was administratively closed.';
$string['commerce_sales_reopened_success'] = 'The sale was reopened and is visible again among active sales.';
$string['commerce_guest_crm_search_placeholder'] = 'Email, customer, order reference or product…';
$string['commerce_guest_crm_filter_status'] = 'Situation';
$string['commerce_guest_crm_kpi_total'] = 'To review';
$string['commerce_guest_crm_kpi_pending'] = 'Pending purchase';
$string['commerce_guest_crm_kpi_multiple'] = 'Multiple purchases';
$string['commerce_guest_crm_kpi_provider_paid'] = 'Paid at provider';
$string['commerce_guest_crm_kpi_provisional'] = 'No purchase';
$string['commerce_guest_crm_column_client'] = 'Customer';
$string['commerce_guest_crm_column_checkout'] = 'Checkout';
$string['commerce_guest_crm_column_purchase'] = 'Purchase / product';
$string['commerce_guest_crm_column_payment'] = 'Payment';
$string['commerce_guest_crm_column_status'] = 'Situation';
$string['commerce_guest_crm_column_age'] = 'Age';
$string['commerce_guest_crm_age_minutes'] = '{$a} min';
$string['commerce_guest_crm_age_hours'] = '{$a} h';
$string['commerce_guest_crm_age_days'] = '{$a} d';

$string['commerce_sales_closed_banner'] = 'This sale was administratively closed on {$a}. It remains available in history.';

$string['commerce_mail_library_subject'] = 'Subject';

$string['commerce_sales_action_view_customer_order'] = 'View customer page';
$string['commerce_order_details_back_to_sales'] = 'Back to sales';
$string['commerce_mail_actions_message'] = 'Message';
$string['commerce_mail_actions_delivery'] = 'Delivery';
$string['commerce_mail_actions_context'] = 'Context';

$string['commerce_mail_filters_collapsed_hint'] = 'Click to open';

$string['commerce_guest_crm_search_filters_title'] = 'Search and filters';
$string['commerce_guest_crm_account_id'] = 'Account #{$a}';
$string['commerce_guest_crm_checkout_id'] = 'Payment session #{$a}';
$string['commerce_guest_crm_unknown_product'] = 'Unidentified product';
$string['commerce_guest_crm_resume_active'] = 'Payment resume active';
$string['commerce_guest_crm_provider_state'] = 'Provider status: {$a}';
$string['commerce_guest_crm_provider_status_open'] = 'Open';
$string['commerce_guest_crm_provider_status_unpaid'] = 'Unpaid';
$string['commerce_guest_crm_provider_status_open_unpaid'] = 'Open · unpaid';
$string['commerce_guest_crm_provider_status_paid'] = 'Paid';
$string['commerce_guest_crm_provider_status_succeeded'] = 'Paid';
$string['commerce_guest_crm_provider_status_pending'] = 'Pending';
$string['commerce_guest_crm_provider_status_authorized'] = 'Authorized';
$string['commerce_guest_crm_provider_status_declined'] = 'Declined';
$string['commerce_guest_crm_provider_status_cancelled'] = 'Cancelled';
$string['commerce_guest_crm_provider_status_canceled'] = 'Cancelled';
$string['commerce_guest_crm_provider_status_failed'] = 'Failed';
$string['commerce_guest_crm_provider_status_error'] = 'Error';
$string['commerce_guest_crm_provider_status_expired'] = 'Expired';
$string['commerce_guest_crm_help_legend_title'] = 'Understanding unfinished checkouts';
$string['commerce_guest_crm_help_legend_hint'] = 'Click to show the legend';
$string['commerce_guest_crm_help_checkout_title'] = 'Unfinished checkout';
$string['commerce_guest_crm_help_checkout_text'] = 'The customer started a payment journey but it has not yet resulted in a completed sale. This does not necessarily mean that the payment failed.';
$string['commerce_guest_crm_help_resume_title'] = 'Payment resume active';
$string['commerce_guest_crm_help_resume_text'] = 'This badge identifies the purchase currently linked to the payment-resume session. It is the purchase the customer will recover when continuing the checkout.';
$string['commerce_guest_crm_help_provider_title'] = 'Payment provider';
$string['commerce_guest_crm_help_provider_text'] = 'The logo shows the payment provider. The status next to it is CampusFR Commerce tracking; when a live provider check has run, its result is shown below.';
$string['commerce_guest_crm_help_situations_title'] = 'Situation';
$string['commerce_guest_crm_help_situations_text'] = 'The situation summarises the main issue: pending payment, multiple competing purchases, payment confirmed by the provider but still pending in CampusFR, blocked identity, or checkout without a purchase.';

$string['commerce_result_scope_label'] = 'Scope';
$string['commerce_result_scope_period_all'] = 'Period: all dates';
$string['commerce_result_scope_period_range'] = 'Period: {$a->from} → {$a->to}';
$string['commerce_result_scope_period_named'] = 'Period: {$a}';
$string['commerce_result_scope_search'] = 'Search: {$a}';
$string['commerce_result_scope_product_type'] = 'Type: {$a}';
$string['commerce_result_scope_commercial_status'] = 'Status: {$a}';
$string['commerce_result_scope_provider'] = 'Provider: {$a}';
$string['commerce_result_scope_currency'] = 'Currency: {$a}';
$string['commerce_result_scope_origin'] = 'Origin: {$a}';
$string['commerce_result_scope_payment'] = 'Payment: {$a}';
$string['commerce_result_scope_fulfillment'] = 'Delivery: {$a}';
$string['commerce_result_scope_admin_state'] = 'State: {$a}';
$string['commerce_result_scope_mail_type'] = 'Type: {$a}';
$string['commerce_result_scope_mail_status'] = 'Status: {$a}';
$string['commerce_result_scope_language'] = 'Language: {$a}';
$string['commerce_result_scope_purchase'] = 'Order #{$a}';
$string['commerce_result_scope_attempts'] = 'Attempts ≥ {$a}';
$string['commerce_result_scope_audit_excluded'] = 'AUDIT excluded';
$string['commerce_result_scope_audit_included'] = 'AUDIT included';
$string['commerce_result_scope_remove_filter'] = 'Remove this filter';
$string['commerce_result_scope_remove_filter_named'] = 'Remove filter “{$a}”';

$string['commerce_filters_apply'] = 'Apply';

// Commerce N7.1 — unified Offers & access workspace.
$string['crm_commerce_nav_offers_access'] = 'Offers & access';
$string['commerce_offers_access_title'] = 'Offers & access';
$string['commerce_offers_access_description'] = 'Manage preferential offers and access granted directly to customers.';
$string['commerce_offers_access_tab_overview'] = 'Overview';
$string['commerce_offers_access_tab_offers'] = 'Personal offers';
$string['commerce_offers_access_tab_grants'] = 'Grants';
$string['commerce_offers_access_tab_campaigns'] = 'Campaigns';
$string['commerce_offers_access_question'] = 'What would you like to do?';
$string['commerce_offers_access_offer_title'] = 'Propose an offer';
$string['commerce_offers_access_offer_description'] = 'Offer preferential pricing to one or more customers.';
$string['commerce_offers_access_offer_action'] = 'Create an offer';
$string['commerce_offers_access_grant_title'] = 'Grant access';
$string['commerce_offers_access_grant_description'] = 'Give direct access to a product or course.';
$string['commerce_offers_access_grant_action'] = 'Grant access';
$string['commerce_offers_access_beneficiary_hint'] = 'Beneficiaries — one customer or several — will be selected in the next step.';
$string['commerce_offers_access_kpi_active_offers'] = 'Active offers';
$string['commerce_offers_access_kpi_used_offers'] = 'Used offers';
$string['commerce_offers_access_kpi_grants'] = 'Access granted';
$string['commerce_offers_access_kpi_campaigns'] = 'Active campaigns';
$string['commerce_offers_access_kpi_pending'] = 'Pending';
$string['commerce_offers_access_kpi_attention'] = 'Needs review';
$string['commerce_offers_access_kpi_now'] = 'currently';
$string['commerce_offers_access_kpi_total'] = 'total';
$string['commerce_offers_access_kpi_active'] = 'in progress';
$string['commerce_offers_access_kpi_to_process'] = 'to process';
$string['commerce_offers_access_kpi_to_check'] = 'needs action';
$string['commerce_offers_access_recent_title'] = 'Recent activity';
$string['commerce_offers_access_recent_hint'] = 'Recent offers and grants will be surfaced here in a following iteration.';
$string['commerce_offers_access_view_all'] = 'View all campaigns';
$string['commerce_offers_access_campaigns_title'] = 'Campaigns';
$string['commerce_offers_access_campaigns_description'] = 'Prepare and monitor operations intended for multiple customers.';
$string['commerce_offers_access_new_offer_campaign'] = 'New offer campaign';
$string['commerce_offers_access_new_grant_campaign'] = 'New grant campaign';
$string['commerce_offers_access_campaign_action'] = 'Action';
$string['commerce_offers_access_campaign_audience'] = 'Audience';
$string['commerce_offers_access_campaign_progress'] = 'Progress';
$string['commerce_offers_access_kind_offer'] = 'Personal offer';
$string['commerce_offers_access_kind_grant'] = 'Grant';
$string['commerce_offers_access_campaigns_empty'] = 'No campaigns yet.';

$string['commerce_offers_access_create_title'] = 'New action';
$string['commerce_offers_access_create_description'] = 'First choose what you want to grant. The beneficiaries will be selected at the next step.';
$string['commerce_offers_access_create_audience_title'] = 'Choose beneficiaries';
$string['commerce_offers_access_create_audience_description'] = 'Choose whether this action concerns one customer or a group of customers.';
$string['commerce_offers_access_create_question'] = 'What would you like to do?';
$string['commerce_offers_access_create_offer'] = 'Create an offer';
$string['commerce_offers_access_create_offer_help'] = 'Grant preferential pricing or conditions without immediately granting access.';
$string['commerce_offers_access_create_grant'] = 'Grant access';
$string['commerce_offers_access_create_grant_help'] = 'Grant a product or course directly, independently from a sale.';
$string['commerce_offers_access_create_continue'] = 'Continue';
$string['commerce_offers_access_create_selected_action'] = 'Selected action';
$string['commerce_offers_access_create_who'] = 'Who should receive it?';
$string['commerce_offers_access_create_one'] = 'One customer';
$string['commerce_offers_access_create_one_help'] = 'Find or select one person, then configure the offer or access precisely.';
$string['commerce_offers_access_create_many'] = 'Multiple customers';
$string['commerce_offers_access_create_many_help'] = 'Define an audience, simulate it, then freeze beneficiaries before execution.';
$string['commerce_offers_access_workflow_beneficiaries'] = 'Beneficiaries';
$string['commerce_offers_access_workflow_offer'] = 'Offer';
$string['commerce_offers_access_workflow_access'] = 'Access';
$string['commerce_offers_access_workflow_verification'] = 'Review';
$string['commerce_offers_access_workflow_execution'] = 'Execution';
$string['commerce_offers_access_workflow_one'] = '1 customer';
$string['commerce_offers_access_workflow_many'] = 'Multiple customers';
$string['commerce_offers_access_new_campaign'] = 'New campaign';

$string['commerce_offers_access_config_identity_help'] = 'Give the operation a clear name. Technical identifiers remain available in advanced options.';
$string['commerce_offers_access_config_technical'] = 'Technical information';
$string['commerce_offers_access_config_optional'] = 'Optional · generated automatically if empty';
$string['commerce_offers_access_config_audience_help'] = 'Define the intended audience. Complex rules remain available in advanced options.';
$string['commerce_offers_access_config_advanced_audience'] = 'Advanced audience options';
$string['commerce_offers_access_config_advanced_audience_hint'] = 'Additional sources, dates, exclusions and complex rules';
$string['commerce_offers_access_config_offer_help'] = 'Choose the product, commercial terms and validity period.';
$string['commerce_offers_access_config_summary_offer_campaign'] = 'Offer campaign summary';
$string['commerce_offers_access_config_summary_offer'] = 'Offer summary';
$string['commerce_offers_access_config_summary_grant_campaign'] = 'Access grant summary';
$string['commerce_offers_access_config_not_set'] = 'To be defined';
$string['commerce_offers_access_config_audience'] = 'Beneficiaries';
$string['commerce_offers_access_config_product'] = 'Product';
$string['commerce_offers_access_config_conditions'] = 'Terms';
$string['commerce_offers_access_config_validity'] = 'Validity';
$string['commerce_offers_access_config_mailstudio_title'] = 'Communication';
$string['commerce_offers_access_config_mailstudio_help'] = 'Email composition stays centralized in Mail Studio. Mail Engine then handles delivery and traceability.';
$string['commerce_offers_access_config_open_mailstudio'] = 'Open Mail Studio';
$string['commerce_offers_access_config_bulk_audience_title'] = 'Define beneficiaries and access';
$string['commerce_offers_access_config_bulk_audience_help'] = 'Choose the source population and target product, then run a simulation before any change.';
$string['commerce_offers_access_config_source'] = 'Source population';
$string['commerce_offers_access_config_mode'] = 'Mode';
$string['commerce_offers_access_config_simulation_required'] = 'Simulation required';
$string['commerce_offers_access_config_open_user360'] = 'Open User360';
$string['commerce_offers_access_config_technical_evidence'] = 'View technical details';
$string['commerce_offers_access_config_communication'] = 'Beneficiary communication';
$string['commerce_offers_access_config_beneficiary_title'] = 'Beneficiary';
$string['commerce_offers_access_config_beneficiary_help'] = 'Select the customer. Linking and source information remain in advanced options.';
$string['commerce_offers_access_config_context_title'] = 'Context and linking';
$string['commerce_offers_access_config_context_hint'] = 'Campaign, purchase or source product · optional';
$string['commerce_offers_access_config_communication_hint'] = 'Image and email template';
$string['commerce_offers_access_config_beneficiary'] = 'Customer';
$string['commerce_offers_access_config_no_limit'] = 'No defined limit';

$string['commerce_offers_access_config_manual_access_title'] = 'Configure access';
$string['commerce_offers_access_config_manual_access_help'] = 'Select the customer, product and access settings. Existing grant engines remain unchanged.';
$string['commerce_offers_access_config_summary_grant'] = 'Access summary';
$string['commerce_offers_access_config_choose_in_form'] = 'Choose in the form';

$string['commerce_offers_access_campaign_step_configuration'] = 'Configuration';
$string['commerce_offers_access_campaign_step_configuration_done'] = 'Configuration ready';
$string['commerce_offers_access_campaign_step_audience'] = 'Audience';
$string['commerce_offers_access_campaign_step_audience_count'] = '{$a} eligible beneficiaries';
$string['commerce_offers_access_campaign_step_audience_waiting'] = 'Audience to calculate';
$string['commerce_offers_access_campaign_step_snapshot'] = 'Frozen population';
$string['commerce_offers_access_campaign_step_snapshot_done'] = '{$a} beneficiaries frozen';
$string['commerce_offers_access_campaign_step_snapshot_waiting'] = 'Population to freeze';
$string['commerce_offers_access_campaign_step_execution'] = 'Execution';
$string['commerce_offers_access_campaign_step_execution_waiting'] = 'Ready to launch';
$string['commerce_offers_access_campaign_step_execution_running'] = '{$a} beneficiaries processed';
$string['commerce_offers_access_campaign_step_execution_done'] = '{$a} beneficiaries processed';
$string['commerce_offers_access_campaign_step_complete'] = 'Complete';
$string['commerce_offers_access_campaign_step_complete_waiting'] = 'Waiting for execution to finish';
$string['commerce_offers_access_campaign_step_complete_done'] = 'Campaign complete';
$string['commerce_offers_access_campaign_step_complete_errors'] = 'Completed with {$a} error(s)';
$string['commerce_offers_access_campaign_summary_title'] = 'Campaign summary';
$string['commerce_offers_access_campaign_selected'] = 'Selected beneficiaries';
$string['commerce_offers_access_campaign_status'] = 'Status';
$string['commerce_offers_access_campaign_communication_title'] = 'Communication';
$string['commerce_offers_access_campaign_mail_queued'] = 'Pending';
$string['commerce_offers_access_campaign_mail_sent'] = 'Sent';
$string['commerce_offers_access_campaign_mail_failed'] = 'Errors';
$string['commerce_offers_access_campaign_open_mail_journal'] = 'View email journal';
$string['commerce_offers_access_campaign_member_details'] = 'Details';

$string['commerce_offers_access_search_filters'] = 'Search and filters';
$string['commerce_offers_access_period'] = 'Period';
$string['commerce_offers_access_period_7'] = 'Last 7 days';
$string['commerce_offers_access_period_30'] = 'Last 30 days';
$string['commerce_offers_access_period_90'] = 'Last 90 days';
$string['commerce_offers_access_period_365'] = '1 year';
$string['commerce_offers_access_period_all'] = 'All dates';
$string['commerce_offers_access_offers_found'] = '{$a} offers found';
$string['commerce_offers_access_created'] = 'Created';
$string['commerce_offers_access_grants_workspace_description'] = 'Review access actually granted to customers and follow its status without exposing technical references.';
$string['commerce_offers_access_grants_kpi_total'] = 'Grants';
$string['commerce_offers_access_grants_kpi_active'] = 'Active access';
$string['commerce_offers_access_grants_kpi_pending'] = 'Pending';
$string['commerce_offers_access_grants_kpi_failed'] = 'Needs review';
$string['commerce_offers_access_grants_search_placeholder'] = 'Customer, email or product…';
$string['commerce_offers_access_grants_found'] = '{$a} grants found';
$string['commerce_offers_access_grants_empty'] = 'No access grant matches the selected criteria.';
$string['commerce_offers_access_grant_status_planned'] = 'Pending';
$string['commerce_offers_access_grant_status_active'] = 'Granted';
$string['commerce_offers_access_grant_status_failed'] = 'Failed';
$string['commerce_offers_access_validity'] = 'Validity';
$string['commerce_offers_access_recent_grant_campaigns'] = 'Recent access campaigns';
$string['commerce_offers_access_campaign_state_active'] = 'In progress';
$string['commerce_offers_access_campaign_state_completed'] = 'Completed';
$string['commerce_offers_access_campaign_state_error'] = 'With errors';
$string['commerce_offers_access_campaign_kpi_total'] = 'Campaigns';
$string['commerce_offers_access_campaign_kpi_active'] = 'In progress';
$string['commerce_offers_access_campaign_kpi_completed'] = 'Completed';
$string['commerce_offers_access_campaign_kpi_error'] = 'Needs review';
$string['commerce_offers_access_campaign_search_placeholder'] = 'Campaign name…';
$string['commerce_offers_access_campaigns_found'] = '{$a} campaigns found';

$string['commerce_personal_offer_eligibility_detail'] = 'Details';
$string['commerce_offers_access_offer_detail_help'] = 'Review the offer, beneficiary, terms, communication and lifecycle from one screen.';
$string['commerce_offers_access_now'] = 'Now';
$string['commerce_offers_access_no_expiry'] = 'No expiry';
$string['commerce_offers_access_offer_mail_journal'] = 'View emails';
$string['commerce_offers_access_open_source_sale'] = 'Open source sale';
$string['commerce_offers_access_open_redeemed_sale'] = 'Open redeemed sale';
$string['commerce_offers_access_open_campaign'] = 'Open campaign';
$string['commerce_offers_access_offer_context'] = 'Origin and eligibility';
$string['commerce_offers_access_last_mail_sent'] = 'Last email sent';
$string['commerce_offers_access_management'] = 'Management';
$string['commerce_offers_access_grant_detail_title'] = 'Access detail';
$string['commerce_offers_access_grant_detail_help'] = 'Review the access actually granted, its origin, validity and related communication.';
$string['commerce_offers_access_grant_status_completed'] = 'Completed';
$string['commerce_offers_access_grant_quantity'] = 'Quantity';
$string['commerce_offers_access_grant_access_title'] = 'Granted access';
$string['commerce_offers_access_grant_type'] = 'Access type';
$string['commerce_offers_access_grant_no_sale'] = 'Grant outside a sale';
$string['commerce_offers_access_grant_origin_title'] = 'Origin';
$string['commerce_offers_access_grant_lifecycle_title'] = 'Lifecycle';
$string['commerce_offers_access_grant_mail_journal'] = 'Email journal';
$string['commerce_offers_access_grant_reference'] = 'Access reference';
$string['commerce_offers_access_grant_resource'] = 'Resource';
$string['commerce_offers_access_grant_idempotency'] = 'Idempotency key';
$string['commerce_offers_access_grant_item_reference'] = 'Item reference';
$string['commerce_offers_access_grant_configuration'] = 'Configuration';
$string['commerce_offers_access_grant_metadata'] = 'Metadata';
$string['commerce_offers_access_source_sale'] = 'Source sale';

$string['commerce_offers_access_remove_filter'] = 'Remove this filter';
$string['commerce_offers_access_offers_empty_title'] = 'No offers to display';
$string['commerce_offers_access_offers_empty_help'] = 'No offer currently matches this scope. Change the filters or create a new offer.';
$string['commerce_offers_access_grants_empty_title'] = 'No access grants to display';
$string['commerce_offers_access_campaigns_empty_title'] = 'No campaigns to display';
$string['commerce_offers_access_change'] = 'Change';

$string['commerce_offers_access_product_legacy'] = 'Legacy';
$string['commerce_personal_offer_mail_template'] = 'Email template';
$string['commerce_personal_offer_mail_template_default'] = 'Default transactional template';
$string['commerce_personal_offer_mail_template_help'] = 'The selected template is frozen with the offer. Later Mail Studio edits will not alter this email.';
$string['commerce_personal_offer_no_expiration'] = 'This offer does not expire';
$string['commerce_personal_offer_no_expiration_help'] = 'Explicitly select this only when the offer must remain valid with no end date.';
$string['commerce_personal_offer_expiration_required'] = 'Enter an expiration date and time, or select “This offer does not expire”.';
$string['commerce_personal_offer_expiration_after_start'] = 'The expiration date must be after the validity start.';

$string['commerce_personal_offer_mail_refresh_status'] = 'Refresh status';
$string['commerce_personal_offer_mail_preview'] = 'Email preview';
$string['commerce_personal_offer_mail_preview_unavailable'] = 'The email preview is not available right now.';
$string['commerce_personal_offer_secure_link_copy'] = 'Copy link';
$string['commerce_personal_offer_secure_link_copied'] = 'Copied';

$string['commerce_personal_offer_validity_mode_help'] = 'Choose a fixed date range, or a duration calculated from the time the offer is created.';
$string['commerce_offers_access_create_offer_action'] = 'Create an offer';
$string['commerce_offers_access_menu_offer'] = 'Offer';
$string['commerce_offers_access_menu_communication'] = 'Communication';
$string['commerce_offers_access_recent_offer'] = 'Offer created for {$a->email} · {$a->product}';
$string['commerce_offers_access_recent_grant'] = 'Access granted to {$a->email} · {$a->product}';
$string['commerce_offers_access_recent_campaign'] = 'Campaign “{$a}”';
$string['commerce_personal_offer_conditions_required_help'] = 'Define the offer price and validity. These conditions are required.';
$string['commerce_manual_grant_page_title'] = 'Grant access';
$string['commerce_manual_grant_page_description'] = 'Manually grant Legacy or Commerce access to a customer without creating a sale.';
$string['commerce_manual_grant_beneficiary_section'] = 'Beneficiary';
$string['commerce_manual_grant_mode_legacy_access'] = 'Legacy access';
$string['commerce_manual_grant_mode_commerce_product'] = 'Commerce product';
$string['commerce_manual_grant_legacy_section'] = 'Legacy access';
$string['commerce_manual_grant_legacy_plan'] = 'Legacy plan';
$string['commerce_manual_grant_commerce_section'] = 'Commerce access';
$string['commerce_manual_grant_silent_help'] = 'If unchecked, access is granted silently and no email is sent to the customer. Useful for fixing access without contacting them.';
$string['commerce_manual_grant_mail_template'] = 'Email template';
$string['commerce_manual_grant_mail_template_default'] = 'Default “Access available” template';
$string['commerce_manual_grant_mail_template_help'] = 'Choose an active Mail Studio template. The access grant remains independent from the message content.';
$string['commerce_bulk_grant_silent_help'] = 'If unchecked, access is granted without emailing beneficiaries.';
$string['commerce_bulk_grant_mail_template'] = 'Email template';
$string['commerce_bulk_grant_mail_template_default'] = 'Default “Access available” template';
$string['commerce_bulk_grant_mail_template_help'] = 'The selected template is frozen with the campaign so later Mail Studio edits do not change the send.';
$string['commerce_bulk_grant_schedule_enable'] = 'Schedule campaign execution';
$string['commerce_bulk_grant_schedule_at'] = 'Scheduled date and time';
$string['commerce_bulk_grant_schedule_timezone'] = 'Timezone: {$a}';
$string['commerce_bulk_grant_schedule_action'] = 'Schedule';
$string['commerce_bulk_grant_schedule_future_required'] = 'The scheduled date must be in the future.';
$string['commerce_bulk_grant_campaign_scheduled'] = 'The grant campaign has been scheduled.';
$string['commerce_bulk_grant_campaign_run_now'] = 'Run immediately';
$string['commerce_bulk_grant_campaign_run_now_done'] = 'Campaign run immediately: {$a} beneficiary(ies) processed.';
$string['commerce_offers_access_last_update'] = 'Last update';
$string['commerce_manual_grant_user_language'] = 'New user language';
$string['commerce_manual_grant_user_language_help'] = 'This language is saved on the account and is used for the access email. Russian is selected by default.';
$string['commerce_language_ru'] = 'Russian';
$string['commerce_language_fr'] = 'French';
$string['commerce_language_en'] = 'English';
$string['commerce_grant_menu_grant'] = 'Grant';
$string['commerce_grant_menu_details'] = 'View grant details';
$string['commerce_grant_menu_client'] = 'Customer';
$string['commerce_grant_menu_communication'] = 'Communication';
$string['commerce_grant_menu_mail_journal'] = 'View email journal';
$string['commerce_bulk_grant_campaign_process_all_now'] = 'Process all beneficiaries now';
$string['commerce_grant_preview_email'] = 'Preview email';
$string['commerce_grant_preview_email_help'] = 'The preview uses the currently selected product, template and language.';
$string['commerce_grant_mail_preview_title'] = 'Grant email preview';
$string['commerce_grant_mail_preview_description'] = 'Review the message that will be sent with the grant. You can switch language and preview mode.';
$string['commerce_grant_preview_example_product'] = 'Granted CampusFR product';
$string['commerce_grant_campaign_email_preview'] = 'Preview campaign email';

$string['commerce_offers_access_campaign_type'] = 'Type';
$string['commerce_offers_access_campaign_processing'] = 'Recipient processing';
$string['commerce_offers_access_campaign_menu_campaign'] = 'CAMPAIGN';
$string['commerce_campaign_scope_type'] = 'Type: {$a}';
$string['commerce_campaign_menu_edit'] = 'Edit campaign';
$string['commerce_campaign_menu_email'] = 'Configure email';
$string['commerce_campaign_menu_preview_email'] = 'Preview email';
$string['commerce_campaign_menu_mail_journal'] = 'View email journal';
$string['commerce_campaign_beneficiaries_processed'] = '{$a->processed} / {$a->total} beneficiaries processed';
$string['commerce_offer_campaign_secondary_counts'] = 'Already covered: {$a->covered} · Identity to review: {$a->identity}';
$string['commerce_offer_campaign_details'] = 'Details';
$string['commerce_offer_campaign_view_details'] = 'View details';
$string['commerce_campaign_member_search_placeholder'] = 'Name, email or Moodle ID';
$string['commerce_mail_context_grant_campaign'] = 'Grant campaign';
$string['commerce_mail_action_open_grant_campaign'] = 'View grant campaign';
$string['commerce_campaign_mail_not_applicable'] = 'Not applicable';
$string['commerce_campaign_member_results'] = '{$a->visible} shown out of {$a->total}';
$string['commerce_campaign_member_per_page'] = 'Per page';

$string['commerce_manual_grant_activation_mail_title'] = 'Complete your CampusFR access';

$string['commerce_manual_grant_activation_mail_help'] = 'Your account has just been created. Set your password so you can sign in to CampusFR. This link is personal and temporary.';

$string['commerce_manual_grant_activation_mail_button'] = 'Set my password';

$string['commerce_manual_grant_new_user_silent_warning'] = 'For a new user, disabling the email also creates the account silently: no password setup link will be sent.';
$string['commerce_product_search_placeholder'] = 'Name, type or technical reference';
$string['commerce_product_validation_filter'] = 'Validation';
$string['commerce_product_filter_status_active'] = 'Active';
$string['commerce_product_filter_status_inactive'] = 'Inactive';
$string['commerce_product_filter_status_archived'] = 'Archived';
$string['commerce_product_filter_validation_valid'] = 'Valid';
$string['commerce_product_filter_validation_incomplete'] = 'Needs review';
$string['commerce_product_kpi_total'] = 'Products';
$string['commerce_product_kpi_active'] = 'Active';
$string['commerce_product_kpi_inactive'] = 'Inactive';
$string['commerce_product_kpi_archived'] = 'Archived';
$string['commerce_product_kpi_incomplete'] = 'Needs review';
$string['commerce_products_found'] = '{$a} products found';
$string['commerce_product_scope_type'] = 'Type: {$a}';
$string['commerce_product_scope_validation'] = 'Validation: {$a}';
$string['commerce_product_scope_origin'] = 'Origin: {$a}';
$string['commerce_product_scope_currency'] = 'Currency: {$a}';
$string['commerce_product_menu_product'] = 'Product';
$string['commerce_product_menu_commerce'] = 'Commerce';
$string['commerce_product_menu_sales'] = 'View sales for this product';
$string['commerce_product_pagination_count'] = '{$a->visible} shown out of {$a->total}';
$string['commerce_product_technical_information'] = 'Technical information';
$string['commerce_product_technical_sku'] = 'Technical reference';
$string['commerce_product_status_publication'] = 'Publication';
$string['commerce_product_status_publication_help'] = 'Editorial state of the product.';
$string['commerce_product_status_visibility'] = 'Visibility';
$string['commerce_product_status_visibility_help'] = 'Presence across Commerce journeys and spaces.';
$string['commerce_product_status_sale'] = 'Sales';
$string['commerce_product_status_sale_help'] = 'Current availability for purchase.';
$string['commerce_product_status_validation'] = 'Validation';
$string['commerce_product_status_validation_help'] = 'Technical consistency of the configuration.';
$string['commerce_product_downloads_total'] = 'downloads';
$string['commerce_result_scope_status'] = 'Status: {$a}';
$string['commerce_product_edit_general_title'] = 'General information';
$string['commerce_product_fallback_name'] = 'Product fallback name';
$string['commerce_product_fallback_name_help'] = 'Used only when no usable translation exists in the current language, Campus default language, RU, FR or EN.';
$string['commerce_product_identity_title'] = 'Product identity';
$string['commerce_product_identity_editable_help'] = 'SKU and product type remain editable until a customer has purchased or received this product.';
$string['commerce_product_identity_locked_help'] = 'SKU and product type are locked because this product has already been consumed by at least one customer.';
$string['commerce_product_identity_locked'] = 'The SKU or product type can no longer be changed because this product has already been consumed by a customer.';
$string['commerce_product_sku_duplicate'] = 'This SKU is already used by another product.';
$string['commerce_product_sku_auto_placeholder'] = 'Generated automatically when left empty';
$string['commerce_product_digital_file_ready'] = 'File ready for delivery';
$string['commerce_product_digital_file_missing'] = 'No Native file saved';
$string['commerce_product_digital_file_upload_prompt'] = 'Add a PDF file for this version.';
$string['commerce_product_digital_file_replace_or_add'] = 'Add or replace the file';
$string['commerce_product_pricing_business_intro'] = 'Set the regular price for each currency and, when needed, a temporary promotion. During the promotion, the customer pays the promotional price and sees the regular price crossed out. When it ends, the regular price is restored automatically.';
$string['commerce_product_pricing_regular_price'] = 'Regular price';
$string['commerce_product_pricing_regular_price_help'] = 'The real reference price charged outside promotions.';
$string['commerce_product_pricing_available_for_sale'] = 'Available for sale';
$string['commerce_product_pricing_enabled'] = 'Active';
$string['commerce_product_pricing_disabled'] = 'Inactive';
$string['commerce_product_pricing_new_currency'] = 'New currency';
$string['commerce_product_pricing_add_currency'] = 'Add a currency';
$string['commerce_product_pricing_add_currency_help'] = 'Add a regular price. You can also enable a promotion immediately.';
$string['commerce_product_promotion_enable'] = 'Enable a temporary promotion';
$string['commerce_product_promotion_auto_restore'] = 'The regular price will automatically be restored when the promotion ends.';
$string['commerce_product_promotion_price'] = 'Promotional price';
$string['commerce_product_promotion_start'] = 'Start';
$string['commerce_product_promotion_end'] = 'End';
$string['commerce_product_promotion_timezone'] = 'Time zone: {$a}';
$string['commerce_product_promotion_none'] = 'No promotion';
$string['commerce_product_promotion_active'] = 'Promotion active';
$string['commerce_product_promotion_scheduled'] = 'Scheduled';
$string['commerce_product_promotion_expired'] = 'Ended';
$string['commerce_product_promotion_invalid'] = 'Needs review';
$string['commerce_product_promotion_invalid_price'] = 'Enter a valid promotional price.';
$string['commerce_product_promotion_must_be_lower'] = 'The promotional price must be greater than zero and strictly lower than the regular price.';
$string['commerce_product_promotion_invalid_period'] = 'The promotion end date must be later than its start date.';
$string['commerce_product_promotion_invalid_datetime'] = 'The promotion date or time is invalid.';
$string['commerce_storefront_promotions_moved'] = 'Promotions are now managed in Pricing.';
$string['commerce_access_scope_business_title'] = 'Access scope';
$string['commerce_access_scope_business_intro'] = 'Define what the customer actually receives with this product. Compatibility with the former Legacy catalogue remains available separately for migration purposes.';
$string['commerce_access_scope_metric_source'] = 'Access source';
$string['commerce_access_scope_metric_scope'] = 'Applied scope';
$string['commerce_access_scope_metric_courses'] = 'Courses delivered';
$string['commerce_access_scope_customer_access_title'] = 'Access delivered to the customer';
$string['commerce_access_scope_customer_access_help'] = 'Choose the historical plan whose access scope should be reused by this Commerce product. Several Native products may share the same scope.';
$string['commerce_access_scope_source_plan_business'] = 'Scope source';
$string['commerce_access_scope_source_plan_business_help'] = 'This choice determines the courses actually granted after a purchase or an administrative grant.';
$string['commerce_access_scope_effective_scope'] = 'Currently applied scope: {$a}';
$string['commerce_access_scope_courses_business_title'] = 'Delivered content';
$string['commerce_access_scope_courses_count'] = '{$a} courses';
$string['commerce_access_scope_courses_empty'] = 'No course is currently associated with this scope.';
$string['commerce_access_scope_legacy_compatibility_title'] = 'Legacy catalogue compatibility';
$string['commerce_access_scope_legacy_compatibility_badge'] = 'Migration only';
$string['commerce_access_scope_legacy_compatibility_help'] = 'This setting does not change customer access. It only identifies which former Legacy Plan canonically corresponds to this Native product for migrations, repairs and backfills.';
$string['commerce_access_scope_legacy_plan_business'] = 'Corresponding Legacy Plan';
$string['commerce_access_scope_legacy_plan_help'] = 'A Legacy Plan can be canonically linked to only one Native product.';
$string['commerce_access_scope_legacy_current_mapping'] = 'Current Legacy mapping: {$a}';
$string['commerce_access_scope_admin_shortcuts'] = 'Advanced administration';
$string['commerce_access_scope_unknown_product'] = 'unknown Native product';
$string['commerce_bundle_components_help_n89'] = 'Build the bundle with the products you want. Reorder them by drag and drop or with the arrow buttons; this order is preserved wherever the composition is displayed.';
$string['commerce_bundle_reorder_help'] = 'Drag components to change their order, or use the up/down arrows.';
$string['commerce_bundle_move_up'] = 'Move this component up';
$string['commerce_bundle_move_down'] = 'Move this component down';
$string['commerce_bundle_drag_handle'] = 'Drag to reorder';
$string['commerce_bundle_component_row_help'] = 'Product included in this bundle';
$string['commerce_bundle_add_component'] = 'Add a component';
$string['commerce_bundle_preview_help_n89'] = 'Preview of the effective expanded composition after nested bundles are resolved.';
$string['commerce_bundle_pricing_intro_n810'] = 'Choose how the bundle regular price is calculated, then manage temporary promotions exactly like other products. A promotion changes the amount actually charged, and the regular price is restored automatically when it expires.';
$string['commerce_bundle_pricing_method_help_n810'] = 'Fixed pricing directly defines the regular price. Component sum uses component prices. Percentage discount calculates the bundle regular price by applying a discount to that sum.';
$string['commerce_bundle_pricing_strategy_fixed_help_n810'] = 'You enter the bundle regular price for each currency.';
$string['commerce_bundle_pricing_strategy_sum_help_n810'] = 'The regular price is recalculated automatically from component prices.';
$string['commerce_bundle_pricing_strategy_discount_help_n810'] = 'The regular price is the component sum minus the discount configured here.';
$string['commerce_bundle_discount_percent_help_n810'] = 'Used only with the component discount strategy.';
$string['commerce_bundle_pricing_currency_section'] = 'Prices and promotions by currency';
$string['commerce_bundle_pricing_currency_section_help'] = 'Each currency has a regular price. You can then enable an independent temporary promotion for that currency.';
$string['commerce_bundle_pricing_calculated_price'] = 'Calculated regular price';
$string['commerce_bundle_add_currency_help_n810'] = 'Add a new bundle currency. With calculated strategies, the currency must also be available on every component.';
$string['commerce_bundle_preview_intro_n811'] = 'Check what the customer will actually receive: included products, quantities, delivered access and the final bundle price.';
$string['commerce_bundle_preview_unavailable_help_n811'] = 'The preview cannot be calculated with the current composition. Check the bundle components.';
$string['commerce_bundle_preview_contents_title_n811'] = 'Bundle contents';
$string['commerce_bundle_preview_contents_help_n811'] = 'Each card represents a product actually delivered to the customer after nested bundles are expanded.';
$string['commerce_bundle_preview_technical_details_n811'] = 'Technical information';
$string['commerce_bundle_preview_pricing_help_n811'] = 'Price effectively shown to the customer today, including active promotions.';
$string['commerce_bundle_preview_pricing_note_title_n811'] = 'Good to know';
$string['commerce_bundle_preview_pricing_note_n811'] = 'Prices follow the strategy configured in Pricing. Temporary promotions apply automatically during their validity period.';
$string['commerce_storefront_n812_title'] = 'Store Page — {$a}';
$string['commerce_storefront_n812_intro'] = 'Build the customer page without mixing content, appearance, commercial distribution and technical tools.';
$string['commerce_storefront_n812_eyebrow'] = 'Store Page';
$string['commerce_storefront_n812_tab_content'] = 'Content';
$string['commerce_storefront_n812_tab_presentation'] = 'Presentation';
$string['commerce_storefront_n812_tab_distribution'] = 'Distribution';
$string['commerce_storefront_n812_tab_tools'] = 'Tools';
$string['commerce_storefront_n812_sections_short'] = 'sections';
$string['commerce_storefront_n812_ready_short'] = 'ready';
$string['commerce_storefront_n812_attention_short'] = 'to review';
$string['commerce_storefront_n812_content_title'] = 'Page content';
$string['commerce_storefront_n812_content_help'] = 'These are the blocks currently present in the selected language. Open the Builder to edit their content, order and presentation.';
$string['commerce_storefront_n812_open_builder'] = 'Open Builder';
$string['commerce_storefront_n812_empty_title'] = 'No editorial block';
$string['commerce_storefront_n812_empty_help'] = 'Add the first block to start building this Store Page locale.';
$string['commerce_storefront_n812_status_ready'] = 'Ready';
$string['commerce_storefront_n812_status_attention'] = 'Review';
$string['commerce_storefront_n812_status_draft'] = 'Draft';
$string['commerce_storefront_n812_builder_next_title'] = 'Visual Builder';
$string['commerce_storefront_n812_builder_next_help'] = 'The Builder is block-focused, with clear descriptions, visual layout choices and a preview of each block before publishing.';
$string['commerce_storefront_n812_metric_layout'] = 'Page template';
$string['commerce_storefront_n812_metric_commerce'] = 'Commerce block';
$string['commerce_storefront_n812_metric_header'] = 'Product header';
$string['commerce_storefront_n812_presentation_title'] = 'General presentation';
$string['commerce_storefront_n812_presentation_help'] = 'Settings that control the overall page structure without changing editorial content.';
$string['commerce_storefront_n812_modify_presentation'] = 'Edit presentation';
$string['commerce_storefront_n812_card_layout_title'] = 'Page layout';
$string['commerce_storefront_n812_card_layout_help'] = 'Overall page zones and width.';
$string['commerce_storefront_n812_card_commerce_title'] = 'Commerce block position';
$string['commerce_storefront_n812_card_commerce_help'] = 'Controls where prices, purchase actions and commercial information appear.';
$string['commerce_storefront_n812_card_shell_title'] = 'Moodle shell';
$string['commerce_storefront_n812_card_shell_help'] = 'Product header, Edly header/footer and general display mode.';
$string['commerce_storefront_n812_advanced_title'] = 'Advanced settings';
$string['commerce_storefront_n812_advanced_presentation_help'] = 'Theme keys, global zones and shell details remain available for compatibility but no longer belong to the primary workflow.';
$string['commerce_storefront_n812_metric_featured'] = 'Featured';
$string['commerce_storefront_n812_metric_showroom'] = 'Showroom';
$string['commerce_storefront_n812_metric_languages'] = 'Configured languages';
$string['commerce_storefront_n812_showroom_configured'] = 'Linked';
$string['commerce_storefront_n812_showroom_custom'] = 'Custom association';
$string['commerce_storefront_n812_distribution_title'] = 'Distribution and discovery';
$string['commerce_storefront_n812_distribution_help'] = 'Everything that controls how the product appears in the Store, Showrooms, search and recommendations.';
$string['commerce_storefront_n812_modify_distribution'] = 'Edit distribution';
$string['commerce_storefront_n812_merch_title'] = 'Commercial merchandising';
$string['commerce_storefront_n812_merch_help'] = 'Featured status, display order and marketing badges.';
$string['commerce_storefront_n812_experience_title'] = 'Customer experience';
$string['commerce_storefront_n812_experience_help'] = 'Catalogue category, reassurance items and key facts.';
$string['commerce_storefront_n812_seo_title'] = 'SEO and sharing';
$string['commerce_storefront_n812_seo_help'] = 'Public title, description and URLs. Automatic values remain preferred unless customization is needed.';
$string['commerce_storefront_n812_discovery_title'] = 'Discovery destination';
$string['commerce_storefront_n812_discovery_help'] = 'Controls whether the customer opens this Store Page directly or the linked Showroom.';
$string['commerce_storefront_n812_badges_short'] = 'badges';
$string['commerce_storefront_n812_items_short'] = 'items';
$string['commerce_storefront_n812_customised'] = 'Customized';
$string['commerce_storefront_n812_automatic'] = 'Automatic';
$string['commerce_storefront_n812_defaults_title'] = 'Toward sensible defaults';
$string['commerce_storefront_n812_defaults_help'] = 'Automatic settings avoid unnecessary configuration: SEO, reassurance and Showroom destination can be customized only when needed.';
$string['commerce_storefront_n812_tools_title'] = 'Maintenance tools';
$string['commerce_storefront_n812_tools_help'] = 'Rare operations live here: translation, configuration transfer and reset.';
$string['commerce_storefront_n812_open_tools'] = 'Open tools';
$string['commerce_storefront_n812_tool_translation_title'] = 'Locales and translation';
$string['commerce_storefront_n812_tool_translation_help'] = 'Copy an existing locale or prepare an OpenAI translation.';
$string['commerce_storefront_n812_tool_transfer_title'] = 'Import / export';
$string['commerce_storefront_n812_tool_transfer_help'] = 'Transfer the full Store Page configuration in a .cfrproduct file.';
$string['commerce_storefront_n812_tool_reset_title'] = 'Reset';
$string['commerce_storefront_n812_tool_reset_help'] = 'Remove Storefront configuration without changing the product, prices or access rights.';
$string['commerce_storefront_n812_tools_safety_help'] = 'These operations are deliberately separated from the Builder so editorial creation and technical maintenance do not compete for attention.';
$string['commerce_storefront_n812_back_to_hub'] = 'Back to Store Page';
$string['commerce_storefront_n812_builder_transition_help'] = 'Advanced Store Page editor.';
$string['commerce_storefront_n813_builder_focus_help'] = 'Content Builder — editorial blocks are the primary focus. Presentation, distribution and maintenance settings remain in their dedicated areas.';
$string['commerce_storefront_n813_content_builder_title'] = 'Build the content';
$string['commerce_storefront_n813_content_builder_help'] = 'Add blocks, choose their layout visually and immediately check the result. Technical settings remain available but no longer dominate the workflow.';
$string['commerce_storefront_n813_add_block_title'] = 'Add a block';
$string['commerce_storefront_n813_add_block_help'] = 'Start with what you want to communicate. Each block type has a clear editorial purpose.';
$string['commerce_storefront_n813_type_hero_help'] = 'Large page opening with headline, promise, visual and optionally a call to action.';
$string['commerce_storefront_n813_type_rich_text_help'] = 'Free editorial text to explain, reassure or detail part of the offer.';
$string['commerce_storefront_n813_type_image_text_help'] = 'Combines a visual and text side by side to explain a benefit or feature.';
$string['commerce_storefront_n813_type_video_help'] = 'Use a video for a demo, testimonial or explanation.';
$string['commerce_storefront_n813_type_features_help'] = 'Shows several benefits or features as easy-to-scan cards.';
$string['commerce_storefront_n813_type_cta_help'] = 'Ends or restarts a sequence with a clear visitor action.';
$string['commerce_storefront_n813_more_blocks'] = 'Other block types';
$string['commerce_storefront_n813_more_blocks_help'] = 'FAQ, testimonials, programme, gallery, H5P and other components remain available in the detailed selector below.';
$string['commerce_storefront_n813_layout_choice_title'] = 'Visual layout';
$string['commerce_storefront_n813_layout_choice_help'] = 'Click the sketch that best matches the intended result. The matching technical fields are synchronized automatically.';
$string['commerce_storefront_n813_layout_automatic_help'] = 'For this block type, the standard layout is usually the best choice. Width, spacing and alignment can still be refined below.';
$string['commerce_storefront_n813_advanced_layout_title'] = 'Fine layout settings';
$string['commerce_storefront_n813_advanced_layout_help'] = 'Use these options for precise adjustments. In most cases, the visual choice above is enough.';
$string['commerce_storefront_n814_title'] = 'Distribution — {$a}';
$string['commerce_storefront_n814_intro'] = 'Choose how the product is discovered and commercially presented. Automatic defaults are preferred to avoid unnecessary configuration.';
$string['commerce_storefront_n814_defaults_hint'] = 'Automatic values follow the product type and the content already available.';
$string['commerce_storefront_n814_discovery_title'] = 'When a customer clicks “Discover”';
$string['commerce_storefront_n814_discovery_help'] = 'Choose the main destination. The Store Page always remains directly accessible.';
$string['commerce_storefront_n814_destination_storefront'] = 'Open the Store Page';
$string['commerce_storefront_n814_destination_storefront_help'] = 'The customer opens this product’s complete presentation directly.';
$string['commerce_storefront_n814_destination_showroom'] = 'Open the linked Showroom';
$string['commerce_storefront_n814_destination_showroom_help'] = 'The customer discovers the product inside a commercial page grouping several offers.';
$string['commerce_storefront_n814_showroom_label'] = 'Linked Showroom';
$string['commerce_storefront_n814_no_showroom'] = 'No Showroom';
$string['commerce_storefront_n814_show_storefront_cta'] = 'From the Showroom, allow opening the complete product page';
$string['commerce_storefront_n814_show_storefront_cta_help'] = 'Adds a link to this Store Page without changing the main Discover destination.';
$string['commerce_storefront_n814_merch_title'] = 'Store merchandising';
$string['commerce_storefront_n814_merch_help'] = 'Control only the signals that influence catalogue ordering and visible badges.';
$string['commerce_storefront_n814_display_order'] = 'Display priority';
$string['commerce_storefront_n814_display_order_help'] = 'Featured products come first; for equal priority, the smallest value appears first.';
$string['commerce_storefront_n814_experience_title'] = 'Customer experience';
$string['commerce_storefront_n814_experience_help'] = 'Let CampusFR automatically choose items appropriate for the product type, and customize only when needed.';
$string['commerce_storefront_n814_catalog_group'] = 'Catalogue category';
$string['commerce_storefront_n814_catalog_group_help'] = 'Automatic derives the category from the product type.';
$string['commerce_storefront_n814_reassurance_title'] = 'Reassurance items';
$string['commerce_storefront_n814_reassurance_help'] = 'In automatic mode, CampusFR shows the guarantees relevant to this product type.';
$string['commerce_storefront_n814_reassurance_auto'] = 'Automatic — recommended';
$string['commerce_storefront_n814_reassurance_custom'] = 'Customize';
$string['commerce_storefront_n814_automatic'] = 'Automatic';
$string['commerce_storefront_n814_custom'] = 'Customized';
$string['commerce_storefront_n814_recommendations_title'] = 'Complete the journey';
$string['commerce_storefront_n814_recommendations_help'] = 'Select up to four complementary products. Names use the Product Name Resolver; no technical key is needed.';
$string['commerce_storefront_n814_recommendations_limit'] = 'Maximum 4 products. The current product is excluded.';
$string['commerce_storefront_n814_seo_title'] = 'SEO and social sharing';
$string['commerce_storefront_n814_seo_help'] = 'Automatic mode uses the product name, description and best available visual. Customize only when marketing requires it.';
$string['commerce_storefront_n814_auto_title_label'] = 'Resolved title';
$string['commerce_storefront_n814_auto_description_label'] = 'Fallback description';
$string['commerce_storefront_n814_seo_auto'] = 'Automatic SEO — recommended';
$string['commerce_storefront_n814_seo_custom'] = 'Customize SEO';
$string['commerce_storefront_n814_public_urls'] = 'Customize public URLs';
$string['commerce_storefront_n814_seo_no_description'] = 'No product description is available yet.';
$string['commerce_storefront_n815_presentation_title'] = 'Presentation — {$a}';
$string['commerce_storefront_n815_presentation_intro'] = 'Configure the overall Store Page structure. Visual choices cover common cases while technical parameters stay collapsed by default.';
$string['commerce_storefront_n815_layout_title'] = 'Overall page style';
$string['commerce_storefront_n815_layout_help'] = 'Choose the structure that best matches how you want to tell the product story.';
$string['commerce_storefront_n815_template_default_help'] = 'Balanced and versatile. A good default for most products.';
$string['commerce_storefront_n815_template_editorial_help'] = 'More editorial reading flow for explanation-rich pages.';
$string['commerce_storefront_n815_template_immersive_help'] = 'Highly visual presentation designed for campaigns and major launches.';
$string['commerce_storefront_n815_commerce_title'] = 'Where should purchasing appear?';
$string['commerce_storefront_n815_commerce_help'] = 'The Commerce block contains price and purchase actions. Choose its position without dealing with technical page structure.';
$string['commerce_storefront_n815_position_hero_help'] = 'Price and purchase actions are integrated into the opening area.';
$string['commerce_storefront_n815_position_sidebar_help'] = 'The purchase block stays visible on the right on larger screens.';
$string['commerce_storefront_n815_position_none_help'] = 'No automatic Commerce block. Use only when purchasing is handled elsewhere.';
$string['commerce_storefront_n815_shell_title'] = 'Page shell';
$string['commerce_storefront_n815_shell_help'] = 'Control Moodle elements around the content without changing editorial blocks.';
$string['commerce_storefront_n815_advanced_title'] = 'Advanced technical settings';
$string['commerce_storefront_n815_advanced_help'] = 'Legacy compatibility settings. Change only when a specific zone or theme override is genuinely required.';
$string['commerce_storefront_n815_tools_title'] = 'Tools — {$a}';
$string['commerce_storefront_n815_tools_intro'] = 'Rare and technical operations are isolated from the Builder to reduce risk during everyday editing.';
$string['commerce_storefront_n815_tools_scope_help'] = 'These tools can copy, translate, import or remove an entire configuration. They do not change product prices or access rights unless explicitly stated.';

$string['commerce_storefront_n816_advanced_options'] = 'Advanced layout options';

$string['commerce_storefront_n816_seo_language'] = 'SEO language';

$string['commerce_storefront_n816_seo_language_help'] = 'SEO title and description are specific to this language. Other distribution settings remain global to the product.';

$string['commerce_storefront_n816_tools_target_language'] = 'Target language version for language tools';
$string['commerce_storefront_n817_block_preview'] = 'Block preview';
$string['commerce_storefront_n818_missing_items'] = 'Add at least one card or question.';
$string['commerce_storefront_n818_missing_image'] = 'Add an image.';
$string['commerce_storefront_n818_missing_text'] = 'Add a title or content.';
$string['commerce_storefront_n818_missing_video'] = 'Add or select a video.';
$string['commerce_storefront_n818_missing_h5p'] = 'Add or select H5P content.';
$string['commerce_storefront_n818_missing_content'] = 'Add the block\'s main content.';
$string['commerce_storefront_n818_feature_items'] = 'Benefit cards';
$string['commerce_storefront_n818_feature_items_help'] = 'One card per line: title ||| content. A generic main-content field is not required for this block type.';
$string['commerce_storefront_n818_faq_items'] = 'Questions and answers';
$string['commerce_storefront_n818_faq_items_help'] = 'One question per line: question ||| answer. A generic main-content field is not required for this block type.';
$string['commerce_storefront_n819_tab_builder'] = 'Builder';
$string['commerce_storefront_n819_preview_device'] = 'Responsive preview';
$string['commerce_showroom_n9_description'] = 'Create, publish and manage the Showroom pages used to present your commercial offers.';
$string['commerce_showroom_n9_kpi_total'] = 'Showrooms';
$string['commerce_showroom_n9_search_placeholder'] = 'Name or public URL';
$string['commerce_showroom_n9_public_language'] = 'Public language';
$string['commerce_showroom_n9_public_pages'] = 'Public pages';
$string['commerce_showroom_n9_updated'] = 'Last updated';
$string['commerce_showroom_n9_found'] = '{$a} showrooms found';
$string['commerce_showroom_n9_empty_title'] = 'No showrooms to display';
$string['commerce_showroom_n9_empty'] = 'No showroom matches the selected filters.';
$string['commerce_showroom_n9_no_public_page'] = 'No public page';
$string['commerce_showroom_n9_scope_status'] = 'Status: {$a}';
$string['commerce_showroom_n9_scope_language'] = 'Language: {$a}';
$string['commerce_showroom_n9_menu_public'] = 'Public pages';
$string['commerce_showroom_n9_menu_admin'] = 'Administration';
$string['commerce_showroom_n9_menu_danger'] = 'Sensitive actions';
$string['commerce_showroom_n9_open_public'] = 'Open {$a} version';
$string['commerce_showroom_n9_export_json'] = 'Export JSON';
$string['commerce_showroom_n9_export_portable'] = 'Export portable package';
$string['commerce_showroom_n9_delete_confirm'] = 'Permanently delete this showroom?';
$string['commerce_showroom_n91_import_intro'] = 'Import a complete showroom or restore configuration only. The portable package is recommended for transfers between environments.';
$string['commerce_showroom_n91_import_package_title'] = 'Import a showroom';
$string['commerce_showroom_n91_import_package_help'] = 'Prefer a .showroom.zip package: it contains configuration, blocks and media. A JSON file remains available for configuration-only imports.';
$string['commerce_showroom_n91_import_formats'] = 'Accepted formats: recommended .showroom.zip, or .json without media.';
$string['commerce_showroom_n91_import_json_advanced'] = 'Advanced JSON import';
$string['commerce_showroom_n91_import_action'] = 'Import showroom';
$string['commerce_showroom_n92_history_title'] = 'History — {$a}';
$string['commerce_showroom_n92_history_description'] = 'Review saved revisions and publication changes, and restore an earlier version when needed.';
$string['commerce_showroom_n92_back_showroom'] = 'Back to showroom';
$string['commerce_showroom_n92_current_status'] = 'Current status';
$string['commerce_showroom_n92_revision_count'] = 'Revisions';
$string['commerce_showroom_n92_latest_revision'] = 'Latest revision';
$string['commerce_showroom_n92_latest_badge'] = 'Latest';
$string['commerce_showroom_n92_restore_help'] = 'Restoring a revision recreates that version as a draft; it does not silently replace the currently published version.';
$string['commerce_showroom_n92_restore_confirm'] = 'Restore revision {$a} as a draft?';
$string['commerce_showroom_n931_menu_transfer'] = 'Transfer and backup';
$string['commerce_showroom_n931_general_title'] = 'General information';
$string['commerce_showroom_n931_general_help'] = 'Identify the showroom and choose its public layout.';
$string['commerce_showroom_n931_public_layout'] = 'Public layout';
$string['commerce_showroom_n931_public_layout_help'] = 'Choose the presentation used to display this showroom to visitors.';
$string['commerce_showroom_n931_products_help'] = 'Associate the products offered in this showroom. Technical references remain hidden from the normal workflow.';
$string['commerce_showroom_n931_change_product'] = 'Change';
$string['commerce_showroom_n931_publication_title'] = 'Publication';
$string['commerce_showroom_n931_publication_help'] = 'Manage the showroom publication workflow here, separately from its configuration.';
$string['commerce_showroom_n931_publication_status'] = 'Status';
$string['commerce_showroom_n931_publication_status_draft'] = 'This showroom is currently a draft and is not published.';
$string['commerce_showroom_n931_publication_status_review'] = 'This showroom is awaiting approval before publication.';
$string['commerce_showroom_n931_publication_status_published'] = 'This showroom is currently published and visible through its public URLs.';
$string['commerce_showroom_n931_publication_status_archived'] = 'This showroom is archived.';
$string['commerce_showroom_n931_publication_note_placeholder'] = 'Optional note for publication history';
$string['commerce_showroom_n932_seo_title'] = 'SEO and sharing';
$string['commerce_showroom_n932_seo_help'] = 'Define the public URL and metadata shown to search engines and social networks for each language.';
$string['commerce_showroom_n932_social_image_help'] = 'This image is shared by all languages and used when the page is shared on social networks.';
$string['commerce_showroom_n932_no_social_image'] = 'No custom sharing image';
$string['commerce_showroom_n932_locale_help'] = 'The fields for this language are independent from the other language versions.';
$string['commerce_showroom_n932_public_url'] = 'Public URL';
$string['commerce_showroom_n932_public_url_help'] = 'Use a short, readable and stable identifier. Do not include the domain name.';
$string['commerce_showroom_n932_open_public_page'] = 'Open public page';
$string['commerce_showroom_n932_social_overrides'] = 'Social sharing';
$string['commerce_showroom_n932_social_overrides_help'] = 'Optional. When empty, the SEO title and description are used automatically.';
$string['commerce_showroom_n932_technical'] = 'Legacy SEO compatibility';
$string['commerce_showroom_n932_technical_help'] = 'These keys are only fallbacks for legacy Moodle content. Current SEO configuration is managed by the fields above; internal JSON is no longer exposed here.';
$string['commerce_showroom_n94_builder_title'] = 'Build the showroom';
$string['commerce_showroom_n94_builder_help'] = 'Reorder blocks by drag and drop. Add a block or apply a template without leaving this page.';
$string['commerce_showroom_n94_block_count'] = '{$a} blocks';
$string['commerce_showroom_n94_add_block_title'] = 'Add a block';
$string['commerce_showroom_n94_template_title'] = 'Start from a template';
$string['commerce_showroom_n94_more_actions'] = 'Options';
$string['commerce_showroom_n94_collapse_all'] = 'Collapse all';
$string['commerce_showroom_n94_expand_all'] = 'Expand all';
$string['commerce_showroom_n94_visible'] = 'Visible';
$string['commerce_showroom_n94_hidden'] = 'Hidden';
$string['commerce_showroom_n94_collapse_block'] = 'Collapse or expand block';
$string['commerce_showroom_n94_hide_block'] = 'Hide block';
$string['commerce_showroom_n94_show_block'] = 'Show block';
$string['commerce_showroom_n94_technical_info'] = 'Technical information';
$string['commerce_showroom_n94_block_key'] = 'Block key';
$string['commerce_showroom_n941_information_page_title'] = 'Information — {$a}';
$string['commerce_showroom_n941_information_page_subtitle'] = 'Configure the showroom identity, associated products and publication workflow.';
$string['commerce_showroom_n941_seo_page_title'] = 'SEO — {$a}';
$string['commerce_showroom_n941_seo_page_subtitle'] = 'Configure public URLs, search metadata and social sharing for each language.';
$string['commerce_showroom_n941_builder_page_title'] = 'Builder — {$a}';
$string['commerce_showroom_n941_builder_page_subtitle'] = 'Build the showroom page by adding, arranging and configuring its blocks.';
$string['commerce_showroom_n95_common_presentation'] = 'Block presentation';
$string['commerce_showroom_n95_common_presentation_help'] = 'These settings are shared by all blocks. They provide generic presentation and act as a fallback when a block has no specific background.';
$string['commerce_showroom_n95_common_background'] = 'Block background';
$string['commerce_showroom_n95_width'] = 'Width';
$string['commerce_showroom_n95_width_contained'] = 'Contained';
$string['commerce_showroom_n95_width_wide'] = 'Wide';
$string['commerce_showroom_n95_width_full'] = 'Full width';
$string['commerce_showroom_n95_background'] = 'Background';
$string['commerce_showroom_n95_background_default'] = 'Default';
$string['commerce_showroom_n95_background_white'] = 'White';
$string['commerce_showroom_n95_background_light'] = 'Light';
$string['commerce_showroom_n95_background_soft'] = 'Soft';
$string['commerce_showroom_n95_background_pink'] = 'CampusFR pink';
$string['commerce_showroom_n95_background_dark'] = 'Dark';
$string['commerce_showroom_n95_background_gradient'] = 'Gradient';
$string['commerce_showroom_n95_background_custom'] = 'Custom';
$string['commerce_showroom_n95_background_image'] = 'Image';
$string['commerce_showroom_n95_spacing'] = 'Spacing';
...
// N10.1 — Commerce configuration hub.
$string['commerce_configuration_description_n101'] = 'Review Commerce configuration at a glance and access system settings from one dashboard.';
$string['commerce_configuration_status_enabled'] = 'Enabled';
$string['commerce_configuration_status_disabled'] = 'Disabled';
$string['commerce_configuration_catalogue_title'] = 'Catalogue, access and course enrolment';
$string['commerce_configuration_catalogue_description'] = 'Access scopes and plans are catalogue business objects: they connect Moodle courses to Commerce products, enrolments and upgrade strategies. They remain separate from system settings.';
$string['commerce_configuration_catalogue_step_course'] = 'Moodle course';
$string['commerce_configuration_catalogue_step_scope'] = 'Access scope';
$string['commerce_configuration_catalogue_step_plan'] = 'Commercial plan';
$string['commerce_configuration_catalogue_step_product'] = 'Commerce product';
$string['commerce_configuration_open_products'] = 'Open products';
$string['commerce_configuration_open_scopes'] = 'Manage access scopes';
$string['commerce_configuration_open_plans'] = 'Manage plans';
$string['commerce_configuration_system_title'] = 'System configuration';
$string['commerce_configuration_system_description'] = 'A concise view of the settings that drive Commerce. Secrets and sensitive parameters remain in Moodle administration.';
$string['commerce_configuration_advanced_settings'] = 'Advanced Moodle settings';
$string['commerce_configuration_configure'] = 'Configure';
$string['commerce_configuration_technical_badge'] = 'Technical';
$string['commerce_configuration_payments_title'] = 'Payments';
$string['commerce_configuration_payments_description'] = 'Providers, Stripe and Alfa environments, and payment reconciliation.';
$string['commerce_configuration_localisation_title'] = 'Commerce & languages';
$string['commerce_configuration_localisation_description'] = 'Commerce availability, default languages and currency presentation.';
$string['commerce_configuration_checkout_title'] = 'Checkout & follow-ups';
$string['commerce_configuration_checkout_description'] = 'Pending payment lifecycle, expiry and automatic reminders.';
$string['commerce_configuration_communications_title'] = 'Communications';
$string['commerce_configuration_communications_description'] = 'Commerce email, support, personal-offer campaigns and sending limits.';
$string['commerce_configuration_legal_title'] = 'Billing & legal';
$string['commerce_configuration_legal_description'] = 'Billing identities, policies, terms and legal information.';
$string['commerce_configuration_storefront_title'] = 'Shop & Storefront';
$string['commerce_configuration_storefront_description'] = 'Global Boutique editorial services and compatibility settings still used by the legacy catalogue.';
$string['commerce_configuration_engine_title'] = 'Commerce engine';
$string['commerce_configuration_engine_description'] = 'Native/Legacy runtime, fallback, shadow and migration or repair tools.';
$string['commerce_configuration_fact_provider'] = 'Default provider';
$string['commerce_configuration_fact_availability'] = 'Availability';
$string['commerce_configuration_fact_user_language'] = 'Account language';
$string['commerce_configuration_fact_email_language'] = 'Email language';
$string['commerce_configuration_site_default'] = 'Site default';
$string['commerce_configuration_fact_pending_expiry'] = 'Payment expiry';
$string['commerce_configuration_fact_reminder1'] = 'First reminder';
$string['commerce_configuration_fact_reminder2'] = 'Second reminder';
$string['commerce_configuration_fact_support_email'] = 'Support email';
$string['commerce_configuration_fact_offer_batch'] = 'Campaign batch';
$string['commerce_configuration_fact_hourly_limit'] = 'Hourly limit';
$string['commerce_configuration_fact_ru_policy'] = 'RU policy';
$string['commerce_configuration_fact_row_policy'] = 'ROW policy';
$string['commerce_configuration_fact_copy_to'] = 'Email copy';
$string['commerce_configuration_fact_ai_translation'] = 'AI translation';
$string['commerce_configuration_fact_currency_symbols'] = 'Currency symbols';
$string['commerce_configuration_fact_runtime'] = 'Runtime';
$string['commerce_configuration_fact_read_mode'] = 'Read mode';
$string['commerce_configuration_fact_repair'] = 'Native repair';

// Commerce configuration N10.2.
$string['commerce_configuration_open_section'] = 'View settings';
$string['commerce_configuration_back_overview'] = 'Overview';
$string['commerce_configuration_section_notice'] = 'This page shows the Commerce settings currently in use. Changes and secrets deliberately remain in the advanced Moodle settings.';
$string['commerce_configuration_group_general'] = 'General settings';
$string['commerce_configuration_group_payment_routing'] = 'Payment routing';
$string['commerce_configuration_group_reconciliation'] = 'Automatic reconciliation';
$string['commerce_configuration_group_followup'] = 'Expiry and reminders';
$string['commerce_configuration_group_checkout_safety'] = 'Checkout safety and cleanup';
$string['commerce_configuration_group_mail_audit'] = 'E-mail copies and audit';
$string['commerce_configuration_group_legal_links'] = 'Legal documents and links';
$string['commerce_configuration_group_runtime'] = 'Commerce runtime';
$string['commerce_configuration_group_native_tools'] = 'Native controls and migration';

// Commerce configuration editor (N10.3).
$string['commerce_configuration_saved'] = 'Configuration saved.';
$string['commerce_configuration_edit_notice'] = 'These settings are saved directly to Commerce configuration. The technical name shown under each field is the key used by get_config().';
$string['commerce_configuration_url_setting_desc'] = 'URL used by Commerce for this legal page.';
$string['commerce_configuration_stripe_environment'] = 'Stripe environment';
$string['commerce_configuration_alfa_environment'] = 'Alfa environment';
$string['commerce_configuration_stripe_reconciliation_batch_size_desc'] = 'Limits the number of pending Stripe payments checked during one scheduled-task run. Recommended value: 20.';
$string['commerce_configuration_stripe_reconciliation_min_age_desc'] = 'Minimum delay after a Stripe payment is created before automatic reconciliation can check it. Recommended value: 300 seconds.';
$string['commerce_configuration_stripe_reconciliation_max_age_desc'] = 'Stripe payments older than this window are no longer queried automatically. Recommended value: 172800 seconds (48 hours).';
$string['commerce_configuration_group_payment_integrity'] = 'Payment integrity';
$string['commerce_configuration_group_payment_integrity_desc'] = 'Checks applied to amounts and currencies returned by payment providers before a payment is finalized.';
$string['commerce_configuration_group_commerce_availability'] = 'Commerce availability';
$string['commerce_configuration_group_languages'] = 'Languages';
$string['commerce_configuration_group_currencies'] = 'Currencies and price display';
$string['commerce_configuration_availability_label'] = 'Commerce page availability';
$string['commerce_configuration_availability_desc'] = 'Controls access to public Commerce pages. This setting is actively used by the plugin access guard: public, administrators only, or disabled.';
$string['commerce_configuration_default_user_language_label'] = 'Default language for new accounts';
$string['commerce_configuration_default_user_language_desc'] = 'Used when automatically creating new accounts when no more specific user language is available. Existing users keep their own language.';
$string['commerce_configuration_default_email_language_label'] = 'Forced Commerce email language';
$string['commerce_configuration_default_email_language_desc'] = 'When a language is selected, the Commerce mailer uses it for applicable emails. Leave the site-language option to keep the normal recipient/fallback behavior.';
$string['commerce_configuration_enabled_currencies_label'] = 'Enabled currencies';
$string['commerce_configuration_enabled_currencies_desc'] = 'Determines the currencies offered and accepted by the Native Commerce catalogue. At least one currency must remain enabled.';
$string['commerce_configuration_currency_symbols_label'] = 'Display currency symbols';
$string['commerce_configuration_currency_symbols_desc'] = 'Used by checkout and payment result pages to display values such as €49 instead of 49 EUR. This remains a global Commerce setting.';
$string['commerce_configuration_currency_eur'] = 'Euro';
$string['commerce_configuration_currency_rub'] = 'Russian ruble';
$string['commerce_configuration_currency_usd'] = 'US dollar';
$string['commerce_configuration_currency_gbp'] = 'Pound sterling';
$string['commerce_configuration_currency_chf'] = 'Swiss franc';
$string['commerce_configuration_currency_cad'] = 'Canadian dollar';
$string['commerce_configuration_currency_jpy'] = 'Japanese yen';
$string['commerce_configuration_currency_required'] = 'Enable at least one Commerce currency.';
$string['commerce_configuration_group_payment_lifecycle'] = 'Payment request expiry';
$string['commerce_configuration_group_payment_reminders'] = 'Payment reminders';
$string['commerce_configuration_group_guest_cleanup'] = 'Guest checkout account cleanup';
$string['commerce_configuration_expire_pending_after_minutes_desc'] = 'A payment request still pending is marked expired after this delay. This state transition remains active independently of reminder email delivery.';
$string['commerce_configuration_reminder1_after_minutes_desc'] = 'First reminder threshold measured from payment-request creation. Actual email delivery also depends on the Legacy automatic-mail policy.';
$string['commerce_configuration_reminder2_after_minutes_desc'] = 'Second reminder threshold measured from creation. It cannot precede the first reminder; the job also enforces a minimum gap between sends.';
$string['commerce_configuration_checkout_mail_policy_note'] = 'The reminder delays below control the payment follow-up job. They do not enable the old automatic emails by themselves: that permission remains managed in Communications / Mail Studio.';
$string['commerce_configuration_duration_minutes'] = '{$a} min';
$string['commerce_configuration_duration_hours'] = '{$a} h';
$string['commerce_configuration_duration_days'] = '{$a} d';
$string['commerce_configuration_group_mail_identity'] = 'Sending identity and addresses';
$string['commerce_configuration_group_mail_global_throttle'] = 'SMTP throughput protection';
$string['commerce_configuration_group_mail_workers'] = 'Mail Engine workers';
$string['commerce_configuration_group_legacy_mail'] = 'Legacy automatic sends';
$string['commerce_configuration_support_email_desc'] = 'Support address used in emails, payment pages, Showroom and support requests.';
$string['commerce_configuration_admin_copy_desc'] = 'Legacy administrative copy added by the generic mailer. Multiple addresses may be comma-separated.';
$string['commerce_configuration_transactional_enabled_desc'] = 'Enables or suspends the transactional email worker (orders, access, payments and priority messages). The Moodle task remains scheduled.';
$string['commerce_configuration_transactional_batch_label'] = 'Transactional — emails per batch';
$string['commerce_configuration_transactional_hourly_label'] = 'Transactional — hourly limit';
$string['commerce_configuration_personal_offer_enabled_desc'] = 'Enables or suspends the worker dedicated to personal-offer emails. The Moodle task remains scheduled.';
$string['commerce_configuration_personal_offer_batch_label'] = 'Personal offers — emails per batch';
$string['commerce_configuration_personal_offer_hourly_label'] = 'Personal offers — hourly limit';
$string['commerce_configuration_marketing_enabled_desc'] = 'Enables or suspends the marketing campaign worker created from Mail Studio.';
$string['commerce_configuration_marketing_batch_label'] = 'Marketing campaigns — emails per batch';
$string['commerce_configuration_marketing_hourly_label'] = 'Marketing campaigns — hourly limit';
$string['commerce_configuration_audit_copy_generation_label'] = 'Create audit copies';
$string['commerce_configuration_audit_copy_generation_desc'] = 'Controls whether eligible customer emails create a second audit-mail intent. This setting creates copies; it does not process the queue.';
$string['commerce_configuration_audit_copy_address_desc'] = 'Technical address receiving generated audit copies, for example log@campusfr.fr.';
$string['commerce_configuration_audit_worker_label'] = 'Process the audit-copy queue';
$string['commerce_configuration_audit_worker_desc'] = 'Enables or suspends the worker that sends audit copies already created. It is distinct from “Create audit copies”.';
$string['commerce_configuration_audit_batch_label'] = 'Audit copies — emails per batch';
$string['commerce_configuration_audit_hourly_label'] = 'Audit copies — hourly limit';
$string['commerce_configuration_communications_mail_engine_note'] = 'This page and Emails > Configuration control the same Mail Engine keys, so values stay synchronized. The Emails screen remains useful for worker health, Moodle task status and last-run information.';
$string['commerce_configuration_open_mail_engine'] = 'View worker status';
$string['commerce_configuration_copy_destination_label'] = 'Copy / audit address';
$string['commerce_configuration_copy_destination_desc'] = 'Shared destination for Legacy administrative copies and Native Mail Engine audit copies. Saving this value synchronises both mechanisms.';
$string['commerce_configuration_group_invoice_eur'] = 'EUR invoicing — Stripe';
$string['commerce_configuration_group_invoice_rub'] = 'RUB invoicing — Alfa';
$string['commerce_configuration_invoice_name_desc'] = 'Name or legal entity displayed as the invoice issuer.';
$string['commerce_configuration_invoice_address_desc'] = 'Full postal address of the issuing entity.';
$string['commerce_configuration_invoice_legal_desc'] = 'Registration numbers, legal form and other legal details to display.';
$string['commerce_configuration_invoice_email_desc'] = 'Contact email displayed on invoices.';
$string['commerce_configuration_invoice_phone_desc'] = 'Phone number displayed on invoices.';
$string['commerce_configuration_invoice_website_desc'] = 'Website of the issuing entity.';
$string['commerce_configuration_invoice_tax_notice_desc'] = 'Tax or VAT notice specific to this entity.';
$string['commerce_configuration_invoice_footer_desc'] = 'Free text added to the PDF invoice footer.';
$string['commerce_configuration_policy_url_ru_by_label'] = 'Privacy policy — Russia / Belarus';
$string['commerce_configuration_policy_url_ru_by_desc'] = 'Document used when Commerce detects a visitor in Russia or Belarus.';
$string['commerce_configuration_policy_url_row_label'] = 'Privacy policy — Rest of world';
$string['commerce_configuration_policy_url_row_desc'] = 'Document used for all other countries.';
$string['commerce_configuration_terms_url_ru_by_label'] = 'Terms of use — Russia / Belarus';
$string['commerce_configuration_terms_url_ru_by_desc'] = 'Terms used when Commerce detects a visitor in Russia or Belarus.';
$string['commerce_configuration_terms_url_row_label'] = 'Terms of use — Rest of world';
$string['commerce_configuration_terms_url_row_desc'] = 'Terms used for all other countries.';
$string['commerce_configuration_offer_url_ru_by_label'] = 'Terms of sale — Russia / Belarus';
$string['commerce_configuration_offer_url_ru_by_desc'] = 'Sales terms used when Commerce detects a visitor in Russia or Belarus.';
$string['commerce_configuration_offer_url_row_label'] = 'Terms of sale — Rest of world';
$string['commerce_configuration_offer_url_row_desc'] = 'Sales terms used for all other countries.';
$string['commerce_configuration_legal_resolution_note'] = 'Invoice profiles are resolved by currency: EUR uses the Stripe profile and RUB uses the Alfa profile. Legal links are resolved separately by detected region (Russia/Belarus or rest of world).';
$string['commerce_configuration_fact_invoice_eur'] = 'EUR issuer';
$string['commerce_configuration_fact_invoice_rub'] = 'RUB issuer';
$string['commerce_configuration_fact_legal_regions'] = 'Legal regions';
$string['commerce_configuration_legal_regions_value'] = 'RU/BY + rest of world';
$string['commerce_configuration_group_legal_ru_by'] = 'Legal documents — Russia / Belarus';
$string['commerce_configuration_group_legal_row'] = 'Legal documents — Rest of world';
$string['commerce_configuration_policy_document_label'] = 'Privacy policy';
$string['commerce_configuration_terms_document_label'] = 'Terms of use';
$string['commerce_configuration_offer_document_label'] = 'Terms of sale';
$string['commerce_configuration_brand_logo_email_label'] = 'Logo used in e-mails';
$string['commerce_configuration_brand_logo_email_desc'] = 'Brand logo used by the Commerce mail engine. This setting does not control Boutique or Showroom visuals.';
$string['commerce_configuration_group_storefront_editorial'] = 'Storefront editorial services';
$string['commerce_configuration_group_storefront_legacy'] = 'Legacy offers page compatibility';
$string['commerce_configuration_storefront_ai_translation_desc'] = 'Allows the Product Page Builder to prepare translations with the configured OpenAI account. Translation still requires preview and approval before saving.';
$string['commerce_configuration_featured_plan_legacy_label'] = 'Featured plan — legacy fallback';
$string['commerce_configuration_featured_plan_legacy_desc'] = 'Used only by the old offers page when the plan does not already define its own highlight type. Native Product Pages do not depend on this setting.';
$string['commerce_configuration_no_featured_plan'] = 'No forced featured plan';
$string['commerce_configuration_plan_inactive'] = 'Inactive';
$string['commerce_configuration_storefront_scope_title'] = 'Where is the Boutique configured?';
$string['commerce_configuration_storefront_scope_desc'] = 'Editorial and commercial settings now live on each Product (Product Page) and Showroom. This page only keeps global system settings.';
$string['commerce_configuration_storefront_open_products'] = 'Open Products';
$string['commerce_configuration_storefront_open_showrooms'] = 'Open Showrooms';
$string['commerce_configuration_nav_overview'] = 'Overview';
$string['commerce_configuration_internal_navigation'] = 'Commerce configuration navigation';
$string['commerce_configuration_fact_currencies'] = 'Currencies';
$string['commerce_configuration_fact_guest_cleanup'] = 'Guest cleanup';
$string['commerce_configuration_fact_transactional_worker'] = 'Transactional emails';
$string['commerce_configuration_fact_marketing_worker'] = 'Marketing campaigns';
$string['commerce_configuration_fact_legacy_featured_plan'] = 'Featured legacy plan';
$string['commerce_configuration_fact_engine_switches'] = 'Checkout / fulfillment';

$string['commerce_configuration_group_engine_availability'] = 'Engine availability';
$string['commerce_configuration_checkout_engine_enabled_desc'] = 'Global Commerce checkout switch. Disabling it blocks new Native checkout flows and should only be used as a controlled operational stop.';
$string['commerce_configuration_fulfillment_engine_enabled_desc'] = 'Global Commerce fulfillment switch. Disabling it suspends post-payment entitlement delivery and acts as an operational rollback control.';
$string['commerce_configuration_runtime_mode_label'] = 'Authoritative fulfillment engine';
$string['commerce_configuration_runtime_mode_desc'] = 'Legacy runs the historical fulfillment path. Shadow keeps Legacy authoritative while validating Native in parallel. Native makes Native fulfillment authoritative.';
$string['commerce_configuration_runtime_fallback_desc'] = 'In Native mode, if Native fulfillment throws an exception, Commerce immediately tries the Legacy path. This safety net is useful during transition and stabilization.';
$string['commerce_configuration_group_runtime_reads'] = 'Commerce data reads';
$string['commerce_configuration_runtime_read_mode_label'] = 'Commerce read source';
$string['commerce_configuration_runtime_read_mode_desc'] = 'Controls the persistence source used by Commerce readers that still support Legacy/Native. Native reads Native persistence; Auto prefers Native with Legacy fallback; Shadow compares without making Native authoritative.';
$string['commerce_configuration_runtime_read_strict_label'] = 'Strict Native reads';
$string['commerce_configuration_runtime_read_strict_desc'] = 'In Native read mode, prevents silent fallback when expected Native data is missing. Enable only after Native coverage has been certified.';
$string['commerce_configuration_native_reconciliation_label'] = 'Allow Legacy → Native reconciliation';
$string['commerce_configuration_native_reconciliation_desc'] = 'Enables explicit tools that compare and synchronize Legacy purchases into Native. This setting does not enable a reconciliation cron task by itself.';
$string['commerce_configuration_native_repair_label'] = 'Allow repairs during reconciliation';
$string['commerce_configuration_native_repair_desc'] = 'Allows explicit repair operations during reconciliation. Native reconciliation must also be enabled.';
$string['commerce_configuration_repair_requires_reconciliation'] = 'Native repair cannot be enabled while Native reconciliation is disabled.';
$string['commerce_configuration_engine_shadow_status_title'] = 'Native fulfillment Shadow';
$string['commerce_configuration_engine_shadow_status_desc'] = 'This technical flag is now synchronized automatically with the fulfillment mode: enabled only when Shadow mode is selected. It is no longer edited separately in this interface.';
$string['commerce_product_course_journey_title'] = 'Register a Moodle course in Commerce';
$string['commerce_product_course_journey_description'] = 'To sell a new course, first attach it to an access scope, then create or reuse a commercial plan, and finally create the Commerce product. This keeps enrolments and upgrade strategies consistent.';

// N10.6A — Access scopes UX.
$string['commerce_scopes_description_n106'] = 'Access scopes group the courses delivered together by a commercial plan. They connect Moodle courses to Plans and then to Commerce Products.';
$string['commerce_scope_add_description_n106'] = 'Create a scope by grouping the courses that should be granted together when a commercial plan is purchased.';
$string['commerce_scope_edit_description_n106'] = 'Define the courses granted by this scope and used by its commercial plans.';
$string['commerce_scope_course_search'] = 'Search and select courses…';
$string['commerce_scope_courses_help'] = 'Search for a course by name, then select one or more courses. Selected courses remain visible in the field.';
$string['commerce_scope_courses_help_help'] = 'Search for a course by name, then select one or more courses. Selected courses remain visible in the field.';
$string['commerce_scope_courses_badge'] = '{$a} courses';
$string['commerce_scope_plans_badge'] = '{$a} plans';
$string['commerce_scope_dependency_title'] = 'Used by {$a} commercial plan(s)';
$string['commerce_scope_dependency_help'] = 'Changing the courses in this scope changes the access delivered by products using these plans.';
$string['commerce_scope_general_title'] = 'General information';
$string['commerce_scope_general_description'] = 'Define the scope name and the Moodle courses it groups together.';

$string['commerce_scope_view_description_n106'] = 'Review the included courses, the commercial plans using this scope and its technical information.';
$string['commerce_scope_view_courses_description'] = 'Moodle courses granted when a plan using this scope is delivered.';
$string['commerce_scope_view_plans_description'] = 'Commercial plans currently linked to this access scope.';
$string['commerce_scope_view_no_plans'] = 'No commercial plan currently uses this access scope.';

// N10.6B — Plans, entitlements and upgrades.
$string['commerce_plans_description_n106'] = 'Plans turn an access scope into a commercial offer: duration, recurrence, execution entitlements and upgrade rules. They can then be linked to a Native Commerce Product.';
$string['commerce_plans_list_title'] = 'Commercial plans';
$string['commerce_plans_list_description'] = 'Overview of Plans, their access scope, activity and optional link to a Native Product.';
$string['commerce_plans_empty'] = 'No commercial Plan has been configured yet.';
$string['commerce_plan_native_product'] = 'Native Commerce Product';
$string['commerce_plan_native_product_desc'] = 'Native Product currently linked to this Plan through the Commerce compatibility layer.';
$string['commerce_plan_no_native_product'] = 'No Native Product linked';
$string['commerce_plan_no_native_product_desc'] = 'This Plan still exists without a link to a Native Commerce Product.';
$string['commerce_plan_open_native_product'] = 'Open Native Product';
$string['commerce_plan_add_description_n106'] = 'Create a commercial Plan from an access scope and define its duration and commercial behaviour.';
$string['commerce_plan_edit_description_n106'] = 'Edit this Plan’s commercial properties while keeping its entitlements, upgrades and linked Native Product visible.';
$string['commerce_plan_general_title'] = 'General information';
$string['commerce_plan_general_description'] = 'Define the Plan name, access scope, duration, recurrence and merchandising highlight.';
$string['commerce_plan_view_description_n106'] = 'Review the Plan’s commercial structure, entitlements, upgrade rules and optional Native Commerce Product link.';
$string['commerce_plan_business_information_desc_n106'] = 'Business settings used by this Plan to determine access and offer duration.';
$string['commerce_plan_entitlements_rules_title'] = 'Configured entitlements';
$string['commerce_plan_entitlements_rules_desc'] = 'Historical execution rules that complement the Plan access scope.';
$string['commerce_plan_upgrade_rules_title'] = 'Configured upgrade rules';
$string['commerce_plan_upgrade_rules_desc'] = 'Allowed transitions between this Plan and other Plans, including their pricing calculation mode.';

// N10.6C — Legacy Plan prices/translations.
$string['commerce_plan_legacy_compatibility_title'] = 'Legacy compatibility';
$string['commerce_plan_legacy_mapped_readonly_desc'] = 'This Plan is linked to a Native Commerce Product. Legacy prices and translations are kept for compatibility and audit purposes but can no longer be edited here. The Native Product is now the authoritative editorial source.';
$string['commerce_plan_legacy_unmapped_desc'] = 'This historical screen remains available only for Legacy Plans that have not yet been linked to a Native Commerce Product.';
$string['commerce_plan_legacy_readonly_notice'] = 'This Plan is linked to a Native Commerce Product: Legacy data is read-only. Edit the Native Product instead.';
$string['commerce_plan_legacy_readonly_badge'] = 'Read-only';
$string['commerce_plan_open_native_prices'] = 'Manage Native prices';
$string['commerce_plan_open_native_translations'] = 'Manage Native translations';

// Commerce 7.95N10.7 — Promotions and coupons in Offers & access.
$string['commerce_offers_access_tab_promotions'] = 'Promotions & coupons';
$string['commerce_offers_access_promotion_title'] = 'Promotion or coupon';
$string['commerce_offers_access_promotion_description'] = 'Create an automatic discount or a coupon code that can be applied during Commerce checkout.';
$string['commerce_offers_access_promotion_action'] = 'Create a promotion';
$string['commerce_promotions_coupon_hint'] = 'An automatic promotion applies without a code. A manual promotion with a code is a coupon entered during checkout.';
...
$string['commerce_promotions_metric_active'] = 'Active';
$string['commerce_promotions_metric_coupons'] = 'Coupons';
$string['commerce_promotions_metric_automatic'] = 'Automatic';
$string['commerce_promotions_mode_title'] = 'Two application modes';
$string['commerce_promotions_list_title'] = 'Promotions & coupons';
$string['commerce_promotions_list_description'] = 'Overview of available discounts, how they are applied, and their usage.';
$string['commerce_promotion_section_identity'] = 'Identity & application mode';
$string['commerce_promotion_section_identity_desc'] = 'Set the internal name, optional code, and how the discount is applied.';
$string['commerce_promotion_section_discount'] = 'Discount & limits';
$string['commerce_promotion_section_discount_desc'] = 'Configure the discount calculation, currency, cart minimum, and usage limits.';
$string['commerce_promotion_section_products'] = 'Eligible products';
$string['commerce_promotion_section_products_desc'] = 'Limit the promotion to selected products or product types. Leave unrestricted to apply it to the full catalogue.';

// N10.7.2 — Promotions & coupons UX, details and validity.
$string['commerce_promotion_section_validity'] = 'Validity period';
$string['commerce_promotion_section_validity_desc'] = 'Define when the promotion can be applied. Leave either date empty to keep that side of the period unrestricted.';
$string['commerce_promotion_starts_at'] = 'Valid from';
$string['commerce_promotion_starts_at_help'] = 'Date and time from which the promotion becomes applicable. Leave empty for immediate availability.';
$string['commerce_promotion_ends_at'] = 'Valid until';
$string['commerce_promotion_ends_at_help'] = 'Date and time after which the promotion can no longer be applied. Leave empty for no end date.';
$string['commerce_promotion_validity'] = 'Validity';
$string['commerce_promotion_validity_upcoming'] = 'Upcoming';
$string['commerce_promotion_validity_expired'] = 'Expired';
$string['commerce_promotion_validity_unlimited'] = 'No time limit';
$string['commerce_promotion_validity_current'] = 'Current';
$string['commerce_promotion_validity_immediate'] = 'immediately';
$string['commerce_promotion_validity_no_end'] = 'no end date';
$string['commerce_promotion_validity_range'] = '{$a->from} → {$a->to}';
$string['commerce_promotion_view_description'] = 'Review the discount, validity period, product restrictions and customer eligibility rules.';
$string['commerce_promotion_view_summary'] = 'Promotion summary';
$string['commerce_promotion_view_limits'] = 'Limits and usage';
$string['commerce_promotion_mode'] = 'Application mode';
$string['commerce_promotion_no_restriction'] = 'No restriction';
$string['commerce_promotion_unlimited'] = 'Unlimited';

$string['commerce_promotions_found'] = '{$a} promotion(s) found';
$string['commerce_promotions_no_results'] = 'No promotion matches the current filters.';
$string['commerce_promotions_search_placeholder'] = 'Search by name or code…';
