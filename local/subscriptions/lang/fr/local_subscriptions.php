...
$string['commerce_identity_merge_preferred_identity_safety'] = 'Seuls le username et l’email sont échangés. Le compte conservé garde son ID Moodle, son historique pédagogique, son nom et ses données Commerce. Le compte absorbé est suspendu et reçoit les anciens identifiants du compte conservé. Le changement complet est journalisé dans l’audit de fusion.';
