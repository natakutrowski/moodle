...
$string['availability_mode'] = 'Disponibilité des pages Commerce';
$string['availability_mode_desc'] = 'Contrôle l’accès aux pages publiques Commerce. Le mode « Admin uniquement » permet de fermer temporairement le Commerce aux clients sans bloquer les administrateurs.';
...
$string['commerce_storefront_edit_language'] = 'Version linguistique';
$string['commerce_storefront_edit_language_help'] = 'Vous modifiez la version linguistique sélectionnée de la Page Boutique. Les blocs, textes et médias éditoriaux peuvent différer d’une langue à l’autre.';
...
$string['commerce_promotion_productskus'] = 'Produits éligibles';
...
$string['commerce_personal_offer_mail_queue_single'] = 'Mettre l’e-mail en file d’attente';
...
$string['commerce_identity_merge_m756_scope_detail'] = 'La prévisualisation a détecté {$a->learning} élément(s) pédagogiques, {$a->commerce} élément(s) commerciaux et {$a->gamification} élément(s) Level Up XP/Quest. Ils seront consolidés avant la désactivation des anciens comptes.';
...
$string['commerce_guest_crm_class_provider_paid_pending'] = 'Payé chez le provider, vente encore en attente';
...
$string['commerce_guest_crm_check_provider'] = 'Vérifier chez le fournisseur';
...
$string['commerce_personal_offer_identity_conflict_title'] = 'Cette offre appartient à une autre identité';
$string['commerce_personal_offer_identity_conflict_message'] = 'Cette offre personnelle a été envoyée à {$a->offeremail}, mais vous êtes actuellement connecté avec {$a->currentemail}. Pour votre sécurité, l’offre ne peut pas être utilisée avec le compte actuellement connecté.';
$string['commerce_personal_offer_identity_conflict_continue'] = 'Me déconnecter et continuer avec cette offre';
$string['commerce_personal_offer_identity_conflict_cancel'] = 'Conserver mon compte actuel';
$string['commerce_identity_nav_relationships'] = 'Liens d’identité';
$string['commerce_identity_relationships_title'] = 'Liens d’identité et historique des emails';
$string['commerce_identity_relationships_description'] = 'Consultez les emails historiques connus et les rapprochements potentiels à vérifier manuellement. Aucun compte n’est rattaché ou fusionné automatiquement.';
$string['commerce_identity_relationships_userid'] = 'ID utilisateur Moodle';
$string['commerce_identity_relationships_inspect'] = 'Examiner l’identité';
$string['user360_identity_graph_title'] = 'Emails et identités';
$string['user360_identity_graph_help'] = 'Historique d’emails connu et comptes potentiellement liés. Les rapprochements potentiels sont uniquement des signaux de vérification manuelle.';
$string['user360_identity_current'] = 'Actuel';
$string['user360_identity_historical'] = 'Historique';
$string['user360_identity_potential_title'] = 'Comptes potentiellement liés';
$string['user360_identity_potential_help'] = 'Ces comptes ne sont pas liés. Une similarité peut être fortuite : vérifiez toujours la personne avant toute action.';
$string['user360_identity_source_moodle_current'] = 'Compte Moodle actuel';
$string['user360_identity_source_commerce_purchase'] = 'Achat Commerce';
$string['user360_identity_source_legacy_digital'] = 'Achat digital Legacy';
$string['user360_identity_source_personal_offer'] = 'Offre personnelle';
$string['user360_identity_source_merged_account'] = 'Compte fusionné';
$string['user360_identity_source_merge_identity_history'] = 'Historique d’identité de fusion';
$string['commerce_identity_merge_preferred_identity_title'] = 'Identité de connexion après fusion';
$string['commerce_identity_merge_preferred_identity_help'] = 'Conservez le compte recommandé pour son historique pédagogique tout en pouvant reprendre l’email et le login d’un autre compte comparé.';
$string['commerce_identity_merge_preferred_identity_choice'] = '#{$a->userid} — {$a->email} · login {$a->username}';
$string['commerce_identity_merge_preferred_identity_safety'] = 'Le username et l’email sont échangés indépendamment du choix du mot de passe ci-dessous. Le compte conservé garde son ID Moodle, son historique pédagogique, son nom et ses données Commerce. Le compte absorbé est suspendu et reçoit l’ancienne identité de connexion du compte conservé.';
$string['commerce_identity_merge_preferred_identity_invalid'] = 'L’identité de connexion demandée ne peut pas être transférée de façon sûre.';
$string['commerce_identity_merge_preferred_password_title'] = 'Mot de passe après fusion';
$string['commerce_identity_merge_preferred_password_help'] = 'Choisissez explicitement le mot de passe actuel que conservera le compte Moodle final. Par défaut, le compte conservé garde son propre mot de passe.';
$string['commerce_identity_merge_preferred_password_choice'] = 'Conserver le mot de passe du compte #{$a->userid} — {$a->email}';
$string['commerce_identity_merge_preferred_password_unavailable'] = 'indisponible avec une authentification externe';
$string['commerce_identity_merge_preferred_password_safety'] = 'Un mot de passe ne peut être transféré qu’entre deux comptes utilisant l’authentification manuelle Moodle. Les hashes ne sont jamais affichés ni enregistrés dans l’audit de fusion.';
$string['commerce_identity_merge_preferred_password_invalid'] = 'Le compte choisi pour le mot de passe n’est pas valide pour cette fusion.';
$string['commerce_identity_merge_preferred_password_manual_only'] = 'Le mot de passe ne peut être transféré qu’entre deux comptes utilisant l’authentification manuelle Moodle.';
$string['user360_merge_identity_transfer'] = 'Identité de connexion modifiée pendant la fusion : {$a->oldemail} → {$a->newemail} (identité reprise du compte #{$a->sourceuserid}).';
$string['commerce_identity_relationships_email'] = 'Email (pour les identités Legacy/Commerce sans compte)';
$string['user360_identity_source_external_current'] = 'Identité externe / Commerce sans compte';


// Identity merge final-state preview.
$string['commerce_identity_merge_final_state_title'] = 'État final après fusion';
$string['commerce_identity_merge_final_state_help'] = 'Vérifiez le compte qui restera utilisable, son identité de connexion finale et les données qui seront conservées ou consolidées.';
$string['commerce_identity_merge_final_retained_title'] = 'Compte qui restera actif';
$string['commerce_identity_merge_final_retained_help'] = 'C’est le compte que le client utilisera après la fusion.';
$string['commerce_identity_merge_final_absorbed_title'] = 'Compte(s) absorbé(s) et suspendu(s)';
$string['commerce_identity_merge_final_absorbed_help'] = 'Ces comptes ne seront plus utilisables par le client après la fusion.';
$string['commerce_identity_merge_final_active_badge'] = 'ACTIF';
$string['commerce_identity_merge_final_suspended_badge'] = 'SUSPENDU';
$string['commerce_identity_merge_final_identity_title'] = 'Identité finale';
$string['commerce_identity_merge_final_moodle_id'] = 'ID Moodle';
$string['commerce_identity_merge_final_name'] = 'Nom du compte';
$string['commerce_identity_merge_final_email'] = 'Email de connexion';
$string['commerce_identity_merge_final_username'] = 'Login (username)';
$string['commerce_identity_merge_final_status'] = 'État';
$string['commerce_identity_merge_final_status_value'] = 'Actif · compte conservé';
$string['commerce_identity_merge_final_learning_title'] = 'Données pédagogiques';
$string['commerce_identity_merge_final_courses'] = 'cours inscrits actuellement';
$string['commerce_identity_merge_final_completed_courses'] = 'cours terminés actuellement';
$string['commerce_identity_merge_final_activities'] = 'activités complétées actuellement';
$string['commerce_identity_merge_final_grades'] = 'notes actuellement';
$string['commerce_identity_merge_final_grades_value'] = '{$a->count} · moyenne {$a->average}%';
$string['commerce_identity_merge_final_learning_consolidation'] = '{$a} enregistrement(s) pédagogique(s) supplémentaire(s) provenant des comptes absorbés seront consolidés. Les doublons et conflits suivent les choix affichés plus bas ; les compteurs finaux peuvent donc évoluer.';
$string['commerce_identity_merge_final_learning_unchanged'] = 'Aucune donnée pédagogique supplémentaire détectée sur les comptes absorbés : ces compteurs resteront inchangés.';
$string['commerce_identity_merge_final_commerce_title'] = 'Données Commerce finales';
$string['commerce_identity_merge_final_purchases'] = 'achats';
$string['commerce_identity_merge_final_grants'] = 'droits';
$string['commerce_identity_merge_final_digital'] = 'accès digitaux';
$string['commerce_identity_merge_final_guests'] = 'sessions guest';
$string['commerce_identity_merge_final_commerce_consolidated'] = 'Toutes les données Commerce prises en charge seront rattachées au compte conservé.';
$string['commerce_identity_merge_final_after_merge'] = 'État après fusion';
$string['commerce_identity_merge_final_absorbed_status'] = 'Suspendu · non utilisable';
$string['commerce_identity_merge_final_absorbed_identity_swap_note'] = 'L’identité de connexion de ce compte est transférée au compte conservé. Il reçoit les anciens identifiants du compte conservé afin de libérer l’email et le login choisis.';
$string['commerce_identity_merge_final_absorbed_regular_note'] = 'Ce compte sera suspendu après consolidation de ses données prises en charge.';
$string['commerce_identity_merge_final_transferred_from'] = 'transféré de #{$a}';
$string['commerce_identity_merge_final_replaced_by_target'] = 'anciens identifiants de #{$a}';
$string['commerce_identity_merge_final_sentence'] = 'Résultat : le client se connectera avec {$a->email} au compte Moodle #{$a->userid}. Ce compte conservera son historique actuel ({$a->courses} cours, {$a->activities} activités complétées, {$a->grades} notes) et regroupera {$a->purchases} achat(s) Commerce. {$a->sources} compte(s) source(s) seront suspendu(s).';
$string['commerce_identity_merge_technical_title'] = 'Détail technique complet';
$string['commerce_identity_merge_technical_badge'] = 'Masqué par défaut';
$string['commerce_identity_merge_technical_help'] = 'Affiche les identifiants avant/après, les volumes bruts détectés et les paramètres de consolidation. À utiliser pour contrôle ou audit.';
$string['commerce_identity_merge_warning_different_emails_transfer'] = 'Les comptes utilisent des adresses email différentes. L’identité de connexion sélectionnée sera transférée au compte principal ; son ancienne adresse ne restera donc pas son email de connexion.';
$string['commerce_identity_merge_final_confirmation'] = 'Vous êtes sur le point de conserver le compte Moodle #{$a->userid}, avec {$a->email} comme email de connexion final, et de suspendre {$a->sources} compte(s) source(s). Vérifiez une dernière fois l’état final ci-dessus avant de confirmer.';

// Detailed irreversible merge preview.
$string['commerce_identity_merge_technical_help_detailed'] = 'Inspectez les cours, achats, données Legacy, droits et changements d’identité exacts qui seront consolidés. Ces informations sont en lecture seule et reflètent les enregistrements trouvés avant validation.';
$string['commerce_identity_merge_technical_courses'] = 'Cours et historique pédagogique';
$string['commerce_identity_merge_technical_purchases'] = 'Historique des achats Commerce';
$string['commerce_identity_merge_technical_legacy'] = 'Abonnements et achats digitaux Legacy';
$string['commerce_identity_merge_technical_rights'] = 'Droits et accès digitaux';
$string['commerce_identity_merge_technical_identity_audit'] = 'Identité et audit de fusion';
$string['commerce_identity_merge_detail_origin'] = 'Compte d’origine';
$string['commerce_identity_merge_detail_course'] = 'Cours';
$string['commerce_identity_merge_detail_enrolment'] = 'Inscription';
$string['commerce_identity_merge_detail_completion'] = 'Complétion';
$string['commerce_identity_merge_detail_activity_grade'] = 'Activités / notes';
$string['commerce_identity_merge_detail_decision'] = 'Résultat de fusion';
$string['commerce_identity_merge_detail_purchase'] = 'Achat';
$string['commerce_identity_merge_detail_product'] = 'Produit / identité';
$string['commerce_identity_merge_detail_status_amount'] = 'Statut / montant';
$string['commerce_identity_merge_detail_legacy_link'] = 'Lien Legacy';
$string['commerce_identity_merge_detail_record'] = 'Enregistrement';
$string['commerce_identity_merge_detail_period_access'] = 'Période / accès';
$string['commerce_identity_merge_detail_status'] = 'Statut';
$string['commerce_identity_merge_detail_none'] = 'Aucun enregistrement correspondant.';
$string['commerce_identity_merge_detail_already_target'] = 'Déjà rattaché au compte conservé ; sera préservé tel quel.';
$string['commerce_identity_merge_detail_course_consolidate'] = 'Également présent sur le compte conservé ; les données pédagogiques seront consolidées selon les règles de conflit existantes.';
$string['commerce_identity_merge_detail_course_transfer'] = 'Sera transféré vers le compte conservé.';
$string['commerce_identity_merge_detail_purchase_transfer'] = 'Le userid de l’achat sera rattaché au compte conservé #{$a}.';
$string['commerce_identity_merge_detail_legacy_transfer'] = 'L’enregistrement Legacy sera rattaché au compte conservé #{$a}.';
$string['commerce_identity_merge_detail_right_transfer'] = 'Le bénéficiaire du droit/de l’accès sera rattaché au compte conservé #{$a}.';
$string['commerce_identity_merge_detail_enrolment_value'] = '{$a->status} · depuis {$a->date}';
$string['commerce_identity_merge_detail_completed_on'] = 'Terminé : {$a}';
$string['commerce_identity_merge_detail_not_completed'] = 'Non terminé';
$string['commerce_identity_merge_detail_activity_grade_value'] = '{$a->activities} activités complétées · {$a->grades} notes · moyenne {$a->average} · dernier accès {$a->lastaccess}';
...
$string['commerce_showroom_config_social_image'] = 'Image de partage';
$string['commerce_showroom_config_social_image_help'] = 'Image utilisée dans les aperçus Telegram, WhatsApp, Facebook et autres réseaux. Si elle est vide, le showroom continue d’utiliser automatiquement une image d’offre.';
...
$string['commerce_identity_merge_gamification_summary'] = 'Level Up : {$a->xp} XP · {$a->quests} quête(s) terminée(s)';
$string['commerce_identity_merge_advanced_mode'] = 'Mode avancé — construire le compte final champ par champ';
$string['commerce_identity_merge_advanced_mode_help'] = 'Activez ce mode pour choisir manuellement la valeur conservée pour chaque information de profil en conflit. L’email/login et le mot de passe restent sélectionnables séparément juste au-dessus. Les données pédagogiques, Commerce, Level Up XP et Quest sont consolidées sans supprimer l’historique.';
$string['commerce_identity_merge_advanced_no_profile_conflicts'] = 'Aucune autre information de profil différente n’a été détectée entre ces comptes.';
$string['commerce_identity_merge_advanced_field'] = 'Information';
$string['commerce_identity_merge_advanced_account_column'] = 'Compte {$a->letter} · #{$a->userid}';
$string['commerce_identity_merge_advanced_identity_note'] = 'Les choix ci-dessus concernent le profil Moodle. L’identité de connexion (email + login) et le mot de passe sont gérés par leurs sélecteurs dédiés afin de préserver les contraintes d’unicité et de sécurité.';
$string['commerce_identity_merge_m16_gamification_title'] = 'Progression Level Up récupérée';
$string['commerce_identity_merge_gamification_incomplete'] = 'La fusion Level Up XP/Quest est incomplète : des données restent rattachées à un compte source. La transaction a été annulée.';
$string['commerce_customer_email_change_action'] = 'Changer l’adresse email';
$string['commerce_customer_email_change_title'] = 'Changer l’adresse email du client';
$string['commerce_customer_email_change_description'] = 'Modifie l’identité email actuelle dans Moodle et Commerce sans réécrire l’historique commercial.';
$string['commerce_customer_email_change_current'] = 'Adresse actuelle : {$a->email}';
$string['commerce_customer_email_change_scope_title'] = 'Portée de la modification';
$string['commerce_customer_email_change_scope_current'] = 'L’adresse actuelle sera mise à jour dans le profil Moodle et les droits/accès Commerce liés à ce compte.';
$string['commerce_customer_email_change_scope_history'] = 'Les anciennes commandes, paiements, factures et snapshots Legacy conservent l’adresse utilisée au moment de l’achat.';
$string['commerce_customer_email_change_confirm'] = 'Je confirme que cette nouvelle adresse doit devenir l’identité email actuelle de ce client.';
$string['commerce_customer_email_change_preview'] = 'Prévisualiser';
$string['commerce_customer_email_change_execute'] = 'Appliquer le changement';
$string['commerce_customer_email_change_preview_title'] = 'Prévisualisation';
$string['commerce_customer_email_change_preview_current'] = '{$a->count} référence(s) d’identité/accès actuelle(s) seront alignées sur la nouvelle adresse.';
$string['commerce_customer_email_change_preview_history'] = '{$a->count} enregistrement(s) commercial(aux) historique(s) resteront inchangés.';
$string['commerce_customer_email_change_success'] = 'L’adresse email actuelle du client a été mise à jour.';
$string['commerce_customer_email_change_duplicate'] = 'Cette adresse email est déjà utilisée par un autre compte Moodle actif.';
$string['commerce_customer_email_change_confirmation_required'] = 'Vous devez confirmer explicitement le changement d’adresse email.';

$string['commerce_customer_email_change_newemail'] = 'Nouvelle adresse email';
$string['commerce_customer_email_change_newlang'] = 'Nouvelle langue du compte';
$string['commerce_customer_email_change_preview_email'] = 'Email';
$string['commerce_customer_email_change_preview_language'] = 'Langue du compte';
$string['commerce_customer_email_change_preview_impacted_title'] = 'Ce qui sera réellement mis à jour';
$string['commerce_customer_email_change_preview_preserved_title'] = 'Ce qui restera inchangé';
$string['commerce_customer_email_change_impact_moodle_user'] = 'Profil Moodle : changement email {$a->email} ; changement langue {$a->lang}.';
$string['commerce_customer_email_change_impact_grants'] = '{$a} droit(s) Commerce seront alignés sur le nouvel email.';
$string['commerce_customer_email_change_impact_digital'] = '{$a} accès numérique(s) seront alignés sur le nouvel email.';
$string['commerce_customer_email_change_impact_offers'] = '{$a} offre(s) personnelle(s) seront alignées sur le nouvel email.';
$string['commerce_customer_email_change_impact_offer_campaigns'] = '{$a} inscription(s) à une campagne d’offre personnelle seront alignées sur le nouvel email.';
$string['commerce_customer_email_change_impact_grant_campaigns'] = '{$a} inscription(s) à une campagne de droits seront alignées sur le nouvel email.';
$string['commerce_customer_email_change_impact_guests'] = '{$a} identité(s) de session/invité active(s) seront alignées sur le nouvel email.';
$string['commerce_customer_email_change_history_purchases'] = '{$a} achat(s) Commerce historiques conservent l’email enregistré lors de l’achat.';
$string['commerce_customer_email_change_history_payments'] = '{$a} demande(s) de paiement historiques conservent leur email d’origine.';
$string['commerce_customer_email_change_history_digital_payments'] = '{$a} demande(s) de paiement numérique historiques conservent leur email d’origine.';
$string['commerce_customer_email_change_history_none'] = 'Aucun enregistrement commercial historique n’est concerné.';

$string['commerce_customer_email_change_impact_moodle_email'] = 'L’adresse email du profil Moodle deviendra la nouvelle adresse.';
$string['commerce_customer_email_change_impact_moodle_language'] = 'La langue du compte Moodle sera remplacée par la langue sélectionnée.';

// 7.95N CRM UX and navigation.
$string['crm_nav_showrooms'] = 'Showrooms';
$string['crm_nav_dashboard'] = 'CRM Dashboard';
$string['crm_nav_users'] = 'Utilisateurs';
$string['crm_nav_commerce'] = 'Commerce';
$string['crm_nav_inbox'] = 'Boîte de réception';
$string['crm_nav_work'] = 'Work Items';
$string['crm_nav_assistant'] = 'Assistant';
$string['crm_nav_tools'] = 'Outils';
$string['crm_nav_help'] = 'Aide';
$string['crm_nav_users_overview'] = 'Tous les utilisateurs';
$string['crm_nav_inbox_overview'] = 'Boîte de réception';
$string['crm_nav_diagnostics'] = 'Diagnostics';
$string['crm_nav_work_items'] = 'Work Items';
$string['crm_nav_work_teams'] = 'Équipes';
$string['crm_nav_tools_overview'] = 'Tous les outils';
$string['crm_nav_tools_history'] = 'Historique des outils';
$string['crm_nav_help_overview'] = 'Centre d’aide';
$string['crm_nav_open_menu'] = 'Ouvrir le menu {$a}';

// Commerce 7.95N2 — dashboard Commerce.
$string['crm_breadcrumb_root'] = 'CRM';
$string['commerce_dashboard_revenue_30d'] = 'Ventes (30 derniers jours)';
$string['commerce_dashboard_orders_30d'] = 'Commandes';
$string['commerce_dashboard_mails_30d'] = 'E-mails envoyés';
$string['commerce_dashboard_unfinished_checkouts'] = 'Checkouts inachevés';
$string['commerce_dashboard_active_offers'] = 'Offres actives';
$string['commerce_dashboard_customers_30d'] = 'Nouveaux clients';
$string['commerce_dashboard_new_today'] = '{$a} nouveaux aujourd’hui';
$string['commerce_dashboard_expiring_7d'] = '{$a} expirent dans 7 jours';
$string['commerce_dashboard_vs_previous'] = 'vs période précédente';
$string['commerce_dashboard_no_comparison'] = 'Pas de comparaison disponible';
$string['commerce_dashboard_sales_30d'] = 'Ventes au cours des 30 derniers jours';
$string['commerce_dashboard_sales_chart'] = 'Évolution des ventes des 30 derniers jours';
$string['commerce_dashboard_latest_sales'] = 'Dernières ventes';
$string['commerce_dashboard_view_all_sales'] = 'Voir toutes les ventes';
$string['commerce_dashboard_no_sales_data'] = 'Pas encore de données sur cette période.';
$string['commerce_dashboard_quick_actions'] = 'Accès rapides';
$string['commerce_dashboard_action_create_product'] = 'Créer un produit';
$string['commerce_dashboard_action_create_offer'] = 'Créer une offre personnelle';
$string['commerce_dashboard_action_mail'] = 'Gérer les e-mails';
$string['commerce_dashboard_action_import'] = 'Importer des abonnements';
$string['commerce_dashboard_action_unfinished'] = 'Voir les checkouts inachevés';
$string['commerce_dashboard_action_statistics'] = 'Statistiques commerciales';
$string['commerce_dashboard_alerts'] = 'Alertes';
$string['commerce_dashboard_alert_checkouts'] = '{$a} checkouts inachevés';
$string['commerce_dashboard_alert_offers'] = '{$a} offres expirent bientôt';
$string['commerce_dashboard_alert_mail'] = '{$a} e-mails en échec';
$string['commerce_dashboard_no_alerts'] = 'Aucune alerte Commerce pour le moment.';
$string['commerce_dashboard_top_products'] = 'Meilleures ventes (30 jours)';
$string['commerce_dashboard_view_statistics'] = 'Voir les statistiques';
$string['commerce_dashboard_product_summary'] = 'Résumé produits';
$string['commerce_dashboard_products_total'] = 'Produits';
$string['commerce_dashboard_products_bundles'] = 'Packs';
$string['commerce_dashboard_products_courses'] = 'Cours';
$string['commerce_dashboard_products_digital'] = 'Produits digitaux';
$string['commerce_dashboard_active'] = 'Actifs';
$string['commerce_dashboard_manage_catalog'] = 'Gérer le catalogue';
$string['commerce_dashboard_minutes_ago'] = 'Il y a {$a} min';
$string['commerce_dashboard_hours_ago'] = 'Il y a {$a} h';

// Commerce 7.95N2.3 dashboard UX.
$string['crm_commerce_nav_showrooms'] = 'Showrooms';
$string['crm_commerce_nav_offers_access'] = 'Offres & accès';
$string['commerce_dashboard_period_label'] = 'Période';
$string['commerce_dashboard_period_days'] = '{$a} derniers jours';
$string['commerce_dashboard_revenue'] = 'Ventes encaissées';
$string['commerce_dashboard_orders_paid'] = 'Commandes payées';
$string['commerce_dashboard_orders_status_foot'] = '{$a->total} initiées · {$a->pending} en attente · {$a->failed} échec/annulées';
$string['commerce_dashboard_mails_sent'] = 'E-mails envoyés';
$string['commerce_dashboard_new_customers'] = 'Nouveaux clients';
$string['commerce_dashboard_conversion_rate'] = 'Conversion paiement';
$string['commerce_dashboard_sales_period'] = 'Ventes sur la période sélectionnée';
$string['commerce_dashboard_period_today'] = 'Aujourd’hui';
$string['commerce_dashboard_period_7'] = '7 jours';
$string['commerce_dashboard_period_30'] = '30 jours';
$string['commerce_dashboard_period_90'] = '90 jours';
$string['commerce_dashboard_period_365'] = '1 an';
$string['commerce_dashboard_period_apply'] = 'Appliquer';
$string['commerce_dashboard_alert_pending_orders'] = '{$a} commandes en attente';
$string['commerce_dashboard_alert_failed_orders'] = '{$a} commandes annulées/échouées';
$string['commerce_dashboard_alert_grants'] = '{$a} problèmes de livraison de droits';
$string['commerce_dashboard_alert_mail_pending'] = '{$a} e-mails en attente';
$string['commerce_dashboard_top_products_period'] = 'Meilleures ventes';

$string['commerce_dashboard_sales_short'] = 'Ventes';

$string['commerce_dashboard_period_summary'] = 'Résumé du {$a->start} au {$a->end}';

$string['commerce_dashboard_action_merge_accounts'] = 'Fusionner des comptes';

$string['commerce_dashboard_product_showroom_summary'] = 'Résumé produits & showrooms';
$string['commerce_dashboard_products_section'] = 'Produits';
$string['commerce_dashboard_showrooms_section'] = 'Showrooms';
$string['commerce_dashboard_showrooms_total'] = 'Showrooms';
$string['commerce_dashboard_showrooms_published'] = 'Publiés';
$string['commerce_dashboard_showrooms_workinprogress'] = 'En préparation';
$string['commerce_dashboard_manage_showrooms'] = 'Gérer les showrooms';

$string['commerce_sales_filters_title'] = 'Filtres';
$string['commerce_sales_search_placeholder'] = 'Rechercher par référence, client, e-mail ou produit…';
$string['commerce_sales_period'] = 'Période';
$string['commerce_sales_period_today'] = 'Aujourd’hui';
$string['commerce_sales_period_7'] = '7 derniers jours';
$string['commerce_sales_period_30'] = '30 derniers jours';
$string['commerce_sales_period_90'] = '90 derniers jours';
$string['commerce_sales_period_365'] = '1 an';
$string['commerce_sales_period_all'] = 'Toute la période';
$string['commerce_sales_period_custom'] = 'Personnalisée';
$string['commerce_sales_more_filters'] = 'Plus de filtres';
$string['commerce_sales_date_from'] = 'Du';
$string['commerce_sales_date_to'] = 'Au';
$string['commerce_sales_currency'] = 'Devise';
$string['commerce_sales_kpi_matches'] = 'Ventes correspondantes';
$string['commerce_sales_kpi_revenue'] = 'Chiffre d’affaires encaissé';
$string['commerce_sales_kpi_delivered'] = 'Ventes délivrées';
$string['commerce_sales_kpi_pending'] = 'En attente';
$string['commerce_sales_kpi_failed'] = 'Échouées / annulées';
$string['commerce_sales_kpi_invalid_checkouts'] = 'Checkouts invalides';
$string['commerce_sales_kpi_invalid_current'] = 'Situation actuelle';
$string['commerce_sales_found'] = '{$a} ventes trouvées';
$string['commerce_sales_per_page'] = 'Par page';

$string['commerce_sales_product_type'] = 'Type de produit';
$string['commerce_sales_columns'] = 'Colonnes';
$string['commerce_sales_export'] = 'Exporter';
$string['commerce_sales_apply_columns'] = 'Appliquer';
$string['commerce_sales_more_actions'] = 'Plus d’actions';
$string['commerce_sales_sort_by'] = 'Trier par {$a->column} ({$a->direction})';
$string['commerce_sales_sort_ascending'] = 'ordre croissant';
$string['commerce_sales_sort_descending'] = 'ordre décroissant';
$string['commerce_purchase_payment_status_redirected'] = 'Redirigé vers le paiement';
$string['commerce_purchase_payment_status_unknown'] = 'Inconnu';
$string['commerce_purchase_fulfillment_status_planned'] = 'Planifiée';
$string['commerce_purchase_fulfillment_status_skipped'] = 'Ignorée';

$string['commerce_purchase_payment_status_requires_action'] = 'Action requise';
$string['commerce_purchase_payment_status_open'] = 'Ouvert';
$string['commerce_purchase_payment_status_complete'] = 'Terminé';
$string['commerce_purchase_payment_status_captured'] = 'Encaissé';
$string['commerce_purchase_payment_status_authorized'] = 'Autorisé';
$string['commerce_purchase_payment_status_payment_pending'] = 'Paiement en attente';
$string['commerce_purchase_fulfillment_status_success'] = 'Réussi';
$string['commerce_purchase_fulfillment_status_succeeded'] = 'Réussi';
$string['commerce_purchase_fulfillment_status_cancelled'] = 'Annulée';
$string['commerce_purchase_fulfillment_status_canceled'] = 'Annulée';

$string['commerce_sales_origin'] = 'Origine';
$string['commerce_sales_origin_personal_offer'] = 'Offre personnelle';
$string['commerce_sales_origin_standard'] = 'Vente standard';
$string['commerce_sales_personal_offer_badge'] = 'Offre personnelle';
$string['commerce_sales_kpi_personal_offers'] = 'Offres personnelles';

$string['commerce_sales_filters_toggle'] = 'Recherche et filtres';
$string['commerce_sales_filters_active'] = 'Filtres actifs';
$string['commerce_sales_filters_collapsed_hint'] = 'Cliquer pour ouvrir';

$string['commerce_mail_admin_description_n41'] = 'Supervision des communications e-mail Commerce, journal des envois et état du moteur.';
$string['commerce_mail_nav_label'] = 'Navigation E-mails Commerce';
$string['commerce_mail_nav_journal'] = 'Journal des e-mails';
$string['commerce_mail_nav_templates'] = 'Modèles d’e-mails';
$string['commerce_mail_nav_campaigns'] = 'Campagnes';
$string['commerce_mail_health_operational'] = 'Mail Engine opérationnel';
$string['commerce_mail_health_operational_subtitle'] = 'Moteur transactionnel opérationnel et contrôlé.';
$string['commerce_mail_health_diagnostic'] = 'Voir le diagnostic';
$string['commerce_mail_period'] = 'Période';
$string['commerce_mail_period_today'] = 'Aujourd’hui';
$string['commerce_mail_period_7'] = '7 derniers jours';
$string['commerce_mail_period_30'] = '30 derniers jours';
$string['commerce_mail_period_90'] = '90 derniers jours';
$string['commerce_mail_period_365'] = '1 an';
$string['commerce_mail_period_all'] = 'Toute la période';
$string['commerce_mail_period_custom'] = 'Personnalisée';
$string['commerce_mail_search_placeholder_n41'] = 'Destinataire, e-mail, ID commande, clé d’idempotence…';
$string['commerce_mail_attempts_min'] = 'Tentatives minimum';
$string['commerce_mail_date_from'] = 'Du';
$string['commerce_mail_date_to'] = 'Au';
$string['commerce_mail_more_filters'] = 'Plus de filtres';
$string['commerce_mail_columns'] = 'Colonnes';
$string['commerce_mail_columns_apply'] = 'Appliquer';
$string['commerce_mail_export'] = 'Exporter';
$string['commerce_mail_filters_title'] = 'Recherche et filtres';
$string['commerce_mail_filters_active'] = 'Filtres actifs';
$string['commerce_mail_kpi_total'] = 'E-mails';
$string['commerce_mail_kpi_period'] = 'Sur la période sélectionnée';
$string['commerce_mail_kpi_sent'] = 'Envoyés';
$string['commerce_mail_kpi_pending'] = 'En attente';
$string['commerce_mail_kpi_failed'] = 'Échecs';
$string['commerce_mail_kpi_campaigns'] = 'Campagnes actives';
$string['commerce_mail_kpi_campaigns_help'] = 'Brouillons / en cours';
$string['commerce_mail_kpi_templates_review'] = 'Modèles à vérifier';
$string['commerce_mail_kpi_templates_review_help'] = 'Modèles désactivés';
$string['commerce_mail_recipient_column'] = 'Destinataire';
$string['commerce_mail_context_column'] = 'Contexte';
$string['commerce_mail_last_error'] = 'Dernière erreur';
$string['commerce_mail_context_personal_offer'] = 'Offre personnelle';
$string['commerce_mail_context_order'] = 'Commande #{$a}';
$string['commerce_mail_action_preview'] = 'Prévisualiser';
$string['commerce_mail_action_open_order'] = 'Ouvrir la commande';
$string['commerce_mail_action_open_context'] = 'Ouvrir l’offre / campagne';
$string['commerce_mail_more_actions'] = 'Plus d’actions';
$string['commerce_mail_found'] = '{$a} e-mails trouvés';
$string['commerce_mail_per_page'] = 'Par page';

// Commerce 7.95N4.2 — mail journal operational polish.
$string['commerce_mail_search_placeholder_n42'] = 'Destinataire, e-mail, commande, produit, campagne…';
$string['commerce_mail_send_now'] = 'Envoyer maintenant';
$string['commerce_mail_send_now_success'] = 'L’e-mail a été envoyé immédiatement.';
$string['commerce_mail_send_now_failed'] = 'L’envoi immédiat n’a pas pu aboutir. Vérifiez le statut et le détail de l’erreur.';
$string['commerce_mail_send_now_not_allowed'] = 'Seul un e-mail actuellement en attente peut être envoyé immédiatement.';
$string['commerce_mail_health_compact_ok'] = 'Moteur OK';
$string['commerce_mail_health_compact_issues'] = '{$a->warnings} alertes · {$a->errors} erreurs';
$string['commerce_mail_technical_details'] = 'Détails techniques';
$string['commerce_mail_internal_id'] = 'ID de l’e-mail';
$string['commerce_mail_idempotency_key'] = 'Clé d’idempotence';

$string['commerce_mail_include_audit'] = 'Afficher les mails d’AUDIT';
$string['commerce_mail_kpi_offers_sent'] = 'Offres envoyées';
$string['commerce_mail_kpi_offers_pending'] = 'Offres en attente';
$string['commerce_mail_kpi_sent_last_hour'] = 'Envoyés dernière heure';
$string['commerce_mail_kpi_last_check'] = 'Dernier contrôle : {$a}';
$string['commerce_mail_kpi_last_check_never'] = 'Dernier contrôle : jamais';
$string['commerce_mail_kpi_smtp_load_help'] = 'Charge SMTP hors audit';

$string['commerce_mail_nav_configuration'] = 'Configuration';
$string['commerce_mail_configuration_title'] = 'Configuration des e-mails';
$string['commerce_mail_configuration_description'] = 'Pilotez les workers d’envoi, le débit SMTP et les limites de traitement du Mail Engine.';
$string['commerce_mail_configuration_saved'] = 'Configuration du Mail Engine enregistrée.';
$string['commerce_mail_configuration_smtp_title'] = 'Protection du débit SMTP';
$string['commerce_mail_configuration_smtp_help'] = 'Définissez un garde-fou commun à tous les e-mails Commerce. Le plafond global s’applique aux e-mails transactionnels, aux offres personnelles et aux copies d’audit.';
$string['commerce_mail_configuration_sent_last_hour'] = 'e-mails envoyés sur la dernière heure';
$string['commerce_mail_configuration_global_hourly'] = 'Plafond SMTP global / heure';
$string['commerce_mail_configuration_global_hourly_help'] = '0 = illimité. Lorsqu’il est défini, aucun worker Commerce ne peut dépasser ce plafond cumulé sur une fenêtre glissante d’une heure.';
$string['commerce_mail_configuration_workers_title'] = 'Workers d’envoi';
$string['commerce_mail_configuration_workers_help'] = 'Les interrupteurs ci-dessous activent ou suspendent fonctionnellement le traitement. Les tâches Moodle restent planifiées afin de pouvoir être réactivées instantanément.';
$string['commerce_mail_configuration_transactional_title'] = 'E-mails transactionnels';
$string['commerce_mail_configuration_transactional_description'] = 'Confirmations, accès, paiements et autres messages prioritaires envoyés aux clients.';
$string['commerce_mail_configuration_personal_title'] = 'Offres personnelles';
$string['commerce_mail_configuration_personal_description'] = 'Worker dédié aux campagnes d’offres personnelles avec limitation spécifique du débit.';
$string['commerce_mail_configuration_audit_title'] = 'Copies d’audit';
$string['commerce_mail_configuration_audit_description'] = 'Copies techniques de faible priorité, traitées uniquement lorsqu’aucun e-mail client prioritaire n’attend.';
$string['commerce_mail_configuration_processing_enabled'] = 'Traitement activé';
$string['commerce_mail_configuration_processing_enabled_help'] = 'Désactiver suspend les envois de ce worker sans modifier la planification de la tâche Moodle.';
$string['commerce_mail_configuration_batch_size'] = 'E-mails par batch';
$string['commerce_mail_configuration_hourly_limit'] = 'Plafond par heure';
$string['commerce_mail_configuration_hourly_zero_help'] = '0 = aucune limite horaire spécifique pour ce worker. Le plafond SMTP global reste applicable s’il est défini.';
$string['commerce_mail_configuration_transactional_batch_help'] = 'Nombre maximal d’e-mails transactionnels traités à chaque passage du worker.';
$string['commerce_mail_configuration_personal_batch_help'] = 'Nombre maximal d’e-mails d’offres personnelles traités à chaque passage.';
$string['commerce_mail_configuration_personal_hourly_help'] = 'Plafond spécifique aux offres personnelles sur une fenêtre glissante d’une heure.';
$string['commerce_mail_configuration_audit_batch_help'] = 'Nombre maximal de copies d’audit traitées à chaque passage.';
$string['commerce_mail_configuration_audit_hourly_help'] = 'Plafond spécifique aux copies d’audit sur une fenêtre glissante d’une heure.';
$string['commerce_mail_configuration_task_active'] = 'Tâche Moodle active';
$string['commerce_mail_configuration_task_disabled'] = 'Tâche Moodle désactivée';
$string['commerce_mail_configuration_task_missing'] = 'Tâche Moodle introuvable';
$string['commerce_mail_configuration_last_run'] = 'Dernier passage : {$a}';
$string['commerce_mail_configuration_next_run'] = 'Prochain passage : {$a}';
$string['commerce_mail_configuration_cron_note'] = 'Les interrupteurs Commerce ne modifient pas l’expression cron Moodle. La planification système reste administrable depuis les tâches planifiées Moodle.';
$string['commerce_mail_configuration_open_scheduled_tasks'] = 'Ouvrir les tâches planifiées';

$string['commerce_mail_library_description'] = 'Bibliothèque unifiée des modèles CampusFR : marketing, transactionnels, offres personnelles, relances commerciales et système.';
$string['commerce_mail_library_heading'] = 'Mail Studio · Bibliothèque de modèles';
$string['commerce_mail_library_help'] = 'Créez, classez, dupliquez, exportez et importez les modèles qui seront progressivement utilisés par les campagnes et les e-mails transactionnels.';
$string['commerce_mail_library_new'] = 'Nouveau modèle';
$string['commerce_mail_library_import'] = 'Importer';
$string['commerce_mail_library_export'] = 'Exporter';
$string['commerce_mail_library_category'] = 'Catégorie';
$string['commerce_mail_library_category_marketing'] = 'Marketing';
$string['commerce_mail_library_category_transactional'] = 'Transactionnel';
$string['commerce_mail_library_category_personal_offer'] = 'Offre personnelle';
$string['commerce_mail_library_category_system'] = 'Système';
$string['commerce_mail_library_status_draft'] = 'Brouillon';
$string['commerce_mail_library_status_active'] = 'Actif';
$string['commerce_mail_library_status_archived'] = 'Archivé';
$string['commerce_mail_library_runtime_live'] = 'Utilisé en production';
$string['commerce_mail_library_modified'] = 'Modifié {$a}';
$string['commerce_mail_library_native_title'] = 'Modèles Mail Studio';
$string['commerce_mail_library_runtime_title'] = 'Modèles transactionnels actuels';
$string['commerce_mail_library_runtime_help'] = 'Ces modèles alimentent encore directement le moteur transactionnel actuel. Ils sont visibles dans la bibliothèque via un adaptateur et peuvent déjà être exportés au format Mail Studio.';
$string['commerce_mail_library_transactional_bridge_help'] = 'Modèle transactionnel actuel · {$a} langue(s) personnalisée(s), les autres utilisent le contenu par défaut.';
$string['commerce_mail_library_edit_transactional'] = 'Modifier les langues';
$string['commerce_mail_library_empty'] = 'Aucun modèle ne correspond à ces filtres.';
$string['commerce_mail_library_archive'] = 'Archiver';
$string['commerce_mail_library_archive_confirm'] = 'Archiver ce modèle ? Il restera disponible dans la bibliothèque mais ne sera plus considéré comme actif.';
$string['commerce_mail_library_duplicated'] = 'Le modèle a été dupliqué en brouillon.';
$string['commerce_mail_library_archived'] = 'Le modèle a été archivé.';
$string['commerce_mail_library_copy_suffix'] = 'Copie';
$string['commerce_mail_library_create_title'] = 'Créer un modèle';
$string['commerce_mail_library_edit_title'] = 'Modifier « {$a} »';
$string['commerce_mail_library_edit_description'] = 'Modifiez le contenu du modèle dans Mail Studio et conservez une structure réutilisable, traduisible et portable.';
$string['commerce_mail_library_name'] = 'Nom interne du modèle';
$string['commerce_mail_library_body'] = 'Corps HTML';
$string['commerce_mail_library_language_optional'] = 'Langue facultative';
$string['commerce_mail_library_foundation_note'] = 'Ce modèle est stocké dans la bibliothèque Mail Studio. Son utilisation dépend de sa catégorie et du contexte d’envoi associé.';
$string['commerce_mail_library_import_title'] = 'Importer un modèle';
$string['commerce_mail_library_import_description'] = 'Importez un modèle CampusFR Mail Studio exporté depuis cette instance ou une autre.';
$string['commerce_mail_library_import_drop_title'] = 'Importer un fichier Mail Studio';
$string['commerce_mail_library_import_help'] = 'Fichier JSON CampusFR Mail Studio (schema campusfr-mail-template v1), 2 Mo maximum. L’import crée toujours un nouveau brouillon afin d’éviter tout remplacement accidentel.';
$string['commerce_mail_library_import_missing'] = 'Sélectionnez un fichier JSON à importer.';
$string['commerce_mail_library_import_too_large'] = 'Le fichier ne doit pas dépasser 2 Mo.';
$string['commerce_mail_library_import_success'] = 'Modèle importé en brouillon. Vous pouvez maintenant le vérifier et l’adapter.';

$string['commerce_mail_library_builder_note'] = 'Mail Studio utilise maintenant le builder commun CampusFR. Le contenu riche est édité avec TinyMCE et les tags de variables/blocs restent compatibles avec les campagnes d’offres personnelles.';
$string['commerce_mail_builder_variables'] = 'Variables';
$string['commerce_mail_builder_blocks'] = 'Blocs du Mail Builder';
$string['commerce_mail_builder_no_variables'] = 'Aucune variable disponible dans ce contexte.';
$string['commerce_mail_builder_tag_help'] = 'Cliquez sur un tag pour le copier, puis collez-le à l’endroit souhaité dans le contenu TinyMCE.';

$string['commerce_mail_library_builder_badge'] = 'Builder v{$a}';

$string['commerce_personal_offer_mailstudio_title'] = 'Mail Studio';
$string['commerce_personal_offer_mailstudio_help'] = 'Réutilisez un modèle Mail Studio ou transformez le contenu de cette campagne en modèle. Un modèle chargé est copié dans la campagne : les modifications futures du modèle ne changent jamais une campagne déjà préparée.';
$string['commerce_personal_offer_mailstudio_library'] = 'Bibliothèque de modèles';
$string['commerce_personal_offer_mailstudio_snapshot_source'] = 'Contenu initialisé depuis « {$a} » — copie indépendante';
$string['commerce_personal_offer_mailstudio_apply'] = 'Charger un modèle';
$string['commerce_personal_offer_mailstudio_apply_help'] = 'Le contenu FR/EN/RU du modèle remplace le contenu éditorial actuel de cette campagne. La destination CTA et le showroom restent inchangés.';
$string['commerce_personal_offer_mailstudio_apply_button'] = 'Charger dans la campagne';
$string['commerce_personal_offer_mailstudio_empty'] = 'Aucun modèle « Offre personnelle » n’est encore disponible dans Mail Studio.';
$string['commerce_personal_offer_mailstudio_save_as'] = 'Enregistrer cette campagne comme modèle';
$string['commerce_personal_offer_mailstudio_save_help'] = 'Crée un nouveau modèle brouillon réutilisable dans Mail Studio à partir du contenu actuel.';
$string['commerce_personal_offer_mailstudio_save_button'] = 'Créer le modèle';
$string['commerce_personal_offer_mailstudio_applied'] = 'Le modèle Mail Studio a été chargé dans la campagne.';
$string['commerce_personal_offer_mailstudio_saved'] = 'Le contenu de la campagne a été enregistré comme nouveau modèle Mail Studio.';

$string['commerce_mail_type_marketing_campaign'] = 'Campagne marketing';
$string['commerce_mail_context_marketing_campaign'] = 'Campagne marketing';
$string['task_process_marketing_mail_campaigns'] = 'Préparer les campagnes marketing programmées';
$string['task_process_marketing_mail_queue'] = 'Envoyer la file des campagnes marketing';
$string['commerce_marketing_campaigns_title'] = 'Campagnes';
$string['commerce_marketing_campaigns_description'] = 'Préparez et programmez des campagnes marketing indépendantes des offres personnelles, à partir des modèles Mail Studio.';
$string['commerce_marketing_campaign_new'] = 'Nouvelle campagne';
$string['commerce_marketing_campaign_empty'] = 'Aucune campagne marketing pour le moment.';
$string['commerce_marketing_campaign_status_draft'] = 'Brouillon';
$string['commerce_marketing_campaign_status_scheduled'] = 'Programmée';
$string['commerce_marketing_campaign_status_queued'] = 'En cours';
$string['commerce_marketing_campaign_status_completed'] = 'Terminée';
$string['commerce_marketing_campaign_status_cancelled'] = 'Annulée';
$string['commerce_marketing_campaign_schedule_summary'] = 'Programmation : {$a}';
$string['commerce_marketing_campaign_recipient_count'] = '{$a} destinataires';
$string['commerce_marketing_campaign_sent_count'] = '{$a} envoyés';
$string['commerce_marketing_campaign_failed_count'] = '{$a} échecs';
$string['commerce_marketing_campaign_edit_description'] = 'Choisissez un modèle Marketing, figez votre audience et programmez l’envoi. Le contenu du modèle est copié dans la campagne au moment de l’enregistrement.';
$string['commerce_marketing_campaign_name'] = 'Nom de la campagne';
$string['commerce_marketing_campaign_template'] = 'Modèle Mail Studio';
$string['commerce_marketing_campaign_cta_url'] = 'Destination des CTA';
$string['commerce_marketing_campaign_cta_help'] = 'Les blocs {{cta|…}} du modèle utiliseront cette URL. Laissez vide pour retirer les CTA au rendu.';
$string['commerce_marketing_campaign_schedule'] = 'Date et heure d’envoi';
$string['commerce_marketing_campaign_audience'] = 'Audience';
$string['commerce_marketing_campaign_audience_help'] = 'Une ligne par destinataire : email;prénom;nom;langue. Le prénom, le nom et la langue peuvent être omis si un compte Moodle correspondant existe.';
$string['commerce_marketing_campaign_schedule_button'] = 'Programmer la campagne';
$string['commerce_marketing_campaign_saved'] = 'Campagne marketing enregistrée en brouillon.';
$string['commerce_marketing_campaign_scheduled'] = 'Campagne marketing programmée.';
$string['commerce_marketing_campaign_locked'] = 'Campagne figée : {$a->total} destinataires · {$a->sent} envoyés · {$a->failed} échecs.';
$string['commerce_mail_configuration_marketing_title'] = 'Campagnes marketing';
$string['commerce_mail_configuration_marketing_description'] = 'Envois marketing génériques créés depuis Mail Studio, indépendamment des offres personnelles.';
$string['commerce_mail_configuration_marketing_batch_help'] = 'Nombre maximal d’e-mails marketing traités à chaque passage du worker.';
$string['commerce_mail_configuration_marketing_hourly_help'] = 'Plafond spécifique aux campagnes marketing sur une fenêtre glissante d’une heure. 0 = illimité.';

$string['commerce_mail_transactional_runtime_mailstudio'] = 'Mail Studio actif';
$string['commerce_mail_transactional_runtime_legacy'] = 'Runtime Legacy';
$string['commerce_mail_transactional_migrate'] = 'Migrer vers Mail Studio';
$string['commerce_mail_transactional_edit_mailstudio'] = 'Modifier dans Mail Studio';
$string['commerce_mail_transactional_edit_legacy'] = 'Éditeur Legacy';
$string['commerce_mail_transactional_migrated'] = 'Le modèle transactionnel est maintenant piloté par Mail Studio.';
$string['commerce_mail_transactional_builder_note'] = 'Ce modèle transactionnel conserve la structure dynamique du mail (commande, accès, boutons métier). Mail Studio pilote uniquement l’enveloppe éditoriale : sujet, préheader, titre, introduction, conclusion et signature.';
$string['commerce_mail_transactional_headerimage_compatibility'] = 'Les images d’en-tête des modèles transactionnels migrés sont stockées dans Mail Studio. L’ancien éditeur reste uniquement un point de compatibilité pour les modèles non encore migrés.';

$string['commerce_mail_transactional_migrate_all'] = 'Migrer tous les transactionnels vers Mail Studio';
$string['commerce_mail_transactional_migrate_all_confirm'] = 'Migrer tous les modèles transactionnels encore Legacy vers Mail Studio ? Les modèles déjà migrés ne seront pas modifiés.';
$string['commerce_mail_transactional_migrate_all_done'] = 'Migration terminée : {$a->migrated} modèle(s) migré(s), {$a->already} déjà dans Mail Studio.';

$string['commerce_mail_configuration_legacy_title'] = 'Envois automatiques historiques';
$string['commerce_mail_configuration_legacy_help'] = 'Ces e-mails appartiennent à l’ancien moteur et sont distincts du Mail Engine moderne. Ils sont désactivés par défaut afin d’éviter toute relance historique non désirée.';
$string['commerce_mail_configuration_legacy_warning_title'] = 'Zone Legacy — prudence';
$string['commerce_mail_configuration_legacy_warning'] = 'Laisser cette zone désactivée est recommandé. Les crons continuent leurs traitements métier (expiration d’un paiement, activation ou expiration d’un accès) sans envoyer les anciens e-mails.';
$string['commerce_mail_configuration_legacy_master'] = 'Autoriser les e-mails automatiques Legacy';
$string['commerce_mail_configuration_legacy_master_help'] = 'Interrupteur général. Tant qu’il est désactivé, aucun des trois canaux ci-dessous ne peut envoyer d’e-mail, même si sa case individuelle est cochée.';
$string['commerce_mail_configuration_legacy_payment_reminders'] = 'Rappels de paiement historiques';
$string['commerce_mail_configuration_legacy_payment_reminders_help'] = 'Autorise T_REMINDER_FIRST et T_REMINDER_SECOND depuis followup_task. L’expiration technique des demandes de paiement continue même lorsque ces rappels sont désactivés.';
$string['commerce_mail_configuration_legacy_expiry_reminders'] = 'Rappels avant expiration d’abonnement';
$string['commerce_mail_configuration_legacy_expiry_reminders_help'] = 'Autorise T_SUBSCRIPTION_EXPIRY_REM depuis send_expiry_reminders_task.';
$string['commerce_mail_configuration_legacy_lifecycle'] = 'Notifications d’activation / expiration historiques';
$string['commerce_mail_configuration_legacy_lifecycle_help'] = 'Autorise T_SUBSCRIPTION_ACTIVATED et T_SUBSCRIPTION_EXPIRED depuis le cron de cycle de vie. Les changements d’accès continuent sans ces e-mails.';
$string['commerce_mail_configuration_legacy_task_followup'] = 'Cron suivi des paiements';
$string['commerce_mail_configuration_legacy_task_expiry'] = 'Cron rappels d’expiration';
$string['commerce_mail_configuration_legacy_task_lifecycle'] = 'Cron cycle de vie des abonnements';

$string['commerce_mail_library_delete'] = 'Supprimer';
$string['commerce_mail_library_delete_confirm'] = 'Supprimer définitivement ce modèle Mail Studio archivé ? Cette action est irréversible.';
$string['commerce_mail_library_deleted'] = 'Le modèle Mail Studio a été supprimé définitivement.';
$string['commerce_mail_library_delete_in_use'] = 'Ce modèle ne peut pas être supprimé : il est encore référencé par {$a} campagne(s) marketing. L’historique des campagnes doit rester intact.';

$string['commerce_mail_library_category_sales_followup'] = 'Relances commerciales';
$string['commerce_mail_type_sales_followup'] = 'Relance commerciale';
$string['commerce_sales_followup_action'] = 'Relancer par e-mail';
$string['commerce_sales_followup_title'] = 'Relance commerciale';
$string['commerce_sales_followup_description'] = 'Préparez un e-mail depuis Mail Studio, adaptez-le au contexte de la vente, prévisualisez-le puis décidez explicitement de l’envoyer.';
$string['commerce_sales_followup_not_eligible'] = 'Cette vente n’est plus éligible à une relance commerciale. Son paiement a peut-être été finalisé ou aucun e-mail client exploitable n’est disponible.';
$string['commerce_sales_followup_invalid_template'] = 'Le modèle de relance sélectionné n’est pas disponible.';
$string['commerce_sales_followup_no_templates'] = 'Aucun modèle de relance commerciale n’est disponible dans Mail Studio.';
$string['commerce_sales_followup_context_title'] = 'Contexte de la vente';
$string['commerce_sales_followup_customer'] = 'Client';
$string['commerce_sales_followup_order'] = 'Commande';
$string['commerce_sales_followup_product'] = 'Produit';
$string['commerce_sales_followup_amount'] = 'Montant';
$string['commerce_sales_followup_payment_status'] = 'Paiement';
$string['commerce_sales_followup_language'] = 'Langue';
$string['commerce_sales_followup_template'] = 'Modèle Mail Studio';
$string['commerce_sales_followup_load_template'] = 'Charger le modèle';
$string['commerce_sales_followup_preview'] = 'Prévisualiser';
$string['commerce_sales_followup_preview_title'] = 'Aperçu du message';
$string['commerce_sales_followup_send_now'] = 'Envoyer maintenant';
$string['commerce_sales_followup_send_confirm'] = 'Envoyer maintenant cette relance commerciale au client ? Le message sera journalisé dans le Mail Engine et lié à cette vente.';
$string['commerce_sales_followup_sent'] = 'La relance commerciale a été envoyée et journalisée.';
$string['commerce_sales_followup_send_failed'] = 'La relance a été placée dans le Mail Engine mais l’envoi immédiat n’a pas abouti. Vérifiez le détail du mail.';
$string['commerce_sales_followup_resume_payment'] = 'Finaliser mon achat';
$string['commerce_sales_followup_no_resume_url'] = 'Aucun lien de reprise de paiement fiable n’est disponible pour cette vente. Le bloc {{resume_payment}} sera simplement retiré du message.';
$string['commerce_sales_followup_previous'] = '{$a->count} relance(s) déjà créée(s) pour cette vente. Dernière : {$a->date}.';

$string['commerce_sales_followup_open_library'] = 'Ouvrir les modèles de relance dans Mail Studio';

$string['commerce_sales_actions_customer'] = 'Client';
$string['commerce_sales_actions_communication'] = 'Communication';
$string['commerce_sales_actions_commercial'] = 'Actions commerciales';
$string['commerce_sales_actions_order'] = 'Commande';
$string['commerce_sales_action_open_user360'] = 'Ouvrir User360';
$string['commerce_sales_action_resend_invoice'] = 'Renvoyer facture';
$string['commerce_sales_action_resend_invoice_help'] = 'Renvoie au client le reçu avec la facture PDF en pièce jointe.';
$string['commerce_sales_action_resend_invoice_confirm'] = 'Renvoyer maintenant au client l’e-mail de reçu avec la facture PDF jointe ?';
$string['commerce_sales_action_resend_access'] = 'Renvoyer les accès';
$string['commerce_sales_action_create_offer'] = 'Créer une offre personnelle';

$string['commerce_sales_subnav_label'] = 'Navigation des ventes';
$string['commerce_sales_subnav_sales'] = 'Ventes';
$string['commerce_sales_subnav_unfinished'] = 'Checkouts inachevés';
$string['commerce_sales_adminstate'] = 'État administratif';
$string['commerce_sales_adminstate_open'] = 'Ventes actives';
$string['commerce_sales_adminstate_closed'] = 'Ventes clôturées';
$string['commerce_sales_adminstate_all'] = 'Toutes les ventes';
$string['commerce_sales_admin_closed_badge'] = 'Clôturée';
$string['commerce_sales_actions_administration'] = 'Administration';
$string['commerce_sales_action_view_details'] = 'Voir les détails';
$string['commerce_sales_action_close'] = 'Clôturer la vente';
$string['commerce_sales_action_close_confirm'] = 'Clôturer administrativement cette vente ? Elle restera dans l’historique mais sera masquée de la liste par défaut.';
$string['commerce_sales_action_reopen'] = 'Rouvrir la vente';
$string['commerce_sales_close_not_allowed'] = 'Cette vente ne peut pas être clôturée manuellement. Seules les ventes en échec/annulées ou en attente depuis au moins 24 heures sont éligibles.';
$string['commerce_sales_close_default_reason'] = 'Clôture manuelle depuis le CRM';
$string['commerce_sales_closed_success'] = 'La vente a été clôturée administrativement.';
$string['commerce_sales_reopened_success'] = 'La vente a été rouverte et réapparaît dans les ventes actives.';
$string['commerce_guest_crm_search_placeholder'] = 'E-mail, client, référence de commande ou produit…';
$string['commerce_guest_crm_filter_status'] = 'Situation';
$string['commerce_guest_crm_kpi_total'] = 'À examiner';
$string['commerce_guest_crm_kpi_pending'] = 'Achat en attente';
$string['commerce_guest_crm_kpi_multiple'] = 'Plusieurs achats';
$string['commerce_guest_crm_kpi_provider_paid'] = 'Payé chez le provider';
$string['commerce_guest_crm_kpi_provisional'] = 'Sans achat';
$string['commerce_guest_crm_column_client'] = 'Client';
$string['commerce_guest_crm_column_checkout'] = 'Checkout';
$string['commerce_guest_crm_column_purchase'] = 'Achat / produit';
$string['commerce_guest_crm_column_payment'] = 'Paiement';
$string['commerce_guest_crm_column_status'] = 'Situation';
$string['commerce_guest_crm_column_age'] = 'Ancienneté';
$string['commerce_guest_crm_age_minutes'] = '{$a} min';
$string['commerce_guest_crm_age_hours'] = '{$a} h';
$string['commerce_guest_crm_age_days'] = '{$a} j';

$string['commerce_sales_closed_banner'] = 'Cette vente a été clôturée administrativement le {$a}. Elle reste disponible dans l’historique.';

$string['commerce_mail_library_subject'] = 'Sujet';

$string['commerce_sales_action_view_customer_order'] = 'Voir la page client';
$string['commerce_order_details_back_to_sales'] = 'Retour vers les ventes';
$string['commerce_mail_actions_message'] = 'Message';
$string['commerce_mail_actions_delivery'] = 'Envoi';
$string['commerce_mail_actions_context'] = 'Contexte';

$string['commerce_mail_filters_collapsed_hint'] = 'Cliquer pour ouvrir';

$string['commerce_guest_crm_search_filters_title'] = 'Recherche et filtres';
$string['commerce_guest_crm_account_id'] = 'Compte #{$a}';
$string['commerce_guest_crm_checkout_id'] = 'Session de paiement #{$a}';
$string['commerce_guest_crm_unknown_product'] = 'Produit non identifié';
$string['commerce_guest_crm_resume_active'] = 'Reprise de paiement active';
$string['commerce_guest_crm_provider_state'] = 'État fournisseur : {$a}';
$string['commerce_guest_crm_provider_status_open'] = 'Ouvert';
$string['commerce_guest_crm_provider_status_unpaid'] = 'Non payé';
$string['commerce_guest_crm_provider_status_open_unpaid'] = 'Ouvert · non payé';
$string['commerce_guest_crm_provider_status_paid'] = 'Payé';
$string['commerce_guest_crm_provider_status_succeeded'] = 'Payé';
$string['commerce_guest_crm_provider_status_pending'] = 'En attente';
$string['commerce_guest_crm_provider_status_authorized'] = 'Autorisé';
$string['commerce_guest_crm_provider_status_declined'] = 'Refusé';
$string['commerce_guest_crm_provider_status_cancelled'] = 'Annulé';
$string['commerce_guest_crm_provider_status_canceled'] = 'Annulé';
$string['commerce_guest_crm_provider_status_failed'] = 'Échec';
$string['commerce_guest_crm_provider_status_error'] = 'Erreur';
$string['commerce_guest_crm_provider_status_expired'] = 'Expiré';
$string['commerce_guest_crm_help_legend_title'] = 'Comprendre les checkouts inachevés';
$string['commerce_guest_crm_help_legend_hint'] = 'Cliquer pour afficher la légende';
$string['commerce_guest_crm_help_checkout_title'] = 'Checkout inachevé';
$string['commerce_guest_crm_help_checkout_text'] = 'Le client a commencé un parcours de paiement mais celui-ci n’a pas encore abouti à une vente finalisée. Cela ne signifie pas forcément que le paiement a échoué.';
$string['commerce_guest_crm_help_resume_title'] = 'Reprise de paiement active';
$string['commerce_guest_crm_help_resume_text'] = 'Ce badge indique quel achat est actuellement relié à la session de reprise du paiement. C’est celui que le client retrouvera s’il reprend son checkout.';
$string['commerce_guest_crm_help_provider_title'] = 'Fournisseur de paiement';
$string['commerce_guest_crm_help_provider_text'] = 'Le logo indique le fournisseur utilisé. L’état affiché à côté correspond à notre suivi Commerce ; lorsqu’une vérification fournisseur a été faite, son résultat est indiqué en dessous.';
$string['commerce_guest_crm_help_situations_title'] = 'Situation';
$string['commerce_guest_crm_help_situations_text'] = 'La situation synthétise le problème principal : paiement en attente, plusieurs achats concurrents, paiement confirmé chez le fournisseur mais encore en attente chez CampusFR, identité bloquée ou checkout sans achat.';

$string['commerce_result_scope_label'] = 'Périmètre';
$string['commerce_result_scope_period_all'] = 'Période : toutes les dates';
$string['commerce_result_scope_period_range'] = 'Période : {$a->from} → {$a->to}';
$string['commerce_result_scope_period_named'] = 'Période : {$a}';
$string['commerce_result_scope_search'] = 'Recherche : {$a}';
$string['commerce_result_scope_product_type'] = 'Type : {$a}';
$string['commerce_result_scope_commercial_status'] = 'Statut : {$a}';
$string['commerce_result_scope_provider'] = 'Fournisseur : {$a}';
$string['commerce_result_scope_currency'] = 'Devise : {$a}';
$string['commerce_result_scope_origin'] = 'Origine : {$a}';
$string['commerce_result_scope_payment'] = 'Paiement : {$a}';
$string['commerce_result_scope_fulfillment'] = 'Délivrance : {$a}';
$string['commerce_result_scope_admin_state'] = 'État : {$a}';
$string['commerce_result_scope_mail_type'] = 'Type : {$a}';
$string['commerce_result_scope_mail_status'] = 'Statut : {$a}';
$string['commerce_result_scope_language'] = 'Langue : {$a}';
$string['commerce_result_scope_purchase'] = 'Commande #{$a}';
$string['commerce_result_scope_attempts'] = 'Tentatives ≥ {$a}';
$string['commerce_result_scope_audit_excluded'] = 'AUDIT exclus';
$string['commerce_result_scope_audit_included'] = 'AUDIT inclus';
$string['commerce_result_scope_remove_filter'] = 'Retirer ce filtre';
$string['commerce_result_scope_remove_filter_named'] = 'Retirer le filtre « {$a} »';

$string['commerce_filters_apply'] = 'Appliquer';

// Commerce N7.1 — espace unifié Offres & accès.
$string['crm_commerce_nav_offers_access'] = 'Offres & accès';
$string['commerce_offers_access_title'] = 'Offres & accès';
$string['commerce_offers_access_description'] = 'Gérez les offres préférentielles et les accès accordés directement aux clients.';
$string['commerce_offers_access_tab_overview'] = 'Vue d’ensemble';
$string['commerce_offers_access_tab_offers'] = 'Offres personnelles';
$string['commerce_offers_access_tab_grants'] = 'Attributions';
$string['commerce_offers_access_tab_campaigns'] = 'Campagnes';
$string['commerce_offers_access_question'] = 'Que souhaitez-vous faire ?';
$string['commerce_offers_access_offer_title'] = 'Proposer une offre';
$string['commerce_offers_access_offer_description'] = 'Proposer un tarif préférentiel à un ou plusieurs clients.';
$string['commerce_offers_access_offer_action'] = 'Créer une offre';
$string['commerce_offers_access_grant_title'] = 'Donner un accès';
$string['commerce_offers_access_grant_description'] = 'Donner directement accès à un produit ou un cours.';
$string['commerce_offers_access_grant_action'] = 'Attribuer un accès';
$string['commerce_offers_access_beneficiary_hint'] = 'Les bénéficiaires — un client ou plusieurs — seront choisis à l’étape suivante.';
$string['commerce_offers_access_kpi_active_offers'] = 'Offres actives';
$string['commerce_offers_access_kpi_used_offers'] = 'Offres utilisées';
$string['commerce_offers_access_kpi_grants'] = 'Accès accordés';
$string['commerce_offers_access_kpi_campaigns'] = 'Campagnes actives';
$string['commerce_offers_access_kpi_pending'] = 'En attente';
$string['commerce_offers_access_kpi_attention'] = 'À vérifier';
$string['commerce_offers_access_kpi_now'] = 'actuellement';
$string['commerce_offers_access_kpi_total'] = 'au total';
$string['commerce_offers_access_kpi_active'] = 'en cours';
$string['commerce_offers_access_kpi_to_process'] = 'à traiter';
$string['commerce_offers_access_kpi_to_check'] = 'nécessite une action';
$string['commerce_offers_access_recent_title'] = 'Activité récente';
$string['commerce_offers_access_recent_hint'] = 'Les dernières offres et attributions apparaîtront ici dans une prochaine étape du chantier.';
$string['commerce_offers_access_view_all'] = 'Voir toutes les campagnes';
$string['commerce_offers_access_campaigns_title'] = 'Campagnes';
$string['commerce_offers_access_campaigns_description'] = 'Préparez et suivez les opérations destinées à plusieurs clients.';
$string['commerce_offers_access_new_offer_campaign'] = 'Nouvelle campagne d’offres';
$string['commerce_offers_access_new_grant_campaign'] = 'Nouvelle campagne d’attribution';
$string['commerce_offers_access_campaign_action'] = 'Action';
$string['commerce_offers_access_campaign_audience'] = 'Audience';
$string['commerce_offers_access_campaign_progress'] = 'Progression';
$string['commerce_offers_access_kind_offer'] = 'Offre personnelle';
$string['commerce_offers_access_kind_grant'] = 'Attribution';
$string['commerce_offers_access_campaigns_empty'] = 'Aucune campagne pour le moment.';

$string['commerce_offers_access_create_title'] = 'Nouvelle action';
$string['commerce_offers_access_create_description'] = 'Choisissez d’abord ce que vous souhaitez accorder. Le type de bénéficiaires sera sélectionné à l’étape suivante.';
$string['commerce_offers_access_create_audience_title'] = 'Choisir les bénéficiaires';
$string['commerce_offers_access_create_audience_description'] = 'Indiquez si l’action concerne un seul client ou une population de clients.';
$string['commerce_offers_access_create_question'] = 'Que souhaitez-vous faire ?';
$string['commerce_offers_access_create_offer'] = 'Proposer une offre';
$string['commerce_offers_access_create_offer_help'] = 'Accorder un tarif ou des conditions préférentielles sans donner immédiatement l’accès.';
$string['commerce_offers_access_create_grant'] = 'Donner un accès';
$string['commerce_offers_access_create_grant_help'] = 'Accorder directement un produit ou un cours, indépendamment d’une vente.';
$string['commerce_offers_access_create_continue'] = 'Continuer';
$string['commerce_offers_access_create_selected_action'] = 'Action sélectionnée';
$string['commerce_offers_access_create_who'] = 'À qui souhaitez-vous l’accorder ?';
$string['commerce_offers_access_create_one'] = 'Un client';
$string['commerce_offers_access_create_one_help'] = 'Rechercher ou sélectionner une personne, puis configurer précisément l’offre ou l’accès.';
$string['commerce_offers_access_create_many'] = 'Plusieurs clients';
$string['commerce_offers_access_create_many_help'] = 'Définir une audience, la simuler puis figer les bénéficiaires avant l’exécution.';
$string['commerce_offers_access_workflow_beneficiaries'] = 'Bénéficiaires';
$string['commerce_offers_access_workflow_offer'] = 'Offre';
$string['commerce_offers_access_workflow_access'] = 'Accès';
$string['commerce_offers_access_workflow_verification'] = 'Vérification';
$string['commerce_offers_access_workflow_execution'] = 'Exécution';
$string['commerce_offers_access_workflow_one'] = '1 client';
$string['commerce_offers_access_workflow_many'] = 'Plusieurs clients';
$string['commerce_offers_access_new_campaign'] = 'Nouvelle campagne';

$string['commerce_offers_access_config_identity_help'] = 'Donnez un nom clair à l’opération. Les identifiants techniques restent disponibles dans les options avancées.';
$string['commerce_offers_access_config_technical'] = 'Informations techniques';
$string['commerce_offers_access_config_optional'] = 'Optionnel · généré automatiquement si vide';
$string['commerce_offers_access_config_audience_help'] = 'Définissez simplement la population concernée. Les règles complexes restent accessibles dans les options avancées.';
$string['commerce_offers_access_config_advanced_audience'] = 'Options avancées de l’audience';
$string['commerce_offers_access_config_advanced_audience_hint'] = 'Sources supplémentaires, dates, exclusions et règles complexes';
$string['commerce_offers_access_config_offer_help'] = 'Choisissez le produit, les conditions commerciales et la durée de validité.';
$string['commerce_offers_access_config_summary_offer_campaign'] = 'Résumé de la campagne d’offres';
$string['commerce_offers_access_config_summary_offer'] = 'Résumé de l’offre';
$string['commerce_offers_access_config_summary_grant_campaign'] = 'Résumé de l’attribution';
$string['commerce_offers_access_config_not_set'] = 'À définir';
$string['commerce_offers_access_config_audience'] = 'Bénéficiaires';
$string['commerce_offers_access_config_product'] = 'Produit';
$string['commerce_offers_access_config_conditions'] = 'Conditions';
$string['commerce_offers_access_config_validity'] = 'Validité';
$string['commerce_offers_access_config_mailstudio_title'] = 'Communication';
$string['commerce_offers_access_config_mailstudio_help'] = 'La composition des e-mails reste centralisée dans Mail Studio. Le Mail Engine assurera ensuite l’envoi et la traçabilité.';
$string['commerce_offers_access_config_open_mailstudio'] = 'Ouvrir Mail Studio';
$string['commerce_offers_access_config_bulk_audience_title'] = 'Définir les bénéficiaires et l’accès';
$string['commerce_offers_access_config_bulk_audience_help'] = 'Choisissez la population source et le produit à attribuer, puis lancez une simulation avant toute modification.';
$string['commerce_offers_access_config_source'] = 'Population source';
$string['commerce_offers_access_config_mode'] = 'Mode';
$string['commerce_offers_access_config_simulation_required'] = 'Simulation à lancer';
$string['commerce_offers_access_config_open_user360'] = 'Ouvrir User360';
$string['commerce_offers_access_config_technical_evidence'] = 'Voir les détails techniques';
$string['commerce_offers_access_config_communication'] = 'Communication avec les bénéficiaires';
$string['commerce_offers_access_config_beneficiary_title'] = 'Bénéficiaire';
$string['commerce_offers_access_config_beneficiary_help'] = 'Sélectionnez la personne concernée. Les informations de rattachement restent dans les options avancées.';
$string['commerce_offers_access_config_context_title'] = 'Contexte et rattachement';
$string['commerce_offers_access_config_context_hint'] = 'Campagne, achat ou produit source · optionnel';
$string['commerce_offers_access_config_communication_hint'] = 'Image et modèle d’e-mail';
$string['commerce_offers_access_config_beneficiary'] = 'Client';
$string['commerce_offers_access_config_no_limit'] = 'Sans limite définie';

$string['commerce_offers_access_config_manual_access_title'] = 'Configurer l’accès';
$string['commerce_offers_access_config_manual_access_help'] = 'Sélectionnez le client, le produit et les paramètres d’accès. Les moteurs d’attribution existants restent inchangés.';
$string['commerce_offers_access_config_summary_grant'] = 'Résumé de l’accès';
$string['commerce_offers_access_config_choose_in_form'] = 'À choisir dans le formulaire';

$string['commerce_offers_access_campaign_step_configuration'] = 'Configuration';
$string['commerce_offers_access_campaign_step_configuration_done'] = 'Configuration prête';
$string['commerce_offers_access_campaign_step_audience'] = 'Audience';
$string['commerce_offers_access_campaign_step_audience_count'] = '{$a} bénéficiaires éligibles';
$string['commerce_offers_access_campaign_step_audience_waiting'] = 'Audience à calculer';
$string['commerce_offers_access_campaign_step_snapshot'] = 'Population figée';
$string['commerce_offers_access_campaign_step_snapshot_done'] = '{$a} bénéficiaires figés';
$string['commerce_offers_access_campaign_step_snapshot_waiting'] = 'Population à figer';
$string['commerce_offers_access_campaign_step_execution'] = 'Exécution';
$string['commerce_offers_access_campaign_step_execution_waiting'] = 'Prête à être lancée';
$string['commerce_offers_access_campaign_step_execution_running'] = '{$a} bénéficiaires traités';
$string['commerce_offers_access_campaign_step_execution_done'] = '{$a} bénéficiaires traités';
$string['commerce_offers_access_campaign_step_complete'] = 'Terminé';
$string['commerce_offers_access_campaign_step_complete_waiting'] = 'En attente de la fin de l’exécution';
$string['commerce_offers_access_campaign_step_complete_done'] = 'Campagne terminée';
$string['commerce_offers_access_campaign_step_complete_errors'] = 'Terminée avec {$a} erreur(s)';
$string['commerce_offers_access_campaign_summary_title'] = 'Résumé de la campagne';
$string['commerce_offers_access_campaign_selected'] = 'Bénéficiaires sélectionnés';
$string['commerce_offers_access_campaign_status'] = 'Statut';
$string['commerce_offers_access_campaign_communication_title'] = 'Communication';
$string['commerce_offers_access_campaign_mail_queued'] = 'En attente';
$string['commerce_offers_access_campaign_mail_sent'] = 'Envoyés';
$string['commerce_offers_access_campaign_mail_failed'] = 'Erreurs';
$string['commerce_offers_access_campaign_open_mail_journal'] = 'Voir le journal des e-mails';
$string['commerce_offers_access_campaign_member_details'] = 'Détails';

$string['commerce_offers_access_search_filters'] = 'Recherche et filtres';
$string['commerce_offers_access_period'] = 'Période';
$string['commerce_offers_access_period_7'] = '7 derniers jours';
$string['commerce_offers_access_period_30'] = '30 derniers jours';
$string['commerce_offers_access_period_90'] = '90 derniers jours';
$string['commerce_offers_access_period_365'] = '1 an';
$string['commerce_offers_access_period_all'] = 'Toutes les dates';
$string['commerce_offers_access_offers_found'] = '{$a} offres trouvées';
$string['commerce_offers_access_created'] = 'Créée';
$string['commerce_offers_access_grants_workspace_description'] = 'Consultez les accès réellement accordés aux clients et suivez leur état sans exposer les références techniques.';
$string['commerce_offers_access_grants_kpi_total'] = 'Attributions';
$string['commerce_offers_access_grants_kpi_active'] = 'Accès actifs';
$string['commerce_offers_access_grants_kpi_pending'] = 'En attente';
$string['commerce_offers_access_grants_kpi_failed'] = 'À vérifier';
$string['commerce_offers_access_grants_search_placeholder'] = 'Client, e-mail ou produit…';
$string['commerce_offers_access_grants_found'] = '{$a} attributions trouvées';
$string['commerce_offers_access_grants_empty'] = 'Aucune attribution ne correspond aux critères sélectionnés.';
$string['commerce_offers_access_grant_status_planned'] = 'En attente';
$string['commerce_offers_access_grant_status_active'] = 'Accordé';
$string['commerce_offers_access_grant_status_failed'] = 'Échec';
$string['commerce_offers_access_validity'] = 'Validité';
$string['commerce_offers_access_recent_grant_campaigns'] = 'Campagnes d’attribution récentes';
$string['commerce_offers_access_campaign_state_active'] = 'En cours';
$string['commerce_offers_access_campaign_state_completed'] = 'Terminées';
$string['commerce_offers_access_campaign_state_error'] = 'Avec erreurs';
$string['commerce_offers_access_campaign_kpi_total'] = 'Campagnes';
$string['commerce_offers_access_campaign_kpi_active'] = 'En cours';
$string['commerce_offers_access_campaign_kpi_completed'] = 'Terminées';
$string['commerce_offers_access_campaign_kpi_error'] = 'À vérifier';
$string['commerce_offers_access_campaign_search_placeholder'] = 'Nom de campagne…';
$string['commerce_offers_access_campaigns_found'] = '{$a} campagnes trouvées';

$string['commerce_personal_offer_eligibility_detail'] = 'Détail';
$string['commerce_offers_access_offer_detail_help'] = 'Consultez l’offre, son bénéficiaire, ses conditions, sa communication et son cycle de vie depuis un seul écran.';
$string['commerce_offers_access_now'] = 'Maintenant';
$string['commerce_offers_access_no_expiry'] = 'Sans expiration';
$string['commerce_offers_access_offer_mail_journal'] = 'Voir les e-mails';
$string['commerce_offers_access_open_source_sale'] = 'Ouvrir la vente source';
$string['commerce_offers_access_open_redeemed_sale'] = 'Ouvrir la vente utilisée';
$string['commerce_offers_access_open_campaign'] = 'Ouvrir la campagne';
$string['commerce_offers_access_offer_context'] = 'Origine et éligibilité';
$string['commerce_offers_access_last_mail_sent'] = 'Dernier e-mail envoyé';
$string['commerce_offers_access_management'] = 'Gestion';
$string['commerce_offers_access_grant_detail_title'] = 'Détail de l’accès';
$string['commerce_offers_access_grant_detail_help'] = 'Consultez l’accès réellement accordé, son origine, sa validité et les éléments de communication associés.';
$string['commerce_offers_access_grant_status_completed'] = 'Terminé';
$string['commerce_offers_access_grant_quantity'] = 'Quantité';
$string['commerce_offers_access_grant_access_title'] = 'Accès accordé';
$string['commerce_offers_access_grant_type'] = 'Type d’accès';
$string['commerce_offers_access_grant_no_sale'] = 'Attribution hors vente';
$string['commerce_offers_access_grant_origin_title'] = 'Origine';
$string['commerce_offers_access_grant_lifecycle_title'] = 'Cycle de vie';
$string['commerce_offers_access_grant_mail_journal'] = 'Journal des e-mails';
$string['commerce_offers_access_grant_reference'] = 'Référence de l’accès';
$string['commerce_offers_access_grant_resource'] = 'Ressource';
$string['commerce_offers_access_grant_idempotency'] = 'Clé d’idempotence';
$string['commerce_offers_access_grant_item_reference'] = 'Référence d’élément';
$string['commerce_offers_access_grant_configuration'] = 'Configuration';
$string['commerce_offers_access_grant_metadata'] = 'Métadonnées';
$string['commerce_offers_access_source_sale'] = 'Vente source';

$string['commerce_offers_access_remove_filter'] = 'Retirer ce filtre';
$string['commerce_offers_access_offers_empty_title'] = 'Aucune offre à afficher';
$string['commerce_offers_access_offers_empty_help'] = 'Aucune offre ne correspond actuellement à ce périmètre. Modifiez les filtres ou créez une nouvelle offre.';
$string['commerce_offers_access_grants_empty_title'] = 'Aucun accès à afficher';
$string['commerce_offers_access_campaigns_empty_title'] = 'Aucune campagne à afficher';
$string['commerce_offers_access_change'] = 'Modifier';

$string['commerce_offers_access_product_legacy'] = 'Legacy';
$string['commerce_personal_offer_mail_template'] = 'Modèle d’e-mail';
$string['commerce_personal_offer_mail_template_default'] = 'Modèle transactionnel par défaut';
$string['commerce_personal_offer_mail_template_help'] = 'Le modèle sélectionné est figé avec l’offre. Les modifications ultérieures dans Mail Studio ne modifieront pas cet e-mail.';
$string['commerce_personal_offer_no_expiration'] = 'Cette offre n’expire pas';
$string['commerce_personal_offer_no_expiration_help'] = 'Cochez explicitement cette option uniquement si l’offre doit rester valable sans date de fin.';
$string['commerce_personal_offer_expiration_required'] = 'Indiquez une date et une heure d’expiration, ou cochez « Cette offre n’expire pas ».';
$string['commerce_personal_offer_expiration_after_start'] = 'La date d’expiration doit être postérieure au début de validité.';

$string['commerce_personal_offer_mail_refresh_status'] = 'Rafraîchir le statut';
$string['commerce_personal_offer_mail_preview'] = 'Aperçu de l’e-mail';
$string['commerce_personal_offer_mail_preview_unavailable'] = 'L’aperçu de l’e-mail n’est pas disponible pour le moment.';
$string['commerce_personal_offer_secure_link_copy'] = 'Copier le lien';
$string['commerce_personal_offer_secure_link_copied'] = 'Copié';

$string['commerce_personal_offer_validity_mode_help'] = 'Choisissez une période avec dates précises, ou une durée calculée à partir de la création de l’offre.';
$string['commerce_offers_access_create_offer_action'] = 'Créer une offre';
$string['commerce_offers_access_menu_offer'] = 'Offre';
$string['commerce_offers_access_menu_communication'] = 'Communication';
$string['commerce_offers_access_recent_offer'] = 'Offre créée pour {$a->email} · {$a->product}';
$string['commerce_offers_access_recent_grant'] = 'Accès attribué à {$a->email} · {$a->product}';
$string['commerce_offers_access_recent_campaign'] = 'Campagne « {$a} »';
$string['commerce_personal_offer_conditions_required_help'] = 'Définissez le prix et la validité de l’offre. Ces conditions sont obligatoires.';
$string['commerce_manual_grant_page_title'] = 'Attribuer un accès';
$string['commerce_manual_grant_page_description'] = 'Attribuez manuellement un accès Legacy ou Commerce à un client, sans créer une vente.';
$string['commerce_manual_grant_beneficiary_section'] = 'Bénéficiaire';
$string['commerce_manual_grant_mode_legacy_access'] = 'Accès Legacy';
$string['commerce_manual_grant_mode_commerce_product'] = 'Produit Commerce';
$string['commerce_manual_grant_legacy_section'] = 'Accès Legacy';
$string['commerce_manual_grant_legacy_plan'] = 'Plan Legacy';
$string['commerce_manual_grant_commerce_section'] = 'Accès Commerce';
$string['commerce_manual_grant_silent_help'] = 'Si cette case est décochée, l’accès est attribué silencieusement : aucun e-mail n’est envoyé au client. Utile pour corriger un accès sans le solliciter.';
$string['commerce_manual_grant_mail_template'] = 'Modèle d’e-mail';
$string['commerce_manual_grant_mail_template_default'] = 'Modèle « Accès disponibles » par défaut';
$string['commerce_manual_grant_mail_template_help'] = 'Choisissez un modèle actif de Mail Studio. L’attribution reste indépendante du contenu du message.';
$string['commerce_bulk_grant_silent_help'] = 'Si cette case est décochée, les accès sont attribués sans envoyer d’e-mail aux bénéficiaires.';
$string['commerce_bulk_grant_mail_template'] = 'Modèle d’e-mail';
$string['commerce_bulk_grant_mail_template_default'] = 'Modèle « Accès disponibles » par défaut';
$string['commerce_bulk_grant_mail_template_help'] = 'Le modèle sélectionné est figé avec la campagne afin qu’une modification ultérieure dans Mail Studio ne change pas l’envoi.';
$string['commerce_bulk_grant_schedule_enable'] = 'Programmer l’exécution de la campagne';
$string['commerce_bulk_grant_schedule_at'] = 'Date et heure programmées';
$string['commerce_bulk_grant_schedule_timezone'] = 'Fuseau horaire : {$a}';
$string['commerce_bulk_grant_schedule_action'] = 'Programmer';
$string['commerce_bulk_grant_schedule_future_required'] = 'La date programmée doit être située dans le futur.';
$string['commerce_bulk_grant_campaign_scheduled'] = 'La campagne d’attribution a été programmée.';
$string['commerce_bulk_grant_campaign_run_now'] = 'Exécuter immédiatement';
$string['commerce_bulk_grant_campaign_run_now_done'] = 'Campagne exécutée immédiatement : {$a} bénéficiaire(s) traité(s).';
$string['commerce_offers_access_last_update'] = 'Dernière mise à jour';
$string['commerce_manual_grant_user_language'] = 'Langue du nouvel utilisateur';
$string['commerce_manual_grant_user_language_help'] = 'Cette langue sera enregistrée sur le compte et utilisée notamment pour l’e-mail d’accès. Le russe est proposé par défaut.';
$string['commerce_language_ru'] = 'Russe';
$string['commerce_language_fr'] = 'Français';
$string['commerce_language_en'] = 'Anglais';
$string['commerce_grant_menu_grant'] = 'Attribution';
$string['commerce_grant_menu_details'] = 'Voir le détail de l’attribution';
$string['commerce_grant_menu_client'] = 'Client';
$string['commerce_grant_menu_communication'] = 'Communication';
$string['commerce_grant_menu_mail_journal'] = 'Voir le journal des e-mails';
$string['commerce_bulk_grant_campaign_process_all_now'] = 'Traiter tous les bénéficiaires maintenant';
$string['commerce_grant_preview_email'] = 'Prévisualiser l’e-mail';
$string['commerce_grant_preview_email_help'] = 'La prévisualisation utilise le produit, le modèle et la langue actuellement sélectionnés.';
$string['commerce_grant_mail_preview_title'] = 'Prévisualisation de l’e-mail d’attribution';
$string['commerce_grant_mail_preview_description'] = 'Vérifiez le message qui sera envoyé lors de l’attribution. Vous pouvez changer la langue et le mode d’affichage.';
$string['commerce_grant_preview_example_product'] = 'Produit CampusFR attribué';
$string['commerce_grant_campaign_email_preview'] = 'Prévisualiser l’e-mail de la campagne';

$string['commerce_offers_access_campaign_type'] = 'Type';
$string['commerce_offers_access_campaign_processing'] = 'Traitement des bénéficiaires';
$string['commerce_offers_access_campaign_menu_campaign'] = 'CAMPAGNE';
$string['commerce_campaign_scope_type'] = 'Type : {$a}';
$string['commerce_campaign_menu_edit'] = 'Modifier la campagne';
$string['commerce_campaign_menu_email'] = 'Configurer l’e-mail';
$string['commerce_campaign_menu_preview_email'] = 'Prévisualiser l’e-mail';
$string['commerce_campaign_menu_mail_journal'] = 'Voir le journal des e-mails';
$string['commerce_campaign_beneficiaries_processed'] = '{$a->processed} / {$a->total} bénéficiaires traités';
$string['commerce_offer_campaign_secondary_counts'] = 'Déjà couverts : {$a->covered} · Identité à vérifier : {$a->identity}';
$string['commerce_offer_campaign_details'] = 'Détails';
$string['commerce_offer_campaign_view_details'] = 'Voir les détails';
$string['commerce_campaign_member_search_placeholder'] = 'Nom, prénom, e-mail ou ID Moodle';
$string['commerce_mail_context_grant_campaign'] = 'Campagne d’attribution';
$string['commerce_mail_action_open_grant_campaign'] = 'Voir la campagne d’attribution';
$string['commerce_campaign_mail_not_applicable'] = 'Non concerné';
$string['commerce_campaign_member_results'] = '{$a->visible} affiché(s) sur {$a->total}';
$string['commerce_campaign_member_per_page'] = 'Par page';

$string['commerce_manual_grant_activation_mail_title'] = 'Finalisez votre accès CampusFR';

$string['commerce_manual_grant_activation_mail_help'] = 'Votre compte vient d’être créé. Définissez votre mot de passe pour pouvoir vous connecter à CampusFR. Ce lien est personnel et temporaire.';

$string['commerce_manual_grant_activation_mail_button'] = 'Définir mon mot de passe';

$string['commerce_manual_grant_new_user_silent_warning'] = 'Pour un nouvel utilisateur, décocher l’envoi crée aussi le compte silencieusement : aucun lien de définition du mot de passe ne lui sera envoyé.';
$string['commerce_product_search_placeholder'] = 'Nom, type ou référence technique';
$string['commerce_product_validation_filter'] = 'Validation';
$string['commerce_product_filter_status_active'] = 'Actif';
$string['commerce_product_filter_status_inactive'] = 'Inactif';
$string['commerce_product_filter_status_archived'] = 'Archivé';
$string['commerce_product_filter_validation_valid'] = 'Valide';
$string['commerce_product_filter_validation_incomplete'] = 'À vérifier';
$string['commerce_product_kpi_total'] = 'Produits';
$string['commerce_product_kpi_active'] = 'Actifs';
$string['commerce_product_kpi_inactive'] = 'Inactifs';
$string['commerce_product_kpi_archived'] = 'Archivés';
$string['commerce_product_kpi_incomplete'] = 'À vérifier';
$string['commerce_products_found'] = '{$a} produits trouvés';
$string['commerce_product_scope_type'] = 'Type : {$a}';
$string['commerce_product_scope_validation'] = 'Validation : {$a}';
$string['commerce_product_scope_origin'] = 'Origine : {$a}';
$string['commerce_product_scope_currency'] = 'Monnaie : {$a}';
$string['commerce_product_menu_product'] = 'Produit';
$string['commerce_product_menu_commerce'] = 'Commerce';
$string['commerce_product_menu_sales'] = 'Voir les ventes de ce produit';
$string['commerce_product_pagination_count'] = '{$a->visible} affiché(s) sur {$a->total}';
$string['commerce_product_technical_information'] = 'Informations techniques';
$string['commerce_product_technical_sku'] = 'Référence technique';
$string['commerce_product_status_publication'] = 'Publication';
$string['commerce_product_status_publication_help'] = 'État éditorial du produit.';
$string['commerce_product_status_visibility'] = 'Visibilité';
$string['commerce_product_status_visibility_help'] = 'Présence dans les parcours et espaces Commerce.';
$string['commerce_product_status_sale'] = 'Vente';
$string['commerce_product_status_sale_help'] = 'Disponibilité actuelle à l’achat.';
$string['commerce_product_status_validation'] = 'Validation';
$string['commerce_product_status_validation_help'] = 'Cohérence technique de la configuration.';
$string['commerce_product_downloads_total'] = 'téléchargements';
$string['commerce_result_scope_status'] = 'Statut : {$a}';
$string['commerce_product_edit_general_title'] = 'Informations générales';
$string['commerce_product_fallback_name'] = 'Nom de secours du produit';
$string['commerce_product_fallback_name_help'] = 'Utilisé uniquement si aucune traduction exploitable n’est disponible dans la langue courante, la langue par défaut du Campus, RU, FR ou EN.';
$string['commerce_product_identity_title'] = 'Identité du produit';
$string['commerce_product_identity_editable_help'] = 'Le SKU et le type restent modifiables tant qu’aucun client n’a acheté ou reçu ce produit.';
$string['commerce_product_identity_locked_help'] = 'Le SKU et le type sont verrouillés car ce produit a déjà été consommé par au moins un client.';
$string['commerce_product_identity_locked'] = 'Le SKU ou le type de ce produit ne peut plus être modifié car il a déjà été consommé par un client.';
$string['commerce_product_sku_duplicate'] = 'Ce SKU est déjà utilisé par un autre produit.';
$string['commerce_product_sku_auto_placeholder'] = 'Généré automatiquement si laissé vide';
$string['commerce_product_digital_file_ready'] = 'Fichier prêt pour la livraison';
$string['commerce_product_digital_file_missing'] = 'Aucun fichier Native enregistré';
$string['commerce_product_digital_file_upload_prompt'] = 'Ajoutez un fichier PDF pour cette version.';
$string['commerce_product_digital_file_replace_or_add'] = 'Ajouter ou remplacer le fichier';
$string['commerce_product_pricing_business_intro'] = 'Définissez le prix normal de chaque devise et, si besoin, une promotion temporaire. Pendant la promotion, le client paie le prix promotionnel et voit le prix normal barré. À l\'expiration, le prix normal est automatiquement rétabli sans intervention.';
$string['commerce_product_pricing_regular_price'] = 'Prix normal';
$string['commerce_product_pricing_regular_price_help'] = 'Prix de référence réellement facturé hors promotion.';
$string['commerce_product_pricing_available_for_sale'] = 'Disponible à la vente';
$string['commerce_product_pricing_enabled'] = 'Actif';
$string['commerce_product_pricing_disabled'] = 'Inactif';
$string['commerce_product_pricing_new_currency'] = 'Nouvelle devise';
$string['commerce_product_pricing_add_currency'] = 'Ajouter une devise';
$string['commerce_product_pricing_add_currency_help'] = 'Ajoutez un prix normal. Vous pourrez également activer une promotion immédiatement.';
$string['commerce_product_promotion_enable'] = 'Activer une promotion temporaire';
$string['commerce_product_promotion_auto_restore'] = 'Le prix normal sera automatiquement rétabli à la fin de la promotion.';
$string['commerce_product_promotion_price'] = 'Prix promotionnel';
$string['commerce_product_promotion_start'] = 'Début';
$string['commerce_product_promotion_end'] = 'Fin';
$string['commerce_product_promotion_timezone'] = 'Fuseau horaire : {$a}';
$string['commerce_product_promotion_none'] = 'Sans promotion';
$string['commerce_product_promotion_active'] = 'Promotion active';
$string['commerce_product_promotion_scheduled'] = 'Programmée';
$string['commerce_product_promotion_expired'] = 'Terminée';
$string['commerce_product_promotion_invalid'] = 'À vérifier';
$string['commerce_product_promotion_invalid_price'] = 'Saisissez un prix promotionnel valide.';
$string['commerce_product_promotion_must_be_lower'] = 'Le prix promotionnel doit être supérieur à zéro et strictement inférieur au prix normal.';
$string['commerce_product_promotion_invalid_period'] = 'La date de fin de la promotion doit être postérieure à sa date de début.';
$string['commerce_product_promotion_invalid_datetime'] = 'La date ou l\'heure de promotion est invalide.';
$string['commerce_storefront_promotions_moved'] = 'Les promotions sont désormais gérées dans Tarification.';
$string['commerce_access_scope_business_title'] = 'Périmètre d’accès';
$string['commerce_access_scope_business_intro'] = 'Définissez ce que le client reçoit réellement avec ce produit. La compatibilité avec l’ancien catalogue Legacy reste disponible séparément pour les besoins de migration.';
$string['commerce_access_scope_metric_source'] = 'Source d’accès';
$string['commerce_access_scope_metric_scope'] = 'Périmètre appliqué';
$string['commerce_access_scope_metric_courses'] = 'Cours délivrés';
$string['commerce_access_scope_customer_access_title'] = 'Accès délivré au client';
$string['commerce_access_scope_customer_access_help'] = 'Choisissez le plan historique dont le périmètre d’accès doit être réutilisé par ce produit Commerce. Plusieurs produits Native peuvent partager le même périmètre.';
$string['commerce_access_scope_source_plan_business'] = 'Source du périmètre';
$string['commerce_access_scope_source_plan_business_help'] = 'Ce choix détermine les cours réellement attribués après l’achat ou une attribution administrative.';
$string['commerce_access_scope_effective_scope'] = 'Périmètre actuellement appliqué : {$a}';
$string['commerce_access_scope_courses_business_title'] = 'Contenu délivré';
$string['commerce_access_scope_courses_count'] = '{$a} cours';
$string['commerce_access_scope_courses_empty'] = 'Aucun cours n’est actuellement associé à ce périmètre.';
$string['commerce_access_scope_legacy_compatibility_title'] = 'Compatibilité avec le catalogue Legacy';
$string['commerce_access_scope_legacy_compatibility_badge'] = 'Migration uniquement';
$string['commerce_access_scope_legacy_compatibility_help'] = 'Ce réglage ne change pas les accès délivrés au client. Il indique uniquement quel ancien Plan Legacy correspond canoniquement à ce produit Native pour les migrations, réparations et backfills.';
$string['commerce_access_scope_legacy_plan_business'] = 'Plan Legacy correspondant';
$string['commerce_access_scope_legacy_plan_help'] = 'Un même Plan Legacy ne peut être rattaché canoniquement qu’à un seul produit Native.';
$string['commerce_access_scope_legacy_current_mapping'] = 'Correspondance Legacy actuelle : {$a}';
$string['commerce_access_scope_admin_shortcuts'] = 'Administration avancée';
$string['commerce_access_scope_unknown_product'] = 'produit Native inconnu';
$string['commerce_bundle_components_help_n89'] = 'Composez le bundle avec les produits voulus. Réorganisez-les par glisser-déposer ou avec les flèches ; l’ordre affiché ici sera conservé partout où la composition est présentée.';
$string['commerce_bundle_reorder_help'] = 'Faites glisser les composants pour changer leur ordre, ou utilisez les flèches haut/bas.';
$string['commerce_bundle_move_up'] = 'Monter ce composant';
$string['commerce_bundle_move_down'] = 'Descendre ce composant';
$string['commerce_bundle_drag_handle'] = 'Faire glisser pour réordonner';
$string['commerce_bundle_component_row_help'] = 'Produit inclus dans ce bundle';
$string['commerce_bundle_add_component'] = 'Ajouter un composant';
$string['commerce_bundle_preview_help_n89'] = 'Aperçu de la composition réellement développée, après résolution des bundles imbriqués.';
$string['commerce_bundle_pricing_intro_n810'] = 'Choisissez comment le prix normal du bundle est calculé, puis gérez les promotions temporaires exactement comme pour les autres produits. Une promotion modifie réellement le prix payé et le prix normal est rétabli automatiquement à son expiration.';
$string['commerce_bundle_pricing_method_help_n810'] = 'Le prix fixe définit directement le prix normal. La somme reprend les prix des composants. La remise calcule le prix normal du bundle en appliquant un pourcentage à cette somme.';
$string['commerce_bundle_pricing_strategy_fixed_help_n810'] = 'Vous saisissez le prix normal du bundle pour chaque devise.';
$string['commerce_bundle_pricing_strategy_sum_help_n810'] = 'Le prix normal est recalculé automatiquement à partir des composants.';
$string['commerce_bundle_pricing_strategy_discount_help_n810'] = 'Le prix normal est la somme des composants moins la remise définie ici.';
$string['commerce_bundle_discount_percent_help_n810'] = 'Utilisé uniquement avec la méthode « remise sur les composants ».';
$string['commerce_bundle_pricing_currency_section'] = 'Prix et promotions par devise';
$string['commerce_bundle_pricing_currency_section_help'] = 'Chaque devise possède un prix normal. Vous pouvez ensuite activer une promotion temporaire indépendante pour cette devise.';
$string['commerce_bundle_pricing_calculated_price'] = 'Prix normal calculé';
$string['commerce_bundle_add_currency_help_n810'] = 'Ajoutez une nouvelle devise au bundle. Pour les stratégies calculées, elle doit aussi être disponible sur tous les composants.';
$string['commerce_bundle_preview_intro_n811'] = 'Contrôlez simplement ce que le client recevra réellement : produits inclus, quantités, accès délivrés et prix final du bundle.';
$string['commerce_bundle_preview_unavailable_help_n811'] = 'L’aperçu ne peut pas être calculé avec la composition actuelle. Vérifiez les composants du bundle.';
$string['commerce_bundle_preview_contents_title_n811'] = 'Contenu du bundle';
$string['commerce_bundle_preview_contents_help_n811'] = 'Chaque carte représente un produit réellement délivré au client après développement des bundles imbriqués.';
$string['commerce_bundle_preview_technical_details_n811'] = 'Informations techniques';
$string['commerce_bundle_preview_pricing_help_n811'] = 'Prix effectivement présenté au client aujourd’hui, promotions actives comprises.';
$string['commerce_bundle_preview_pricing_note_title_n811'] = 'À savoir';
$string['commerce_bundle_preview_pricing_note_n811'] = 'Les prix sont calculés selon la stratégie définie dans Tarification. Les promotions temporaires s’appliquent automatiquement pendant leur période de validité.';
$string['commerce_storefront_n812_title'] = 'Page Boutique — {$a}';
$string['commerce_storefront_n812_intro'] = 'Construisez la page client sans mélanger contenu, apparence, diffusion commerciale et outils techniques.';
$string['commerce_storefront_n812_eyebrow'] = 'Page Boutique';
$string['commerce_storefront_n812_tab_content'] = 'Contenu';
$string['commerce_storefront_n812_tab_presentation'] = 'Présentation';
$string['commerce_storefront_n812_tab_distribution'] = 'Diffusion';
$string['commerce_storefront_n812_tab_tools'] = 'Outils';
$string['commerce_storefront_n812_sections_short'] = 'sections';
$string['commerce_storefront_n812_ready_short'] = 'prêtes';
$string['commerce_storefront_n812_attention_short'] = 'à vérifier';
$string['commerce_storefront_n812_content_title'] = 'Contenu de la page';
$string['commerce_storefront_n812_content_help'] = 'Voici les blocs réellement présents dans la langue sélectionnée. Ouvrez le Builder pour modifier leur contenu, leur ordre et leur présentation.';
$string['commerce_storefront_n812_open_builder'] = 'Ouvrir le Builder';
$string['commerce_storefront_n812_empty_title'] = 'Aucun bloc éditorial';
$string['commerce_storefront_n812_empty_help'] = 'Ajoutez votre premier bloc pour commencer à construire cette version de la Page Boutique.';
$string['commerce_storefront_n812_status_ready'] = 'Prêt';
$string['commerce_storefront_n812_status_attention'] = 'À vérifier';
$string['commerce_storefront_n812_status_draft'] = 'Brouillon';
$string['commerce_storefront_n812_builder_next_title'] = 'Builder visuel';
$string['commerce_storefront_n812_builder_next_help'] = 'Le Builder est centré sur les blocs : descriptions claires, choix visuels des mises en page et aperçu de chaque bloc avant publication.';
$string['commerce_storefront_n812_metric_layout'] = 'Modèle de page';
$string['commerce_storefront_n812_metric_commerce'] = 'Bloc Commerce';
$string['commerce_storefront_n812_metric_header'] = 'En-tête produit';
$string['commerce_storefront_n812_presentation_title'] = 'Présentation générale';
$string['commerce_storefront_n812_presentation_help'] = 'Réglages qui déterminent la structure générale de la page, sans toucher au contenu éditorial.';
$string['commerce_storefront_n812_modify_presentation'] = 'Modifier la présentation';
$string['commerce_storefront_n812_card_layout_title'] = 'Disposition de la page';
$string['commerce_storefront_n812_card_layout_help'] = 'Organisation générale des zones et largeur de la page.';
$string['commerce_storefront_n812_card_commerce_title'] = 'Position du bloc Commerce';
$string['commerce_storefront_n812_card_commerce_help'] = 'Choisit où apparaissent prix, achat et informations commerciales.';
$string['commerce_storefront_n812_card_shell_title'] = 'Enveloppe Moodle';
$string['commerce_storefront_n812_card_shell_help'] = 'En-tête produit, header/footer Edly et mode d’affichage général.';
$string['commerce_storefront_n812_advanced_title'] = 'Réglages avancés';
$string['commerce_storefront_n812_advanced_presentation_help'] = 'Les clés de thème, zones globales et paramètres de shell restent disponibles pour compatibilité, mais ne font plus partie du parcours principal.';
$string['commerce_storefront_n812_metric_featured'] = 'Mis en avant';
$string['commerce_storefront_n812_metric_showroom'] = 'Showroom';
$string['commerce_storefront_n812_metric_languages'] = 'Langues configurées';
$string['commerce_storefront_n812_showroom_configured'] = 'Associé';
$string['commerce_storefront_n812_showroom_custom'] = 'Association personnalisée';
$string['commerce_storefront_n812_distribution_title'] = 'Diffusion et découverte';
$string['commerce_storefront_n812_distribution_help'] = 'Tout ce qui détermine comment ce produit apparaît dans la Boutique, les Showrooms, le référencement et les recommandations.';
$string['commerce_storefront_n812_modify_distribution'] = 'Modifier la diffusion';
$string['commerce_storefront_n812_merch_title'] = 'Mise en avant commerciale';
$string['commerce_storefront_n812_merch_help'] = 'Produit vedette, ordre d’affichage et badges marketing.';
$string['commerce_storefront_n812_experience_title'] = 'Expérience client';
$string['commerce_storefront_n812_experience_help'] = 'Catégorie de catalogue, éléments de réassurance et informations clés.';
$string['commerce_storefront_n812_seo_title'] = 'SEO et partage';
$string['commerce_storefront_n812_seo_help'] = 'Titre, description et URL publiques. Les valeurs automatiques restent prioritaires lorsqu’aucune personnalisation n’est nécessaire.';
$string['commerce_storefront_n812_discovery_title'] = 'Destination de découverte';
$string['commerce_storefront_n812_discovery_help'] = 'Détermine si le client ouvre directement cette Page Boutique ou le Showroom associé.';
$string['commerce_storefront_n812_badges_short'] = 'badges';
$string['commerce_storefront_n812_items_short'] = 'éléments';
$string['commerce_storefront_n812_customised'] = 'Personnalisé';
$string['commerce_storefront_n812_automatic'] = 'Automatique';
$string['commerce_storefront_n812_defaults_title'] = 'Vers une configuration par défaut';
$string['commerce_storefront_n812_defaults_help'] = 'Les réglages automatiques réduisent les configurations inutiles : SEO, réassurance et destination Showroom peuvent être personnalisés uniquement lorsque c’est nécessaire.';
$string['commerce_storefront_n812_tools_title'] = 'Outils de maintenance';
$string['commerce_storefront_n812_tools_help'] = 'Regroupe les opérations rares : traduction, transfert de configuration et réinitialisation.';
$string['commerce_storefront_n812_open_tools'] = 'Ouvrir les outils';
$string['commerce_storefront_n812_tool_translation_title'] = 'Locales et traduction';
$string['commerce_storefront_n812_tool_translation_help'] = 'Copier une locale existante ou préparer une traduction avec OpenAI.';
$string['commerce_storefront_n812_tool_transfer_title'] = 'Importer / exporter';
$string['commerce_storefront_n812_tool_transfer_help'] = 'Transférer la configuration complète de la Page Boutique dans un fichier .cfrproduct.';
$string['commerce_storefront_n812_tool_reset_title'] = 'Réinitialiser';
$string['commerce_storefront_n812_tool_reset_help'] = 'Supprimer la configuration Storefront sans modifier le produit, ses prix ou ses accès.';
$string['commerce_storefront_n812_tools_safety_help'] = 'Ces opérations sont volontairement séparées du Builder pour éviter de mélanger création éditoriale et maintenance technique.';
$string['commerce_storefront_n812_back_to_hub'] = 'Retour à Page Boutique';
$string['commerce_storefront_n812_builder_transition_help'] = 'Éditeur avancé de la Page Boutique.';
$string['commerce_storefront_n813_builder_focus_help'] = 'Builder Contenu — seuls les blocs éditoriaux sont au premier plan. Les réglages de présentation, diffusion et maintenance restent dans leurs espaces dédiés.';
$string['commerce_storefront_n813_content_builder_title'] = 'Construire le contenu';
$string['commerce_storefront_n813_content_builder_help'] = 'Ajoutez des blocs, choisissez visuellement leur disposition et contrôlez immédiatement leur rendu. Les réglages techniques restent disponibles mais passent au second plan.';
$string['commerce_storefront_n813_add_block_title'] = 'Ajouter un bloc';
$string['commerce_storefront_n813_add_block_help'] = 'Choisissez d’abord ce que vous voulez raconter. Chaque type correspond à un usage éditorial précis.';
$string['commerce_storefront_n813_type_hero_help'] = 'Grande ouverture de page : titre, promesse, visuel et éventuellement appel à l’action.';
$string['commerce_storefront_n813_type_rich_text_help'] = 'Texte éditorial libre pour expliquer, rassurer ou détailler une partie de l’offre.';
$string['commerce_storefront_n813_type_image_text_help'] = 'Associe un visuel et du texte côte à côte pour expliquer un bénéfice ou une fonctionnalité.';
$string['commerce_storefront_n813_type_video_help'] = 'Présente une démonstration, un témoignage ou une explication vidéo.';
$string['commerce_storefront_n813_type_features_help'] = 'Affiche plusieurs bénéfices ou caractéristiques sous forme de cartes faciles à parcourir.';
$string['commerce_storefront_n813_type_cta_help'] = 'Termine ou relance une séquence avec une action claire pour le visiteur.';
$string['commerce_storefront_n813_more_blocks'] = 'Autres types de blocs';
$string['commerce_storefront_n813_more_blocks_help'] = 'FAQ, témoignages, programme, galerie, H5P et autres composants restent disponibles dans le sélecteur détaillé juste en dessous.';
$string['commerce_storefront_n813_layout_choice_title'] = 'Disposition visuelle';
$string['commerce_storefront_n813_layout_choice_help'] = 'Cliquez sur le schéma qui ressemble au rendu souhaité. Les champs techniques correspondants sont synchronisés automatiquement.';
$string['commerce_storefront_n813_layout_automatic_help'] = 'Pour ce type de bloc, la disposition standard est généralement la meilleure option. Vous pouvez toujours affiner la largeur, l’espacement ou l’alignement ci-dessous.';
$string['commerce_storefront_n813_advanced_layout_title'] = 'Réglages fins de mise en page';
$string['commerce_storefront_n813_advanced_layout_help'] = 'Ces options servent aux ajustements précis. Dans la plupart des cas, le choix visuel ci-dessus suffit.';
$string['commerce_storefront_n814_title'] = 'Diffusion — {$a}';
$string['commerce_storefront_n814_intro'] = 'Décidez comment le produit est découvert et présenté commercialement. Les réglages automatiques sont privilégiés pour éviter les configurations inutiles.';
$string['commerce_storefront_n814_defaults_hint'] = 'Les valeurs automatiques suivent le type du produit et les contenus déjà disponibles.';
$string['commerce_storefront_n814_discovery_title'] = 'Quand un client clique sur « Découvrir »';
$string['commerce_storefront_n814_discovery_help'] = 'Choisissez la destination principale. La Page Boutique reste toujours accessible directement.';
$string['commerce_storefront_n814_destination_storefront'] = 'Ouvrir la Page Boutique';
$string['commerce_storefront_n814_destination_storefront_help'] = 'Le client arrive directement sur la présentation complète de ce produit.';
$string['commerce_storefront_n814_destination_showroom'] = 'Ouvrir le Showroom associé';
$string['commerce_storefront_n814_destination_showroom_help'] = 'Le client découvre ce produit dans une page commerciale regroupant plusieurs offres.';
$string['commerce_storefront_n814_showroom_label'] = 'Showroom associé';
$string['commerce_storefront_n814_no_showroom'] = 'Aucun Showroom';
$string['commerce_storefront_n814_show_storefront_cta'] = 'Depuis le Showroom, permettre d’ouvrir la fiche complète du produit';
$string['commerce_storefront_n814_show_storefront_cta_help'] = 'Ajoute un lien vers cette Page Boutique sans modifier la destination principale du bouton « Découvrir ».';
$string['commerce_storefront_n814_merch_title'] = 'Mise en avant dans la Boutique';
$string['commerce_storefront_n814_merch_help'] = 'Contrôlez uniquement les signaux qui influencent l’ordre et les badges visibles dans le catalogue.';
$string['commerce_storefront_n814_display_order'] = 'Priorité d’affichage';
$string['commerce_storefront_n814_display_order_help'] = 'Les produits mis en avant apparaissent d’abord ; à priorité égale, la valeur la plus petite passe avant.';
$string['commerce_storefront_n814_experience_title'] = 'Expérience client';
$string['commerce_storefront_n814_experience_help'] = 'Laissez CampusFR choisir automatiquement les éléments adaptés au type de produit, puis personnalisez uniquement si nécessaire.';
$string['commerce_storefront_n814_catalog_group'] = 'Catégorie de catalogue';
$string['commerce_storefront_n814_catalog_group_help'] = '« Automatique » déduit la catégorie depuis le type du produit.';
$string['commerce_storefront_n814_reassurance_title'] = 'Éléments de réassurance';
$string['commerce_storefront_n814_reassurance_help'] = 'En mode automatique, CampusFR affiche les garanties pertinentes pour ce type de produit.';
$string['commerce_storefront_n814_reassurance_auto'] = 'Automatique — recommandé';
$string['commerce_storefront_n814_reassurance_custom'] = 'Personnaliser';
$string['commerce_storefront_n814_automatic'] = 'Automatique';
$string['commerce_storefront_n814_custom'] = 'Personnalisé';
$string['commerce_storefront_n814_recommendations_title'] = 'Compléter le parcours';
$string['commerce_storefront_n814_recommendations_help'] = 'Sélectionnez jusqu’à quatre produits complémentaires. Les noms affichés utilisent le Product Name Resolver ; aucune clé technique n’est nécessaire.';
$string['commerce_storefront_n814_recommendations_limit'] = 'Maximum 4 produits. Le produit actuel est exclu de la liste.';
$string['commerce_storefront_n814_seo_title'] = 'SEO et partage social';
$string['commerce_storefront_n814_seo_help'] = 'Le mode automatique reprend le nom et la description du produit ainsi que le meilleur visuel disponible. Personnalisez uniquement si le marketing l’exige.';
$string['commerce_storefront_n814_auto_title_label'] = 'Titre résolu';
$string['commerce_storefront_n814_auto_description_label'] = 'Description de repli';
$string['commerce_storefront_n814_seo_auto'] = 'SEO automatique — recommandé';
$string['commerce_storefront_n814_seo_custom'] = 'Personnaliser le SEO';
$string['commerce_storefront_n814_public_urls'] = 'Personnaliser les URL publiques';
$string['commerce_storefront_n814_seo_no_description'] = 'Aucune description produit n’est encore disponible.';
$string['commerce_storefront_n815_presentation_title'] = 'Présentation — {$a}';
$string['commerce_storefront_n815_presentation_intro'] = 'Réglez l’organisation générale de la Page Boutique. Les choix visuels couvrent les cas courants ; les paramètres techniques sont repliés par défaut.';
$string['commerce_storefront_n815_layout_title'] = 'Style général de la page';
$string['commerce_storefront_n815_layout_help'] = 'Choisissez la structure qui correspond le mieux à la manière dont vous voulez raconter le produit.';
$string['commerce_storefront_n815_template_default_help'] = 'Structure équilibrée et polyvalente. Bon choix pour la majorité des produits.';
$string['commerce_storefront_n815_template_editorial_help'] = 'Lecture plus éditoriale, adaptée aux pages riches en explications et en contenu.';
$string['commerce_storefront_n815_template_immersive_help'] = 'Présentation très visuelle, pensée pour les campagnes et lancements forts.';
$string['commerce_storefront_n815_commerce_title'] = 'Où afficher l’achat ?';
$string['commerce_storefront_n815_commerce_help'] = 'Le bloc Commerce contient le prix et l’action d’achat. Choisissez son emplacement sans avoir à connaître la structure technique de la page.';
$string['commerce_storefront_n815_position_hero_help'] = 'Prix et achat sont intégrés à la zone d’ouverture de la page.';
$string['commerce_storefront_n815_position_sidebar_help'] = 'Le bloc achat reste visible à droite pendant la consultation sur grand écran.';
$string['commerce_storefront_n815_position_none_help'] = 'Aucun bloc Commerce automatique. À réserver aux pages dont le parcours d’achat est géré autrement.';
$string['commerce_storefront_n815_shell_title'] = 'Enveloppe de la page';
$string['commerce_storefront_n815_shell_help'] = 'Contrôlez la présence des éléments Moodle autour du contenu sans modifier les blocs éditoriaux.';
$string['commerce_storefront_n815_advanced_title'] = 'Réglages techniques avancés';
$string['commerce_storefront_n815_advanced_help'] = 'Compatibilité avec les anciennes pages : à modifier uniquement si vous savez pourquoi une zone ou un thème spécifique est nécessaire.';
$string['commerce_storefront_n815_tools_title'] = 'Outils — {$a}';
$string['commerce_storefront_n815_tools_intro'] = 'Les opérations rares et techniques sont isolées du Builder afin de réduire les risques pendant l’édition quotidienne.';
$string['commerce_storefront_n815_tools_scope_help'] = 'Ces outils peuvent copier, traduire, importer ou supprimer une configuration entière. Ils n’ont aucun effet sur les prix ni les droits d’accès du produit, sauf mention explicite.';

$string['commerce_storefront_n816_advanced_options'] = 'Options avancées de mise en page';

$string['commerce_storefront_n816_seo_language'] = 'Langue du référencement';

$string['commerce_storefront_n816_seo_language_help'] = 'Le titre et la description SEO sont propres à cette langue. Les autres réglages de diffusion restent globaux au produit.';

$string['commerce_storefront_n816_tools_target_language'] = 'Version cible pour les outils de langue';
$string['commerce_storefront_n817_block_preview'] = 'Aperçu du bloc';
$string['commerce_storefront_n818_missing_items'] = 'Ajoutez au moins une carte ou une question.';
$string['commerce_storefront_n818_missing_image'] = 'Ajoutez une image.';
$string['commerce_storefront_n818_missing_text'] = 'Ajoutez un titre ou un contenu.';
$string['commerce_storefront_n818_missing_video'] = 'Ajoutez ou sélectionnez une vidéo.';
$string['commerce_storefront_n818_missing_h5p'] = 'Ajoutez ou sélectionnez un contenu H5P.';
$string['commerce_storefront_n818_missing_content'] = 'Ajoutez le contenu principal du bloc.';
$string['commerce_storefront_n818_feature_items'] = 'Cartes avantages';
$string['commerce_storefront_n818_feature_items_help'] = 'Une carte par ligne : titre ||| contenu. Le contenu principal générique n’est pas nécessaire pour ce type de bloc.';
$string['commerce_storefront_n818_faq_items'] = 'Questions et réponses';
$string['commerce_storefront_n818_faq_items_help'] = 'Une question par ligne : question ||| réponse. Le contenu principal générique n’est pas nécessaire pour ce type de bloc.';
$string['commerce_storefront_n819_tab_builder'] = 'Builder';
$string['commerce_storefront_n819_preview_device'] = 'Aperçu responsive';
$string['commerce_showroom_n9_description'] = 'Créez, publiez et administrez les pages Showroom utilisées pour présenter vos offres commerciales.';
$string['commerce_showroom_n9_kpi_total'] = 'Showrooms';
$string['commerce_showroom_n9_search_placeholder'] = 'Nom ou URL publique';
$string['commerce_showroom_n9_public_language'] = 'Langue publique';
$string['commerce_showroom_n9_public_pages'] = 'Pages publiques';
$string['commerce_showroom_n9_updated'] = 'Dernière modification';
$string['commerce_showroom_n9_found'] = '{$a} showrooms trouvés';
$string['commerce_showroom_n9_empty_title'] = 'Aucun showroom à afficher';
$string['commerce_showroom_n9_empty'] = 'Aucun showroom ne correspond aux filtres sélectionnés.';
$string['commerce_showroom_n9_no_public_page'] = 'Aucune page publique';
$string['commerce_showroom_n9_scope_status'] = 'Statut : {$a}';
$string['commerce_showroom_n9_scope_language'] = 'Langue : {$a}';
$string['commerce_showroom_n9_menu_public'] = 'Pages publiques';
$string['commerce_showroom_n9_menu_admin'] = 'Administration';
$string['commerce_showroom_n9_menu_danger'] = 'Zone sensible';
$string['commerce_showroom_n9_open_public'] = 'Ouvrir la version {$a}';
$string['commerce_showroom_n9_export_json'] = 'Exporter en JSON';
$string['commerce_showroom_n9_export_portable'] = 'Exporter le package portable';
$string['commerce_showroom_n9_delete_confirm'] = 'Supprimer définitivement ce showroom ?';
$string['commerce_showroom_n91_import_intro'] = 'Importez un showroom complet ou restaurez uniquement sa configuration. Le package portable est recommandé pour les transferts entre environnements.';
$string['commerce_showroom_n91_import_package_title'] = 'Importer un showroom';
$string['commerce_showroom_n91_import_package_help'] = 'Choisissez de préférence un package .showroom.zip : il contient la configuration, les blocs et les médias. Un fichier JSON reste accepté pour la configuration seule.';
$string['commerce_showroom_n91_import_formats'] = 'Formats acceptés : .showroom.zip recommandé, ou .json sans médias.';
$string['commerce_showroom_n91_import_json_advanced'] = 'Import JSON avancé';
$string['commerce_showroom_n91_import_action'] = 'Importer le showroom';
$string['commerce_showroom_n92_history_title'] = 'Historique — {$a}';
$string['commerce_showroom_n92_history_description'] = 'Consultez les révisions enregistrées, les changements de publication et restaurez une version antérieure si nécessaire.';
$string['commerce_showroom_n92_back_showroom'] = 'Retour au showroom';
$string['commerce_showroom_n92_current_status'] = 'Statut actuel';
$string['commerce_showroom_n92_revision_count'] = 'Révisions';
$string['commerce_showroom_n92_latest_revision'] = 'Dernière révision';
$string['commerce_showroom_n92_latest_badge'] = 'Dernière';
$string['commerce_showroom_n92_restore_help'] = 'Restaurer une révision recrée cette version comme brouillon : la version publiée actuelle n’est pas remplacée silencieusement.';
$string['commerce_showroom_n92_restore_confirm'] = 'Restaurer la révision {$a} comme brouillon ?';
$string['commerce_showroom_n931_menu_transfer'] = 'Transfert et sauvegarde';
$string['commerce_showroom_n931_general_title'] = 'Informations générales';
$string['commerce_showroom_n931_general_help'] = 'Identifiez le showroom et choisissez sa mise en page publique.';
$string['commerce_showroom_n931_public_layout'] = 'Mise en page publique';
$string['commerce_showroom_n931_public_layout_help'] = 'Choisissez la présentation utilisée pour afficher ce showroom aux visiteurs.';
$string['commerce_showroom_n931_products_help'] = 'Associez les produits proposés dans ce showroom. Les références techniques restent masquées dans le parcours normal.';
$string['commerce_showroom_n931_change_product'] = 'Changer';
$string['commerce_showroom_n931_publication_title'] = 'Publication';
$string['commerce_showroom_n931_publication_help'] = 'Gérez ici le cycle de publication du showroom sans mélanger ces actions avec sa configuration.';
$string['commerce_showroom_n931_publication_status'] = 'Statut';
$string['commerce_showroom_n931_publication_status_draft'] = 'Ce showroom est actuellement en brouillon et n’est pas publié.';
$string['commerce_showroom_n931_publication_status_review'] = 'Ce showroom est en attente de validation avant publication.';
$string['commerce_showroom_n931_publication_status_published'] = 'Ce showroom est actuellement publié et visible selon ses URLs publiques.';
$string['commerce_showroom_n931_publication_status_archived'] = 'Ce showroom est archivé.';
$string['commerce_showroom_n931_publication_note_placeholder'] = 'Note facultative pour l’historique de publication';
$string['commerce_showroom_n932_seo_title'] = 'Référencement et partage';
$string['commerce_showroom_n932_seo_help'] = 'Définissez l’URL publique et les métadonnées visibles par les moteurs de recherche et les réseaux sociaux pour chaque langue.';
$string['commerce_showroom_n932_social_image_help'] = 'Cette image est commune aux différentes langues et utilisée lorsque la page est partagée sur les réseaux sociaux.';
$string['commerce_showroom_n932_no_social_image'] = 'Aucune image de partage personnalisée';
$string['commerce_showroom_n932_locale_help'] = 'Les champs de cette langue sont indépendants des autres versions linguistiques.';
$string['commerce_showroom_n932_public_url'] = 'URL publique';
$string['commerce_showroom_n932_public_url_help'] = 'Utilisez un identifiant court, lisible et stable. Il ne doit pas contenir le nom de domaine.';
$string['commerce_showroom_n932_open_public_page'] = 'Ouvrir la page publique';
$string['commerce_showroom_n932_social_overrides'] = 'Partage sur les réseaux sociaux';
$string['commerce_showroom_n932_social_overrides_help'] = 'Facultatif. Si ces champs sont vides, le titre et la description SEO sont utilisés automatiquement.';
$string['commerce_showroom_n932_technical'] = 'Compatibilité SEO historique';
$string['commerce_showroom_n932_technical_help'] = 'Ces clés servent uniquement de fallback pour les anciens contenus Moodle. La configuration SEO courante est gérée par les champs ci-dessus ; le JSON interne n’est plus exposé ici.';
$string['commerce_showroom_n94_builder_title'] = 'Construire le showroom';
$string['commerce_showroom_n94_builder_help'] = 'Organisez les blocs par glisser-déposer. Ajoutez un bloc ou appliquez un modèle sans quitter cette page.';
$string['commerce_showroom_n94_block_count'] = '{$a} blocs';
$string['commerce_showroom_n94_add_block_title'] = 'Ajouter un bloc';
$string['commerce_showroom_n94_template_title'] = 'Partir d’un modèle';
$string['commerce_showroom_n94_more_actions'] = 'Options';
$string['commerce_showroom_n94_collapse_all'] = 'Tout replier';
$string['commerce_showroom_n94_expand_all'] = 'Tout déplier';
$string['commerce_showroom_n94_visible'] = 'Visible';
$string['commerce_showroom_n94_hidden'] = 'Masqué';
$string['commerce_showroom_n94_collapse_block'] = 'Replier ou déplier le bloc';
$string['commerce_showroom_n94_hide_block'] = 'Masquer le bloc';
$string['commerce_showroom_n94_show_block'] = 'Afficher le bloc';
$string['commerce_showroom_n94_technical_info'] = 'Informations techniques';
$string['commerce_showroom_n94_block_key'] = 'Clé du bloc';
$string['commerce_showroom_n941_information_page_title'] = 'Informations — {$a}';
$string['commerce_showroom_n941_information_page_subtitle'] = 'Configurez l’identité du showroom, les produits associés et son cycle de publication.';
$string['commerce_showroom_n941_seo_page_title'] = 'Référencement — {$a}';
$string['commerce_showroom_n941_seo_page_subtitle'] = 'Configurez les URLs publiques, le référencement et le partage social pour chaque langue.';
$string['commerce_showroom_n941_builder_page_title'] = 'Builder — {$a}';
$string['commerce_showroom_n941_builder_page_subtitle'] = 'Construisez la page du showroom en ajoutant, organisant et configurant ses différents blocs.';
$string['commerce_showroom_n95_common_presentation'] = 'Présentation du bloc';
$string['commerce_showroom_n95_common_presentation_help'] = 'Ces réglages sont communs à tous les blocs. Ils servent de présentation générique et de fallback lorsque le bloc ne définit pas son propre fond.';
$string['commerce_showroom_n95_common_background'] = 'Fond du bloc';
$string['commerce_showroom_n95_width'] = 'Largeur';
$string['commerce_showroom_n95_width_contained'] = 'Centrée';
$string['commerce_showroom_n95_width_wide'] = 'Large';
$string['commerce_showroom_n95_width_full'] = 'Pleine largeur';
$string['commerce_showroom_n95_background'] = 'Fond';
$string['commerce_showroom_n95_background_default'] = 'Par défaut';
$string['commerce_showroom_n95_background_white'] = 'Blanc';
$string['commerce_showroom_n95_background_light'] = 'Clair';
$string['commerce_showroom_n95_background_soft'] = 'Doux';
$string['commerce_showroom_n95_background_pink'] = 'Rose CampusFR';
$string['commerce_showroom_n95_background_dark'] = 'Sombre';
$string['commerce_showroom_n95_background_gradient'] = 'Dégradé';
$string['commerce_showroom_n95_background_custom'] = 'Personnalisé';
$string['commerce_showroom_n95_background_image'] = 'Image';
$string['commerce_showroom_n95_spacing'] = 'Espacement';
$string['commerce_showroom_n95_spacing_compact'] = 'Compact';
$string['commerce_showroom_n95_spacing_normal'] = 'Normal';
$string['commerce_showroom_n95_spacing_large'] = 'Large';

// N10.1 — Centre de configuration Commerce.
$string['commerce_configuration_description_n101'] = 'Visualisez l’état des réglages Commerce et accédez aux paramètres système depuis un tableau de bord unique.';
$string['commerce_configuration_status_enabled'] = 'Activé';
$string['commerce_configuration_status_disabled'] = 'Désactivé';
$string['commerce_configuration_catalogue_title'] = 'Catalogue, accès et inscription aux cours';
$string['commerce_configuration_catalogue_description'] = 'Les AccessScopes et les Plans sont des briques métier du catalogue : ils relient les cours Moodle aux produits Commerce, aux inscriptions et aux stratégies d’upgrade. Leur gestion reste séparée des réglages système.';
$string['commerce_configuration_catalogue_step_course'] = 'Cours Moodle';
$string['commerce_configuration_catalogue_step_scope'] = 'Périmètre d’accès';
$string['commerce_configuration_catalogue_step_plan'] = 'Plan commercial';
$string['commerce_configuration_catalogue_step_product'] = 'Produit Commerce';
$string['commerce_configuration_open_products'] = 'Ouvrir les produits';
$string['commerce_configuration_open_scopes'] = 'Gérer les périmètres d’accès';
$string['commerce_configuration_open_plans'] = 'Gérer les plans';
$string['commerce_configuration_system_title'] = 'Configuration système';
$string['commerce_configuration_system_description'] = 'Une vue synthétique des réglages qui pilotent le moteur Commerce. Les secrets et paramètres sensibles restent dans l’administration Moodle.';
$string['commerce_configuration_advanced_settings'] = 'Réglages Moodle avancés';
$string['commerce_configuration_configure'] = 'Configurer';
$string['commerce_configuration_technical_badge'] = 'Technique';
$string['commerce_configuration_payments_title'] = 'Paiements';
$string['commerce_configuration_payments_description'] = 'Providers, environnements Stripe et Alfa et réconciliation des paiements.';
$string['commerce_configuration_localisation_title'] = 'Commerce & langues';
$string['commerce_configuration_localisation_description'] = 'Disponibilité du Commerce, langues par défaut et présentation des devises.';
$string['commerce_configuration_checkout_title'] = 'Checkout & relances';
$string['commerce_configuration_checkout_description'] = 'Cycle des paiements en attente, expiration et relances automatiques.';
$string['commerce_configuration_communications_title'] = 'Communications';
$string['commerce_configuration_communications_description'] = 'E-mails Commerce, support, campagnes d’offres personnelles et limites d’envoi.';
$string['commerce_configuration_legal_title'] = 'Facturation & légal';
$string['commerce_configuration_legal_description'] = 'Coordonnées de facturation, politiques, conditions et informations légales.';
$string['commerce_configuration_storefront_title'] = 'Boutique & Storefront';
$string['commerce_configuration_storefront_description'] = 'Services éditoriaux globaux de la Boutique et paramètres de compatibilité encore utilisés par l’ancien catalogue.';
$string['commerce_configuration_engine_title'] = 'Moteur Commerce';
$string['commerce_configuration_engine_description'] = 'Runtime Native/Legacy, fallback, shadow et outils de migration ou de réparation.';
$string['commerce_configuration_fact_provider'] = 'Provider par défaut';
$string['commerce_configuration_fact_availability'] = 'Disponibilité';
$string['commerce_configuration_fact_user_language'] = 'Langue comptes';
$string['commerce_configuration_fact_email_language'] = 'Langue e-mails';
$string['commerce_configuration_site_default'] = 'Défaut du site';
$string['commerce_configuration_fact_pending_expiry'] = 'Expiration paiement';
$string['commerce_configuration_fact_reminder1'] = '1re relance';
$string['commerce_configuration_fact_reminder2'] = '2e relance';
$string['commerce_configuration_fact_support_email'] = 'E-mail support';
$string['commerce_configuration_fact_offer_batch'] = 'Lot campagnes';
$string['commerce_configuration_fact_hourly_limit'] = 'Limite / heure';
$string['commerce_configuration_fact_ru_policy'] = 'Politique RU';
$string['commerce_configuration_fact_row_policy'] = 'Politique ROW';
$string['commerce_configuration_fact_copy_to'] = 'Copie e-mail';
$string['commerce_configuration_fact_ai_translation'] = 'Traduction IA';
$string['commerce_configuration_fact_currency_symbols'] = 'Symboles devises';
$string['commerce_configuration_fact_runtime'] = 'Runtime';
$string['commerce_configuration_fact_read_mode'] = 'Mode lecture';
$string['commerce_configuration_fact_repair'] = 'Réparation Native';

// Commerce configuration N10.2.
$string['commerce_configuration_open_section'] = 'Voir les réglages';
$string['commerce_configuration_back_overview'] = 'Vue d’ensemble';
$string['commerce_configuration_section_notice'] = 'Cette page présente les réglages Commerce effectivement utilisés. Les modifications et les secrets restent volontairement dans les réglages Moodle avancés.';
$string['commerce_configuration_group_general'] = 'Réglages généraux';
$string['commerce_configuration_group_payment_routing'] = 'Routage des paiements';
$string['commerce_configuration_group_reconciliation'] = 'Réconciliation automatique';
$string['commerce_configuration_group_followup'] = 'Expiration et relances';
$string['commerce_configuration_group_checkout_safety'] = 'Sécurité et nettoyage du checkout';
$string['commerce_configuration_group_mail_audit'] = 'Copies et audit des e-mails';
$string['commerce_configuration_group_legal_links'] = 'Documents et liens légaux';
$string['commerce_configuration_group_runtime'] = 'Runtime Commerce';
$string['commerce_configuration_group_native_tools'] = 'Contrôles Native et migration';
$string['commerce_configuration_setting_provider_default'] = 'Provider par défaut';
$string['commerce_configuration_setting_stripe_env'] = 'Environnement Stripe';
$string['commerce_configuration_setting_alfa_env'] = 'Environnement Alfa';
$string['commerce_configuration_setting_stripe_reconciliation_cron_enabled'] = 'Réconciliation Stripe';
$string['commerce_configuration_setting_stripe_reconciliation_batch_size'] = 'Lot Stripe';
$string['commerce_configuration_setting_alfa_reconciliation_cron_enabled'] = 'Réconciliation Alfa';
$string['commerce_configuration_setting_alfa_reconciliation_batch_size'] = 'Lot Alfa';
$string['commerce_configuration_setting_availability_mode'] = 'Disponibilité Commerce';
$string['commerce_configuration_setting_defaultuserlang'] = 'Langue par défaut des comptes';
$string['commerce_configuration_setting_defaultemaillang'] = 'Langue par défaut des e-mails';
$string['commerce_configuration_setting_commerce_enabled_currencies'] = 'Devises activées';
$string['commerce_configuration_setting_display_currency_symbols'] = 'Symboles des devises';
$string['commerce_configuration_setting_expire_pending_after_minutes'] = 'Expiration des paiements en attente';
$string['commerce_configuration_setting_reminder1_after_minutes'] = 'Première relance';
$string['commerce_configuration_setting_reminder2_after_minutes'] = 'Deuxième relance';
$string['commerce_configuration_setting_guest_checkout_cleanup_enabled'] = 'Nettoyage des checkouts invités';
$string['commerce_configuration_setting_guest_checkout_cleanup_age_days'] = 'Ancienneté avant nettoyage (jours)';
$string['commerce_configuration_setting_payments_lock_strict'] = 'Verrouillage strict des paiements';
$string['commerce_configuration_setting_payments_mismatch_tolerance_cents'] = 'Tolérance d’écart de paiement (centimes)';
$string['commerce_configuration_setting_support_email'] = 'E-mail support';
$string['commerce_configuration_setting_email_copy_to'] = 'Copie des e-mails';
$string['commerce_configuration_setting_personal_offer_mail_batch_size'] = 'Taille des lots de campagnes';
$string['commerce_configuration_setting_personal_offer_mail_hourly_limit'] = 'Limite de campagnes par heure';
$string['commerce_configuration_setting_commerce_mail_audit_copy_enabled'] = 'Copie d’audit';
$string['commerce_configuration_setting_commerce_mail_audit_copy_address'] = 'Adresse de copie d’audit';
$string['commerce_configuration_setting_commerce_mail_audit_batch_size'] = 'Taille des lots d’audit';
$string['commerce_configuration_setting_commerce_mail_audit_hourly_limit'] = 'Limite d’audit par heure';
$string['commerce_configuration_setting_policy_url_ru'] = 'Politique — Russie';
$string['commerce_configuration_setting_policy_url_row'] = 'Politique — autres régions';
$string['commerce_configuration_setting_terms_url_ru'] = 'Conditions — Russie';
$string['commerce_configuration_setting_terms_url_row'] = 'Conditions — autres régions';
$string['commerce_configuration_setting_offer_url_ru'] = 'Offre publique — Russie';
$string['commerce_configuration_setting_offer_url_row'] = 'Offre publique — autres régions';
$string['commerce_configuration_setting_storefront_ai_translation_enabled'] = 'Traduction IA du Storefront';
$string['commerce_configuration_setting_brand_logo_url'] = 'Logo de marque';
$string['commerce_configuration_setting_featured_planid'] = 'Plan mis en avant';
$string['commerce_configuration_setting_commerce_runtime_mode'] = 'Runtime principal';
$string['commerce_configuration_setting_commerce_runtime_read_mode'] = 'Mode de lecture';
$string['commerce_configuration_setting_commerce_runtime_read_strict'] = 'Lecture stricte';
$string['commerce_configuration_setting_commerce_runtime_native_fallback_enabled'] = 'Fallback Native';
$string['commerce_configuration_setting_commerce_fulfillment_shadow_enabled'] = 'Fulfillment shadow';
$string['commerce_configuration_setting_commerce_native_reconciliation_enabled'] = 'Réconciliation Native';
$string['commerce_configuration_setting_commerce_native_repair_enabled'] = 'Réparation Native';

// Commerce configuration editor (N10.3).
$string['commerce_configuration_saved'] = 'Configuration enregistrée.';
$string['commerce_configuration_edit_notice'] = 'Ces réglages sont enregistrés directement dans la configuration Commerce. Le nom technique affiché sous chaque champ correspond à la clé utilisée par get_config().';
$string['commerce_configuration_url_setting_desc'] = 'URL utilisée par Commerce pour cette page légale.';
$string['commerce_configuration_stripe_environment'] = 'Environnement Stripe';
$string['commerce_configuration_alfa_environment'] = 'Environnement Alfa';
$string['commerce_configuration_stripe_reconciliation_batch_size_desc'] = 'Limite le nombre de paiements Stripe en attente vérifiés lors d’une exécution de la tâche planifiée. Valeur recommandée : 20.';
$string['commerce_configuration_stripe_reconciliation_min_age_desc'] = 'Délai minimal après la création d’un paiement Stripe avant sa vérification automatique. Valeur recommandée : 300 secondes.';
$string['commerce_configuration_stripe_reconciliation_max_age_desc'] = 'Les paiements Stripe plus anciens que cette durée ne sont plus interrogés automatiquement. Valeur recommandée : 172800 secondes (48 h).';
$string['commerce_configuration_group_payment_integrity'] = 'Intégrité des paiements';
$string['commerce_configuration_group_payment_integrity_desc'] = 'Contrôles appliqués aux montants et devises reçus des prestataires avant de finaliser un paiement.';
$string['commerce_configuration_group_commerce_availability'] = 'Disponibilité du Commerce';
$string['commerce_configuration_group_languages'] = 'Langues';
$string['commerce_configuration_group_currencies'] = 'Devises et affichage des prix';
$string['commerce_configuration_availability_label'] = 'Disponibilité des pages Commerce';
$string['commerce_configuration_availability_desc'] = 'Contrôle l’accès aux pages publiques Commerce. Ce réglage est actif dans le garde d’accès du plugin : public, administrateurs uniquement ou désactivé.';
$string['commerce_configuration_default_user_language_label'] = 'Langue par défaut des nouveaux comptes';
$string['commerce_configuration_default_user_language_desc'] = 'Utilisée lors de la création automatique de nouveaux comptes quand aucune langue utilisateur plus précise n’est disponible. Les utilisateurs existants conservent leur langue.';
$string['commerce_configuration_default_email_language_label'] = 'Langue forcée des e-mails Commerce';
$string['commerce_configuration_default_email_language_desc'] = 'Si une langue est sélectionnée, le mailer Commerce l’utilise pour les e-mails concernés. Laissez « langue du site » pour respecter la langue du destinataire ou le fallback normal.';
$string['commerce_configuration_enabled_currencies_label'] = 'Devises activées';
$string['commerce_configuration_enabled_currencies_desc'] = 'Détermine les devises proposées et acceptées par le catalogue Commerce Native. Au moins une devise doit rester active.';
$string['commerce_configuration_currency_symbols_label'] = 'Afficher les symboles monétaires';
$string['commerce_configuration_currency_symbols_desc'] = 'Utilisé par le checkout et les pages de résultat de paiement pour afficher par exemple 49 € plutôt que 49 EUR. Ce réglage reste global à Commerce.';
$string['commerce_configuration_currency_eur'] = 'Euro';
$string['commerce_configuration_currency_rub'] = 'Rouble russe';
$string['commerce_configuration_currency_usd'] = 'Dollar américain';
$string['commerce_configuration_currency_gbp'] = 'Livre sterling';
$string['commerce_configuration_currency_chf'] = 'Franc suisse';
$string['commerce_configuration_currency_cad'] = 'Dollar canadien';
$string['commerce_configuration_currency_jpy'] = 'Yen japonais';
$string['commerce_configuration_currency_required'] = 'Activez au moins une devise Commerce.';
$string['commerce_configuration_group_payment_lifecycle'] = 'Expiration des demandes de paiement';
$string['commerce_configuration_group_payment_reminders'] = 'Relances de paiement';
$string['commerce_configuration_group_guest_cleanup'] = 'Nettoyage des comptes checkout invités';
$string['commerce_configuration_expire_pending_after_minutes_desc'] = 'Une demande de paiement encore en attente est marquée expirée après ce délai. Ce traitement reste actif indépendamment de l’envoi des e-mails de relance.';
$string['commerce_configuration_reminder1_after_minutes_desc'] = 'Premier seuil de relance calculé depuis la création de la demande de paiement. L’envoi effectif dépend aussi de la politique des e-mails automatiques Legacy.';
$string['commerce_configuration_reminder2_after_minutes_desc'] = 'Second seuil de relance calculé depuis la création. Il ne peut pas être antérieur au premier rappel ; le job applique aussi un délai minimum entre les deux envois.';
$string['commerce_configuration_checkout_mail_policy_note'] = 'Les délais de relance ci-dessous pilotent le job de suivi des paiements. Ils n’activent pas à eux seuls les anciens e-mails automatiques : leur autorisation reste gérée dans la configuration des communications / Mail Studio.';
$string['commerce_configuration_duration_minutes'] = '{$a} min';
$string['commerce_configuration_duration_hours'] = '{$a} h';
$string['commerce_configuration_duration_days'] = '{$a} j';
$string['commerce_configuration_group_mail_identity'] = 'Adresses et identité d’envoi';
$string['commerce_configuration_group_mail_global_throttle'] = 'Protection du débit SMTP';
$string['commerce_configuration_group_mail_workers'] = 'Workers du Mail Engine';
$string['commerce_configuration_group_legacy_mail'] = 'Envois automatiques historiques';
$string['commerce_configuration_support_email_desc'] = 'Adresse de support utilisée dans les e-mails, les pages de paiement, le Showroom et les demandes d’assistance.';
$string['commerce_configuration_admin_copy_desc'] = 'Copie administrative historique ajoutée par le mailer générique. Plusieurs adresses peuvent être séparées par des virgules.';
$string['commerce_configuration_transactional_enabled_desc'] = 'Active ou suspend le worker des e-mails transactionnels (commandes, accès, paiements et messages prioritaires). La tâche Moodle reste planifiée.';
$string['commerce_configuration_transactional_batch_label'] = 'Transactionnels — e-mails par batch';
$string['commerce_configuration_transactional_hourly_label'] = 'Transactionnels — plafond par heure';
$string['commerce_configuration_personal_offer_enabled_desc'] = 'Active ou suspend le worker dédié aux e-mails des offres personnelles. La tâche Moodle reste planifiée.';
$string['commerce_configuration_personal_offer_batch_label'] = 'Offres personnelles — e-mails par batch';
$string['commerce_configuration_personal_offer_hourly_label'] = 'Offres personnelles — plafond par heure';
$string['commerce_configuration_marketing_enabled_desc'] = 'Active ou suspend le worker des campagnes marketing créées depuis Mail Studio.';
$string['commerce_configuration_marketing_batch_label'] = 'Campagnes marketing — e-mails par batch';
$string['commerce_configuration_marketing_hourly_label'] = 'Campagnes marketing — plafond par heure';
$string['commerce_configuration_audit_copy_generation_label'] = 'Créer les copies d’audit';
$string['commerce_configuration_audit_copy_generation_desc'] = 'Détermine si les e-mails clients éligibles génèrent une seconde intention d’e-mail d’audit. Ce réglage crée les copies ; il ne traite pas la file.';
$string['commerce_configuration_audit_copy_address_desc'] = 'Adresse technique qui reçoit les copies d’audit générées, par exemple log@campusfr.fr.';
$string['commerce_configuration_audit_worker_label'] = 'Traiter la file des copies d’audit';
$string['commerce_configuration_audit_worker_desc'] = 'Active ou suspend le worker qui expédie les copies d’audit déjà créées. Il est distinct du réglage « Créer les copies d’audit ».';
$string['commerce_configuration_audit_batch_label'] = 'Copies d’audit — e-mails par batch';
$string['commerce_configuration_audit_hourly_label'] = 'Copies d’audit — plafond par heure';
$string['commerce_configuration_communications_mail_engine_note'] = 'Cette page et l’écran E-mails > Configuration pilotent les mêmes clés du Mail Engine. Les valeurs sont donc synchronisées. L’écran E-mails reste utile pour l’état des workers, des tâches Moodle et leur dernier passage.';
$string['commerce_configuration_open_mail_engine'] = 'Voir l’état des workers';
$string['commerce_configuration_copy_destination_label'] = 'Adresse de copie / audit';
$string['commerce_configuration_copy_destination_desc'] = 'Adresse commune aux copies administratives de l’ancien mailer et aux copies d’audit du Mail Engine Native. L’enregistrement synchronise automatiquement les deux mécanismes.';
$string['commerce_configuration_group_invoice_eur'] = 'Facturation EUR — Stripe';
$string['commerce_configuration_group_invoice_rub'] = 'Facturation RUB — Alfa';
$string['commerce_configuration_invoice_name_desc'] = 'Nom ou raison sociale affiché comme émetteur sur la facture.';
$string['commerce_configuration_invoice_address_desc'] = 'Adresse postale complète de l’entité émettrice.';
$string['commerce_configuration_invoice_legal_desc'] = 'Numéros d’enregistrement, forme juridique et autres informations légales à afficher.';
$string['commerce_configuration_invoice_email_desc'] = 'Adresse de contact affichée sur les factures.';
$string['commerce_configuration_invoice_phone_desc'] = 'Numéro de téléphone affiché sur les factures.';
$string['commerce_configuration_invoice_website_desc'] = 'Site web de l’entité émettrice.';
$string['commerce_configuration_invoice_tax_notice_desc'] = 'Mention fiscale ou TVA spécifique à cette entité.';
$string['commerce_configuration_invoice_footer_desc'] = 'Texte libre ajouté au pied de la facture PDF.';
$string['commerce_configuration_policy_url_ru_by_label'] = 'Politique de confidentialité — Russie / Biélorussie';
$string['commerce_configuration_policy_url_ru_by_desc'] = 'Document utilisé lorsque Commerce détecte un visiteur en Russie ou en Biélorussie.';
$string['commerce_configuration_policy_url_row_label'] = 'Politique de confidentialité — Reste du monde';
$string['commerce_configuration_policy_url_row_desc'] = 'Document utilisé pour les autres pays.';
$string['commerce_configuration_terms_url_ru_by_label'] = 'Conditions générales d’utilisation — Russie / Biélorussie';
$string['commerce_configuration_terms_url_ru_by_desc'] = 'CGU utilisées lorsque Commerce détecte un visiteur en Russie ou en Biélorussie.';
$string['commerce_configuration_terms_url_row_label'] = 'Conditions générales d’utilisation — Reste du monde';
$string['commerce_configuration_terms_url_row_desc'] = 'CGU utilisées pour les autres pays.';
$string['commerce_configuration_offer_url_ru_by_label'] = 'Conditions générales de vente — Russie / Biélorussie';
$string['commerce_configuration_offer_url_ru_by_desc'] = 'CGV utilisées lorsque Commerce détecte un visiteur en Russie ou en Biélorussie.';
$string['commerce_configuration_offer_url_row_label'] = 'Conditions générales de vente — Reste du monde';
$string['commerce_configuration_offer_url_row_desc'] = 'CGV utilisées pour les autres pays.';
$string['commerce_configuration_legal_resolution_note'] = 'Les profils de facturation sont résolus par devise : EUR utilise le profil Stripe et RUB le profil Alfa. Les liens légaux sont résolus séparément selon la région détectée (Russie/Biélorussie ou reste du monde).';
$string['commerce_configuration_fact_invoice_eur'] = 'Émetteur EUR';
$string['commerce_configuration_fact_invoice_rub'] = 'Émetteur RUB';
$string['commerce_configuration_fact_legal_regions'] = 'Régions légales';
$string['commerce_configuration_legal_regions_value'] = 'RU/BY + reste du monde';
$string['commerce_configuration_group_legal_ru_by'] = 'Documents légaux — Russie / Biélorussie';
$string['commerce_configuration_group_legal_row'] = 'Documents légaux — Reste du monde';
$string['commerce_configuration_policy_document_label'] = 'Politique de confidentialité';
$string['commerce_configuration_terms_document_label'] = 'Conditions générales d’utilisation';
$string['commerce_configuration_offer_document_label'] = 'Conditions générales de vente';
$string['commerce_configuration_brand_logo_email_label'] = 'Logo utilisé dans les e-mails';
$string['commerce_configuration_brand_logo_email_desc'] = 'Logo de marque utilisé par le moteur d’e-mails Commerce. Ce réglage ne pilote pas les visuels de la Boutique ni des Showrooms.';
$string['commerce_configuration_group_storefront_editorial'] = 'Services éditoriaux Storefront';
$string['commerce_configuration_group_storefront_legacy'] = 'Compatibilité de l’ancienne page des offres';
$string['commerce_configuration_storefront_ai_translation_desc'] = 'Autorise le Builder Page Boutique à préparer des traductions avec le compte OpenAI configuré. La traduction reste soumise à prévisualisation et validation avant enregistrement.';
$string['commerce_configuration_featured_plan_legacy_label'] = 'Plan mis en avant — fallback historique';
$string['commerce_configuration_featured_plan_legacy_desc'] = 'Utilisé uniquement par l’ancienne page des offres lorsque le plan ne définit pas déjà son propre type de mise en avant. Les Pages Boutique Native ne dépendent pas de ce réglage.';
$string['commerce_configuration_no_featured_plan'] = 'Aucun plan imposé';
$string['commerce_configuration_plan_inactive'] = 'Inactif';
$string['commerce_configuration_storefront_scope_title'] = 'Où configurer la Boutique ?';
$string['commerce_configuration_storefront_scope_desc'] = 'Les réglages éditoriaux et commerciaux sont désormais portés par chaque Produit (Page Boutique) et chaque Showroom. Cette page ne conserve que les paramètres système globaux.';
$string['commerce_configuration_storefront_open_products'] = 'Ouvrir les Produits';
$string['commerce_configuration_storefront_open_showrooms'] = 'Ouvrir les Showrooms';
$string['commerce_configuration_nav_overview'] = 'Vue d’ensemble';
$string['commerce_configuration_internal_navigation'] = 'Navigation de la configuration Commerce';
$string['commerce_configuration_fact_currencies'] = 'Devises';
$string['commerce_configuration_fact_guest_cleanup'] = 'Nettoyage invités';
$string['commerce_configuration_fact_transactional_worker'] = 'E-mails transactionnels';
$string['commerce_configuration_fact_marketing_worker'] = 'Campagnes marketing';
$string['commerce_configuration_fact_legacy_featured_plan'] = 'Plan Legacy mis en avant';
$string['commerce_configuration_fact_engine_switches'] = 'Checkout / fulfillment';

$string['commerce_configuration_group_engine_availability'] = 'Disponibilité du moteur';
$string['commerce_configuration_checkout_engine_enabled_desc'] = 'Interrupteur global du checkout Commerce. Le désactiver bloque les nouveaux parcours de checkout Native ; à utiliser uniquement comme arrêt opérationnel contrôlé.';
$string['commerce_configuration_fulfillment_engine_enabled_desc'] = 'Interrupteur global du fulfillment Commerce. Le désactiver suspend l’attribution des droits après paiement et constitue un mécanisme de rollback opérationnel.';
$string['commerce_configuration_runtime_mode_label'] = 'Moteur de fulfillment autoritaire';
$string['commerce_configuration_runtime_mode_desc'] = 'Legacy exécute l’ancien fulfillment. Shadow conserve Legacy comme autorité et vérifie Native en parallèle. Native exécute le fulfillment Native comme chemin autoritaire.';
$string['commerce_configuration_runtime_fallback_desc'] = 'En mode Native, si le fulfillment Native échoue par exception, Commerce tente immédiatement le chemin Legacy. Ce filet de sécurité est utile pendant la période de transition et de stabilisation.';
$string['commerce_configuration_group_runtime_reads'] = 'Lecture des données Commerce';
$string['commerce_configuration_runtime_read_mode_label'] = 'Source de lecture Commerce';
$string['commerce_configuration_runtime_read_mode_desc'] = 'Détermine la source utilisée par les lecteurs Commerce encore compatibles Legacy/Native. Native lit la persistance Native ; Auto privilégie Native avec fallback Legacy ; Shadow compare sans rendre Native autoritaire.';
$string['commerce_configuration_runtime_read_strict_label'] = 'Lecture Native stricte';
$string['commerce_configuration_runtime_read_strict_desc'] = 'En mode de lecture Native, refuse les fallbacks silencieux lorsque les données Native attendues sont absentes. À activer uniquement lorsque la couverture Native est certifiée.';
$string['commerce_configuration_native_reconciliation_label'] = 'Autoriser la réconciliation Legacy → Native';
$string['commerce_configuration_native_reconciliation_desc'] = 'Autorise les outils explicites de comparaison et synchronisation des achats Legacy vers Native. Ce réglage n’active pas à lui seul une tâche cron de réconciliation.';
$string['commerce_configuration_native_repair_label'] = 'Autoriser les réparations pendant la réconciliation';
$string['commerce_configuration_native_repair_desc'] = 'Autorise les opérations explicites de réparation lors d’une réconciliation. Nécessite que la réconciliation Native soit activée.';
$string['commerce_configuration_repair_requires_reconciliation'] = 'La réparation Native ne peut pas être activée lorsque la réconciliation Native est désactivée.';
$string['commerce_configuration_engine_shadow_status_title'] = 'Shadow du fulfillment Native';
$string['commerce_configuration_engine_shadow_status_desc'] = 'Ce drapeau technique est désormais synchronisé automatiquement avec le mode de fulfillment : actif uniquement lorsque le mode Shadow est sélectionné. Il n’est plus modifiable séparément dans cette interface.';
$string['commerce_product_course_journey_title'] = 'Enregistrer un cours Moodle dans Commerce';
$string['commerce_product_course_journey_description'] = 'Pour commercialiser un nouveau cours, rattachez-le d’abord à un périmètre d’accès, créez ou réutilisez ensuite un plan commercial, puis créez le produit Commerce. Ce parcours garantit que les inscriptions et les stratégies d’upgrade restent cohérentes.';

// N10.6A — Access scopes UX.
$string['commerce_scopes_description_n106'] = 'Les périmètres regroupent les cours délivrés ensemble par un plan commercial. Ils relient les cours Moodle aux Plans puis aux Produits Commerce.';
$string['commerce_scope_add_description_n106'] = 'Créez un périmètre en regroupant les cours qui doivent être accordés ensemble lors de l’achat d’un plan commercial.';
$string['commerce_scope_edit_description_n106'] = 'Définissez les cours accordés par ce périmètre et utilisés par ses plans commerciaux.';
$string['commerce_scope_course_search'] = 'Rechercher et sélectionner des cours…';
$string['commerce_scope_courses_help'] = 'Recherchez un cours par son nom puis sélectionnez un ou plusieurs cours. Les cours sélectionnés restent visibles dans le champ.';
$string['commerce_scope_courses_help_help'] = 'Recherchez un cours par son nom puis sélectionnez un ou plusieurs cours. Les cours sélectionnés restent visibles dans le champ.';
$string['commerce_scope_courses_badge'] = '{$a} cours';
$string['commerce_scope_plans_badge'] = '{$a} plans';
$string['commerce_scope_dependency_title'] = 'Utilisé par {$a} plan(s) commercial(aux)';
$string['commerce_scope_dependency_help'] = 'Modifier les cours de ce périmètre modifiera les accès délivrés par les produits utilisant ces plans.';
$string['commerce_scope_general_title'] = 'Informations générales';
$string['commerce_scope_general_description'] = 'Définissez le nom du périmètre et les cours Moodle qu’il regroupe.';

$string['commerce_scope_view_description_n106'] = 'Consultez les cours inclus, les plans commerciaux qui utilisent ce périmètre et ses informations techniques.';
$string['commerce_scope_view_courses_description'] = 'Cours Moodle accordés lorsqu’un plan utilisant ce périmètre est délivré.';
$string['commerce_scope_view_plans_description'] = 'Plans commerciaux actuellement rattachés à ce périmètre.';
$string['commerce_scope_view_no_plans'] = 'Aucun plan commercial n’utilise actuellement ce périmètre.';

// N10.6B — Plans, droits d’accès et upgrades.
$string['commerce_plans_description_n106'] = 'Les Plans traduisent un périmètre d’accès en offre commerciale : durée, récurrence, droits d’exécution et règles d’upgrade. Ils peuvent ensuite être reliés à un Produit Commerce Native.';
$string['commerce_plans_list_title'] = 'Plans commerciaux';
$string['commerce_plans_list_description'] = 'Vue d’ensemble des Plans, de leur périmètre, de leur activité et de leur liaison éventuelle avec un Produit Native.';
$string['commerce_plans_empty'] = 'Aucun Plan commercial n’est encore configuré.';
$string['commerce_plan_native_product'] = 'Produit Commerce Native';
$string['commerce_plan_native_product_desc'] = 'Produit Native actuellement relié à ce Plan par la couche de compatibilité Commerce.';
$string['commerce_plan_no_native_product'] = 'Aucun Produit Native lié';
$string['commerce_plan_no_native_product_desc'] = 'Ce Plan existe encore sans liaison vers un Produit Commerce Native.';
$string['commerce_plan_open_native_product'] = 'Ouvrir le Produit Native';
$string['commerce_plan_add_description_n106'] = 'Créez un Plan commercial à partir d’un périmètre d’accès et définissez sa durée ainsi que son comportement commercial.';
$string['commerce_plan_edit_description_n106'] = 'Modifiez les propriétés commerciales de ce Plan sans perdre de vue ses droits d’accès, ses upgrades et son Produit Native associé.';
$string['commerce_plan_general_title'] = 'Informations générales';
$string['commerce_plan_general_description'] = 'Définissez le nom, le périmètre d’accès, la durée, la récurrence et la mise en avant du Plan.';
$string['commerce_plan_view_description_n106'] = 'Consultez la structure commerciale du Plan, ses droits d’accès, ses règles d’upgrade et sa liaison éventuelle avec un Produit Commerce Native.';
$string['commerce_plan_business_information_desc_n106'] = 'Paramètres métier utilisés par ce Plan pour déterminer les accès et la durée de la formule.';
$string['commerce_plan_entitlements_rules_title'] = 'Droits d’accès configurés';
$string['commerce_plan_entitlements_rules_desc'] = 'Règles d’exécution historiques qui complètent le périmètre d’accès du Plan.';
$string['commerce_plan_upgrade_rules_title'] = 'Règles d’upgrade configurées';
$string['commerce_plan_upgrade_rules_desc'] = 'Passages autorisés entre ce Plan et d’autres Plans, avec leur méthode de calcul tarifaire.';

// N10.6C — Prix/traductions Legacy des Plans.
$string['commerce_plan_legacy_compatibility_title'] = 'Compatibilité Legacy';
$string['commerce_plan_legacy_mapped_readonly_desc'] = 'Ce Plan est relié à un Produit Commerce Native. Les anciens prix et traductions sont conservés pour la compatibilité et l’audit, mais ne sont plus éditables ici. Le Produit Native est désormais la source éditoriale officielle.';
$string['commerce_plan_legacy_unmapped_desc'] = 'Cet écran historique reste disponible uniquement pour les Plans Legacy qui ne sont pas encore reliés à un Produit Commerce Native.';
$string['commerce_plan_legacy_readonly_notice'] = 'Ce Plan est relié à un Produit Commerce Native : les données Legacy sont en lecture seule. Modifiez le Produit Native à la place.';
$string['commerce_plan_legacy_readonly_badge'] = 'Lecture seule';
$string['commerce_plan_open_native_prices'] = 'Gérer les tarifs Native';
$string['commerce_plan_open_native_translations'] = 'Gérer les traductions Native';

// Commerce 7.95N10.7 — Promotions et coupons dans Offres & accès.
$string['commerce_offers_access_tab_promotions'] = 'Promotions & coupons';
$string['commerce_offers_access_promotion_title'] = 'Promotion ou coupon';
$string['commerce_offers_access_promotion_description'] = 'Créez une remise automatique ou un code coupon applicable au checkout Commerce.';
$string['commerce_offers_access_promotion_action'] = 'Créer une promotion';
$string['commerce_promotions_coupon_hint'] = 'Une promotion automatique s’applique sans code. Une promotion manuelle avec un code correspond à un coupon saisi au checkout.';
$string['commerce_promotion_coupon_badge'] = 'COUPON';
$string['commerce_promotion_automatic_badge'] = 'AUTO';

// N10.7.1 — Promotions UX.
$string['commerce_promotions_metric_total'] = 'Promotions';
$string['commerce_promotions_metric_active'] = 'Actives';
$string['commerce_promotions_metric_coupons'] = 'Coupons';
$string['commerce_promotions_metric_automatic'] = 'Automatiques';
$string['commerce_promotions_mode_title'] = 'Deux modes d’application';
$string['commerce_promotions_list_title'] = 'Promotions & coupons';
$string['commerce_promotions_list_description'] = 'Vue d’ensemble des remises disponibles, de leur mode d’application et de leur utilisation.';
$string['commerce_promotion_section_identity'] = 'Identité & mode d’application';
$string['commerce_promotion_section_identity_desc'] = 'Définissez le nom interne, le code éventuel et la façon dont la remise est appliquée.';
$string['commerce_promotion_section_discount'] = 'Remise & limites';
$string['commerce_promotion_section_discount_desc'] = 'Configurez le calcul de la remise, la monnaie, le minimum de panier et les limites d’utilisation.';
$string['commerce_promotion_section_products'] = 'Produits éligibles';
$string['commerce_promotion_section_products_desc'] = 'Limitez la promotion à certains produits ou types de produits. Laissez sans restriction pour l’appliquer à tout le catalogue.';

// N10.7.2 — Promotions & coupons UX, détails et validité.
$string['commerce_promotion_section_validity'] = 'Période de validité';
$string['commerce_promotion_section_validity_desc'] = 'Définissez quand la promotion peut être appliquée. Laissez une date vide pour ne pas limiter ce côté de la période.';
$string['commerce_promotion_starts_at'] = 'Début de validité';
$string['commerce_promotion_starts_at_help'] = 'Date et heure à partir desquelles la promotion devient applicable. Laissez vide pour une application immédiate.';
$string['commerce_promotion_ends_at'] = 'Fin de validité';
$string['commerce_promotion_ends_at_help'] = 'Date et heure après lesquelles la promotion ne peut plus être appliquée. Laissez vide pour aucune date de fin.';
$string['commerce_promotion_validity'] = 'Validité';
$string['commerce_promotion_validity_upcoming'] = 'À venir';
$string['commerce_promotion_validity_expired'] = 'Expirée';
$string['commerce_promotion_validity_unlimited'] = 'Sans limite de temps';
$string['commerce_promotion_validity_current'] = 'En cours';
$string['commerce_promotion_validity_immediate'] = 'immédiatement';
$string['commerce_promotion_validity_no_end'] = 'sans date de fin';
$string['commerce_promotion_validity_range'] = '{$a->from} → {$a->to}';
$string['commerce_promotion_view_description'] = 'Consultez la remise, sa période de validité, ses restrictions produit et ses conditions d’éligibilité.';
$string['commerce_promotion_view_summary'] = 'Résumé de la promotion';
$string['commerce_promotion_view_limits'] = 'Limites et utilisation';
$string['commerce_promotion_mode'] = 'Mode d’application';
$string['commerce_promotion_no_restriction'] = 'Aucune restriction';
$string['commerce_promotion_unlimited'] = 'Illimité';

$string['commerce_promotions_found'] = '{$a} promotion(s) trouvée(s)';
$string['commerce_promotions_no_results'] = 'Aucune promotion ne correspond aux critères actuels.';
$string['commerce_promotions_search_placeholder'] = 'Rechercher par nom ou code…';
$string['commerce_promotions_menu_manage'] = 'Gestion';
$string['commerce_promotions_menu_danger'] = 'Zone sensible';
$string['commerce_promotion_delete_confirm'] = 'Supprimer cette promotion ? Cette action est définitive.';

/* Commerce 7.95N11.2.1 — User Explorer UX. */
$string['crm_user_sort_score_asc'] = 'Score CRM le plus faible';
$string['crm_user_sort_risk_asc'] = 'Risque le plus faible';
$string['crm_user_sort_subscriptions_asc'] = 'Moins d’abonnements';
$string['crm_user_sort_subscriptions_desc'] = 'Plus d’abonnements';
$string['crm_user_sort_purchases_asc'] = 'Moins d’achats digitaux';
$string['crm_user_sort_purchases_desc'] = 'Plus d’achats digitaux';
$string['crm_user_sort_last_access_asc'] = 'Activité la plus ancienne';
$string['crm_user_sort_created_asc'] = 'Inscription la plus ancienne';
$string['crm_user_actions'] = 'Actions';
$string['crm_user_more_actions'] = 'Plus d’actions';
$string['crm_user_open_moodle_profile'] = 'Ouvrir le profil Moodle';
$string['crm_user_open_inbox'] = 'Ouvrir la boîte de réception';

/* Commerce 7.95N11.2.2 — User Explorer Sales-style UX. */
$string['crm_user_kpi_suspended'] = 'Comptes Moodle suspendus';
$string['crm_user_kpi_no_moodle'] = 'Sans compte Moodle';
$string['crm_user_search_filters_title'] = 'Recherche et filtres';
$string['crm_user_filter_panel_hint'] = 'Cliquer pour ouvrir';
$string['crm_user_filter_panel_active'] = '{$a} filtre(s) actif(s)';
$string['crm_user_save_view_help'] = 'Enregistre les filtres, la recherche et le tri actuels sous un nom pour les réutiliser rapidement. Il ne s’agit pas d’un instantané des utilisateurs.';
$string['crm_user_menu_client'] = 'Client';
$string['crm_user_menu_communication'] = 'Communication';
$string['crm_user_open_user360'] = 'Ouvrir User360';

/* Commerce 7.95N11.2.6 — User Explorer Sales table. */
$string['crm_user_explorer_found'] = '{$a} utilisateur(s) trouvé(s)';
$string['crm_user_explorer_active_filters_short'] = 'Filtres';
$string['crm_user_filter_type_label'] = 'Type d’utilisateur';

$string['crm_user_account_status_no_moodle'] = 'Sans compte Moodle';

/* Commerce 7.95N11.3A — User360 overview. */
$string['crm_user360_n113_moodle_account'] = 'Compte Moodle';
$string['crm_user360_n113_created'] = 'Créé le';
$string['crm_user360_n113_active_subscriptions'] = 'Abonnements actifs';
$string['crm_user360_n113_score'] = 'Score CRM';
$string['crm_user360_n113_risk'] = 'Risque';
$string['crm_user360_n113_nav_label'] = 'Navigation User360';
$string['crm_user360_n113_tab_overview'] = 'Vue d’ensemble';
$string['crm_user360_n113_tab_commerce'] = 'Commerce & accès';
$string['crm_user360_n113_tab_relation'] = 'Relation CRM';
$string['crm_user360_n113_tab_identities'] = 'Identités';
$string['crm_user360_n113_tab_timeline'] = 'Timeline CRM';
$string['crm_user360_n113_current_situation'] = 'Situation actuelle';
$string['crm_user360_n113_identity'] = 'Identité';
$string['crm_user360_n113_no_intelligence'] = 'Aucune analyse Intelligence CRM disponible pour cet utilisateur.';
$string['crm_user360_n113_guest_identity_help'] = 'Cette identité Commerce n’est pas encore rattachée à un compte Moodle.';
$string['crm_user360_n113_recent_activity'] = 'Activité récente';
$string['crm_user360_n113_priority_actions'] = 'Actions prioritaires';
$string['crm_user360_n113_priority_normal'] = 'À voir';
$string['crm_user360_n113_no_priority_action'] = 'Aucune action prioritaire détectée actuellement.';
$string['crm_user360_n113_work_items_hint'] = 'Les Work Items détaillés restent disponibles dans les sections CRM ci-dessous.';
$string['crm_user360_n113_send_email'] = 'Envoyer un e-mail';
$string['crm_user360_n113_create_offer'] = 'Créer une offre';
$string['crm_user360_n113_detailed_sections'] = 'Sections détaillées — migration N11.3 en cours';

// Commerce 7.95 N11.3B — User360 Commerce & access.
$string['crm_user360_n113b_title'] = 'Commerce & accès';
$string['crm_user360_n113b_intro'] = 'Commandes, abonnements, achats digitaux et accès pédagogiques réunis au même endroit.';
$string['crm_user360_n113b_orders'] = 'Commandes';
$string['crm_user360_n113b_orders_help'] = 'Commandes Commerce Native rattachées à ce client.';
$string['crm_user360_n113b_subscriptions'] = 'Abonnements';
$string['crm_user360_n113b_subscriptions_help'] = 'Formules actives et historiques rattachées à ce client.';
$string['crm_user360_n113b_digital'] = 'Achats digitaux';
$string['crm_user360_n113b_digital_help'] = 'Achats digitaux, y compris les données Legacy encore exploitées par le CRM.';
$string['crm_user360_n113b_access'] = 'Accès actuels';
$string['crm_user360_n113b_access_help'] = 'Cours auxquels le compte Moodle peut actuellement accéder.';
$string['crm_user360_n113b_guest_access_title'] = 'Aucun accès Moodle à afficher';
$string['crm_user360_n113b_guest_access_help'] = 'Cette identité Commerce / Legacy n’est pas encore rattachée à un compte Moodle. Ses achats restent visibles ci-dessus.';
$string['crm_user360_n113b_empty'] = 'Aucune activité commerciale n’a été trouvée pour ce client.';

// Commerce 7.95 N11.3C — User360 Relation CRM.
$string['crm_user360_n113c_title'] = 'Relation CRM';
$string['crm_user360_n113c_intro'] = 'Intelligence, actions, notes, Inbox, Customer Success et Work Items réunis dans un même espace.';
$string['crm_user360_n113c_score'] = 'Score commercial';
$string['crm_user360_n113c_engagement'] = 'Engagement';
$string['crm_user360_n113c_risk'] = 'Risque';
$string['crm_user360_n113c_unread'] = 'E-mails non lus';
$string['crm_user360_n113c_intelligence'] = 'Intelligence CRM';
$string['crm_user360_n113c_intelligence_help'] = 'Scores, segments, opportunités et recommandations calculés pour ce client.';
$string['crm_user360_n113c_actions'] = 'Actions CRM';
$string['crm_user360_n113c_actions_help'] = 'Actions opérationnelles et ajout rapide d’une note interne.';
$string['crm_user360_n113c_notes'] = 'Notes internes';
$string['crm_user360_n113c_notes_help'] = 'Historique des notes laissées par l’équipe CRM.';
$string['crm_user360_n113c_customer_success'] = 'Customer Success';
$string['crm_user360_n113c_customer_success_help'] = 'Plans de suivi et étapes Customer Success du client.';
$string['crm_user360_n113c_inbox'] = 'Inbox CRM';
$string['crm_user360_n113c_inbox_help'] = 'Conversations et messages rattachés à ce client.';
$string['crm_user360_n113c_assistant'] = 'Assistant CRM';
$string['crm_user360_n113c_assistant_help'] = 'Recommandations et actions proposées à partir des signaux CRM.';
$string['crm_user360_n113c_work_items'] = 'Work Items';
$string['crm_user360_n113c_work_items_help'] = 'Tâches CRM ouvertes, urgentes ou en retard pour ce client.';

// Commerce 7.95 N11.3D — User360 Identities + Timeline.
$string['crm_user360_n113d_identities_title'] = 'Identités';
$string['crm_user360_n113d_identities_intro'] = 'E-mails connus, compte Moodle, identités Commerce et rapprochements potentiels réunis au même endroit.';
$string['crm_user360_n113d_commerce_identity'] = 'Identité Commerce / Legacy';
$string['crm_user360_n113d_moodle_identity'] = 'Compte Moodle';
$string['crm_user360_n113d_known_identities'] = 'E-mails et identités';
$string['crm_user360_n113d_known_identities_help'] = 'Historique des adresses connues et comptes potentiellement liés.';
$string['crm_user360_n113d_account_linking'] = 'Rattachement Moodle';
$string['crm_user360_n113d_account_linking_help'] = 'Créer ou rattacher le compte Moodle correspondant à cette identité Commerce.';
$string['crm_user360_n113d_merge_history'] = 'Historique des fusions';
$string['crm_user360_n113d_merge_history_help'] = 'Opérations de fusion d’identités déjà réalisées pour ce compte.';
$string['crm_user360_n113d_identity_safety'] = 'Vérification d’identité';
$string['crm_user360_n113d_identity_safety_help'] = 'Les rapprochements potentiels sont uniquement des signaux. Vérifiez toujours la personne avant une fusion ou un rattachement.';
$string['crm_user360_n113d_no_identity_data'] = 'Aucune donnée d’identité supplémentaire disponible.';
$string['crm_user360_n113d_timeline_title'] = 'Timeline CRM';
$string['crm_user360_n113d_timeline_intro'] = 'Historique complet et filtrable des événements Commerce, pédagogiques et CRM.';
$string['crm_user360_n113d_timeline_events'] = 'Événements';
$string['crm_user360_n113d_timeline_important'] = 'Importants';

// Commerce 7.95 N11.3E — User360 final polish.
$string['crm_user360_n113e_match_high'] = 'Correspondance forte';
$string['crm_user360_n113e_match_medium'] = 'Correspondance possible';
$string['crm_user360_n113e_match_low'] = 'À vérifier';

// Commerce 7.95 N11.3F — User360 workspace consolidation.
$string['crm_user360_n113f_assistant_open'] = 'Afficher l’Assistant CRM';

// Commerce 7.95 N11.4A — Support-first User360.
$string['crm_user360_n114_orders'] = 'Commandes';
$string['crm_user360_n114_spent'] = 'Dépensé';
$string['crm_user360_n114_courses'] = 'Cours accessibles';
$string['crm_user360_n114_started'] = 'Cours commencés';
$string['crm_user360_n114_completed'] = 'Cours terminés';
$string['crm_user360_n114_last_activity'] = 'Dernière activité';
$string['crm_user360_n114_purchases_title'] = 'Achats récents';
$string['crm_user360_n114_purchases_help'] = 'Ce que le client a acheté sur le site.';
$string['crm_user360_n114_no_purchases'] = 'Aucun achat trouvé pour ce client.';
$string['crm_user360_n114_learning_title'] = 'Cours et progression';
$string['crm_user360_n114_learning_help'] = 'Accès actuels, progression Moodle et périmètre Level Up XP.';
$string['crm_user360_n114_no_moodle_learning'] = 'Cette identité Commerce n’a pas encore de compte Moodle associé.';
$string['crm_user360_n114_no_courses'] = 'Aucun cours accessible actuellement.';
$string['crm_user360_n114_progress_unavailable'] = 'Non suivi';
$string['crm_user360_n114_activity_progress'] = '{$a->completed} / {$a->tracked} activités terminées';
$string['crm_user360_n114_no_tracking'] = 'Progression Moodle non suivie';
$string['crm_user360_n114_communication_title'] = 'Échanges avec le client';
$string['crm_user360_n114_communication_help'] = 'Conversations, messages et notes utiles au service client.';
$string['crm_user360_n114_conversations'] = 'Conversations';
$string['crm_user360_n114_unread'] = 'Non lus';
$string['crm_user360_n114_last_exchange'] = 'Dernier échange';
$string['crm_user360_n114_internal_notes'] = 'Notes internes';
$string['crm_user360_n114_recent_title'] = 'Activité récente';
$string['crm_user360_n114_recent_help'] = 'Derniers événements utiles pour comprendre la situation du client.';
$string['crm_user360_n114_no_activity'] = 'Aucune activité récente.';
$string['crm_user360_n114_actions_title'] = 'Actions rapides';
$string['crm_user360_n114_send_email'] = 'Envoyer un e-mail';
$string['crm_user360_n114_create_offer'] = 'Créer une offre';
$string['crm_user360_n114_xp_disabled'] = 'XP désactivé';
$string['crm_user360_n114_xp_site_scope'] = 'XP · Global';
$string['crm_user360_n114_xp_course_scope'] = 'XP · Cours';
$string['crm_user360_n114_xp_level'] = 'Niveau {$a}';
$string['crm_user360_n114_status_paid'] = 'Payé';
$string['crm_user360_n114_status_failed'] = 'Échec';
$string['crm_user360_n114_status_pending'] = 'En attente';
$string['crm_user360_n114_advanced_open'] = 'Ouvrir le dossier CRM avancé';

// Commerce 7.95 N11.4B — Support-first dashboard design.
$string['crm_user360_n114b_started_sub'] = '{$a} cours commencé(s)';
$string['crm_user360_n114b_xp_total'] = 'Level Up XP';
$string['crm_user360_n114b_xp_courses_sub'] = 'XP sur {$a} cours';
$string['crm_user360_n114b_recent_purchases'] = 'Dernières commandes';
$string['crm_user360_n114b_view_all_purchases'] = 'Voir toutes les commandes';
$string['crm_user360_n114b_view_all_courses'] = 'Voir tous les cours';
$string['crm_user360_n114b_recent_conversations'] = 'Conversations récentes';
$string['crm_user360_n114b_unread_badge'] = '{$a} non lus';
$string['crm_user360_n114b_no_conversations'] = 'Aucune conversation récente.';
$string['crm_user360_n114b_last_note'] = 'Dernière note';
$string['crm_user360_n114b_internal_note'] = 'Note interne';
$string['crm_user360_n114b_no_notes'] = 'Aucune note interne.';
$string['crm_user360_n114b_open_exchanges'] = 'Ouvrir les échanges';
$string['crm_user360_n114b_recent_notes'] = 'Notes internes récentes';
$string['crm_user360_n114b_recent_notes_help'] = 'Notes et rappels utiles à l’équipe support.';
$string['crm_user360_n114b_view_all_notes'] = 'Voir toutes les notes';
$string['crm_user360_n114b_view_all_activity'] = 'Voir toute l’activité';
$string['crm_user360_n114b_actions_help'] = 'Actions fréquentes pour gérer ce client.';
$string['crm_user360_n114b_open_inbox'] = 'Ouvrir les échanges';
$string['crm_user360_n114b_all_actions'] = 'Toutes les actions';
$string['crm_user360_n114b_total_activities'] = 'Total activités';
$string['crm_user360_n114b_average_progress'] = 'Progression moyenne';
$string['crm_user360_n114b_access_active'] = 'Actif';

// Commerce 7.95 N11.4C — Support dashboard refinements.
$string['crm_user360_n114c_no_course_activity'] = 'Aucune activité terminée';

// Commerce 7.95 N11.5A — User360 Advanced CRM architecture.
$string['crm_user360_n115a_eyebrow'] = 'Dossier expert';
$string['crm_user360_n115a_title'] = 'CRM avancé';
$string['crm_user360_n115a_intro'] = 'Analyse, historique complet et outils experts. Ces informations complètent la Vue client sans surcharger le travail quotidien du support.';
$string['crm_user360_n115a_navigation'] = 'Navigation du dossier CRM avancé';
$string['crm_user360_n115a_relation'] = 'Relation CRM';
$string['crm_user360_n115a_relation_short'] = 'Analyse et suivi';
$string['crm_user360_n115a_relation_help'] = 'Intelligence CRM, actions, échanges, notes et suivi Customer Success.';
$string['crm_user360_n115a_commerce'] = 'Commerce avancé';
$string['crm_user360_n115a_commerce_short'] = 'Historique et droits';
$string['crm_user360_n115a_commerce_help'] = 'Commandes Native, abonnements, achats Legacy et droits d’accès détaillés.';
$string['crm_user360_n115a_identities'] = 'Identités';
$string['crm_user360_n115a_identities_short'] = 'Comptes et rapprochements';
$string['crm_user360_n115a_identities_help'] = 'E-mails connus, comptes potentiellement liés, rattachements et historique des fusions.';
$string['crm_user360_n115a_timeline'] = 'Timeline complète';
$string['crm_user360_n115a_timeline_short'] = 'Historique filtrable';
$string['crm_user360_n115a_timeline_help'] = 'Historique complet des événements Commerce, pédagogiques, Inbox, CRM et administratifs.';
$string['crm_user360_n115a_intelligence_title'] = 'Intelligence CRM détaillée';
$string['crm_user360_n115a_intelligence_help'] = 'Scores, tendance, segments, opportunités et explication des signaux calculés pour ce client.';
$string['crm_user360_n115a_expert_followup'] = 'Suivi expert';
$string['crm_user360_n115a_expert_followup_help'] = 'Outils utiles ponctuellement, repliés par défaut pour conserver un écran lisible.';
$string['crm_user360_n115a_assistant_help'] = 'Recommandations et interrogation de l’Assistant CRM.';
$string['crm_user360_n115a_workitems_help'] = 'Tâches CRM ouvertes, urgentes ou en retard.';
$string['crm_user360_n115a_customer_success_help'] = 'Plans et étapes de suivi Customer Success.';

// Commerce 7.95 N11.5B — Advanced Relation CRM dashboard.
$string['crm_user360_n115b_no_intelligence'] = 'Aucune analyse CRM détaillée n’est encore disponible pour ce client.';
$string['crm_user360_n115b_intelligence_dashboard_help'] = 'Synthèse des scores et des signaux utiles pour comprendre la situation du client.';
$string['crm_user360_n115b_why_score'] = 'Pourquoi ce score ?';
$string['crm_user360_n115b_why_score_help'] = 'Principaux facteurs qui influencent la note globale.';
$string['crm_user360_n115b_segments_title'] = 'Segments et axes prioritaires';
$string['crm_user360_n115b_segments_help'] = 'Segments applicables et recommandations actuellement détectées.';
$string['crm_user360_n115b_recommendations_priority'] = 'Recommandations prioritaires';
$string['crm_user360_n115b_actions_help'] = 'Raccourcis pour intervenir ou agir sur ce client.';
$string['crm_user360_n115b_inbox_help'] = 'Conversations et messages récents du client.';
$string['crm_user360_n115b_inbox_unavailable'] = 'L’Inbox CRM n’est pas disponible pour cet utilisateur.';
$string['crm_user360_n115b_notes_recent'] = 'Notes internes récentes';
$string['crm_user360_n115b_notes_help'] = 'Notes et rappels de l’équipe CRM, limités aux plus récents.';
$string['crm_user360_n115b_assistant_help'] = 'Deux recommandations prioritaires de l’IA, puis l’accès à l’Assistant CRM.';
$string['crm_user360_n115b_workitems_help'] = 'Tâches CRM ouvertes, urgentes ou en retard pour ce client.';
$string['crm_user360_n115b_customer_success_help'] = 'Plans de suivi et étapes Customer Success actuellement en cours.';
$string['crm_user360_n115b_no_customer_success'] = 'Aucun plan Customer Success ouvert.';
$string['crm_user360_n115b_no_score_factors'] = 'Aucun facteur explicatif détaillé n’est disponible.';
$string['crm_user360_n115b_no_segments'] = 'Aucun segment CRM détecté.';
$string['crm_user360_n115c_digital_products'] = 'Produits digitaux';
$string['crm_user360_n115c_digital_products_help'] = 'Ressources numériques possédées, téléchargements disponibles et historique lorsqu’il est suivi.';
$string['crm_user360_n115c_no_digital_products'] = 'Aucun produit digital disponible.';
$string['crm_user360_n115c_owned_since'] = 'Possédé depuis le {$a}';
$string['crm_user360_n115c_download_count'] = '{$a} téléchargement(s)';
$string['crm_user360_n115c_last_download'] = 'Dernier téléchargement : {$a}';
$string['crm_user360_n115c_download_history_unavailable'] = 'Historique de téléchargement non disponible';
$string['crm_user360_n115c_digital_resource'] = 'Produit digital';
$string['crm_user360_n115c_action_change_email_help'] = 'Modifier l’identité de connexion du compte.';
$string['crm_user360_n115c_action_reset_password_help'] = 'Action sensible : réinitialiser le mot de passe.';
$string['crm_user360_n115c_action_resend_delivery_help'] = 'Renvoyer le message de livraison d’un achat digital.';
$string['crm_user360_n115c_action_expert_help'] = 'Action CRM avancée sur ce client.';
$string['crm_user360_n115c_no_expert_actions'] = 'Aucune action CRM avancée disponible.';
$string['crm_intelligence_recommendation_review_customer_success_risk'] = 'Vérifier le risque Customer Success';
$string['crm_intelligence_recommendation_intervene_disengagement_spiral'] = 'Intervenir face au désengagement';
$string['crm_intelligence_recommendation_review_learning_difficulty'] = 'Vérifier une difficulté pédagogique';

// Commerce 7.95 N11.5D — Relation CRM fixes.
$string['crm_user360_n115d_assistant_recommendations'] = 'Recommandations prioritaires';
$string['crm_user360_n115d_assistant_question'] = 'Interroger l’Assistant';
$string['crm_user360_n115d_no_assistant_recommendations'] = 'Aucune recommandation prioritaire actuellement.';
$string['crm_user360_n115d_assistant_unavailable'] = 'L’Assistant conversationnel n’est pas disponible pour cette session.';

// Commerce 7.95 N11.6A — Advanced Commerce.
$string['crm_user360_n116a_orders_title'] = 'Commandes détaillées';
$string['crm_user360_n116a_orders_help'] = 'Historique Commerce Native et unifié, avec navigation directe vers les commandes et les produits.';
$string['crm_user360_n116a_legacy_subscriptions_title'] = 'Abonnements Legacy';
$string['crm_user360_n116a_legacy_subscriptions_help'] = 'Anciennes formules d’abonnement encore conservées pour l’historique et les opérations de support.';
$string['crm_user360_n116a_open_course'] = 'Ouvrir le cours';
$string['crm_user360_n116a_open_product'] = 'Voir le produit';
$string['crm_user360_n116a_communication'] = 'Communication';
$string['crm_user360_n116a_management'] = 'Gestion';
$string['crm_user360_n116a_extend_30_days'] = 'Prolonger de 30 jours';
$string['crm_user360_n116a_access_period'] = 'Du {$a->start} au {$a->end}';
$string['crm_user360_n116a_access_until'] = 'Jusqu’au {$a}';
$string['crm_user360_n116a_access_unlimited'] = 'Accès permanent';

// Commerce 7.95 N11.6B — User360 Commerce actions/readability.
$string['crm_user360_n116b_open_sales'] = 'Voir dans CRM Ventes';

// Commerce 7.95 N11.6C — User360 / Commerce polish.
$string['crm_user360_n116c_access_lifetime'] = 'Accès à vie';
$string['crm_user360_n116c_access_until'] = 'Accès jusqu’au {$a}';
$string['crm_user360_n116c_access_expired'] = 'Accès expiré';

// Commerce 7.95 N11.7A — User360 Identity panel.
$string['crm_user360_n117a_commerce_orders'] = '{$a} commande(s) Commerce';
$string['crm_user360_n117a_legacy_purchases'] = '{$a} achat(s) Legacy';
$string['crm_user360_n117a_personal_offers'] = '{$a} offre(s) personnelle(s)';
$string['crm_user360_n117a_merge_sources'] = '{$a} élément(s) de fusion';
$string['crm_user360_n117a_identity_source_details'] = 'Voir le détail technique';

// Commerce 7.95 N11.7B — Identity 2-column layout.
$string['crm_user360_n117b_merge'] = 'Fusionner';
$string['crm_user360_n117b_potential_column_title'] = 'Comptes potentiellement liés';

// Commerce 7.95 N11.8A — Legacy subscription editor polish.
$string['crm_subscription_edit_legacy_badge'] = 'Abonnement Legacy';
$string['crm_subscription_edit_current_period'] = 'Période actuelle';
$string['crm_subscription_edit_access_title'] = 'Paramètres d’accès';
$string['crm_subscription_edit_access_help'] = 'Modifiez uniquement la période d’accès ou le statut de cet abonnement Legacy.';
$string['crm_subscription_edit_start_date'] = 'Date de début';
$string['crm_subscription_edit_start_date_help'] = 'Date à partir de laquelle l’abonnement donne accès aux ressources associées.';
$string['crm_subscription_edit_no_end_date'] = 'Accès sans date de fin';
$string['crm_subscription_edit_no_end_date_help'] = 'Activez cette option pour conserver l’accès sans date d’expiration.';
$string['crm_subscription_edit_end_date'] = 'Date de fin';
$string['crm_subscription_edit_end_date_help'] = 'Dernier jour de validité lorsque l’abonnement possède une durée limitée.';
$string['crm_subscription_edit_status'] = 'Statut';
$string['crm_subscription_edit_status_help'] = 'État administratif Legacy de l’abonnement. À modifier uniquement lorsqu’une correction manuelle est nécessaire.';

// Commerce 7.95 N11.8B — Legacy CSV import polish.
$string['crm_legacy_import_upload_title'] = 'Importer des accès Legacy';
$string['crm_legacy_import_upload_help'] = 'Sélectionnez un fichier CSV d’abonnements Legacy. Une prévisualisation permet de vérifier les lignes avant toute création.';
$string['crm_legacy_import_preview_title'] = 'Vérifier l’import';
$string['crm_legacy_import_preview_help'] = 'Contrôlez les bénéficiaires, les plans et les montants. Les doublons détectés sont exclus automatiquement.';
$string['crm_legacy_import_result_summary_title'] = 'Import terminé';
$string['crm_legacy_import_result_summary_help'] = 'Voici le résultat de la création des accès Legacy à partir du fichier CSV.';
$string['crm_legacy_import_no_file'] = 'Aucun fichier sélectionné';
$string['crm_legacy_import_entry_title'] = 'Import CSV Legacy';
$string['crm_legacy_import_entry_help'] = 'Créer plusieurs accès Legacy depuis un fichier CSV historique.';
$string['crm_legacy_import_entry_action'] = 'Importer des accès';

// Commerce 7.95 N11.9B — Identity reconciliation UX.
$string['crm_identity_reconciliation_search_placeholder'] = 'E-mail, client, référence CFR…';
$string['crm_identity_reconciliation_more_filters'] = 'Plus de filtres';
$string['crm_identity_reconciliation_results_title'] = '{$a} vente(s) à rapprocher';
$string['crm_identity_reconciliation_results_help'] = 'Chaque ligne propose le compte Moodle le plus probable, sans modifier les données tant que vous ne validez pas l’action.';
$string['crm_identity_reconciliation_sale'] = 'Vente';
$string['crm_identity_reconciliation_proposed_account'] = 'Compte proposé';
$string['crm_identity_reconciliation_expected_effect'] = 'Effet prévu';
$string['crm_identity_reconciliation_moodle_account'] = 'Compte Moodle';
$string['crm_identity_reconciliation_effect_total'] = '{$a} modification(s) prévue(s)';
$string['crm_identity_reconciliation_effect_course_access'] = '{$a} accès cours';
$string['crm_identity_reconciliation_effect_digital'] = '{$a} accès numérique(s)';
$string['crm_identity_reconciliation_effect_guest'] = '{$a} session(s) invitée(s)';
$string['crm_identity_reconciliation_effect_legacy'] = '{$a} donnée(s) Legacy';
$string['crm_identity_reconciliation_effect_link_only'] = 'Rattachement du client à la vente';

// Commerce 7.95 N11.9B.1 — Reconciliation impact details.
$string['crm_identity_reconciliation_effect_heading'] = 'Ce qui sera modifié';
$string['crm_identity_reconciliation_effect_purchase_link'] = 'Rattacher la vente au compte Moodle #{$a->userid}';
$string['crm_identity_reconciliation_effect_course_access_detail'] = 'Attribuer {$a->count} accès cours au compte Moodle #{$a->userid}';
$string['crm_identity_reconciliation_effect_digital_detail'] = 'Attribuer {$a->count} accès numérique(s) au compte Moodle #{$a->userid}';
$string['crm_identity_reconciliation_effect_guest_detail'] = 'Rattacher {$a->count} session(s) invitée(s) au compte Moodle #{$a->userid}';
$string['crm_identity_reconciliation_effect_legacy_detail'] = 'Rattacher l’achat digital Legacy #{$a->legacyid} au compte Moodle #{$a->userid}';
$string['crm_identity_reconciliation_effect_none'] = 'Aucune donnée associée supplémentaire à mettre à jour';

// Commerce 7.95 N11.9C — Similarity UX and scoring.
$string['crm_identity_similarity_results_title'] = '{$a} correspondance(s) proposée(s)';
$string['crm_identity_similarity_scan_detail'] = '{$a} comptes analysés';
$string['crm_identity_similarity_score_help'] = 'L’indice mesure la force des signaux communs, pas la certitude qu’il s’agit de la même personne. Deux comptes distincts n’atteignent jamais 100 % et toute fusion reste manuelle.';

// Commerce 7.95 N11.9D — Weighted similarity and identity links UX.
$string['crm_identity_similarity_check_email'] = 'E-mail';
$string['crm_identity_similarity_check_name'] = 'Nom et prénom';
$string['crm_identity_similarity_check_phone'] = 'Téléphone';
$string['crm_identity_similarity_check_weight'] = 'poids {$a} %';
$string['crm_identity_relationships_inspector_title'] = 'Examiner une identité';
$string['crm_identity_relationships_inspector_help'] = 'Recherchez soit un compte Moodle, soit une identité Commerce / Legacy. L’écran rassemble ensuite les e-mails connus et les liens d’identité associés.';
$string['crm_identity_relationships_moodle_account'] = 'Compte Moodle';
$string['crm_identity_relationships_moodle_account_help'] = 'Utilisez l’identifiant Moodle lorsque le compte existe déjà.';
$string['crm_identity_relationships_userid_placeholder'] = 'Ex. 163';
$string['crm_identity_relationships_or'] = 'ou';
$string['crm_identity_relationships_external_identity'] = 'Identité Commerce / Legacy';
$string['crm_identity_relationships_external_identity_help'] = 'Utilisez l’e-mail lorsqu’aucun compte Moodle n’est encore connu.';
$string['crm_identity_relationships_email_placeholder'] = 'client@exemple.com';
$string['crm_identity_relationships_empty_help'] = 'Aucune identité sélectionnée. Saisissez un ID Moodle ou un e-mail pour afficher son historique et ses rapprochements.';

// Commerce 7.95 N11.9E — Provisioning and Legacy quality polish.
$string['crm_identity_provisioning_diagnostic'] = 'Diagnostic';
$string['crm_identity_provisioning_recommendation'] = 'Action recommandée';
$string['crm_identity_provisioning_ready_help'] = 'Aucun compte Moodle correspondant détecté : la création peut être prévisualisée.';
$string['crm_identity_provisioning_open_existing'] = 'Ouvrir le compte Moodle #{$a}';
$string['crm_identity_provisioning_ambiguous_help'] = 'Plusieurs comptes utilisent exactement cet e-mail. Vérifiez l’identité avant toute action.';
$string['crm_identity_provisioning_similar_help'] = '{$a} compte(s) potentiellement similaire(s) détecté(s). Vérifiez-les avant de créer un nouveau compte.';
$string['crm_identity_provisioning_more_candidates'] = '+ {$a} autre(s) candidat(s)';
$string['crm_identity_legacy_quality_results_title'] = '{$a} identité(s) Legacy';
$string['crm_identity_legacy_quality_results_help'] = 'Les lignes suspectes ou invalides sont prioritaires ; les adresses saines restent consultables via le filtre.';
$string['crm_identity_legacy_quality_history'] = 'Historique Legacy';
$string['crm_identity_legacy_quality_correct'] = 'Corriger';

// Commerce 7.95 N12.1 — CRM Inbox UX and manual refresh.
$string['crm_inbox_refresh'] = 'Actualiser la boîte';
$string['crm_inbox_refresh_success'] = 'Boîte actualisée : {$a->fetched} message(s) récupéré(s), {$a->created} nouveau(x), {$a->updated} mis à jour, {$a->errors} erreur(s).';
$string['crm_inbox_refresh_has_more'] = 'D\'autres messages restent disponibles ; relancez l’actualisation si nécessaire.';
$string['crm_inbox_refresh_no_accounts'] = 'Aucun compte de messagerie CRM actif n’est configuré.';
$string['crm_inbox_refresh_failed'] = 'L’actualisation de la boîte CRM a échoué. Consultez le diagnostic Inbox pour plus de détails.';

// Commerce 7.95 N12.2 — Inbox card badges and remote-image preview polish.
$string['crm_inbox_unread_count_compact'] = 'Non lus : {$a}';
$string['crm_inbox_remote_images_blocked_summary'] = '{$a} image(s) externe(s) masquée(s). Leur chargement peut informer l’expéditeur que le message a été ouvert.';


$string['crm_inbox_load_remote_images'] = 'Afficher les images';

// Commerce 7.95 N12.4A — Inbox AI translation and analysis workspace.
$string['crm_inbox_ai_panel_description_n124'] = 'Traduisez le dernier message client, analysez sa demande ou préparez une réponse assistée.';
$string['crm_inbox_ai_translate_title'] = 'Traduire le message';
$string['crm_inbox_ai_translate_help'] = 'Traduction du dernier message reçu dans la langue choisie par l’administrateur.';
$string['crm_inbox_ai_translate_action'] = 'Traduire';
$string['crm_inbox_ai_analysis_title_n124'] = 'Analyser la demande';
$string['crm_inbox_ai_analysis_help_n124'] = 'Identifie la langue, l’urgence, la catégorie, les demandes et les points à traiter.';
$string['crm_inbox_ai_reply_title_n124'] = 'Préparer une réponse';
$string['crm_inbox_ai_reply_help_n124'] = 'Propose un brouillon à relire avant tout envoi au client.';
$string['crm_inbox_ai_processing_n124'] = 'Traitement IA en cours…';
$string['crm_inbox_ai_processing_short_n124'] = 'Traitement…';
$string['crm_inbox_ai_empty_title_n124'] = 'Choisissez un outil';
$string['crm_inbox_ai_empty_help_n124'] = 'La traduction et l’analyse s’afficheront ici, dans un espace suffisamment large pour être relues confortablement.';
$string['crm_inbox_ai_translation_result_title'] = 'Traduction du dernier message';
$string['crm_inbox_ai_analysis_result_title_n124'] = 'Analyse de la demande client';
$string['crm_inbox_ai_analysis_no_summary_n124'] = 'Aucun résumé exploitable n’a été produit.';
$string['crm_inbox_ai_analysis_no_details_n124'] = 'Aucun point complémentaire n’a été identifié.';
$string['crm_inbox_ai_fallback_notice_n124'] = 'Analyse locale de secours utilisée pour tout ou partie du résultat. Les fonctions avancées sont plus riches lorsqu’un fournisseur IA distant est disponible.';

// Commerce 7.95 N12.4B — AI layout and result hierarchy fix.
$string['crm_inbox_ai_translation_provider_missing_n124b'] = 'La traduction nécessite le fournisseur IA OpenAI, mais il n’est pas disponible dans la configuration actuelle. Vérifiez l’activation du provider, le modèle et la clé API.';

// Commerce 7.95 N12.7A — Work Management workspace polish.
$string['crm_work_section_navigation_n127a'] = 'Navigation Work Management';
$string['crm_work_open_n127a'] = 'Afficher';
$string['crm_work_no_due_n127a'] = 'Aucune échéance';
$string['crm_work_unassigned_n127a'] = 'Non assigné';
$string['crm_work_assignment_n127a'] = 'Affectation';
$string['crm_work_assignee_n127a'] = 'Responsable';
$string['crm_work_management_n127a'] = 'Pilotage';
$string['crm_work_description_n127a'] = 'Description';
$string['crm_work_create_content_n127a'] = 'Contenu du Work Item';
$string['crm_work_create_settings_n127a'] = 'Organisation et priorité';
$string['crm_work_team_description_n127a'] = 'Description';
$string['crm_work_team_empty_n127a'] = 'Aucune équipe n’a encore été créée.';
$string['crm_work_team_members_n127a'] = 'Membres';
$string['crm_work_team_no_members_n127a'] = 'Aucun membre dans cette équipe.';
...
$string['crm_work_history_created_n127a1'] = 'Work Item créé';
$string['crm_work_history_status_changed_n127a1'] = 'Statut modifié';
$string['crm_work_history_priority_changed_n127a1'] = 'Priorité modifiée';
$string['crm_work_history_assignment_changed_n127a1'] = 'Affectation modifiée';
$string['crm_work_history_comment_added_n127a1'] = 'Commentaire ajouté';
$string['crm_work_history_link_added_n127a1'] = 'Lien ajouté';

// Commerce 7.95 N12.8A — Administrator Tools workspace polish.
$string['crm_admin_tools_navigation_n128a'] = 'Navigation des outils administrateur';
$string['crm_admin_tools_group_messaging_n128a'] = 'Messagerie CRM';
$string['crm_admin_tools_group_messaging_help_n128a'] = 'Synchronisation, connexion et diagnostic de la boîte de réception.';
$string['crm_admin_tools_group_automation_n128a'] = 'Intelligence et automatisations';
$string['crm_admin_tools_group_automation_help_n128a'] = 'Relance des moteurs CRM, recalculs et recommandations.';
$string['crm_admin_tools_group_operations_n128a'] = 'Commerce et maintenance';
$string['crm_admin_tools_group_operations_help_n128a'] = 'Opérations techniques sur les paiements digitaux et la qualité du Help Center.';
$string['crm_admin_tool_execution_context_n128a'] = 'Cette page exécute une opération administrative contrôlée. Le niveau de risque indique son impact potentiel sur les données et les traitements CRM.';
$string['crm_admin_tool_execution_settings_n128a'] = 'Paramètres d’exécution';

// Commerce 7.95 N12.9A — CRM Assistant workspace polish.
$string['crm_assistant_results_count_n129a'] = '{$a} recommandation(s) correspondent aux filtres';
$string['crm_assistant_per_page_n129a'] = 'Par page';
$string['crm_assistant_overview_title_n129a'] = 'Situation de l’Assistant CRM';

// Commerce 7.95 N12.9B — Assistant Customer Success subpages polish.
$string['csplanoverviewlabel_n129b'] = 'Plan Customer Success';
$string['csplanconfirmhelp_n129b'] = 'Vérifiez l’action avant de modifier le plan Customer Success.';
$string['csplanconfirmwarning_n129b'] = 'Cette action modifie le suivi du client. Vous pourrez revenir au plan sans appliquer la modification.';

// Commerce 7.95 N12.9C — User360 Customer Success plan creation.
$string['csplancreate_button_n129c'] = 'Créer un plan';
$string['csplancreate_title_n129c'] = 'Créer un plan Customer Success';
$string['csplancreate_help_n129c'] = 'Préparez un plan de suivi pour {$a}. Le plan sera créé en brouillon avant activation.';
$string['csplancreate_success_n129c'] = 'Le plan Customer Success a été créé.';
$string['csplancreate_plan_section_n129c'] = 'Objectif du suivi';
$string['csplancreate_title_field_n129c'] = 'Titre du plan';
$string['csplancreate_description_field_n129c'] = 'Description';
$string['csplancreate_settings_section_n129c'] = 'Priorité et échéance';
$string['csplancreate_priority_field_n129c'] = 'Priorité';
$string['csplancreate_targetdate_field_n129c'] = 'Échéance globale';
$string['csplancreate_first_step_section_n129c'] = 'Première étape';
$string['csplancreate_first_step_help_n129c'] = 'Facultatif : ajoutez immédiatement une première action au plan.';
$string['csplancreate_first_step_title_n129c'] = 'Action à réaliser';
$string['csplancreate_first_step_description_n129c'] = 'Détails de l’action';
$string['csplancreate_first_step_due_n129c'] = 'Échéance de l’étape';
$string['csplancreate_submit_n129c'] = 'Créer le plan';

// Commerce 7.95 N12.9D — AI diagnostics and Customer Success polish.
$string['csplancreate_new_after_cancel_n129d'] = 'Créer un nouveau plan';
$string['crm_inbox_ai_diag_health_title_n129d'] = 'Assistance IA opérationnelle';
$string['crm_inbox_ai_diag_health_detail_n129d'] = '{$a->ok} contrôles réussis sur {$a->total}.';
$string['crm_inbox_ai_usage_global_label_n129d'] = 'Quota global aujourd’hui';
$string['crm_inbox_ai_usage_user_label_n129d'] = 'Votre quota aujourd’hui';
$string['crm_inbox_ai_failures_label_n129d'] = 'Erreurs aujourd’hui';
$string['crm_inbox_ai_diag_checks_title_n129d'] = 'État de la configuration';
$string['crm_inbox_ai_diag_checks_help_n129d'] = 'Contrôles techniques du stockage, du fournisseur IA et de l’orchestrateur.';
$string['crm_inbox_ai_diag_usage_help_n129d'] = 'Consommation des quotas IA pour la journée en cours.';

// Commerce 7.95 N12.10A — Help diagnostics and Inbox AI navigation polish.
$string['crm_nav_inbox_ai_diagnostics_n1210a'] = 'Diagnostic IA';
$string['crm_help_diagnostics_health_ok_n1210a'] = 'Centre d’aide cohérent';
$string['crm_help_diagnostics_health_attention_n1210a'] = 'Corrections nécessaires';
$string['crm_help_diagnostics_health_detail_n1210a'] = '{$a->total} contrôles exécutés · {$a->errors} erreur(s) · {$a->warnings} avertissement(s)';
$string['crm_help_diagnostics_errors_help_n1210a'] = 'Problèmes bloquants ou contenus manquants à corriger.';
$string['crm_help_diagnostics_warnings_help_n1210a'] = 'Écarts de cohérence ou de traduction qui méritent une vérification.';
$string['crm_help_diagnostics_successes_help_n1210a'] = 'Contrôles validés avec succès. Cette section est repliée par défaut.';

// Commerce 7.95 N12.10B — Help Center homepage polish.
$string['crm_help_quick_navigation_n1210b'] = 'Raccourcis du Centre d’aide';

// Commerce 7.95 N12.10C — localized Help Center diagnostic messages.
$string['crm_help_diag_msg_content_dir_missing_n1210c'] = 'Le répertoire de contenu du Centre d’aide n’existe pas : {$a}';
$string['crm_help_diag_msg_content_dir_unreadable_n1210c'] = 'Le répertoire de contenu du Centre d’aide n’est pas lisible : {$a}';
$string['crm_help_diag_msg_content_dir_ok_n1210c'] = 'Le répertoire de contenu du Centre d’aide est disponible.';
$string['crm_help_diag_msg_language_dir_missing_n1210c'] = 'Répertoire de langue du Centre d’aide manquant : {$a}';
$string['crm_help_diag_msg_language_dir_unreadable_n1210c'] = 'Le répertoire de langue du Centre d’aide n’est pas lisible : {$a}';
$string['crm_help_diag_msg_language_dir_ok_n1210c'] = 'Répertoire de langue du Centre d’aide disponible : {$a}';
$string['crm_help_diag_msg_language_file_unloadable_n1210c'] = 'Impossible de charger le fichier de langue : {$a}';
$string['crm_help_diag_msg_language_strings_loaded_n1210c'] = '{$a->count} chaîne(s) de langue chargée(s) pour {$a->language}.';
$string['crm_help_diag_msg_language_key_missing_n1210c'] = 'Chaîne de langue manquante en {$a->language} : {$a->key}';
$string['crm_help_diag_msg_language_key_extra_n1210c'] = 'La chaîne existe en {$a->language}, mais pas en anglais : {$a->key}';
$string['crm_help_diag_msg_language_keys_match_n1210c'] = 'Le fichier de langue {$a} correspond au jeu de clés anglais.';
$string['crm_help_diag_msg_no_category_n1210c'] = 'Le registre du Centre d’aide ne contient aucune catégorie.';
$string['crm_help_diag_msg_category_empty_id_n1210c'] = 'Une catégorie du Centre d’aide a un identifiant vide.';
$string['crm_help_diag_msg_category_duplicate_id_n1210c'] = 'Identifiant de catégorie dupliqué : {$a}';
$string['crm_help_diag_msg_category_empty_title_n1210c'] = 'Une catégorie a un titre vide : {$a}';
$string['crm_help_diag_msg_category_no_description_n1210c'] = 'Une catégorie n’a pas de description : {$a}';
$string['crm_help_diag_msg_categories_validated_n1210c'] = '{$a} catégorie(s) du Centre d’aide validée(s).';
$string['crm_help_diag_msg_no_article_n1210c'] = 'Le registre du Centre d’aide ne contient aucun article.';
$string['crm_help_diag_msg_articles_validated_n1210c'] = '{$a} article(s) du Centre d’aide validé(s).';
$string['crm_help_diag_msg_article_empty_id_n1210c'] = 'Un article du Centre d’aide a un identifiant vide.';
$string['crm_help_diag_msg_article_duplicate_id_n1210c'] = 'Identifiant d’article dupliqué : {$a}';
$string['crm_help_diag_msg_article_unknown_category_n1210c'] = 'L’article « {$a->article} » référence une catégorie inconnue « {$a->category} ».';
$string['crm_help_diag_msg_article_empty_title_n1210c'] = 'Un article a un titre vide : {$a}';
$string['crm_help_diag_msg_article_no_summary_n1210c'] = 'Un article n’a pas de résumé : {$a}';
$string['crm_help_diag_msg_article_invalid_filename_n1210c'] = 'L’article « {$a->article} » utilise un nom de fichier de contenu invalide : {$a->file}';
$string['crm_help_diag_msg_article_invalid_context_n1210c'] = 'L’article « {$a->article} » référence un contexte invalide « {$a->context} ».';
$string['crm_help_diag_msg_article_no_context_n1210c'] = 'Un article n’a aucune affectation contextuelle : {$a}';
$string['crm_help_diag_msg_article_no_keyword_n1210c'] = 'Un article n’a aucun mot-clé de recherche : {$a}';
$string['crm_help_diag_msg_markdown_missing_n1210c'] = 'Fichier Markdown manquant pour l’article « {$a->article} » en langue « {$a->language} » : {$a->file}';
$string['crm_help_diag_msg_markdown_unreadable_n1210c'] = 'Fichier Markdown illisible : {$a}';
$string['crm_help_diag_msg_markdown_read_failed_n1210c'] = 'Impossible de lire le fichier Markdown : {$a}';
$string['crm_help_diag_msg_markdown_empty_n1210c'] = 'Fichier Markdown vide : {$a}';
$string['crm_help_diag_msg_markdown_no_h1_n1210c'] = 'Le fichier Markdown ne contient aucun titre de niveau 1 : {$a}';
$string['crm_help_diag_msg_markdown_link_missing_n1210c'] = 'L’article « {$a->article} » ({$a->language}) référence un fichier Markdown manquant « {$a->target} ».';
$string['crm_help_diag_source_article_n1210c'] = 'Article {$a->article} ({$a->language})';
$string['crm_help_diag_msg_markdown_unregistered_n1210c'] = 'Fichier Markdown non enregistré : {$a}';
$string['crm_help_diag_msg_no_guide_n1210c'] = 'Le Centre d’aide ne contient aucun guide pratique.';
$string['crm_help_diag_msg_guides_validated_n1210c'] = '{$a} guide(s) pratique(s) validé(s).';
$string['crm_help_diag_msg_guide_empty_id_n1210c'] = 'Un guide pratique a un identifiant vide.';
$string['crm_help_diag_msg_guide_duplicate_id_n1210c'] = 'Identifiant de guide pratique dupliqué : {$a}';
$string['crm_help_diag_msg_guide_empty_title_n1210c'] = 'Un guide a un titre vide : {$a}';
$string['crm_help_diag_msg_guide_no_description_n1210c'] = 'Un guide n’a pas de description : {$a}';
$string['crm_help_diag_msg_guide_no_step_n1210c'] = 'Un guide ne contient aucune étape : {$a}';
$string['crm_help_diag_msg_guide_invalid_context_n1210c'] = 'Le guide « {$a->guide} » référence un contexte invalide « {$a->context} ».';
$string['crm_help_diag_msg_guide_step_empty_id_n1210c'] = 'Le guide « {$a} » contient une étape sans identifiant.';
$string['crm_help_diag_msg_guide_step_duplicate_n1210c'] = 'Le guide « {$a->guide} » contient l’étape dupliquée « {$a->step} ».';
$string['crm_help_diag_msg_guide_step_empty_title_n1210c'] = 'Une étape de guide a un titre vide : {$a->guide}/{$a->step}';
$string['crm_help_diag_msg_guide_step_incomplete_action_n1210c'] = 'Une étape de guide a une action incomplète : {$a->guide}/{$a->step}';
$string['crm_help_diag_source_guide_step_n1210c'] = 'Étape du guide {$a->guide}/{$a->step}';
$string['crm_help_diag_msg_no_onboarding_n1210c'] = 'Le Centre d’aide ne contient aucune étape de prise en main.';
$string['crm_help_diag_msg_onboarding_invalid_object_n1210c'] = 'Objet d’étape de prise en main invalide.';
$string['crm_help_diag_msg_onboarding_empty_id_n1210c'] = 'Une étape de prise en main a un identifiant vide.';
$string['crm_help_diag_msg_onboarding_duplicate_id_n1210c'] = 'Identifiant d’étape de prise en main dupliqué : {$a}';
$string['crm_help_diag_msg_onboarding_empty_title_n1210c'] = 'Une étape de prise en main a un titre vide : {$a}';
$string['crm_help_diag_msg_onboarding_no_description_n1210c'] = 'Une étape de prise en main n’a pas de description : {$a}';
$string['crm_help_diag_source_onboarding_step_n1210c'] = 'Étape de prise en main {$a}';
$string['crm_help_diag_msg_onboarding_validated_n1210c'] = '{$a} étape(s) de prise en main validée(s).';
$string['crm_help_diag_msg_missing_page_n1210c'] = '{$a->source} référence une page manquante : {$a->path}';
$string['crm_help_diag_msg_unknown_help_article_n1210c'] = '{$a->source} référence un article inconnu du Centre d’aide : {$a->article}';
$string['crm_help_diag_empty_value_n1210c'] = '[vide]';

// Commerce 7.95 N12.10D — Help Center page UX harmonisation.
$string['crm_help_internal_navigation_n1210d'] = 'Navigation du Centre d’aide';
$string['crm_help_nav_home_n1210d'] = 'Accueil';
$string['crm_help_nav_guides_n1210d'] = 'Guides pratiques';
$string['crm_help_nav_articles_n1210d'] = 'Documentation';
$string['crm_help_nav_diagnostics_n1210d'] = 'Diagnostic';
$string['crm_help_documentation_title_n1210d'] = 'Documentation CRM';
$string['crm_help_documentation_description_n1210d'] = 'Parcourez les articles par rubrique pour retrouver rapidement le fonctionnement d’un écran, d’un outil ou d’un workflow.';

// Commerce 7.95 N12.11A — Dashboard information architecture.
$string['dashboard_n1211_focus_title'] = 'À piloter maintenant';
$string['dashboard_n1211_focus_description'] = 'Les signaux et priorités qui demandent une décision ou une action rapide.';
$string['dashboard_n1211_operations_title'] = 'Opérations du jour';
$string['dashboard_n1211_operations_description'] = 'Inbox, tâches et suivi Customer Success réunis dans une même zone de travail.';
$string['dashboard_n1211_insights_title'] = 'Analyse et tendances';
$string['dashboard_n1211_insights_description'] = 'Intelligence CRM, funnel, tendances et alertes pour comprendre ce qui évolue.';
$string['dashboard_n1211_secondary_title'] = 'Historique et contexte';
$string['dashboard_n1211_secondary_description'] = 'Activité récente et informations secondaires utiles sans encombrer le pilotage principal.';

// Commerce 7.95 N12.11B — Dashboard grid and density polish.
$string['dashboard_onboarding_open_full_n1211b'] = 'Voir tout le parcours de prise en main →';
$string['dashboard_team_permissions_count_n1211b'] = '{$a} droit(s) CRM actif(s)';
$string['dashboard_team_last_access_n1211b'] = 'Dernier accès : {$a}';

// Commerce 7.95 final certification — Legacy Access Scope compatibility.
$string['commerce_scope_legacy_compatibility_title'] = 'Compatibilité Legacy';
$string['commerce_scope_legacy_mapped_readonly_desc'] = 'Ce périmètre Legacy est relié à un ou plusieurs Produits Commerce Native. Les anciennes traductions sont conservées pour la compatibilité et l’audit, mais ne sont plus la source éditoriale officielle.';
$string['commerce_scope_legacy_unmapped_desc'] = 'Ce périmètre appartient encore au modèle Legacy. Ses traductions restent disponibles tant qu’aucun Produit Commerce Native ne le remplace.';
$string['commerce_scope_legacy_readonly_notice'] = 'Ce périmètre est piloté par Commerce Native et n’est plus modifiable depuis l’éditeur Legacy.';
$string['commerce_scope_legacy_readonly_badge'] = 'Lecture seule';
$string['commerce_scope_open_native_products'] = 'Ouvrir les Produits Native associés :';

// Commerce 7.95O1 — Inbox Premium mailbox reconciliation.
$string['crm_inbox_o1_sync_baseline_ok'] = 'La synchronisation professionnelle Inbox + Envoyés est active.';
$string['crm_inbox_o1_sync_baseline_problem'] = 'La synchronisation doit couvrir au minimum Inbox et Envoyés.';
$string['crm_inbox_o1_mailbox_sync_title'] = 'Synchronisation de la boîte mail';
$string['crm_inbox_o1_mailbox_sync_description'] = 'État des dossiers distants, de l’import incrémental et de la réconciliation IMAP avec les autres clients mail.';
$string['crm_inbox_o1_folder_inbox'] = 'Boîte de réception';
$string['crm_inbox_o1_folder_sent'] = 'Envoyés';
$string['crm_inbox_o1_folder_drafts'] = 'Brouillons';
$string['crm_inbox_o1_folder_archive'] = 'Archives';
$string['crm_inbox_o1_folder_trash'] = 'Corbeille';
$string['crm_inbox_o1_sync_enabled'] = 'Synchronisé';
$string['crm_inbox_o1_sync_disabled'] = 'Non synchronisé';
$string['crm_inbox_o1_incremental'] = 'Import';
$string['crm_inbox_o1_reconciliation'] = 'Réconciliation';
$string['crm_inbox_o1_never'] = 'jamais';
$string['crm_inbox_o1_reconciliation_counts'] = '{$a->checked} vérifié(s) · {$a->updated} état(s) mis à jour · {$a->moved} déplacement(s) détecté(s) · {$a->missing} emplacement(s) disparu(s)';
$string['crm_inbox_o1_refresh_reconciliation'] = 'Réconciliation IMAP : {$a->checked} vérifié(s), {$a->updated} état(s) mis à jour, {$a->moved} déplacement(s) détecté(s), {$a->missing} emplacement(s) distant(s) disparu(s).';

// Commerce 7.95O1.2 — Inbox diagnostics and configurable mailbox account.
$string['crm_inbox_diagnostics_operational'] = 'Boîte de réception CRM opérationnelle';
$string['crm_inbox_diagnostics_operational_desc'] = 'La boîte mail, les connexions serveur et le stockage requis sont opérationnels.';
$string['crm_inbox_diagnostics_attention'] = 'La boîte de réception CRM nécessite une vérification';
$string['crm_inbox_diagnostics_attention_desc'] = '{$a} problème(s) de diagnostic nécessitent une vérification.';
$string['crm_inbox_diagnostics_rerun'] = 'Relancer le diagnostic';
$string['crm_inbox_diagnostics_open_inbox'] = 'Ouvrir la boîte de réception';
$string['crm_inbox_diagnostics_imap'] = 'Réception IMAP';
$string['crm_inbox_diagnostics_smtp'] = 'Envoi SMTP';
$string['crm_inbox_diagnostics_account'] = 'Compte de messagerie';
$string['crm_inbox_diagnostics_database'] = 'Stockage CRM';
$string['crm_inbox_diagnostics_email_account'] = 'Adresse de la boîte';
$string['crm_inbox_diagnostics_account_state'] = 'État du compte';
$string['crm_inbox_diagnostics_credentials'] = 'Identifiants';
$string['crm_inbox_diagnostics_folders'] = 'Dossiers IMAP';
$string['crm_inbox_diagnostics_account_panel'] = 'Boîte configurée';
$string['crm_inbox_diagnostics_server_panel'] = 'Serveur de messagerie';
$string['crm_inbox_diagnostics_ok'] = 'Opérationnel';
$string['crm_inbox_diagnostics_problem'] = 'Problème';
$string['crm_inbox_diagnostics_metric_threads'] = 'Conversations';
$string['crm_inbox_diagnostics_metric_messages'] = 'Messages';
$string['crm_inbox_diagnostics_metric_contacts'] = 'Contacts';
$string['crm_inbox_diagnostics_metric_unmatched'] = 'Contacts non rapprochés';
$string['crm_inbox_diagnostics_metric_ambiguous'] = 'Contacts ambigus';
$string['crm_inbox_diagnostics_metric_pending_attachments'] = 'Pièces jointes en attente';
$string['crm_inbox_diagnostics_metric_failed_attachments'] = 'Pièces jointes en erreur';
$string['crm_inbox_diagnostics_checks_all_ok'] = '{$a} contrôles techniques réussis.';
$string['crm_inbox_diagnostics_checks_errors'] = '{$a} contrôle(s) technique(s) en erreur.';
$string['crm_inbox_diagnostics_technical'] = 'Contrôles techniques';

// Commerce 7.95O2 — professional read/unread management.
$string['crm_inbox_mark_read_o2'] = 'Marquer comme lu';
$string['crm_inbox_mark_unread_o2'] = 'Marquer comme non lu';
$string['crm_inbox_marked_unread_o2'] = 'Conversation marquée comme non lue.';
$string['crm_inbox_bulk_selection_o2'] = 'Actions sur la sélection';
$string['crm_inbox_bulk_none_selected_o2'] = 'Sélectionnez au moins une conversation.';
$string['crm_inbox_bulk_marked_read_o2'] = '{$a} conversation(s) marquée(s) comme lue(s).';
$string['crm_inbox_bulk_marked_unread_o2'] = '{$a} conversation(s) marquée(s) comme non lue(s).';
$string['crm_inbox_select_thread_o2'] = 'Sélectionner la conversation : {$a}';
$string['crm_inbox_unread_o2'] = 'Non lu';

// Commerce 7.95O3 — CRM Inbox unread navbar badge.
$string['crm_nav_inbox_unread_badge_o3'] = '{$a} message(s) entrant(s) non lu(s)';

// Commerce 7.95O4 — Inbox attachments.
$string['crm_inbox_attachments_o4'] = 'Pièces jointes';
$string['crm_inbox_attachments_help_o4'] = 'Jusqu’à {$a->count} fichiers · {$a->each} maximum par fichier · {$a->total} au total.';
$string['crm_inbox_attachments_saved_o4'] = 'Fichiers déjà joints au brouillon';
$string['crm_inbox_attachment_too_many_o4'] = 'Vous pouvez joindre au maximum {$a} fichiers.';
$string['crm_inbox_attachment_total_too_large_o4'] = 'La taille totale des pièces jointes dépasse {$a}.';
$string['crm_inbox_attachment_too_large_o4'] = 'Le fichier « {$a->filename} » dépasse la limite de {$a->limit}.';
$string['crm_inbox_attachment_upload_failed_o4'] = 'Impossible de téléverser la pièce jointe « {$a} ».';
$string['crm_inbox_attachment_read_failed_o4'] = 'Impossible de lire une pièce jointe téléversée.';

// Commerce 7.95O4.4 — attachment integrity hardening.
$string['crm_inbox_attachment_not_ready_o44'] = 'La pièce jointe « {$a} » n’est pas disponible pour l’envoi. Retirez-la puis ajoutez-la à nouveau.';

// Commerce 7.95O5 — inline CID images.
$string['crm_inbox_inline_image_insert_o5'] = 'Insérer une image';
$string['crm_inbox_inline_image_help_o5'] = 'Vous pouvez aussi coller une image ou la déposer directement dans le message.';
$string['crm_inbox_inline_image_type_o5'] = 'Le fichier « {$a} » n’est pas une image compatible.';

// Commerce 7.95O6 — premium composer.
$string['crm_inbox_new_message_o6'] = 'Nouveau message';
$string['crm_inbox_new_message_subtitle_o6'] = 'Rédigez un email complet depuis la boîte de réception CRM.';
$string['crm_inbox_from_o6'] = 'Depuis';
$string['crm_inbox_to_o6'] = 'À';
$string['crm_inbox_reply_all_o6'] = 'Répondre à tous';
$string['crm_inbox_forward_o6'] = 'Transférer';
$string['crm_inbox_forwarded_message_o6'] = 'Message transféré';
$string['crm_inbox_insert_link_o6'] = 'Insérer un lien';
$string['crm_inbox_message_sent_o6'] = 'Message envoyé.';
$string['crm_inbox_invalid_recipient_value_o6'] = 'L’adresse email « {$a} » n’est pas valide.';

// Commerce 7.95O7 — drafts and autosave.
$string['crm_inbox_autosave_ready_o7'] = 'Sauvegarde automatique activée.';
$string['crm_inbox_autosave_saving_o7'] = 'Enregistrement…';
$string['crm_inbox_autosave_saved_o7'] = 'Brouillon enregistré.';
$string['crm_inbox_autosave_error_o7'] = 'La sauvegarde automatique a échoué.';
$string['crm_inbox_drafts_o7'] = 'Brouillons';
$string['crm_inbox_drafts_count_o7'] = 'Brouillons ({$a})';
$string['crm_inbox_drafts_subtitle_o7'] = 'Retrouvez et reprenez les nouveaux messages enregistrés automatiquement.';
$string['crm_inbox_no_drafts_o7'] = 'Aucun brouillon enregistré.';
$string['crm_inbox_resume_draft_o7'] = 'Reprendre';
$string['crm_inbox_thread_without_subject'] = 'Sans objet';
$string['crm_inbox_draft_without_subject_o7'] = 'Sans objet';
$string['crm_inbox_draft_not_found_o7'] = 'Ce brouillon n’existe plus ou n’est plus disponible.';
$string['crm_inbox_back_to_inbox'] = 'Retour à la boîte de réception';

// Commerce 7.95O8 — Sent folder / multi-client interoperability.
$string['crm_inbox_sent_copy_failed_o8'] = 'Le message a bien été envoyé, mais sa copie n’a pas pu être enregistrée dans le dossier Envoyés.';

// Commerce 7.95O9 — signatures and quick replies.
$string['crm_inbox_templates_o9'] = 'Signatures et réponses rapides';
$string['crm_inbox_templates_subtitle_o9'] = 'Créez des signatures par boîte et des réponses réutilisables pour accélérer le traitement des emails.';
$string['crm_inbox_template_type_o9'] = 'Type';
$string['crm_inbox_template_type_signature_o9'] = 'Signature';
$string['crm_inbox_template_type_quickreply_o9'] = 'Réponse rapide';
$string['crm_inbox_template_name_o9'] = 'Nom';
$string['crm_inbox_template_account_o9'] = 'Boîte concernée';
$string['crm_inbox_template_all_accounts_o9'] = 'Toutes les boîtes';
$string['crm_inbox_template_content_o9'] = 'Contenu';
$string['crm_inbox_template_enabled_o9'] = 'Actif';
$string['crm_inbox_template_sortorder_o9'] = 'Ordre';
$string['crm_inbox_template_saved_o9'] = 'Modèle enregistré.';
$string['crm_inbox_template_not_found_o9'] = 'Ce modèle Inbox n’existe plus.';
$string['crm_inbox_template_name_required_o9'] = 'Le nom du modèle est obligatoire.';
$string['crm_inbox_template_body_required_o9'] = 'Le contenu du modèle est obligatoire.';
$string['crm_inbox_quick_reply_choose_o9'] = 'Insérer une réponse rapide…';
$string['crm_inbox_manage_templates_o9'] = 'Gérer les modèles';

// Commerce 7.95O9.1 / O10 — templates UX and conversation semantics.
$string['crm_inbox_template_type_help_o91'] = 'Une signature s’ajoute automatiquement aux emails. Une réponse rapide s’insère à la demande dans le composeur.';
$string['crm_inbox_template_name_help_o91'] = 'Nom interne visible uniquement dans le CRM.';
$string['crm_inbox_template_account_help_o91'] = 'Choisissez une boîte précise ou « Toutes les boîtes » pour rendre ce contenu disponible partout.';
$string['crm_inbox_template_subject_help_o91'] = 'Facultatif. Utilisé surtout pour les nouveaux messages créés depuis une réponse rapide.';
$string['crm_inbox_template_content_help_o91'] = 'Contenu HTML réutilisable. Les signatures sont ajoutées automatiquement ; les réponses rapides sont insérées manuellement.';
$string['crm_inbox_template_sortorder_help_o91'] = 'Les valeurs les plus basses apparaissent en premier.';
$string['crm_inbox_direction_filter_o10'] = 'Dernier message';
$string['crm_inbox_direction_received_o10'] = 'Reçu';
$string['crm_inbox_direction_sent_o10'] = 'Envoyé';

// Commerce 7.95O11 — Premium Inbox search and filters.
$string['crm_inbox_search_help_o11'] = 'Sujet, adresse, nom, contenu des messages, destinataires ou nom de pièce jointe…';
$string['crm_inbox_account_filter_o11'] = 'Boîte mail';
$string['crm_inbox_read_state_o11'] = 'Lecture';
$string['crm_inbox_read_state_unread_o11'] = 'Non lus';
$string['crm_inbox_read_state_read_o11'] = 'Lus';
$string['crm_inbox_attachments_filter_o11'] = 'Pièces jointes';
$string['crm_inbox_attachments_with_o11'] = 'Avec pièce jointe';
$string['crm_inbox_attachments_without_o11'] = 'Sans pièce jointe';
$string['crm_inbox_period_filter_o11'] = 'Période';
$string['crm_inbox_period_7days_o11'] = '7 derniers jours';
$string['crm_inbox_period_30days_o11'] = '30 derniers jours';
$string['crm_inbox_period_90days_o11'] = '90 derniers jours';
$string['crm_inbox_active_filters_o11'] = '{$a} filtre(s) actif(s)';
$string['crm_inbox_clear_filters_o11'] = 'Effacer tous les filtres';

// Commerce 7.95O12 — bulk actions and productivity.
$string['crm_inbox_bulk_choose_action_o12'] = 'Choisir une action…';
$string['crm_inbox_bulk_apply_o12'] = 'Appliquer';
$string['crm_inbox_bulk_select_all_o12'] = 'Tout sélectionner';
$string['crm_inbox_bulk_selected_count_o12'] = '{$a} sélectionné(s)';
$string['crm_inbox_bulk_archive_o12'] = 'Archiver';
$string['crm_inbox_bulk_trash_o12'] = 'Mettre à la corbeille';
$string['crm_inbox_bulk_trash_confirm_o12'] = 'Mettre les conversations sélectionnées à la corbeille ?';
$string['crm_inbox_bulk_status_open_o12'] = 'Statut : Ouvert';
$string['crm_inbox_bulk_status_pending_o12'] = 'Statut : En attente';
$string['crm_inbox_bulk_status_resolved_o12'] = 'Statut : Résolu';
$string['crm_inbox_bulk_status_closed_o12'] = 'Statut : Fermé';
$string['crm_inbox_bulk_status_spam_o12'] = 'Statut : Spam';
$string['crm_inbox_bulk_priority_low_o12'] = 'Priorité : Faible';
$string['crm_inbox_bulk_priority_normal_o12'] = 'Priorité : Normale';
$string['crm_inbox_bulk_priority_high_o12'] = 'Priorité : Haute';
$string['crm_inbox_bulk_priority_urgent_o12'] = 'Priorité : Urgente';
$string['crm_inbox_bulk_success_o12'] = '{$a} conversation(s) mise(s) à jour.';
$string['crm_inbox_bulk_partial_o12'] = '{$a->success} conversation(s) mise(s) à jour ; {$a->failed} échec(s).';

// Commerce 7.95O13 — professional mailbox folders.
$string['crm_inbox_folder_navigation_o13'] = 'Dossiers de messagerie';
$string['crm_inbox_folder_inbox_o13'] = 'Réception';
$string['crm_inbox_folder_sent_o13'] = 'Envoyés';
$string['crm_inbox_folder_drafts_o13'] = 'Brouillons';
$string['crm_inbox_folder_archive_o13'] = 'Archives';
$string['crm_inbox_folder_trash_o13'] = 'Corbeille';
$string['crm_inbox_folder_all_o13'] = 'Tous';
$string['crm_inbox_restore_to_inbox_o13'] = 'Restaurer dans Réception';
$string['crm_inbox_restored_o13'] = 'Conversation restaurée dans la boîte de réception.';

// Commerce 7.95O14 — Inbox hardening and observability.
$string['crm_inbox_o14_operational_title'] = 'Santé opérationnelle';
$string['crm_inbox_o14_operational_desc'] = 'Surveillance de la synchronisation, de l’intégrité locale et de la copie des messages envoyés.';
$string['crm_inbox_o14_last_success'] = 'Dernière synchronisation réussie :';
$string['crm_inbox_o14_failed_syncs'] = 'Échecs de sync · 24 h';
$string['crm_inbox_o14_partial_syncs'] = 'Sync partielles · 24 h';
$string['crm_inbox_o14_stale_runs'] = 'Sync bloquées';
$string['crm_inbox_o14_duplicate_identities'] = 'Identités message dupliquées';
$string['crm_inbox_o14_orphan_remote'] = 'Références IMAP orphelines';
$string['crm_inbox_o14_sentcopy_failures'] = 'Copies Envoyés en échec · 24 h';
$string['crm_inbox_o14_recent_runs'] = 'Dernières exécutions de synchronisation';
$string['crm_inbox_o14_log_counts'] = '{$a->fetched} lus · {$a->created} créés · {$a->errors} erreur(s)';
$string['crm_inbox_o14_sync_fresh_ok'] = 'La synchronisation Inbox est récente.';
$string['crm_inbox_o14_sync_fresh_problem'] = 'Aucune synchronisation réussie récente n’a été détectée.';
$string['crm_inbox_o14_integrity_ok'] = 'Aucune incohérence structurelle détectée.';
$string['crm_inbox_o14_integrity_problem'] = 'Des incohérences de données Inbox ont été détectées.';
$string['crm_inbox_o14_sentcopy_ok'] = 'Les copies dans Envoyés sont opérationnelles.';
$string['crm_inbox_o14_sentcopy_problem'] = '{$a} copie(s) vers Envoyés ont échoué durant les dernières 24 h.';

// Commerce 7.95O15 — Inbox global UX refactor.
$string['crm_inbox_o15_nav_label'] = 'Navigation de la boîte de réception CRM';
$string['crm_inbox_o15_nav_inbox'] = 'Boîte de réception';
$string['crm_inbox_o15_nav_compose'] = 'Nouveau message';
$string['crm_inbox_o15_nav_drafts'] = 'Brouillons';
$string['crm_inbox_o15_nav_templates'] = 'Signatures et réponses rapides';
$string['crm_inbox_o15_nav_diagnostics'] = 'Diagnostics';

// Commerce 7.95O16.1 — Inbox index UX polish.
$string['crm_inbox_o16_1_filters_summary'] = 'Recherche et filtres';
$string['crm_inbox_o16_1_filters_hint'] = 'Afficher les critères avancés';

// Commerce 7.95O16.2 — index filters and thread UX.
$string['crm_inbox_o16_2_apply'] = 'Appliquer';
$string['crm_inbox_o16_2_period_apply'] = 'Appliquer la période';
$string['crm_inbox_o16_2_status_label'] = 'Statut de la conversation';
$string['crm_inbox_o16_2_status_apply'] = 'Mettre à jour';
$string['crm_inbox_o16_2_other_actions'] = 'Autres actions';

// Commerce 7.95O16.3 — premium recipients and reply UX.
$string['crm_inbox_o16_3_recipient_placeholder'] = 'Rechercher un utilisateur ou saisir une adresse email…';
$string['crm_inbox_o16_3_edit_subject'] = 'Modifier le sujet';

$string['crm_inbox_period_custom_o16_3_2'] = 'Plage personnalisée';
$string['crm_inbox_period_from_o16_3_2'] = 'Du';
$string['crm_inbox_period_to_o16_3_2'] = 'Au';
$string['crm_inbox_last_sync_o1634'] = 'Dernière synchro : {$a}';


// Commerce 7.95O16.3.6 — Inbox diagnostics UX polish.
$string['crm_inbox_diagnostics_check_imap_extension_ok'] = 'Extension PHP IMAP activée';
$string['crm_inbox_diagnostics_check_imap_extension_missing'] = 'Extension PHP IMAP manquante';
$string['crm_inbox_diagnostics_check_table_available'] = 'Table {$a} disponible';
$string['crm_inbox_diagnostics_check_table_missing'] = 'Table {$a} manquante';
$string['crm_inbox_diagnostics_check_account_missing'] = 'Aucun compte CRM Inbox configuré';
$string['crm_inbox_diagnostics_check_account_enabled'] = 'Compte activé';
$string['crm_inbox_diagnostics_check_account_disabled'] = 'Compte désactivé';
$string['crm_inbox_diagnostics_check_credentials_available'] = 'Identifiants disponibles';
