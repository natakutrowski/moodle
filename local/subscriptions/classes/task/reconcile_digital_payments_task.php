...
use local_subscriptions\commerce\task\job\DigitalPaymentReconciliationJob;

final class reconcile_digital_payments_task extends AbstractCommerceTask {
    ...
    protected function create_job(): CommerceTaskJob {
        return new DigitalPaymentReconciliationJob();
    }
}
