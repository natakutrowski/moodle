...
final class OpenPurchaseAction extends AbstractCommandAction {

    public function key(): string {
        return CommandActionKeys::OPEN_PURCHASE;
    }
    ...
    public function execute(array $payload): CommandActionResult {
        ...
        return CommandActionResult::success('', (new moodle_url(
            subscription_config::digital_purchase_view_admin_page(), ['id' => $purchaseid]
        ))->out(false));
    }
}