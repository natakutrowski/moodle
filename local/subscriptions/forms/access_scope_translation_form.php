...
class access_scope_translation_form extends moodleform {
    protected function definition() {
        ...
        $mform->addElement('hidden', 'scope_id', $scope->id);
        $mform->setType('scope_id', PARAM_INT);
        ...
        $scopelabel = html_writer::div(
            ...
            html_writer::tag('div', format_string($scope->name) . ' (id : ' . $scope->id . ')', [
		...
		$cancelurl = new moodle_url(subscription_config::scopes_translations_page());
