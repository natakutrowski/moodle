...
final class commerce_795g7f_promotion_polish_test extends \advanced_testcase {
    public function test_configuration_navigation_opens_the_new_hub(): void {
        $registry = file_get_contents(
            __DIR__ . '/../../../classes/crm/commerce/navigation/CommerceSectionNavigationRegistry.php'
        );
        $hub = file_get_contents(
            __DIR__ . '/../../../admin/commerce/configuration/index.php'
        );

        $this->assertIsString($registry);
        $this->assertIsString($hub);
        $this->assertStringContainsString(
            '/admin/commerce/configuration/index.php',
            $registry
        );
        $this->assertStringContainsString(
        ...
        $this->assertStringContainsString(
            'CommerceConfigurationNavigationRenderer::render',
            $hub
        );
        $this->assertStringContainsString(
            "/admin/commerce/configuration/section.php",
            $hub
        );
        $this->assertStringNotContainsString(
            'commerce_configuration_promotions_title',
            $hub
        );
    }
