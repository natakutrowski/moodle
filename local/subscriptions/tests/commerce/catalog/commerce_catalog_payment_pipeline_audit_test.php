...
final class commerce_catalog_payment_pipeline_audit_test extends advanced_testcase {
    public function test_imported_plan_is_equal_through_complete_payment_pipeline(): void {
        ...
        $report = $factory->payment_pipeline_auditor()->audit('fr');
