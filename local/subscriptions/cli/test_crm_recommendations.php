...
Examples:
php local/subscriptions/cli/test_crm_recommendations.php --userid=97
php local/subscriptions/cli/test_crm_recommendations.php --userid=97 --persist
php local/subscriptions/cli/test_crm_recommendations.php --list
php local/subscriptions/cli/test_crm_recommendations.php --expire
