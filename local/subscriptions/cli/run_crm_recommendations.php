...
Examples:
php local/subscriptions/cli/run_crm_recommendations.php
php local/subscriptions/cli/run_crm_recommendations.php --limit=50 --json
php local/subscriptions/cli/run_crm_recommendations.php --reset-cursor
