...
php local/subscriptions/cli/validate_payment_consistency.php

php local/subscriptions/cli/validate_payment_consistency.php --strict

php local/subscriptions/cli/validate_payment_consistency.php --json
