...
php local/subscriptions/cli/audit_crm_commerce_shadow.php

php local/subscriptions/cli/audit_crm_commerce_shadow.php --strict

php local/subscriptions/cli/audit_crm_commerce_shadow.php --json
