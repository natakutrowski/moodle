...
Examples:
  php local/subscriptions/cli/maintenance/language/cleanup_duplicate_lang_keys.php
  php local/subscriptions/cli/maintenance/language/cleanup_duplicate_lang_keys.php --apply
