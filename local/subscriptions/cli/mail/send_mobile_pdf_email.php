...
if ($options['help']) {
    ...
    echo "Usage:\n";
    echo "  php local/subscriptions/cli/mail/send_mobile_pdf_email.php --slug=verbed-3e-groupe\n";
    echo "  php local/subscriptions/cli/mail/send_mobile_pdf_email.php --slug=verbes-3e-groupe --execute\n";
    echo "  php local/subscriptions/cli/mail/send_mobile_pdf_email.php --email=test@example.com --execute\n";
    echo "  php local/subscriptions/cli/mail/send_mobile_pdf_email.php --limit=5\n\n";
    echo "Options:\n";
