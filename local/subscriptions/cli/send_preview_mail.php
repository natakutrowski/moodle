<?php
// local/subscriptions/cli/send_preview_mail.php
// Envoi d'un e-mail de test pour vérifier SPF/DKIM/DMARC (ex: vers Mail-Tester).
// Usage : php local/subscriptions/cli/send_preview_mail.php --to="xxxx@mail-tester.com" [--lang=fr] [--subject="..."] [--preview]
...
Exemples :
  php local/subscriptions/cli/send_preview_mail.php --to='xxxx@mail-tester.com'
  php local/subscriptions/cli/send_preview_mail.php --to='xxxx@mail-tester.com' --lang=fr
  php local/subscriptions/cli/send_preview_mail.php --to='xxxx@mail-tester.com' --subject='Test SPF/DKIM CampusFR'
  php local/subscriptions/cli/send_preview_mail.php --to='xxxx@mail-tester.com' --preview
