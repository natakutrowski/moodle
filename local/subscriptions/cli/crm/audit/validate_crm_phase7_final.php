...
$requiredfiles = [
    ...
    'cli/crm/audit/validate_crm_phase7_languages.php',
    'cli/crm/success/validate_crm_success_plan_integrity.php',
    'cli/crm/success/validate_crm_success_plan_lifecycle.php',
    'cli/crm/audit/validate_crm_phase7_tests.php',
