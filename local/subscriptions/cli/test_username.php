<?php
// local/subscriptions/cli/test_username.php
...
Usage :
  php local/subscriptions/cli/test_username.php -f "Иван" -l "Петров" -e "ivan@example.com"
  php local/subscriptions/cli/test_username.php --demo
