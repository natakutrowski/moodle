...
php local/subscriptions/cli/validate_payment_release.php

php local/subscriptions/cli/validate_payment_release.php --strict

php local/subscriptions/cli/validate_payment_release.php --json
