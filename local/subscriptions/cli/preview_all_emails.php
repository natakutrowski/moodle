<?php
// local/subscriptions/cli/preview_all_emails.php
...
if (!empty($o['help'])) {
  ...
  echo "Usage: php local/subscriptions/cli/preview_all_emails.php --user=ID --plan=ID --sub=ID --types=upgrade,failed --amount=61 --currency=EUR\n";
  exit(0);
}
