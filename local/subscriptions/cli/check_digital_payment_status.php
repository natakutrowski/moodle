...
if ($options['help']) {
    ...
    echo "Usage:\n";
    echo "  php local/subscriptions/cli/check_digital_payment_status.php --id=123\n";
    echo "  php local/subscriptions/cli/check_digital_payment_status.php --provider=stripe --limit=20\n";
    echo "  php local/subscriptions/cli/check_digital_payment_status.php --provider=alfa --limit=20\n\n";
    exit(0);
}
