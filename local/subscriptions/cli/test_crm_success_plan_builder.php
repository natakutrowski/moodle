...
Example:
php local/subscriptions/cli/test_crm_success_plan_builder.php --userid=23
php local/subscriptions/cli/test_crm_success_plan_builder.php --userid=23 --persist
