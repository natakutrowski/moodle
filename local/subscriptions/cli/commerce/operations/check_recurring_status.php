<?php
// local/subscriptions/cli/commerce/operations/check_recurring_status.php
// Contrôle du renouvellement récurrent (plan 14 pour Nico), et des enrolments.
//
// Utilisation (par défaut Nico + plan 14) :
//   php local/subscriptions/cli/commerce/operations/check_recurring_status.php
//
// Options facultatives :
//   php local/subscriptions/cli/commerce/operations/check_recurring_status.php --useremail=user@ex.com --planid=14
//
...
if (!empty($options['help'])) {
    ...
    echo "Usage:\n  php local/subscriptions/cli/commerce/operations/check_recurring_status.php [--useremail=EMAIL] [--planid=ID]\n";
    exit(0);
}
