...
if ($options['help']) {
    echo "7.95F7B — Pricing & promotions certification\n\n--json  Emit machine-readable JSON.\n";
    exit(0);
}

$auditor = new CommercePricingCertificationAuditor($DB);
...
echo '# 7.95F7B — Pricing & promotions certification' . PHP_EOL . PHP_EOL;
