...
if ($options['help']) {
    ...
    echo "Usage:\n";
    echo "  php local/subscriptions/cli/commerce/migration/backfill_digital_payment_userids.php\n";
    echo "  php local/subscriptions/cli/commerce/migration/backfill_digital_payment_userids.php --execute\n";
    echo "  php local/subscriptions/cli/commerce/migration/backfill_digital_payment_userids.php --execute --limit=50\n\n";
    exit(0);
}
