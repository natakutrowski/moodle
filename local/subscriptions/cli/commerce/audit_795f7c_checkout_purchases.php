...
if ($options['help']) {
    echo "7.95F7C — Checkout & purchase certification\n\n--json  Emit machine-readable JSON.\n";
    exit(0);
}

$auditor = new CommerceCheckoutCertificationAuditor($DB);
...
echo '# 7.95F7C — Checkout & purchase certification' . PHP_EOL . PHP_EOL;
