...
php local/subscriptions/cli/commerce/audit/audit_commerce_purchase_domain.php

php local/subscriptions/cli/commerce/audit/audit_commerce_purchase_domain.php --limit=250
