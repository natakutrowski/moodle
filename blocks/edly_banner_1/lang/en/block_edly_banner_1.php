<?php
$string['pluginname'] = '[Edly] Banner One';
$string['edly_banner_1'] = '[Edly] Banner One';
$string['edly_banner_1:addinstance'] = 'Add a new [Edly] Banner block';
$string['edly_banner_1:myaddinstance'] = 'Add a new [Edly] Banner style 1 block';
