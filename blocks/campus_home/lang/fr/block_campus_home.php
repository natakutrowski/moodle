...
$string['pluginname'] = '[Campus] Home section';
$string['campus_home'] = '[Campus] Home section';
...
$string['css_class'] = 'Classe CSS du bloc';
$string['css_class_help'] =
    'Entrez une ou plusieurs classes CSS (ex : bloc1, bloc-hero, bloc-dark).<br>
    Chaque instance du bloc peut ainsi avoir un style totalement différent, défini dans styles.css.';
