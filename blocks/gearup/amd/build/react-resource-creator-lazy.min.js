define("block_gearup/react-resource-creator-lazy",(()=>(()=>{var __webpack_modules__={228:module=>{
/*
        object-assign
        (c) Sindre Sorhus
        @license MIT
...
/** @license React v0.20.2
         ...
         * LICENSE file in the root directory of this source tree.
         */
var f,g,h,k;if("object"==typeof performance&&"function"==typeof performance.now){var l=performance;exports.unstable_now=function(){return l.now()}}else{var p=Date,q=p.now();exports.unstable_now=function(){return p.now()-q}}if("undefined"==typeof window||"function"!=typeof MessageChannel){var t=null,u=null,w=function(){if(null!==t)try{var a=exports.unstable_now();t(!0,a),t=null}catch(b){throw setTimeout(w,0),b}};f=function(a){null!==t?setTimeout(f,0,a):(t=a,setTimeout(w,0))},g=function(a,b){u=setTimeout(a,b)},h=function(){clearTimeout(u)},exports.unstable_shouldYield=function(){return!1},k=exports.unstable_forceFrameRate=function(){}}else{var x=window.setTimeout,y=window.clearTimeout;if("undefined"!=typeof console){var z=window.cancelAnimationFrame;"function"!=typeof window.requestAnimationFrame&&console.error("This browser doesn't support requestAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills"),"function"!=typeof z&&console.error("This browser doesn't support cancelAnimationFrame. Make sure that you load a polyfill in older browsers. https://reactjs.org/link/react-polyfills")}var A=!1,B=null,C=-1,D=5,E=0;exports.unstable_shouldYield=function(){return exports.unstable_now()>=E},k=function(){},exports.unstable_forceFrameRate=function(a){0>a||125<a?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):D=0<a?Math.floor(1e3/a):5};var F=new MessageChannel,G=F.port2;F.port1.onmessage=function(){if(null!==B){var a=exports.unstable_now();E=a+D;try{B(!0,a)?G.postMessage(null):(A=!1,B=null)}catch(b){throw G.postMessage(null),b}}else A=!1},f=function(a){B=a,A||(A=!0,G.postMessage(null))},g=function(a,b){C=x((function(){a(exports.unstable_now())}),b)},h=function(){y(C),C=-1}}function H(a,b){var c=a.length;a.push(b);a:for(;;){var d=c-1>>>1,e=a[d];if(!(void 0!==e&&0<I(e,b)))break a;a[d]=b,a[c]=e,c=d}}function J(a){return void 0===(a=a[0])?null:a}function K(a){var b=a[0];if(void 0!==b){var c=a.pop();if(c!==b){a[0]=c;a:for(var d=0,e=a.length;d<e;){var m=2*(d+1)-1,n=a[m],v=m+1,r=a[v];if(void 0!==n&&0>I(n,c))void 0!==r&&0>I(r,n)?(a[d]=r,a[v]=c,d=v):(a[d]=n,a[m]=c,d=m);else{if(!(void 0!==r&&0>I(r,c)))break a;a[d]=r,a[v]=c,d=v}}}return b}return null}function I(a,b){var c=a.sortIndex-b.sortIndex;return 0!==c?c:a.id-b.id}var L=[],M=[],N=1,O=null,P=3,Q=!1,R=!1,S=!1;function T(a){for(var b=J(M);null!==b;){if(null===b.callback)K(M);else{if(!(b.startTime<=a))break;K(M),b.sortIndex=b.expirationTime,H(L,b)}b=J(M)}}function U(a){if(S=!1,T(a),!R)if(null!==J(L))R=!0,f(V);else{var b=J(M);null!==b&&g(U,b.startTime-a)}}function V(a,b){R=!1,S&&(S=!1,h()),Q=!0;var c=P;try{for(T(b),O=J(L);null!==O&&(!(O.expirationTime>b)||a&&!exports.unstable_shouldYield());){var d=O.callback;if("function"==typeof d){O.callback=null,P=O.priorityLevel;var e=d(O.expirationTime<=b);b=exports.unstable_now(),"function"==typeof e?O.callback=e:O===J(L)&&K(L),T(b)}else K(L);O=J(L)}if(null!==O)var m=!0;else{var n=J(M);null!==n&&g(U,n.startTime-b),m=!1}return m}finally{O=null,P=c,Q=!1}}var W=k;exports.unstable_IdlePriority=5,exports.unstable_ImmediatePriority=1,exports.unstable_LowPriority=4,exports.unstable_NormalPriority=3,exports.unstable_Profiling=null,exports.unstable_UserBlockingPriority=2,exports.unstable_cancelCallback=function(a){a.callback=null},exports.unstable_continueExecution=function(){R||Q||(R=!0,f(V))},exports.unstable_getCurrentPriorityLevel=function(){return P},exports.unstable_getFirstCallbackNode=function(){return J(L)},exports.unstable_next=function(a){switch(P){case 1:case 2:case 3:var b=3;break;default:b=P}var c=P;P=b;try{return a()}finally{P=c}},exports.unstable_pauseExecution=function(){},exports.unstable_requestPaint=W,exports.unstable_runWithPriority=function(a,b){switch(a){case 1:case 2:case 3:case 4:case 5:break;default:a=3}var c=P;P=a;try{return b()}finally{P=c}},exports.unstable_scheduleCallback=function(a,b,c){var d=exports.unstable_now();switch("object"==typeof c&&null!==c?c="number"==typeof(c=c.delay)&&0<c?d+c:d:c=d,a){case 1:var e=-1;break;case 2:e=250;break;case 5:e=1073741823;break;case 4:e=1e4;break;default:e=5e3}return a={id:N++,callback:b,priorityLevel:a,startTime:c,expirationTime:e=c+e,sortIndex:-1},c>d?(a.sortIndex=c,H(M,a),null===J(L)&&a===J(M)&&(S?h():S=!0,g(U,c-d))):(a.sortIndex=e,H(L,a),R||Q||(R=!0,f(V))),a},exports.unstable_wrapCallback=function(a){var b=P;return function(){var c=P;P=b;try{return a.apply(this,arguments)}finally{P=c}}}},982:(module,__unused_webpack_exports,__webpack_require__)=>{module.exports=__webpack_require__(463)}},__webpack_module_cache__={};function __webpack_require__(moduleId){var cachedModule=__webpack_module_cache__[moduleId];if(void 0!==cachedModule)return cachedModule.exports;var module=__webpack_module_cache__[moduleId]={exports:{}};return __webpack_modules__[moduleId](module,module.exports,__webpack_require__),module.exports}__webpack_require__.d=(exports,definition)=>{for(var key in definition)__webpack_require__.o(definition,key)&&!__webpack_require__.o(exports,key)&&Object.defineProperty(exports,key,{enumerable:!0,get:definition[key]})},__webpack_require__.o=(obj,prop)=>Object.prototype.hasOwnProperty.call(obj,prop),__webpack_require__.r=exports=>{"undefined"!=typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(exports,"__esModule",{value:!0})};var __webpack_exports__={};__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{dependencies:()=>dependencies,startApp:()=>startApp,startModalApp:()=>startModalApp});var react=__webpack_require__(540),react_dom=__webpack_require__(961);const classNames=function(){for(var _len=arguments.length,classes=new Array(_len),_key=0;_key<_len;_key++)classes[_key]=arguments[_key];return classes.filter(Boolean).join(" ")};let uniqueId=0;const M=window.M,modules={};function moodle_getString(id,component,a){return M.util.get_string(id,component,a)}function moodle_hasString(id,component){return void 0!==M.str[component]&&void 0!==M.str[component][id]}function getModule(name){return modules[name]}var _isBootstrap5;let loadStringCache=function(){let maxItems=arguments.length>0&&void 0!==arguments[0]?arguments[0]:128,items={},keys=[];const purge=()=>{if(keys.length>maxItems){const idx=Math.max(0,keys.length-maxItems);keys.slice(0,idx).forEach((key=>{delete items[key]})),keys=keys.slice(idx)}};return{set:(key,value)=>{items[key]=value,keys.push(key),purge()},get:key=>items[key]}}(64);async function loadString(id,component){const cacheKey="".concat(id,"/").concat(component);let promise=loadStringCache.get(cacheKey);return promise||(promise=getModule("core/str").get_string(id,component),loadStringCache.set(cacheKey,promise)),await promise}const useRoleButtonListeners=onClick=>({onClick:e=>{e.preventDefault(),onClick()},onKeyDown:e=>{" "!==e.key&&"Enter"!==e.key||(e.preventDefault(),onClick())}}),useUniqueId=()=>{const[id]=(0,react.useState)("gu-".concat(Date.now(),"-").concat(uniqueId++));return id},useString=function(id){let component=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"block_gearup",a=arguments.length>2?arguments[2]:void 0;const wasKnownAtMount=(0,react.useMemo)((()=>moodle_hasString(id,component)),[id,component]),[isLoaded,setLoaded]=(0,react.useState)(!1);return(0,react.useEffect)((()=>{setLoaded(!1)}),[id,component]),(0,react.useEffect)((()=>{if(wasKnownAtMount||isLoaded)return;let cancelled=!1;return(async()=>{try{await loadString(id,component),cancelled||setLoaded(!0)}catch(err){}})(),()=>{cancelled=!0}})),moodle_hasString(id,component)?moodle_getString(id,component,a):""},Button=_ref=>{let{onClick:onClick,disabled:disabled,primary:primary,children:children}=_ref;return react.createElement("button",{className:classNames("btn",primary?"btn-primary":"btn-secondary"),onClick:onClick,disabled:disabled,type:"button"},children)},LinkButton=_ref2=>{let{children:children,onClick:onClick,...props}=_ref2;const anchorButtonProps=(onClick=>({href:"#",role:"button",...useRoleButtonListeners(onClick)}))(onClick);return react.createElement("a",{...props,...anchorButtonProps},children)},DynamicFormLoader=_ref3=>{let{formClass:formClass,formArgs:formArgs,onFormLoaded:onFormLoaded}=_ref3;const id="block_gearup-dynamic-form-loader-".concat(Date.now()),[state,setState]=(0,react.useState)();(0,react.useEffect)((()=>{if(formClass===(null==state?void 0:state.formClass))return;const f=new(getModule("core_form/dynamicform"))(document.querySelector("#".concat(id)),formClass);f.load(formArgs).then((()=>{onFormLoaded&&onFormLoaded(f)})).catch(getModule("core/notification").exception),setState({id:id,form:f,formClass:formClass})}),[formClass]);const effectiveId=null!=state&&state.id&&(null==state?void 0:state.formClass)===formClass?state.id:id;return react.createElement("div",{className:"gu-dynamic-form",id:effectiveId})},InputCheckbox=props=>{useUniqueId();const Component=function(){if(void 0===_isBootstrap5){const el=document.createElement("div");el.className="d-grid",el.style.position="absolute",el.style.visibility="hidden",document.body.appendChild(el);const hasGrid="grid"===window.getComputedStyle(el).display;document.body.removeChild(el),_isBootstrap5=hasGrid}return _isBootstrap5}()?InputCheckboxBs5:InputCheckboxBs4;return react.createElement(Component,{...props})},InputCheckboxBs4=_ref4=>{let{checked:checked,onChange:onChange,disabled:disabled,children:children}=_ref4;const id=useUniqueId();return react.createElement("div",{className:"custom-control custom-checkbox"},react.createElement("input",{type:"checkbox",className:"custom-control-input",id:id,checked:checked,onChange:onChange,disabled:disabled}),react.createElement("label",{className:"custom-control-label",htmlFor:id},children))},InputCheckboxBs5=_ref5=>{let{checked:checked,onChange:onChange,disabled:disabled,children:children}=_ref5;const id=useUniqueId();return react.createElement("div",{className:"form-check"},react.createElement("input",{type:"checkbox",className:"form-check-input",id:id,checked:checked,onChange:onChange,disabled:disabled}),react.createElement("label",{className:"form-check-label",htmlFor:id},children))},components_Str=_ref6=>{let{id:id,component:component="block_gearup",a:a}=_ref6;const str=useString(id,component,a);return react.createElement(react.Fragment,null,str||" ")},ListEntry=_ref7=>{let{resource:resource,onSelect:onSelect}=_ref7;const{label:label,description:description,isavailable:isavailable=!0}=resource,headingId=useUniqueId(),buttonListeners=useRoleButtonListeners(onSelect),disabledOpacityClass="".concat(isavailable?"":"gu-opacity-60 group-focus:gu-opacity-100 group-hover:gu-opacity-100");return react.createElement("div",{className:"gu-p-[0.2rem] gu-relative gu-group focus:gu-z-10 hover:gu-bg-gray-100"},react.createElement("div",{tabIndex:0,role:"button","aria-describedby":headingId,className:"gu-px-1.5 gu-py-0.5",...buttonListeners},react.createElement("div",{id:headingId,className:"gu-flex"},react.createElement("div",{className:classNames(disabledOpacityClass,"gu-text-xl gu-text-medium")},label),isavailable?null:react.createElement("div",{className:"gu-ml-2"},react.createElement("span",{className:"badge gu-badge-pill gu-badge-warning"},react.createElement(components_Str,{id:"unavailable"})))),react.createElement("div",{className:classNames(disabledOpacityClass,"gu-text-gray-500"),dangerouslySetInnerHTML:{__html:description}})))},Container=_ref8=>{let{children:children}=_ref8;return react.createElement("div",{className:"gu-min-h-full gu-max-h-full gu-flex gu-flex-col"},children)},EmptyResult=_ref9=>{let{message:message,content:content}=_ref9;return react.createElement("div",{className:"gu-flex-1 gu-flex gu-flex-col gu-items-center gu-justify-center gu-text-center"},react.createElement("div",null,message||react.createElement(components_Str,{id:"noneareavailable"})),content?react.createElement("div",{className:"gu-my-2"},content):null)},PlainResourceList=_ref10=>{let{resources:resources,onSelect:onSelect,emptyContent:emptyContent}=_ref10;return react.createElement("div",{className:"gu-flex-1 gu-min-h-full gu-max-h-full gu-flex gu-flex-col"},react.createElement("div",{className:"gu-max-h-full gu-overflow-y-auto gu-flex gu-flex-1"},resources.length?react.createElement("div",{className:"gu-flex-1 gu-divide-y gu-divide-gray-200"},resources.map((o=>react.createElement(ListEntry,{key:o.name,resource:o,onSelect:()=>onSelect&&onSelect(o)})))):emptyContent||react.createElement(EmptyResult,null)))},ResourceListWithFilters=_ref11=>{let{resources:resources,...props}=_ref11;const filterStr=useString("filterellipsis","block_gearup"),[stringFilter,setStringFilter]=(0,react.useState)(""),[filterUnavailable,setFilterUnavailable]=(0,react.useState)(!0),nUnavailable=(0,react.useMemo)((()=>resources.filter((r=>!r.isavailable)).length),[resources]),hasUnavailable=nUnavailable>0,effectiveStringFilter=stringFilter.trim().toLowerCase(),hasStringFilter=Boolean(effectiveStringFilter);let finalResources=resources;return hasStringFilter&&(finalResources=finalResources.filter((r=>r.label.toLowerCase().indexOf(effectiveStringFilter)>-1||r.description.toLowerCase().indexOf(effectiveStringFilter)>-1))),filterUnavailable&&(finalResources=finalResources.filter((r=>r.isavailable))),react.createElement(Container,null,react.createElement("div",{className:"gu-mb-2 gu-flex gu-flex-row gu-items-center"},react.createElement("div",{className:"gu-flex-1"},react.createElement("input",{className:"form-control gu-w-full",type:"text",placeholder:filterStr,onChange:e=>setStringFilter(e.target.value),value:stringFilter})),hasUnavailable?react.createElement("div",{className:"gu-ml-4 gu-pr-2"},react.createElement(InputCheckbox,{onChange:e=>setFilterUnavailable(!e.target.checked),checked:!filterUnavailable},react.createElement(components_Str,{id:"showunavailablen",a:nUnavailable}))):null),react.createElement(PlainResourceList,{...props,resources:finalResources,emptyContent:react.createElement(react.Fragment,null,hasStringFilter?react.createElement(EmptyResult,{message:react.createElement(components_Str,{id:"nothingmatchesfilter"}),content:react.createElement(Button,{onClick:e=>setStringFilter("")},react.createElement(components_Str,{id:"clearfilter"}))}):react.createElement(EmptyResult,{content:filterUnavailable&&hasUnavailable?react.createElement(Button,{onClick:e=>setFilterUnavailable(!1)},react.createElement(components_Str,{id:"showunavailable"})):null}))}))},components_ResourceList=_ref12=>{let{withFilters:withFilters,resources:resources,...props}=_ref12;const sortedResources=(0,react.useMemo)((()=>resources.sort(((a,b)=>a.label.localeCompare(b.label)))),[resources]);return withFilters?react.createElement(ResourceListWithFilters,{resources:sortedResources,...props}):react.createElement(PlainResourceList,{resources:sortedResources,...props})},App=_ref13=>{var _selected$unavailable;let{resources:resources,onSelected:onSelected,formClass:formClass,formArgs:formArgs={},formResourceArgAlias:formResourceArgAlias="resource",onFormLoaded:onFormLoaded}=_ref13;const[selected,setSelected]=(0,react.useState)(),listRef=(0,react.useRef)(null),formRef=(0,react.useRef)(null),handleSelect=r=>{const Aria=getModule("core/aria"),listDiv=listRef.current,formDiv=formRef.current;setSelected(r),r?r&&(Aria.unhide(formDiv),null==formDiv||formDiv.focus(),Aria.hide(listDiv)):(Aria.unhide(listDiv),null==listDiv||listDiv.focus(),Aria.hide(formDiv)),onSelected&&onSelected(r)},hasSelected=Boolean(selected),classes="gu-absolute gu-inset-0 gu-transform-gpu gu-transition-transform gu-overflow-y-auto gu-duration-300";return react.createElement("div",{className:"gu-w-full gu-h-full gu-overflow-hidden gu-relative"},react.createElement("div",{className:classNames(classes,hasSelected?"gu--translate-x-full":""),ref:listRef},react.createElement(components_ResourceList,{resources:resources,onSelect:handleSelect,withFilters:!0})),react.createElement("div",{className:classNames(classes,hasSelected?"":"gu-translate-x-full"),ref:formRef},selected?react.createElement(react.Fragment,null,react.createElement("div",{className:"gu-text-sm"},"< ",react.createElement(LinkButton,{onClick:()=>handleSelect()},react.createElement(components_Str,{id:"chooseanother"}))),react.createElement("h3",{className:"gu-mt-1"},selected.label),react.createElement("div",{className:"gu-my-4 gu-mt-2 gu-bg-gray-100 gu-p-2",dangerouslySetInnerHTML:{__html:selected.description}}),selected.isavailable?react.createElement(DynamicFormLoader,{onFormLoaded:onFormLoaded,formClass:formClass,formArgs:{...formArgs,[formResourceArgAlias]:selected.name}}):react.createElement("div",null,react.createElement("p",null,react.createElement(components_Str,{id:"unavailablebecause"})),react.createElement("ul",null,null===(_selected$unavailable=selected.unavailablereasons)||void 0===_selected$unavailable?void 0:_selected$unavailable.map(((r,i)=>react.createElement("li",{key:i},r)))))):null))};async function startModalApp(modal,node,props,originatingNode){!async function(modal,root,props,originatingNode){const ModalEvents=getModule("core/modal_events"),saveButton=modal.getFooter().find(modal.getActionSelector("save"));let form;const handleSelected=r=>{r||saveButton.attr("disabled",!r)},handleFormLoaded=f=>{form=f,saveButton.attr("disabled",!1),form.addEventListener(form.events.SUBMIT_BUTTON_PRESSED,(e=>{saveButton.attr("disabled",!0)})),form.addEventListener(form.events.ERROR,(e=>{saveButton.attr("disabled",!1)})),form.addEventListener(form.events.CLIENT_VALIDATION_ERROR,(e=>{saveButton.attr("disabled",!1)})),form.addEventListener(form.events.SERVER_VALIDATION_ERROR,(e=>{saveButton.attr("disabled",!1)})),form.addEventListener(form.events.FORM_SUBMITTED,(e=>{e.preventDefault(),getModule("block_gearup/compat").markFormSubmitted(getModule("block_gearup/compat").getFormNode(form)),originatingNode&&getModule("block_gearup/refreshable").smartRefreshFromNode(originatingNode,!0)?modal.hide():window.location.reload()}))};saveButton.attr("disabled",!0),modal.getRoot().on(ModalEvents.hidden,(e=>{form&&form.notifyResetFormChanges()})),modal.getRoot().on(ModalEvents.save,(e=>{if(!form)return;e.preventDefault();const node=getModule("block_gearup/compat").getFormNode(form),submitter=document.createElement("input");submitter.type="submit",submitter.hidden=!0,node.appendChild(submitter),submitter.click(),node.removeChild(submitter)}));const{resources:resources,resourceExternalFunction:resourceExternalFunction,resourceExternalFunctionArgs:resourceExternalFunctionArgs,...remainingProps}=props;let resourceLoader=Promise.resolve(resources||[]);!resources&&resourceExternalFunction&&(resourceLoader=getModule("core/ajax").call([{methodname:resourceExternalFunction,args:resourceExternalFunctionArgs}])[0]),resourceLoader.then((resources=>{react_dom.render(react.createElement(App,{...remainingProps,resources:resources,onSelected:handleSelected,onFormLoaded:handleFormLoaded}),root)})).catch(getModule("core/notification").exception)}(modal,node,props,originatingNode)}async function startApp(node,props){console.error("block_gearup/react-creator does not implement startApp.")}const dependencies={list:names=["block_gearup/compat","block_gearup/refreshable","block_gearup/utils","core_form/dynamicform","core/ajax","core/aria","core/modal_events","core/modal_factory","core/notification","core/str"],loader:mods=>{mods.forEach(((mod,i)=>{!function(name,mod){modules[name]=mod}(names[i],mod)}))}};var names;return __webpack_exports__})()));

//# sourceMappingURL=react-resource-creator-lazy.min.js.map