 ...
 * Achievement modal.
 *
 * @module     block_gearup/modal_achievement
...
async function open(missionInstId) {
    ...
    modal.setTitle(Str.get_string('achievement', 'block_gearup'));
    modal.setBody(missionInst.then(data => Templates.render('block_gearup/achievements/modal_body', data)));
