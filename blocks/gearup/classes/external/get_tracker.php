...
class get_tracker extends external_api {
    ...
    public static function execute_parameters() {
        return new external_function_parameters([
            ...
            'showsections' => new external_value(PARAM_RAW, '', VALUE_DEFAULT, null),
        ]);
    }
     ...
     * @return void
     */
    public static function execute($contextid, ?string $pageurl, ?string $showsections) {
        global $USER;

        $params = self::validate_parameters(self::execute_parameters(), ['contextid' => $contextid,
            'pageurl' => $pageurl, 'showsections' => $showsections]);
        ...
        $showsections = is_string($showsections) ? array_map('trim', explode(',', (string) $showsections)) : [];
