...
use block_gearup\di;
use block_gearup\local\exporter\objective_type_exporter;
use context;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class get_objective_types extends external_api {
    ...
    public static function execute($contextid) {
        ...
        return array_values(array_map(function ($type) use ($context, $renderer) {
            $otr = new objective_type_exporter($type, ['context' => $context]);
    ...
    public static function execute_returns() {
        return new external_multiple_structure(objective_type_exporter::get_read_structure());
    }
