...
use block_gearup\di;
use block_gearup\local\exporter\outcome_type_exporter;
use context;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class get_outcome_types extends external_api {
    ...
    public static function execute_returns() {
        return new external_multiple_structure(outcome_type_exporter::get_read_structure());
    }
