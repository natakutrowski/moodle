 ...
 */
class tracker implements named_templatable, renderable {

    /** @var context The context. */
    protected $context;
    /** @var moodle_url|null The page URL. */
    protected $pageurl;
    /** @var string[] The sections to show. */
    protected $sectionstoshow = [];
    /** @var int The user ID. */
    protected $userid;
    ...
    public function export_for_template(renderer_base $output) {
        $exporter = di::get('exporter_factory')->get_tracker_exporter($this->userid, [
            ...
            'showsections' => $this->sectionstoshow,
     ...
     */
    public function set_sections_to_show(array $sections): void {
