 ...
 */
class mission_instance_page implements named_templatable, renderable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        $menu = new menu(array_filter([
            [
                'label' => get_string('viewrecruit', 'block_gearup'),
                'href' => $urlresolver->reverse('user', ['userid' => $missioninst->get_subject_id()])->out(false),
            ],
            ['isdivider' => true],
            $canreset ? [
