...
class library_form extends moodleform {
    ...
    protected function definition() {
        ...
        $mform->addElement('filemanager', 'questnarrators', get_string('questnarrators', 'block_gearup'),
            ['class' => 'gu-accepted-types-hidden'], static::get_quest_narrators_options());
        $mform->addElement('static', 'questnarratorsdesc', '', get_string('questnarratorsdesc', 'block_gearup'));

        $mform->addElement('filemanager', 'achievementbadges', get_string('achievementbadges', 'block_gearup'),
            ['class' => 'gu-accepted-types-hidden'], static::get_achievement_badges_options());
