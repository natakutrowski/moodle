 ...
 */
class objective_instance_reset_dynamic_form extends improved_dynamic_form {
    ...
    public function definition() {
        ...
        $mform->addElement(html::register(), null, html_writer::div(markdown_to_html(
            get_string('resetobjectiveinstanceintro', 'block_gearup')), 'last-of-type:[&_p]:gu-mb-0'));
    }
    ...
    protected function process_dynamic_save() {
        if ($data = $this->get_data()) {
            ...
            $objoperator->reset_instance($this->get_objective_instance());
