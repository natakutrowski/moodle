...
class duplicate_mission_dynamic_form extends mission_dynamic_form_base {
    ...
    public function definition() {
        ...
        if ($nassigners > 0) {
            $assignersel = [];
            $assignersel[] = $mform->createElement('select', 'includeassigners', get_string('copyassigners', 'block_gearup'),
                [0 => get_string('no', 'core'), 1 => get_string('yes', 'core')]);
            $assignersel[] = $mform->createElement('static', 'includeassigners_help', '',
