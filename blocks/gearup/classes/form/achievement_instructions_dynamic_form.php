 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class achievement_instructions_dynamic_form extends mission_dynamic_form_base {

    protected function definition() {
        parent::definition();
        $mform = $this->_form;

        $mform->addElement('textarea', 'instructions', get_string('achievementinstructions', 'block_gearup'), [
            'rows' => 5,
            'placeholder' => get_string('achievementinstructionsplaceholder', 'block_gearup'),
        ]);
        $mform->addHelpButton('instructions', 'achievementinstructions', 'block_gearup');
