 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mission_objectives_update_adhoc extends \core\task\adhoc_task {
    ...
    public function execute() {
        ...
        $missioninsts = $repository->get_instances($data->missionid, 0, 0, [], mission_instance::STATE_STARTED);
        foreach ($missioninsts as $missioninst) {
            ...
            $missionoperator->update_instance_objectives($missioninst);
        }
    }
