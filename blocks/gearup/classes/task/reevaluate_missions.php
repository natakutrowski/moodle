 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class reevaluate_missions extends \core\task\scheduled_task {

    public function get_name() {
        return get_string('taskreevaluatemissions', 'block_gearup');
    }
    ...
    public function execute() {
        ...
        $missioninsts = $repository->get_expired_mission_instances();

        // Re-evaluate each mission.
