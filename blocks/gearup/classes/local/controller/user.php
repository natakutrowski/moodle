...
class user extends route_base {
    ...
    protected function content() {
        $achievements = $this->repository->get_achievement_instances_by_subject_id($this->user->id, null,
            $this->context, ['m.title ASC']);
        $quests = $this->repository->get_quest_instances_by_subject_id($this->user->id, null,
            $this->context, ['mi.timestarted ASC', 'mi.timecreated ASC']);
