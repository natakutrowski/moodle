...
class mission_insights extends mission_route_base {
    ...
    protected function get_completion_rate_insight(mission $mission) {
        ...
        [$groupsql, $groupparams] = $this->get_group_sql();
        $avgcompletionrate = $DB->get_field_select(mission_inst::TABLE, 'AVG(completionratio)',
        ...
        list($ymax, $ystep) = $this->get_scale_step($seriesdata, $total);
    ...
    protected function page_insights_content() {
        ...
        $supportscompletionrate = true; // count($objs) > 1 || $objs[0]->get_count_needed() > 1;
