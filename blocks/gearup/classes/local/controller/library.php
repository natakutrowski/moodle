...
class library extends route_base {
    ...
    protected function pre_content() {
        ...
        if ($form->is_cancelled()) {
            ...
            file_save_draft_area_files($data->achievementbadges, $this->context->id, 'block_gearup', 'achievementbadges', 0,
                library_form::get_achievement_badges_options());
            file_save_draft_area_files($data->questnarrators, $this->context->id, 'block_gearup', 'questnarrators', 0,
    ...
    protected function get_initial_form_data() {
        ...
        file_prepare_draft_area($achievementbadgesdraftitemid, $this->context->id, 'block_gearup', 'achievementbadges',
            0, library_form::get_achievement_badges_options());

        $questnarratorsdraftitemid = file_get_submitted_draft_itemid('questnarrators');
        file_prepare_draft_area($questnarratorsdraftitemid, $this->context->id, 'block_gearup', 'questnarrators',
            0, library_form::get_quest_narrators_options());
