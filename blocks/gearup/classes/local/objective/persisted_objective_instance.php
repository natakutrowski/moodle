...
class persisted_objective_instance implements objective_instance {
    ...
    public function set_type_state($state) {
        ...
        // TODO Decide whether we should, or not, validate the state data with a structure like this.
        // $structure = $this->get_objective()->get_type()->get_state_structure();

        // try {
        // TODO This fails when additional keys are left behind, we should
        // take note of this when we modify the structure.
        // \external_api::validate_parameters($structure, is_object($state) ? (array) $state : $state);
        // } catch (\invalid_parameter_exception $e) {
        // throw $e;
        // throw new \coding_exception('Invalid state data.');
        // }
