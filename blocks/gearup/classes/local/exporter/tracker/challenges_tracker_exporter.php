 ...
 */
class challenges_tracker_exporter extends missions_tracker_exporter_base {
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        $challenges = $mr->get_challenge_instances_by_subject_id($this->userid,
        ...
        return [
            ...
            'challenges' => array_map(function($missioninst) use ($ef, $output) {
                return $ef->get_mission_instance_exporter($missioninst, [
                    'url_exporter' => $this->related['url_resolver'] ?? null,
                ])->export($output);
            }, array_values($challenges)),
            'hasany' => count($challenges) > 0,
        ];
