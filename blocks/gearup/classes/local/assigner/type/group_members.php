 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class group_members implements type, type_with_event_consumption, type_with_backup_handling,
        type_with_update_after_restore, has_availability_info_for_context {
    ...
    public function get_elligible_users_sql(assigner $assigner, mission $mission): array {
        ...
        list($sql, $params) = groups_get_members_ids_sql($groupids, $context, GROUPS_JOIN_ANY);
        return [$sql, $params];
    }
