...
class default_container implements container {
    ...
    /**
     * Get the voices repository.
     *
     * @return speech\voices_repository
     */
    protected function get_voices_repository() {
        return new speech\voices_repository(
            $this->get('metadata_cache'),
            $this->get('api_client')
        );
    }
