...
- Narrators can be given an AI voice to read out the quest dialogue
...
- Mission tracker shortcude can display only some of the mission types

Quality of life

- Recruits preference to mute the quest narration is remembered
- The quest narration must end before the recruit can action it
