...
final class repository_test extends base_testcase {
     ...
     * Test.
     *
     * @covers \block_gearup\local\repository\repository::get_incomplete_objective_instances_of_types
     */
    public function test_get_incomplete_objective_instances_of_types(): void {
        ...
        $ois = $mr->get_incomplete_objective_instances_of_types([new manual(), new access_platform()],
            $u1->id,
            $m1->get_context()
        );
     ...
     */
    public function test_get_incomplete_objective_instance_type_names_amongst_types(
        $lookupctxref,
        $m1ctxref,
        $m2ctxref,
        ?string $missionmode,
